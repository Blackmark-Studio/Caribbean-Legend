#define SKILL_MTP_POWER 0.52           // степень, в которую возводим скилл владения оружием для влияния на урон
...
#define EXP_FOR_HIT 0.88                // коэффициент получения опыта за удар
#define EXP_FOR_KILL 0.96              // коэффициент получения опыта за убийство

#define BACKSTAB_ANGLE 37.0            // разница между 180 и фактическим углом удара, принимаемая за удар в спину, 25 это от 155 до 205
