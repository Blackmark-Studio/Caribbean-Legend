...
void InitCannons()
{
	...
	rCannon.Sound = "Cannon_Shot/Cannon_small";
	rCannon.caliber = 3;
	...
	//8-фунтовая пушка новая спелая садовая
	...
	rCannon.Sound = "Cannon_Shot/Cannon_middle";
	rCannon.caliber = 16;
	...
	rCannon.hp = 78.0;
	InitBaseCannons_CalcSpeedV0(&rCannon,625.0);
	...
	rCannon.Sound = "Cannon_Shot/Cannon_large";
	...
	rCannon.TradeOff = true;
	rCannon.hp = 55.0;
	InitBaseCannons_CalcSpeedV0(&rCannon,575.0);
