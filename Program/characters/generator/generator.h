...
#define GEN_ENEMY_COMMONER_HP_BONUS "-3|-2|0|2|4"
#define GEN_ENEMY_ELITE_HP_BONUS    "0|1|2|3|6"
...
#define GEN_PLAYER_HP_BONUS "7|5|0|0|0" // Влияние сложности на хп-за-уровень для ГГ
#define GEN_CHECK_SUM "08.02.2026"      // Тут просто строка для понимания, что конфиг формата val|val|val актуален, можно ставить дату редактирования