...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Que tipo de perguntas, "+GetSexPhrase("rapaz","moça")+"?","O que você precisa, "+GetSexPhrase("bonito","bonita")+"? Pode perguntar."),"Perguntas de novo?","Hihi, se não se importa - perguntas...",""+GetSexPhrase("Hum, por que você não escolhe uma beleza pra você? Estou começando a ficar desconfiada de você...","Hm, por que você não escolhe uma das nossas beldades? Receio que não temos rapazes por aqui, hihi...")+"","block",1,npchar,Dialog.CurrentNode);
