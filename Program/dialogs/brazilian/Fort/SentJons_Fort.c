...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("O que acha do nosso forte? Está bonito, não está? E a guarnição é tão boa quanto, ha...","A vida de um soldado de forte é bem monótona... Guarda, patrulha, dormir e descansar, e depois tudo de novo. Mas na cidade é diferente... O que você quer, "+GetAddress_Form(NPChar)+"?"),"Incomodar um soldado com perguntas tolas não é bem-vindo, "+GetAddress_Form(NPChar)+"...","Já é a terceira vez que você tenta me perguntar isso hoje...","Não é fácil ser soldado, e mesmo assim aqui está você de novo"+GetSexPhrase(", idiota,  "," ")+" tentando me irritar. Tome cuidado ou vai acabar no porão do forte...","block",1,npchar,Dialog.CurrentNode);
