...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "patria_55":
			...
			{
				dialog.text = "Então, você só tem "+FindRussianQtyString(5-int(pchar.questTemp.Patria.Hunter))+" Restam apenas os navios holandeses para trazermos ao nosso porto.";
