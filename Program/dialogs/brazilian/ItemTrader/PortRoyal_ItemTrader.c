...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Sem perguntas por agora...","Desculpe, não tenho nada a dizer agora..."),"Mais uma vez, me desculpe...","Talvez realmente seja hora de negociar...","Desculpe, vamos negociar...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
