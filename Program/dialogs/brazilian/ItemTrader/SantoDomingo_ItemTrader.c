...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Sem perguntas por agora...","Desculpe, não tenho nada a dizer no momento..."),"Mais uma vez, desculpe...","Talvez seja mesmo hora de negociar...","Desculpe, vamos negociar...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
