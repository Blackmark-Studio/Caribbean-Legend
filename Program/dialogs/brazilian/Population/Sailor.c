...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "crew_1":
			...
			dialog.text = "Há "+int(npchar.quest.crew.qty)+" de nós e só aceitaremos ser contratados juntos. Podemos realizar todas as tarefas básicas de marinheiro."+sTemp+"";
		...
		case "crew_2":
			...
			dialog.text = ""+FindRussianMoneyString(int(npchar.quest.crew.money))+" para cada um. E depois, o salário mensal de um marinheiro comum. Não vamos pedir nada exagerado, capitão.";
