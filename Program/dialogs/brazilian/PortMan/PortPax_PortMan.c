...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		if(sti(Pchar.Ship.Type) != SHIP_NOTUSED && ok)//проверка на наличие корабля в порту
		{
			...
			dialog.text = "Vamos registrar você, Capitão "+GetFullName(pchar)+", navio é "+pchar.Ship.Name+"... Tempo da regata em horas é "+sti(pchar.questTemp.Regata.SecondTransitionTime)+". Pronto, seu resultado foi registrado, pode seguir seu caminho.";
