...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "SharkGoldFleet_18":
			...
			dialog.text = "Desculpe pela espera. Aqui estão seus "+int(pchar.questTemp.SharkGoldFleet)+" peças de oito. E, neste caso, eles mesmos vão pagar pela resposta em Caracas. Diga a eles que fui eu quem mandou.";
