...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		if(sti(Pchar.Ship.Type) != SHIP_NOTUSED && ok)//проверка на наличие корабля в порту
		{
			...
			dialog.text = "Vamos registrar: Capitão "+GetFullName(pchar)+", navio é "+pchar.Ship.Name+"... O tempo da regata em horas é "+sti(pchar.questTemp.Regata.ThirdTransitionTime)+". Pronto, seu resultado foi registrado, pode seguir seu caminho.";
