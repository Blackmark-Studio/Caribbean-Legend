void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Grinspy_40":
			dialog.text = "Você não é bobo, " +pchar.name+". ao contrário de muitos por aqui. Sim, é mais ou menos assim que funciona. Pessoalmente, acho toda essa papelada cansativa, mas tem sido assim desde a época de Alan Milroe e daqueles que lideraram o clã Narval antes dele. Mantemos esses registros-e mais do que isso: até registramos navios que foram alcançados primeiro pelos Rivados ou piratas. Nesses casos, é claro, não sabemos quem ou o que estava a bordo...";
		...
		case "WildRose_Alonso_12":
			...
			dialog.text = "E eu estou muito feliz em ver você, capitão! Alguém contou pra aquele desgraçado que você estava atrás dele — e fomos recebidos por uma chuva de balas de canhão bem no meio do caminho. Consegui recuar com um punhado de homens, e corremos pro porto pra dar o alarme. Por sorte, o vigia na torre, assim que me viu no barco a remo que comprei às pressas na cidade, sacou o que estava acontecendo. Ele reuniu os homens rapidinho — e viemos direto pra cá, ajudar.";
			link.l1 = "Obrigado, meu amigo... "+sld.name+" morreu por minha culpa... Eu mandei vocês direto pra armadilha.";
			link.l1.go = "WildRose_Alonso_13";
		break;

		case "WildRose_Alonso_13":
			dialog.text = "Ninguém sabia que era uma armadilha. Você fez tudo certo, era a gente que devia ter sido mais cauteloso.";
			link.l1 = "Mesmo assim... Eu devia ter previsto isso. Não devia ter entrado naquela taverna.";
			link.l1.go = "WildRose_Alonso_14";
		break;

		case "WildRose_Alonso_14":
			dialog.text = "Agora já era, capitão. O que ordena que a gente faça?";
			link.l1 = "Os corpos dos nossos rapazes devem ser enterrados como manda a tradição. Enterre também Northwood, longe daqui, na selva. Ninguém pode saber desse lugar, especialmente a Mary. Então escolha apenas os homens mais confiáveis.";
			link.l1.go = "WildRose_Alonso_15";
		break;

		case "WildRose_Alonso_15":
			dialog.text = "Vai ser feito.";
			link.l1 = "Mary e eu vamos subir a bordo mais tarde. Precisamos de um tempo a sós.";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_261":
			...
			{
				dialog.text = "Meu Deus, "+pchar.name+"... Eu ainda não consigo, simplesmente não consigo acreditar. Meu pai... Ele é um monstro... Por que ele fez isso comigo? Ele matou "+sSname+"! Será que ele enlouqueceu de verdade?";
				link.l1 = "Motim no 'Cornwall', fuga pelo Atlântico, tempestade e a morte da mãe dele, a travessia dos portais daqueles ídolos – sem a poção dos comanches! Provações mais que dignas, sem dúvida. Mas teria sido melhor se ele não tivesse saído vivo de todo aquele inferno.";
			}
			else
			{	
				dialog.text = "Meu Deus, "+pchar.name+"... Eu ainda não consigo, simplesmente não consigo acreditar. Meu pai... Ele é um monstro... Por que ele fez isso comigo? Será que ele enlouqueceu de verdade?";
				link.l1 = "Ele passou por sofrimentos horríveis. Motim no 'Cornwall', fuga pelo Atlântico, tempestade, a morte da sua mãe... Nem consigo imaginar como ele sobreviveu à travessia dos portais daqueles ídolos sem a poção dos comanches – mas isso foi o que destruiu sua sanidade.";
			}
