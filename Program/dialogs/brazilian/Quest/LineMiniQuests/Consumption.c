...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Sergio_24":
			dialog.text = "Capitão, você parece ser um homem de confiança. Outra coisa muito importante é que você é "+GetSexPhrase(""+NationNameMan(int(pchar.baseNation))+"",""+NationNameWoman(int(pchar.baseNation))+"")+" e você tem seu próprio navio. Sugiro que façamos um acordo comercial.";
