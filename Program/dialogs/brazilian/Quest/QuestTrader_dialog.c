void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Escort_choice"://первые развилки - выбираем между городом, бухтой и необитайкой
			...
			switch (hrand(2))
			{
				case 0://город дружественный
					...
					dialog.text = "Gostaria de pedir que me acompanhe até "+XI_ConvertString("Colony"+pchar.GenQuest.Escort.Trader.City+"Gen")+" dentro de "+FindRussianDaysString(int(pchar.GenQuest.Escort.Trader.DaysQty))+". Eu vou te pagar "+FindRussianMoneyString(int(pchar.GenQuest.Escort.Trader.Money))+".";
				...
				case 2://необитайка
					...
					dialog.text = "Gostaria de pedir que me acompanhe até "+XI_ConvertString(pchar.GenQuest.Escort.Trader.Shore+"Gen")+" que fica em "+XI_ConvertString(pchar.GenQuest.Escort.Trader.Island)+", em "+FindRussianDaysString(int(pchar.GenQuest.Escort.Trader.DaysQty))+". Eu vou te pagar "+FindRussianMoneyString(int(pchar.GenQuest.Escort.Trader.Money))+".";
		...
		case "EscortTrader_complete_2":
			dialog.text = "Sim, uma observação muito perspicaz... Aqui, pegue seu "+FindRussianMoneyString(int(pchar.GenQuest.Escort.Trader.Money))+" e adeus.";
