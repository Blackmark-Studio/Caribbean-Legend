...
void ProcessDialogEvent()
{
	...
	case "merida_head_8":
		...
		case "spy_sailor_1":
			...
			dialog.text = "Sim, capitão. Três navios. A capitânia é " + ship1 + ", os outros dois são " + ship2 + " e " + ship3 + ".";
		...
		case "ShipStock_2":
			...
			dialog.Text = "Então, vamos ficar aqui um"+XI_ConvertString(RealShips[int(chref.Ship.Type)].BaseName+"Acc")+" chamado de '"+chref.Ship.Name+"'. Certo?";
			Link.l1 = "Certo.";
