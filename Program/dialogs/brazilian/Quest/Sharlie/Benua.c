...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Benua_3":
			...
			{
				link.l1 = "O senhor tem razão, abade. Começarei imediatamente os preparativos para a partida. Considerando a posição que ocupo agora, pode levar bastante tempo para que tudo seja resolvido...";
			}
		...
		case "SharlieEpilog_Benua_Delivery":
			...
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Patent") && CheckCharacterItem(pchar, "patent_fra") || CheckAttribute(pchar, "questTemp.Patria.GenGovernor") && !CheckAttribute(pchar, "questTemp.SharlieEpilog_Governor"))
			{
				if (CheckAttribute(pchar, "questTemp.Patria.GenGovernor"))
				{
					link.l3 = "Quero notificar o barão Forger e a chancelaria de Capsterville de que sou obrigado a deixar o cargo de governador-geral.";
					link.l3.go = "SharlieEpilog_Benua_Governor";
				}
				else
				{
					link.l3 = "Tenho um patente francesa válida — quero informar a chancelaria de Capsterville sobre a minha decisão.";
			...
			{
				link.l6 = "Preciso enviar uma mensagem a Fadey Moskovita, de Bas-Ter.";
			...
			{
				link.l7 = "Quero informar sobre minha viagem à família Houk, de Maroon Town.";
				link.l7.go = "SharlieEpilog_Benua_Houk";
			}
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Jino") && CharacterIsAlive("Jino"))
			{
				link.l8 = "Quero avisar Gino Guineili, de Saint John's, sobre minha partida para o Velho Mundo.";
		...
		case "SharlieEpilog_Benua_Money_4":
			dialog.text = "Nesse caso, uma doação de cem mil pesos será suficiente. Com esse valor, poderemos oferecer refeições aos necessitados por muitos meses. Se você tiver consigo a quantia necessária, incluindo a doação para a Igreja, podemos começar imediatamente.";
		...
		case "SharlieEpilog_Benua_Money_5":
			dialog.text = "Nesse caso, sua doação deverá ser de duzentos e cinquenta mil pesos. Esses fundos nos permitirão construir um orfanato que levará seu nome e atenderá suas necessidades pelo menos nos primeiros tempos. Se você tiver consigo a quantia necessária, incluindo a doação para a Igreja, podemos começar imediatamente.";
		...
		case "SharlieEpilog_Benua_Governor":
			dialog.text = "Lamento sinceramente, "+pchar.name+", que, para se encontrar com seu pai, você tenha de deixar um cargo tão elevado. Ainda assim, é reconfortante ver que, para você, a família está acima de tudo.";
			link.l1 = "O que me pesa é que, durante todo o tempo em que estive aqui, no Caribe, não tive o cuidado de lhe enviar uma única carta; e pretendo corrigir isso com uma visita pessoal. Por mais vertiginoso que tenha sido o meu sucesso, não devo esquecer o dever para com meu pai. Quanto ao barão — creio que ele poderá perdoar uma saída tão abrupta: afinal, fiz muito em benefício do nosso Estado comum.";
			link.l1.go = "SharlieEpilog_Benua_Governor_2";
			pchar.questTemp.SharlieEpilog_Governor = true;
		break;

		case "SharlieEpilog_Benua_Governor_2":
			dialog.text = "Fizeste uma escolha difícil, mas digna, meu filho. O poder e as honrarias são passageiros, mas o dever para com a família e o nome é eterno. Crê em mim: o Senhor vê tuas intenções e recompensa não pelos títulos, mas pela fidelidade do coração.";
			link.l1 = "Agradeço-lhe, santo padre. Suas palavras significam muito para mim.";
		...
		case "SharlieEpilog_Benua_Governor_4":
			dialog.text = "Excelente. Tomarei todas as medidas para que as cartas sejam entregues no menor prazo possível.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Benua_Delivery";
