void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Cureer":
			dialog.text = "Peço desculpas. Você é " + GetTitle(NPChar, false) + " " + GetFullName(pchar) + "?";
			link.l1 = "Eu mesmo. Em que posso ajudar?";
			link.l1.go = "SharlieEpilog_Cureer_1";
		break;

		case "SharlieEpilog_Cureer_1":
			dialog.text = "Ah, finalmente... Foi bastante difícil te encontrar, quase percorrer todo o arquipélago. Tenho aqui para você uma correspondência do abade Benoît.";
			link.l1 = "Hum... Do abade? Que inesperado.";
			link.l1.go = "SharlieEpilog_Cureer_2";
		break;

		case "SharlieEpilog_Cureer_2":
			dialog.text = "Fui instruído a entregar isso diretamente em suas mãos. Não se preocupe com o pagamento — o abade já cobriu todas as minhas despesas antecipadamente.";
			link.l1 = "Pois bem, então me entregue. Agradeço.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Dassen":
			dialog.text = "Quais são as ordens, "+GetTitle(NPChar, true)+"?";
			link.l1 = ""+npchar.name+", não vou enrolar - estou deixando o arquipélago. Assuntos de família exigem minha presença na propriedade de meu pai.";
			link.l1.go = "SharlieEpilog_Dassen_1";
		break;
		
		case "SharlieEpilog_Dassen_1":
			dialog.text = "Se entendo corretamente, estamos nos despedindo?";
			link.l1 = "Infelizmente... Não posso agir de outra forma.";
			link.l1.go = "SharlieEpilog_Dassen_2";
		break;
		
		case "SharlieEpilog_Dassen_2":
			dialog.text = "Pois bem, foi uma honra para mim servir sob a mesma bandeira que você, e terei prazer em fazê-lo novamente, se assim a sorte permitir.";
			link.l1 = "Espero que nossa amizade não se rompa, mas apenas se fortaleça, pois compartilhamos muitas aventuras juntos.";
			link.l1.go = "SharlieEpilog_Dassen_nothing";
			link.l2 = "Por sua lealdade e profissionalismo, gostaria de pagar, a título de dispensa, um mês de salário.";
			link.l2.go = "SharlieEpilog_Dassen_salary";
			link.l3 = "Você serviu de forma impecável, e considero necessário recompensá-lo devidamente. Aceite isto - aqui estão três meses de salário. Você mais do que mereceu essa recompensa.";
			link.l3.go = "SharlieEpilog_Dassen_salaryX3";
		break;
		
		case "SharlieEpilog_Dassen_nothing":
			dialog.text = "Compartilho sinceramente dessa esperança, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Chame-me apenas de Charles. E, a propósito, tenho algo para você.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			}
			else
			{
				link.l1 = "Pois bem, até novos encontros, monsieur "+npchar.lastname+". Adeus.";
				link.l1.go = "SharlieEpilog_Dassen_Leave";
			}
		break;
		
		case "SharlieEpilog_Dassen_salary":
			dialog.text = "Agradeço-lhe, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Chame-me apenas de Charles. E, a propósito, tenho algo mais para você.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			}
			else
			{
		...
		case "SharlieEpilog_Dassen_salaryX3":
			dialog.text = "Sou-lhe muito grato, "+GetTitle(NPChar, true)+", você é generoso demais comigo.";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Chame-me apenas de Charles. E, a propósito, tenho algo mais para você.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			...
			{
				link.l1 = "Chega de formalidades, chame-me apenas de Charles. Em homenagem à partida, pretendo organizar uma pequena celebração na taverna. Espero que você se junte a nós.";
		...
		case "SharlieEpilog_Dassen_Governor":
			dialog.text = "Você me intrigou, "+pchar.name+".";
			link.l1 = "Recomendei você para o cargo de governador de Isla Mona. Em breve chegará da chancelaria a carta correspondente, e espero sinceramente que você não a recuse. Esta ilha significa muito para mim, e eu ficaria feliz em vê-lo à frente de sua administração.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_1";
		break;
		
		case "SharlieEpilog_Dassen_Governor_1":
			dialog.text = ""+UpperFirst(GetAddress_Form(NPChar))+"... "+pchar.name+"... Isso é bastante inesperado...";
			link.l1 = "E, ainda assim. Qual será a sua resposta?";
			link.l1.go = "SharlieEpilog_Dassen_Governor_2";
		break;
		
		case "SharlieEpilog_Dassen_Governor_2":
			dialog.text = "Esta é uma proposta daquelas que não se recusam. Aceito-a com prazer e prometo fazer tudo pelo florescimento desta ilha e pelo bem-estar de seus habitantes.";
			link.l1 = "Excelente, meu amigo! Então espero você na taverna, na celebração em homenagem à minha partida. Alonso lhe avisará quando tudo estiver pronto.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_3";
		break;
		
		case "SharlieEpilog_Dassen_Governor_3":
			dialog.text = "De forma alguma perderei isso, monsenhor.";
			link.l1 = "";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		
		case "SharlieEpilog_Dassen_Tavern":
			dialog.text = "De forma alguma perderei isso, "+pchar.name+".";
			link.l1 = "Excelente, meu amigo. Então nos encontraremos lá. Alonso lhe avisará quando estivermos prontos para começar.";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		...
		case "SharlieEpilog_PikarOnUliss_D_1":
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarAlive") || CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarResurrected")){dialog.text = "Você tem razão.";}
		...
		case "SharlieEpilog_HenriDeMonper_Mary_4":
			if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "você vai me apresentar aos outros";
			else sStr = "você vai me apresentar ao nosso convidado";
		...
		case "SharlieEpilog_InKitchenDeMonpe_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer") || CheckAttribute(pchar, "questTemp.LSC.Mary_officer"))
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "bons amigos";
				else sStr = "companheiro";
				dialog.text = "";
			...
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "seus bons amigos";
				else sStr = "seu amigo";
				dialog.text = "";
		...
		case "SharlieEpilog_KomendantFort_5":
			dialog.text = "Plano excelente, Vossa Senhoria! Contudo... sois, sem dúvida, um homem forjado em batalhas navais, e ainda assim não é próprio de alguém de vossa posição arriscar a própria vida. A frota pode muito bem ser comandada por...";
			link.l1 = "Assim como não suportei a vida tranquila na Europa, tampouco suportarei a espera ociosa na costa enquanto o destino da batalha é decidido. Do destino não se foge, "+GetAddress_Form(NPChar)+" "+npchar.lastname+". ";
			link.l1.go = "SharlieEpilog_KomendantFort_6";
		break;

		case "SharlieEpilog_KomendantFort_6":
			dialog.text = "Que seja conforme a vossa vontade. Permitis que eu dê a ordem para iniciar os preparativos?";
			link.l1 = "Procedei. E que Deus esteja conosco.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Mishelle_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) sStr = " e sua esposa";
			dialog.text = "Então você ainda não entendeu? Você morreu. Junto com sua tripulação"+sStr+". Um mercador qualquer que você decidiu assaltar detonou a câmara de pólvora — só para que nenhum tostão fosse parar nas mãos de gente como você.\nSpectra sunt memoria peccatorum. É você quem é o fantasma, "+pchar.name+"... A lenda caribenha de um homem devorado pela ganância e pela vaidade cega. Quantos você matou por ouro?";
