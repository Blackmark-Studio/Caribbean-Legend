...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Sharlie_sailor_3":
			...
			link.l1 = "Um navio é um navio, "+GetStrSmallRegister(XI_ConvertString(GetBaseShipParamFromType(int(RealShips[int(pchar.ship.type)].basetype),"Name")))+". Por quê, isso importa tanto assim?";
...
case "Europe":
		...
		case "MOT_Barbie_107":
			dialog.text = "Sim. Infelizmente, tive uma briga com os contrabandistas de Santiago no ano passado. Quase tinha esquecido disso, mas esses indivíduos mantêm conexões estreitas e memórias longas. Aqui vai um conselho: evite irritá‑los e voltar atrás em acordos; é uma situação que você não vai conseguir resolver depois.";
