...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "lecrua_1":
			...
			{
				link.l1 = "Eu tenho um "+GetStrSmallRegister(XI_ConvertString(GetBaseShipParamFromType(int(RealShips[int(pchar.ship.type)].basetype),"Name")))+", o nome dela é "+pchar.ship.name+".";
