...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Que perguntas você tem para um soldado?","O soldado já tem a vida toda planejada - de guarda, correndo atrás das coisas... Em que posso ajudar, "+GetAddress_Form(NPChar)+"?"),"Você não devia incomodar um soldado com perguntas idiotas, "+GetAddress_Form(NPChar)+"...","Já é a terceira vez hoje que você tenta me fazer uma pergunta...","O destino de um soldado não é fácil, e agora você, desgraçado, está me tirando do sério...","block",1,npchar,Dialog.CurrentNode);
