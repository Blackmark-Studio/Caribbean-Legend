...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "tonzag_bail_2":
			dialog.text = "Claro, porém, isso vai sair um pouco mais caro para você. Deixe-me explicar exatamente... "+pchar.questTemp.TonzagQuest.Bail+" dobrões serão "+int(pchar.questTemp.TonzagQuest.Bail)* 150+" pesos.";
