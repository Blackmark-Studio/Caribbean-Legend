...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "prepare_convoy_quest_3":
			...
			dialog.text = "Preciso ser escoltado até "+XI_ConvertString("Colony"+pchar.quest.destination+"Gen")+", que fica em "+XI_ConvertString(GetIslandByCityName(pchar.quest.destination)+"Dat")+", em "+FindRussianDaysString(sti(pchar.ConvoyQuest.iDay))+", e por isso vou te pagar "+FindRussianMoneyString(sti(pchar.ConvoyQuest.convoymoney))+". Então, qual é a sua decisão?";
