void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BM_IronsThirdJungle_22":
			dialog.text = "好吧, 好吧! 更像是他不想为了我浪费时间。 说到杰克, 我喜欢我第一次从他那里看到的几个传统 --木板和发放黑标记。 这让我当时有了一个有趣的想法。 ";
		...
		case "BM_IronsThirdJungle_23":
			dialog.text = "我更喜欢称之为黑标记。 听起来更好。 一个简单的黑标记不会让他意识到什么。 但用我们的丝绸手帕做成的黑标记, 这是我们连队的一个显著特征 --他会明白的。 我小心翼翼地把它塞进他的口袋。 然后我确保他看到我走向灯塔。 你知道剩下的。 ";
			link.l1 = "那走私者呢? ";
		...
		case "BM_IronsThirdJungle_26":
			dialog.text = "嗯, 了解一个有趣的故事是一回事, 自己创造一个故事是另一回事! 所以计划是这样的。 我们需要给盖比留下另一个特殊的黑标记 --我已经做了一个。 然后我们将跟踪他的踪迹到波特兰峡, 在那里我们将处理他, 不留下任何痕迹。 ";
			link.l1 = "我们要把它种在哪里? ";
		...
		case "BM_IronsJamaicaShore1":
			dialog.text = "太好了, 如果有需要, 我们可以从这里快速撤退。 拿着这个 --一旦你发现盖比住在哪里以及他什么时候在家, 就把这张纸条和一个黑标记给他。 ";
		...
		case "BM_IronsClone5":
			...
			link.l1 = "哦, 所以你不否认你那天的所作所为。 我有东西给你, 盖比。 一个黑标记。 但现在船已经被征用, 我们正要让你吐露实情, 嘿嘿嘿嘿嘿嘿... ";
		...
		case "BM_IronsClone13":
			dialog.text = "这是个黑标记, 你这个蠢货。 你知道, 我开始觉得一旦我在这条围巾上绣上骷髅头和骨头, 它就开始给我带来好运。 我无法解释。 拿着它。 还有... 如果你愿意, 你可以随时借用我可靠的剑和盔甲... 剩下的部分, 哈哈! 它会派上用场的! 你会走得很远。 而我想见证这一切。 我不想让你被流弹打死。 ";
