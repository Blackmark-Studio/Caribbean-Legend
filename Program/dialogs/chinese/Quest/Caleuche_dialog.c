void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Tuttuat_12":
			dialog.text = "坏消息, 白人。 卡莱乌切又开始杀戮了。 ";
			link.l1 = "卡莱乌切? 那个亡灵船长称他的船为‘飞翔之心’。 所以, 你知道幽灵船却没有警告我? 如果我知道这艘航行的噩梦在寻找护身符, 我永远不会... ";
		...
		case "Tuttuat_15":
			dialog.text = "我教你如何从卡莱乌切的船长那里夺回护身符。 这并不容易。 但如果你做到了, 你将把他的船作为奖品, 找到宝贵的宝藏, 与你的人民一起赢得荣耀, 并从我这里获得奖励。 ";
		...
		case "Tuttuat_21_1":
			dialog.text = "我知道头骨在加勒比海。 卡莱乌切来这里不是偶然的。 在过去的六个月里, 它经常在岛上被看到。 以前很多年它都不在那里。 卡莱乌切的船长能感觉到美洲虎人的神器。 他就是这样找到你和你的船的。 ";
			link.l1 = "那么, 我是否正确理解我必须再次找到这个头骨? 然后我该怎么处理它? ";
			link.l1.go = "Tuttuat_22";
		break;
		
		case "Tuttuat_21_2":
			dialog.text = "头骨一定在这里, 在加勒比海。 卡莱乌切来这里不是偶然的。 在过去的六个月里, 它经常在岛上被看到。 以前很多年它都不在那里。 卡莱乌切的船长能感觉到美洲虎人的神器。 他就是这样找到你和你的船的。 ";
			link.l1 = "那么, 我是否正确理解我必须再次找到这个头骨? 然后我该怎么处理它? ";
			link.l1.go = "Tuttuat_22";
		break;
		...
		case "Tuttuat_24":
			dialog.text = "为什么这么惊讶, 白人船长? 尤姆.西米尔是死亡之神, 玉头骨赋予统治生死的力量。 加勒比海。 它由美洲虎人守卫。 没有护身符你无法通过他们。 有了护身符, 你可以进入神庙并生存下来, 你把 skull 留在那里, 然后找到卡莱乌切, 击败她的船长, 夺回他从你那里拿走的护身符。 ";
			link.l1 = "为什么卡莱乌切的船长需要这些护身符? ";
			link.l1.go = "Tuttuat_25";
		break;
		
		case "Tuttuat_25":
			dialog.text = "我想他想去美洲虎人的神庙, 他认为护身符会帮助他。 但我可能错了。 尽管如此, 卡莱乌切总是被我土地上的神器所吸引。 她航行到美洲虎人神庙所在的岛屿附近, 也航行到我祖国的海岸。 ";
			link.l1 = "那个岛在哪里? ";
		...
		case "Tuttuat_28":
			dialog.text = "你要小心, 白人船长。 卡莱乌切能感觉到查文的物品。 当你有护身符时, 她会寻找你。 如果她找到你, 赶紧逃跑。 如果她抓住你, 你就死定了。 ";
			link.l1 = "这艘被诅咒的船快得离谱! 它的速度大约是我见过的任何船的两倍。 但我注意到它在逆风航行时很困难。 ";
			link.l1.go = "Tuttuat_29";
		break;
		
		case "Tuttuat_29":
			dialog.text = "卡莱乌切被诅咒了 —这就是它如此之快的原因。 很难逃脱。 你必须有一艘能超越卡莱乌切的船。 否则你会死。 当你找到护身符时, 把它带给我。 不要把护身符留在船上。 ";
			link.l1 = "我已经知道了。 谢谢你的故事, 伟大的萨满。 我该走了。 ";
			link.l1.go = "Tuttuat_31";
		break;
		
		case "Tuttuat_31":
			dialog.text = "我会请求神灵帮助你, 从卡莱乌切手中拯救你。 ";
			link.l1 = "... ";
		...
		case "Tuttuat_37":
			dialog.text = "你说得对。 尤姆.西米尔的玉头骨。 你必须把它带到查文神庙。 然后卡莱乌切将永远失去力量。 ";
		...
		case "Tuttuat_42":
			dialog.text = "这很糟糕, 白人。 现在你无法通过神庙, 也无法击败卡莱乌切。 我不会给你礼物。 现在你离开。 ";
			link.l1 = "... ";
		...
		case "Tuttuat_46a":
			dialog.text = "我认为, 卡莱乌切害怕头骨或者无法感知它。 我没有其他解释。 也许尤姆.西米尔让玉头骨对卡莱乌切非常危险 —除了诅咒之外。 也许这就是船长如此想得到我们人民的三个护身符的原因。 为了获得如何控制尤姆.西米尔咒语的智慧。 ";
			link.l1 = "那么, 只要我在船上带着玉头骨, 我就不必担心卡莱乌切的攻击? ";
		...
		case "Tuttuat_49":
			...
			if (CheckAttribute(pchar, "questTemp.NatanStory")) link.l1 = "哈! 我想我知道那个‘白脸人’... 这个故事听起来太相似了。 那么, 卡莱乌切被击沉了? ";
			else link.l1 = "嗯... 那么, 卡莱乌切被击沉了? ";
		...
		case "Tuttuat_56":
			dialog.text = "是的。 当你来到尤姆.西米尔的神庙时, 你必须找到圣地和里面的巨鹰雕像。 这是神庙最重要的部分。 在这里你放置尤姆.西米尔的玉头骨, 卡莱乌切的诅咒就会解除。 当他再次攻击你时, 你可以像普通人一样击败他。 然后你把他从你那里拿走的护身符带给我。 ";
			link.l1 = "巨鹰? 那是什么? ";
		...
		case "Tuttuat_60":
			dialog.text = "去吧, 白人战士。 我会召唤神灵帮助你对抗美洲虎战士和卡莱乌切。 记住, 如果你使用我给的护身符, 我可以帮助你, 否则你会灭亡";
		...
		case "Tuttuat_63":
			...
			dialog.text = "你解除了卡莱乌切的诅咒。 之后她找到你了吗? ";
		...
		case "Tuttuat_64":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "你是个快速而强大的战士, 白脸人。 图图阿塔帕克不喜欢白人, 但我尊重勇敢和有技巧的战士。 你做得非常好。 你让海洋摆脱了卡莱乌切。 你给我带来了三个护身符。 我会奖励你。 ";
		...
		case "Tuttuat_75":
			...
			{
				sTemp = "";
				if (int(pchar.questTemp.Caleuche.Mangarosa) == 1) sTemp = " 它使你的动作更快, 你更擅长使用轻便武器。 ";
				if (int(pchar.questTemp.Caleuche.Mangarosa) == 2) sTemp = " 它使你在长途旅行中更耐寒, 你更擅长使用锋利的军刀。 ";
		...
		case "fergus_5":
			...
			link.l1 = "信不信由你, 但我告诉你的是实话。 如果不是亲眼所见, 我自己也不会相信, 我可以对着圣经发誓, 或者你可以问问和我在一起的人。 我在与卡莱乌切的那次遭遇中侥幸存活。 ";
			link.l1.go = "fergus_6";
		break;
