void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "WildRose_Alonso_12":
			...
			dialog.text = "见到您我也太高兴了, 船长! 那个混蛋不知道从谁那里听说您在 找他——我们半路上就遭到了霰弹 的迎头痛击。 我带着一小撮兄弟勉强撤了下来, 立刻马不停蹄地冲回港口报信。 幸好, 值勤的哨兵一看到我驾着那艘 我在城里匆忙买下的小艇, 就立刻明白了情况。 他迅速召集了人手——于是我们赶来这里救援。";
			link.l1 = "谢谢你, 朋友…… "+sld.name+"是因我而死的…… 是我把你们送进了陷阱。";
			link.l1.go = "WildRose_Alonso_13";
		break;

		case "WildRose_Alonso_13":
			dialog.text = "没人知道那是个陷阱。 您做得没错, 是我们该更加小心。";
			link.l1 = "可即便如此……我本该预料到的。不该贸然进那家酒馆。";
			link.l1.go = "WildRose_Alonso_14";
		break;

		case "WildRose_Alonso_14":
			dialog.text = "事到如今已经无法改变了, 船长。 接下来您打算怎么做? ";
			link.l1 = "把我们兄弟的遗体按照所有传统好好安葬。 诺斯伍德也一并下葬, 找个偏远的地方, 埋在丛林深处。 这个地方不能让任何人知道, 尤其是玛丽。 所以, 带上最可靠的人去办。";
			link.l1.go = "WildRose_Alonso_15";
		break;

		case "WildRose_Alonso_15":
			dialog.text = "明白。";
			link.l1 = "我和玛丽稍后再登船。 我们需要单独待一会儿。";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_261":
			...
			{
							dialog.text = "天啊，"+pchar.name+"…… 我到现在都无法相信, 真的无法相信。 我的父亲…… 他是个怪物…… 他为什么要这样对我? 他杀了"+sSname+"! 难道他真的已经疯了吗? ";
							link.l1 = "‘康沃尔号’上的叛乱、 横渡大西洋的逃亡、 风暴与你母亲的死亡, 还有在没有科曼奇人药剂的情况 下穿越那些神像的传送门——必须承认, 这些考验确实非同一般。 可即便如此, 他最好还是没能从那场地狱里活着出来。";
			}
			else
			{	
