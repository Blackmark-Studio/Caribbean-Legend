void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "WildRose_Chimiset_44":
			dialog.text = "没必要了, Mary。你只要照照镜子就知道——你和她简直一模一样。只是你的眼睛是遗传自你父亲的。";
			link.l1 = "...";
		...
		case "WildRose_Sesil_18_2":
			dialog.text = "他从来没提过这种事。你想想看, 对吧, "+npchar.name+", 如果你打算越狱, 你会一见到陌生人就把这事说出来吗? 那家伙绝对不会这么做, 我跟你说。";
		...
		case "WildRose_Chimiset_64_2":
			...
			link.l1 = "你知道吗, 我突然想到, Aurelie好像一直在等我们, 就像她早就知道我们会来找她一样。那位老妇人本可以早一天或晚一天去世, 但她偏偏就在告诉我们关于Mary父亲的重要事情后没多久就去世了。"link.l1.go ="WildRose_Chimiset_65";
			AddCharacterExpToSkill(pchar, "sneak", 100);
		break;
		...
		case "WildRose_Chimiset_68_1":
			dialog.text = "因为我决定要帮你, 我的朋友, 让你知道你需要知道的事情, 也让她完成她的使命。如果我提前告诉你她将面临什么, 你也许就不会继续下去了——而Aurélie就会把她的秘密带进坟墓。那样又有什么意义呢? 她就会白白死去。就像一只被狮子扑倒的羚羊, 最后却没被吃掉, 只能被秃鹫啃食一样。";
			link.l1 = "命运, 目标……你可真是个造命的人, "+npchar.name+"。人间的上帝。";
		...
		case "WildRose_Rupert_38":
			dialog.text = "特蕾莎是第一个被找到的。Casper已经给自己倒了满满一杯威士忌, 所以对任何求情都充耳不闻, 直接下令把那女孩扔下海。不管我怎么求他, 他只是笑得喘不过气来——该死, 我现在跟你说这些的时候, 脑子里还能听见他的笑声……";
		...
		case "WildRose_Rupert_40":
			dialog.text = "我原本确信自己能驾驶 '康沃尔号' 横渡大洋。在这里, 没人认得我们的脸, 对吧? 这就给了我们重新开始新生活的机会。说服其他军官并不难——我的权威还不如那几只普通水手根本不知道的箱子里的东西重要。船员们决定了——Joshua Casper必须活下去。我们几个军官同意拖延时间, 牺牲其中一个箱子。\n可有个混蛋把第二只箱子的事泄露了——结果船员们分裂了。";
			link.l1 = "他们现在开始对你发动叛变了? ";
