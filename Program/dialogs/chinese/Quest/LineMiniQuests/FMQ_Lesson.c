...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "contra_1":
			...
			link.l1 = "" + FindRussianQtyString(int(pchar.questTemp.FMQL.Sanl)) + "的铁木, " + FindRussianQtyString(int(pchar.questTemp.FMQL.Silk)) + "的船用丝绸, " + FindRussianQtyString(int(pchar.questTemp.FMQL.Rope)) + "的绳索和" + FindRussianQtyString(int(pchar.questTemp.FMQL.Oil)) + "的树脂。 ";
			link.l1.go = "contra_2";
		break;
