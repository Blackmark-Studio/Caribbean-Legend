...
void ProcessDialogEvent()
{
	...
	case "rocur_42": //邪恶选项
		...
		case "rocur_44":
			...
			{
            	dialog.text = "干得好, "+pchar.name+"! 是时候分赃了。 我已经算好数目了。 箱子里差不多有2000颗宝石: 1560颗翡翠, 1032颗蛋白石和363颗火蛋白石。 你的那份是三分之一: 350颗翡翠, 244颗蛋白石和63颗火蛋白石。 给, 拿着吧。 ";
            }
            else
           	{
           	dialog.text = "干得好, "+pchar.name+"! 是时候分赃了。 我已经算好数目了。 箱子里差不多有2000颗宝石: 1050颗翡翠, 732颗蛋白石和189颗火蛋白石。 你的那份是三分之一: 350颗翡翠, 244颗蛋白石和63颗火蛋白石。 给, 拿着吧。 ";
           	}
			link.l1 = "太好了! ";
			link.l1.go = "rocur_45";
		break;
		...
		case "rocur_80":
            dialog.text = "别想信任这个妓女。 明天泰瑞克斯就会知道一切。 你想收到黑色印记吗? ";
	...
	case "merida_head_8":
		...
		case "spy_sailor_1":
			...
			dialog.text = "是，船长。三艘船。旗舰是 " + ship1 + "，另外两艘是" + ship2 + "和" + ship3 + "。";
		...
		case "IslaMona_11":
			...
			AddRumor("他们说一些罪犯被流放到一个无人居住的岛屿上! 看来他们是如此凶猛的怪物, 甚至刽子手和神父都不想对付他们! 但为什么他们总是把这样的人带到我们这里来? ! ", "1", "all", "none", "0", string((2022 - STARTGAME_YEAR) * 365), "IslaMona_TerksRumour", "none");
		break;
		...
		case "ShipStock_2":
			...
			dialog.Text = "那么, 我们要在这里保管一艘名为‘" + chref.Ship.Name + "’的" + XI_ConvertString(RealShips[int(chref.Ship.Type)].BaseName + "Acc") + ", 对吗? ";
			Link.l1 = "对。 ";
