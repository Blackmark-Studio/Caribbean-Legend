...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "story_24":
			...
			link.l1 = "为了移除卡莱乌切的诅咒... 嗯, ‘飞翔的荷兰人号’的诅咒。 实际上, 她的名字是‘飞翔的心’, 她的船长名字是‘巴尔萨泽.德.科尔德斯’。 五十年前, 他被印第安死神尤姆.西米尔诅咒。 我拿走了被巴尔萨泽从神庙偷走的尤姆.西米尔的玉头骨, 并把它放回秃鹰雕像前的基座上... ";
			link.l1.go = "story_25";
		break;
		
		case "story_25":
			dialog.text = "";
			link.l1 = "... 通过归还头骨, 我移除了卡莱乌切的诅咒。 因为我身上还有另外两个查文护身符, 她在岛附近攻击了我, 就像当年发生在你身上的一样。 但正如图图阿塔帕克所说, 没有了诅咒, 巴尔萨泽不再不朽。 所以... ‘飞翔的荷兰人号’不再存在了。 我亲自处理了她。 ";
			link.l1.go = "story_26";
		break;
