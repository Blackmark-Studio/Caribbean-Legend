...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ClockTower_Johan_4":
			dialog.text = "van Doorn 管事。 也许他并不完全算主管, 但大家都这么叫他。 他在这里工作十年了 —— 把一切都整顿得井井有条。 现在加勒比海上的所有船只都要经过他的办事处。";
		...
		case "ClockTower_Johan_45":
			dialog.text = "Mynheer van Doorn 一 旦恼火, 就会停下钟, 开始摆弄它。有时整座城市半天都没有时间。而这种事…… ";
			link.l1 = "...";
