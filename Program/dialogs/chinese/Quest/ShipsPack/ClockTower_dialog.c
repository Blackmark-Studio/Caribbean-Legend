...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ClockTower_Johan_4":
			dialog.text = "范多伦管事。 也许他并不完全算主管, 但大家都这么叫他。 他在这里工作十年了——把一切都整顿得井井有条。 现在加勒比海上的所有船只都要经过他的办事处。";
		...
		case "ClockTower_Johan_8_2":
			dialog.text = "嗯, 我也不太清楚。 主管先生会奖励威廉斯塔德的朋友。 帮助这座城市——你就会被注意到。 我明白, 你不是本地人。 但这里讲规矩。 主管先生总是说: 一旦松懈, 我们的塔就会倒塌。";
			link.l1 = "明白了。 你叫什么名字? ";
		...
		case "ClockTower_Visser_2":
			dialog.text = ""+GetFullName(NPChar)+", 副主管。 \n"+
						 "我听说您为威廉斯塔德帮了不少忙。 也许我们办事处也能为您提供帮助。";
			link.l1 = "这就是我来这里的原因。";
		...
		case "ClockTower_Visser_9_3":
			dialog.text = "在海上。 范多伦先生既管理办事处, 又指挥旗舰。";
			link.l1 = "他是怎么做到的? ";
		...
		case "ClockTower_Visser_22":
			dialog.text = "很好。 让我看看\n"+
						"是的, 一切正常。 这些都是真正的海盗船。 工作做得很好。 您应得" + SellJournals() + "金币\n"+
						"请收下。 还请在这里签个字。";
			link.l1 = "那我算是在名单上了? ";
		...
		case "ClockTower_Visser_29":
			dialog.text = "好的。 现在在这里签名, 这里, 还有这里也要签一下。";
			link.l1 = "就这样? ";
		...
		case "ClockTower_Johan_45":
			dialog.text = "范多伦先生 一 旦恼火, 就会停下钟, 开始摆弄它。 有时整座城市半天都没有时间。 而这种事... ";
			link.l1 = "...";
		...
		case "ClockTower_VanDoorn_2":
			...
			dialog.text = "这不公平——我对你的一切了如指掌, 而你除了约翰的闲言碎语外对我一无所知。 我是亨德里克.范多伦。 荷兰西印度公司加勒比地区登记部门主管。 护卫舰阿姆斯特丹号指挥官。 "+shipType+"。 "+GetCannonQuantity(npchar)+"门炮和"+GetMaxCrewQuantity(npchar)+"名船员。";
			link.l1 = "很高兴认识您。";
		...
		case "ClockTower_VanDoorn_3":
			dialog.text = "您获得了五本海盗航海日志。 我的副手对您评价很高, 将您登记到客户名册中, 并向您介绍了我办事处的服务\n"+
						"但准入的最终决定权始终在我, 亲自决定。 在面谈之后, 马尔滕只能提议候选人——仅此而已。";
			link.l1 = "那么, 我们开始吧。";
		...
		case "ClockTower_VanDoorn_4":
			...
			{
				link.l1 = "我消灭了莫蒂默.格林。 海盗双桅横帆船'纪念品号'的船长。";
			...
			{
				link.l2 = "我想您的公司高度评价了我战胜阿尔伯特.布莱克伍德的胜利。 巡逻雪帆船'贝丝女士号'是个强大的对手。";
			...
			link.l7 = "维瑟先生已经验证了我的能力。 您自己副手的评估还不够吗? ";
			link.l7.go = "ClockTower_VanDoorn_5";
			npchar.ClockTower_option = true;
		break;
		
		case "ClockTower_VanDoorn_option_1":
			dialog.text = "格林? 我们组织从未对格林有过任何不满, 恰恰相反。 但对取代他位置的那个人... 我知道他是谁, 以及他最初来到加勒比海的目的。 这样的恶行没有诉讼时效, 我很高兴您惩罚了这个罪犯和我国真正的敌人。";
			link.l1 = "...";
			link.l1.go = "ClockTower_VanDoorn_4";
		...
		case "ClockTower_VanDoorn_option_6":
			dialog.text = "所以它们一文不值——当然, 除非那是达布隆金币。";
			link.l1 = "...";
			link.l1.go = "ClockTower_VanDoorn_4";
		...
		case "ClockTower_VanDoorn_11":
			...
			dialog.text = "我们只接受预约。 您的预约时间是... "+month+""+pchar.quest.ClockTower.date+"号。 如果您在指定日期没来, 也没关系。 联系约翰, 他会告诉您下一个可用的预约时间。";
			link.l1 = "为什么要这么麻烦? ";
		...
		case "ClockTower_VanDoorn_12":
			...
			Month = XI_ConvertString("MonthGen_" + NextMonth);
			dialog.text = "我们的工作很昂贵, 因为我们创造真正的奇迹, 为客户带来巨大的利益。 利益冲突是不可能的, 因此我们将整个工作日专门用于满足特定人员的需求。 您的下一个可用日期: "+month+""+pchar.quest.ClockTower.date+"号\n"+
			"如果您见到维瑟... 马尔滕提议您的候选资格是正确的。 告诉他这一点。 他是个好副手。 让他不要怀疑。";
			link.l1 = "好的。";
		...
		case "ClockTower_Visser_44":
			...
			link.l1 = "副手先生, 你突然变得不像你自己了。";
			link.l1.go = "ClockTower_Visser_45";
		break;

		case "ClockTower_Visser_45":
			dialog.text = "船长, 我是个生意人, 你也是, 所以我就直说了。 \n"+
			 "主管先生早就不为我们工作了。";
			link.l1 = "什么, 您说什么? ! ";
		...
		case "ClockTower_Visser_48_2":
			dialog.text = "我不会撒谎。 我真的累了。 见鬼, 范多伦提拔我就是为了让我在合同结束时接替他! ";
			link.l1 = "...";
			link.l1.go = "ClockTower_Visser_49";
		break;
		...
		case "ClockTower_Visser_50":
			dialog.text = "不, 先生。 想要赶走范多伦的是我们共同的上级。 就是那些坐在塔楼墙后——这栋建筑中央区的人! 但连他们都无法管住他! ";
			link.l1 = "这有什么难的? 范多伦肯定没有斯特伊弗桑特重要。";
			link.l1.go = "ClockTower_Visser_51";
		break;

		case "ClockTower_Visser_51":
			dialog.text = "这不是一艘船, 也不是王室宫廷, 船长。 我们的公司是一种全新的组织形式。 你不能只是指着某人就解雇这样一位有价值的人\n"+
						 "首先, 没人知道范多伦那份合同的原件在哪里。 因此, 根本不存在解雇他的理由。 要是我们真这么做了, 他会派来一大群钻法律空子的律师, 结果反倒是我们欠他的\n"+
						 "其次, 管理层犯了个错误, 给了范多伦'阿姆斯特丹号'的指挥权。 他也许不是个出色的船长, 但他组建的船员是整个地区最好的。 只要他下令, 公司的精锐士兵会毫不犹豫地占领这栋建筑\n"+
						 "第三, 他的妻子非常爱他。 尽管他已经好几年没见过她了。 德.维特本人的女儿, 能为心爱的丈夫做很多事。 而十七人议会也只能对此睁一只眼闭一只眼\n"+
						 "你今天已经亲眼见识过他的爆发了, 船长。 我告诉你一个秘密: 这种事正在变得越来越频繁。 董事们害怕有一天他会把他们统统赶出去, 而他们却无能为力——因为'阿姆斯特丹号'就停在港口, 范多伦的办公室里有一位重要客户, 而在家里, 他还有来自岳父——七省共和国大议长的支持\n"+
						 "换句话说, 董事会会为你的帮助支付丰厚的报酬。 并且会保留你在船只登记处的特权。";
			link.l1 = "令人印象深刻。 你真是个生意人, 马尔滕。 你向我兜售背叛, 用的正是不久前你推销办事处服务时的那种专业手法。";
			link.l1.go = "ClockTower_Visser_57";
		break;

		case "ClockTower_Visser_57":
			dialog.text = "当范多伦亲自教你谈判艺术, 而你又真诚相信自己所说的话时, 这并不难。";
			link.l1 = "那么你想要我做什么? ";
			link.l1.go = "ClockTower_Visser_58";
		break;

		case "ClockTower_Visser_58":
			dialog.text = "只有外人才能做的事。 晚上潜入办公室, 找到范多伦的合同原件。 我会确保门是开着的。";
			link.l1 = "你为什么不自己做? 又是什么阻止我现在就去把一切告诉你的上司? ";
			link.l1.go = "ClockTower_Visser_59";
		break;

		case "ClockTower_Visser_59":
			dialog.text = "因为范多伦习惯在夜里接待任何人, 除了公司员工。 如果有人看到你在不寻常的时间离开这座塔楼, 不会有人感到惊讶。";
			link.l1 = "";
		...
		case "ClockTower_Visser_60":
			...
			Month = XI_ConvertString("MonthGen_" + NextMonth);
			dialog.text = "至于你的威胁... 你现在见不到主管, 你约的是另一天。 "+month+""+pchar.quest.ClockTower.date+"号, 对吧? 到那时候, 消息的紧迫性就会降低不少。 而且, 主管从不奖励告密者。 他总是保护自己的员工。";
			link.l1 = "对你来说倒是方便。";
			link.l1.go = "ClockTower_Visser_61";
		break;

		case "ClockTower_Visser_61":
			dialog.text = "这不是背叛, 船长。 我们只是想遵守合同, 保护公司的安全。 还有威廉斯塔德, 顺便说一句, 你帮了它很多。";
			link.l1 = "我会考虑的。 但我什么都不承诺。";
			link.l1.go = "ClockTower_Visser_62";
		break;

		case "ClockTower_Visser_62":
			dialog.text = "我对你的要求不过如此, 船长。 首先, 你是我们的客户。 无论结果如何, 我都非常自豪, 正是我找到了你, 并把你录入了办事处的登记册。";
			link.l1 = "...";
		...
		case "ClockTower_Johan_51":
			if (GetHour() >= 6 && GetHour() < 24)
			{
				...
				else
				{
					if (!CheckAttribute(npchar, "ClockTower_repeat"))
					{
						dialog.text = ""+UpperFirst(GetTitle(NPChar, true))+", 您约的是另一天。 我们很高兴在"+month+""+pchar.quest.ClockTower.date+"号见到您。";
						npchar.ClockTower_repeat = true;
						SetFunctionTimerCondition("ClockTower_GuardianNewDay", 0, 0, 1, false);
					}
					else
		...
		case "ClockTower_Johan_53":
			...
			{
				dialog.text = "是的。 主管先生刚下了命令。 他是怎么做到的, 我不知道, 但我的时间还是够用的, 既能休息又能值班。 而且他们还给我涨了工资——真没什么可抱怨的! ";
		...
		case "ClockTower_Johan_54":
			...
			{
				dialog.text = "呃。 您想从我这儿得到什么, 船长先生? 我只是个普通士兵, 什么都不知道。";
				link.l1 = "你什么都知道, 约翰。 别这么谦虚。 高层办公室里的先生们也许不用向你汇报, 但你肯定听说过他们之间的矛盾。";
				link.l1.go = "ClockTower_Johan_55";
				Notification_Skill(true, 80, SKILL_LEADERSHIP);
			}
			else
			{
				dialog.text = "我只是个小人物, 但我不会越过直属上司。 抱歉, 船长先生。";
				link.l1 = "我们还会再谈这个话题的。";
		...
		case "ClockTower_Johan_58_hint":
			ClockTower_AddBook();
			dialog.text = "您是个好人, 船长先生。 也许我能帮到您: 我知道主管先生在其中一本书里藏着一把钥匙。 是干什么用的——我不知道, 但也许会有用。";
			link.l1 = "谢谢你, 约翰。";
		...
		case "ClockTower_Peter_51":
			...
			else
			{
				if (!CheckAttribute(npchar, "ClockTower_repeat"))
				{
					dialog.text = "您的预约在另一天: "+month+""+pchar.quest.ClockTower.date+"号。";
					npchar.ClockTower_repeat = true;
					SetFunctionTimerCondition("ClockTower_GuardianNewDay", 0, 0, 1, false);
				}
				else
		...
		case "ClockTower_Visser_74":
			dialog.text = "我会把合同送到阿姆斯特丹。 十七人议会会做出决定。 多伦会被命令回去。 他无法拒绝。";
			link.l1 = "如果他拒绝呢? ";
			link.l1.go = "ClockTower_Visser_75";
		break;

		case "ClockTower_Visser_75":
			dialog.text = "他做不到。 虽然他的妻子是股东、 大议长的女儿, 但就连她父亲也不会对抗议会。 而卡特琳娜本人... 她已经等了十年。 如果她知道他可以回去却拒绝了——这会要了她的命。";
			link.l1 = "真残酷。";
			link.l1.go = "ClockTower_Visser_76";
		break;

		case "ClockTower_Visser_76":
			dialog.text = "是的。 但这是唯一的办法。 谢谢你, 船长。 你做了一件重要的事。";
			link.l1 = "...";
		...
		case "ClockTower_Visser_77":
			...
			{
				dialog.text = "你的报酬——五百杜布隆。 我向你保证: 两三个月后, 当我坐上主管的位子时, 你将获得办事处服务的无限使用权。 不用排队。 不用预约。 随时都可以。";
				AddItems(pchar, "gold_dublon", 500);
			}
			else
			{
				dialog.text = "而且你杀了约翰。 我已经背叛了一个我敬佩、 欠他一切的人。 现在又是这个\n"+
							 "也许在你的船上, 人命如草芥, 但公司珍视自己的员工。 而我对自己成为谋杀的帮凶感到恶心\n"+
							 "你的杜布隆会给约翰的家人, 但我会履行交易的第二部分\n"+
							 "我向你保证: 两三个月后, 当我坐上主管的位子时, 你将获得办事处服务的无限使用权。";
			}
		...
		case "ClockTower_Visser_82":
			dialog.text = "谢谢。 十七人议会的决定比我预期的要快。 合同被证明是充分的证据。 范多伦先生被解除了办事处的管理职务。";
			link.l1 = "他是怎么接受的? ";
		...
		case "ClockTower_Visser_83":
			dialog.text = "他懂得如何接受失败。 只是从办公室收拾了私人物品就离开了。 不过他真的输了吗\n"+
			 "他们保留了他对阿姆斯特丹号的指挥权。 在这一点上, 公司确实犯了个错误。 当时就不应该把那艘船给他\n"+
			 "我们低估了他。 希望最终结果不会更糟\n"+
			 "而这还不是全部。 "
			link.l1 = "还能有多糟? ";
		...
		case "ClockTower_Visser_84":
			dialog.text = "范多伦先生知道是谁从他办公室拿走了合同。";
			link.l1 = "怎么会? ! ";
		...
		case "ClockTower_Johan_61":
			dialog.text = ""+UpperFirst(GetTitle(NPChar, true))+", 您被期待着。 维瑟先生命令所有客户可以自由进入。 他说旧规矩太严格了。";
			link.l1 = "谢谢你, 约翰。";
			link.l1.go = "exit";
		...
		case "ClockTower_Helena_2":
			dialog.text = "啊, 要是真的就好了, 我的船长。 你生活中还有其他的激情。 比如现在, 占据你英俊脑袋的就不是我, 对吧? ";
			link.l1 = "...";
		...
		case "ClockTower_Helena_3":
			...
			link.l1 = "要让范多伦亲自来找我们, 我就必须成为威廉斯塔德的敌人。";
			link.l1.go = "ClockTower_Helena_4";
		break;

		case "ClockTower_Helena_4":
			dialog.text = "哦, 我的船长... 所以就这样了。 不是第一次了, 对吧? ";
			link.l1 = "好像你不赞成似的。";
		...
		case "ClockTower_Mary_3":
			dialog.text = "我就是知道! 我看到了那艘阿姆斯特丹号, 真的。 漂亮的船, 非常漂亮。 但是\n"+
						 "你已经决定好了一切... 就像以前一样, 对吧? ";
			link.l1 = "范多伦会亲自来找我们, 但为此我必须成为威廉斯塔德的敌人。";
		...
		case "ClockTower_Mary_5":
			dialog.text = "我希望你快乐, 真的。 但我还是会请阿隆索再劝劝你放弃这件事, 好吗! ";
		...
		case "ClockTower_Alonso_2":
			dialog.text = "事情是这样的, 船长, 但你必须听我说。 这是, 呃, 怎么说来着\n"+
						 "紧急情况——就是这个! \n"+
						 "总之, 有只小鸟告诉我, 您亲自把公司的一位主管从他舒适的位子上赶了下来, 而他怀恨在心, 现在正开着他那艘漂亮的护卫舰追杀我们。";
			link.l1 = "这明显是夸大其词。";
			link.l1.go = "ClockTower_Alonso_3";
		break;

		case "ClockTower_Alonso_3":
			dialog.text = "您知道人们有多爱嚼舌根, 船长。 让谣言酝酿一周——您就会听说范多伦被种植园主的女儿迷住了, 阿姆斯特丹号上有活死人船员, 货舱里藏着科尔特斯本人的宝藏\n"+
						 "但我更关心真实情况。 那么, 船长, 会有战斗还是不会? ";
			link.l1 = "...";
		...
		case "ClockTower_Alonso_4_5":
			dialog.text = "...";
			link.l1 = "如果真要打, 也不会很快。 范多伦不会寻求报复, 他不是那种人。 首先我们得好好激怒荷兰人。";
			link.l1.go = "ClockTower_Alonso_4_6";
			CharacterTurnByChr(npchar, pchar);
		break;

		case "ClockTower_Alonso_4_6":
			dialog.text = "谢谢, 船长, 这会让船员们安心。";
			link.l1 = "那你呢? ";
		...
		case "ClockTower_Alonso_8":
			dialog.text = "你把一切都搞复杂了! 船长想要一艘漂亮的船——我们就给他弄一艘漂亮的船! 我们是一个团队! ";
			link.l1 = "继续保持, 阿隆索。 汤米, 出去。";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("ClockTower_CuracaoInCabin_4_DlgExit");
		break;
		...
		case "ClockTower_VanDoorn_24":
			dialog.text = "来自卡特琳娜的? ! 您怎么敢把私事和公事混在一起? ! ";
		...
		case "ClockTower_VanDoorn_27":
			dialog.text = "那么恭喜您获胜, 船长"+GetFullName(pchar)+"。 今天登记册上只会少一个船长。 再见。";
			link.l1 = "...";
		...
		case "ClockTower_Visser_102":
			dialog.text = "服务? 服务? ! 在您做了那些事之后? 您是尊贵的荷兰西印度公司的敌人! 另一个船长会取代您的客户位置! ";
			link.l1 = "不太可能。 看看我在范多伦的文件里找到了什么。";
		...
		case "ClockTower_Visser_106":
			...
			link.l1 = "唉, 马尔滕。 您想要占据主管的位置, 尽管他给了您一切。 他把您从审判中救了出来, 甚至不认为有必要告诉您。";
		...
		case "ClockTower_Visser_108":
			dialog.text = "...";
			link.l1 = "现在轮到您被束缚在这个地方了。 但您肯定不会有像范多伦那样的副手。";
		...
		case "ClockTower_Visser_110":
			dialog.text = "您的船是阿姆斯特丹号。 荷兰西印度公司旗舰。 它不能就这么... 重新登记。";
		...
		case "ClockTower_OfficeServices_audit_chosenIdx":
			...
			if (CanUpgradeShip(sld, &sTemp, "Audit"))
			{
				...
				dialog.text = "让我看看... 这将花费您" + n + "枚杜布隆金币。";
			...
			{
				dialog.text = "恐怕我不得不拒绝您。 根据登记册, 您的船多年前已经葬身海魔之口, 这样的时间幽灵无法靠一纸文书改变。 在我们能够合作之前, 您需要先将它修复。 据说宝藏岛上有一位工匠愿意接下这样的工作。";
				link.l1 = "明白, 谢谢。";
				link.l1.go = "ClockTower_OfficeServices_exit";
			}
		...
		case "ClockTower_OfficeServices_changeTrait_chosenIdx":
			...
			{
				dialog.text = "您指的是什么专业化? 您的船只是通用型, 并没有特殊属性。";
				link.l1 = "知道了, 谢谢。";
				link.l1.go = "ClockTower_OfficeServices_exit";
			}
		...
		case "ClockTower_OfficeServices_logbook_1":
			dialog.text = "公司感谢您的工作。 您应得" + JournalsCost() + "枚杜布隆金币。 请收下并在这里签名。";
			link.l1 = "谢谢。";
			link.l1.go = "ClockTower_OfficeServices_exit";
