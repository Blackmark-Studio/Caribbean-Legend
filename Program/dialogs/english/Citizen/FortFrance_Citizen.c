...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Listen, "+GetAddress_FormToNPC(NPChar)+", I want to ask you something... I'm looking for a navigator to serve on my ship, do you know anyone?";
		...
		case "Sharlie_1":
			dialog.text = LinkRandPhrase("No, I don't know any navigators.","I have work to attend to and no, ask someone else...","Unfortunately, I can't help you. I don't know anyone.");
			link.l1 = "I see. I'll ask elsewhere then.";
			link.l1.go = "exit";
