	...
	switch(Dialog.CurrentNode)
	{
        ...
        case "Hostess_NotChoice":
			...
			else
			{
				...
				// <-- legendary edition
				dialog.text = ""+GetSexPhrase("Well, excellent, my stallion!","They are all very skilled at what they do, have no doubt.")+" I can offer you a very lovely girl, her name is "+GetFullName(sld)+", and she is available at the moment. That pleasure will cost you "+FindRussianMoneyString(int(sld.quest.price)+charWhoreCost)+". Agree?";
        ...
        case "Hostess_NotChoice_agree":
			...
			{
				dialog.text = "Oh, you see, the problem is that "+sld.name+" is not a cheap girl, her price is "+FindRussianMoneyString(int(sld.quest.price)+charWhoreCost)+". And I see that you just can't afford her at the moment. Come back when you're wealthy"+GetSexPhrase(", dear","")+"...";
		...
		// belamour ночной приключенец
		case "NA_Girl":
            dialog.text = "Oh, so we have a connoisseur here, hee hee ... Well, well, I have just the girl. But she doesn't come cheap: "+int(pchar.GenQuest.NightAdventure_money)+" pesos.";
			link.l1 = "Deal.";
