	...
	//<-- Бремя гасконца
		...
		case "ship_tunning_start" :		
			...
			{				
				...
				if(!TuningAvailable())
				{
					dialog.Text = "So-so... let's see what we have here... Yes - "+XI_ConvertString(RealShips[int(Pchar.Ship.Type)].BaseName)+". Your ship already has the maximum number of improved characteristics, I'm afraid that any further work on it would be pointless and could only do harm.";
					Link.l1 = "I see...";
					Link.l1.go = "ship_tunning_not_now_1";
					break;
				}
		...
		case "ship_tunning_Capacity_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_Capacity_again";
				dialog.Text = "I still require: ironwood - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Fine.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
		...
		case "ship_tunning_SpeedRate_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_SpeedRate_again";
				dialog.Text = "I still require: ship silk - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Fine.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
		...
		case "ship_tunning_TurnRate_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_TurnRate_again";
				dialog.Text = "I still need: ropes - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Fine.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
		...
		case "ship_tunning_HP_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_HP_again";
				dialog.Text = "I still need: resin - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Fine.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
		...
		case "ship_tunning_rig_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_rig_again";
                dialog.Text = "I still require: ship's silk - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Fine.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
				AddQuestUserData("ShipTuning", "sText", "I need to bring: ship silk - "+ int(NPChar.Tuning.Matherial) + ".");
		...
		case "ship_c_quantity_again_2":		
			...
			{
				NextDiag.TempNode = "ship_c_quantity_again";
				dialog.Text = "I still require: resin - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Fine.";
				link.l1.go = "Exit";
				AddQuestRecord("ShipTuning", "t1");
				AddQuestUserData("ShipTuning", "sText", "I need to bring: resin - "+ int(NPChar.Tuning.Matherial) + ".");
		...
		case "Findship_complete":
			...
			dialog.text = "Here is your money - "+FindRussianMoneyString(int(pchar.GenQuest.Findship.Shipyarder.Money))+". Thank you for the job. Don't forget to come and see me again. Goodbye!";
		...
		case "Device_complete_1":
			...
			dialog.text = "For your efforts, I will pay you "+FindRussianMoneyString(int(pchar.GenQuest.Device.Shipyarder.Money))+". I hope that would be a fitting reward.";
			link.l1 = "Thanks!";
		...
		case "SailsTypeChoose":
			dialog.text = "What sails would you like to install? At the moment you have "+GetSailsType(int(RealShips[int(Pchar.Ship.Type)].ship.upgrades.sails))+".";
		...
		case "SailsTypeChoose2":
			...
			dialog.text = "At the moment you have "+GetSailsType(int(RealShips[int(Pchar.Ship.Type)].ship.upgrades.sails))+", you have selected "+GetSailsType(int(NPChar.SailsTypeChooseIDX))+". The cost of the replacement is "+FindRussianMoneyString(int(NPChar.SailsTypeMoney))+". Proceed?";
		...
		case "SailsColorDone":
			...
			dialog.text = "Agreed. We'll paint the sails "+GetStrSmallRegister(XI_ConvertString(SailsColors[int(NPChar.SailsColorIdx)].name))+" color.";
		    Link.l9 = "Thanks.";
			Link.l9.go = "exit";
...
//<-- -----------------------------------------Бремя гасконца-----------------------------------------------------
		...
		case "IslaMona_7":
            dialog.text = "So, you owe me "+int(pchar.questTemp.IslaMona.Shipyarder.Money)+" doubloons.";
		...
		case "IslaMona_money":
            ...
            dialog.text = "Don't feel sorry for me, you've got a cabin locker full of gold. You owe me "+FindRussianDublonString(int(pchar.questTemp.IslaMona.Shipyarder.Money))+".";
			link.l1 = "";
			link.l1.go = "IslaMona_money_exit";
		break;
