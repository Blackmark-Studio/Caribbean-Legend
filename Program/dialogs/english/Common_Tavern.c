...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
       			dialog.text = NPCharRepPhrase(pchar,LinkRandPhrase("The alarm has been raised in the town, and everyone is looking for you. If I were you, I wouldn't stay here.","All the city guards are scouring the town looking for you. I am not a fool and I will not talk to you!","Run, "+GetSexPhrase("mate","lass")+", before the soldiers turn you into mincemeat..."),LinkRandPhrase("What do you need, "+GetSexPhrase("scoundrel","stinker")+"?! The city guards have your scent, you won't get far"+GetSexPhrase(", filthy pirate!","")+"","Murderer, leave my place at once! Guards!","I am not afraid of you, "+GetSexPhrase("scoundrel","rat")+"! Soon you will be hanged in our fort, you won't get far..."));
				link.l1 = NPCharRepPhrase(pchar,RandPhraseSimple("Heh, an alarm is never a problem for me...","They will never catch me."),RandPhraseSimple("Shut your mouth, "+GetWorkTypeOfMan(npchar,"")+", or I'll rip out your tongue!","Heh, "+GetWorkTypeOfMan(npchar,"")+", and all of them there - to catch pirates! That's what I tell you, mate: sit quietly and you won't die..."));
				link.l1.go = "exit";
				break;
			}
			if (sti(pchar.GenQuest.Piratekill) > 20 && sti(npchar.nation) == PIRATE)
			{
				dialog.text = RandPhraseSimple("And it's you, bastard! You think we're serving you rum here? Certainly not! Boys! To arms! Kill this scoundrel!","Want a drink, pirate? Ha! No! Now we'll show you what's what! Lads, draw your blades!");
			...
			if(NPChar.City == "FortFrance")
			{
				...
				{
					link.l1 = "I've completed your assignment. The longboat with the rum has been delivered to Le François Bay and handed over to your people.";
			...
			if (CheckAttribute(pchar, "questTemp.Sharlie") && pchar.questTemp.Sharlie == "skiper" && npchar.city == "FortFrance")
			{
				...
				Link.l1 = ""+npchar.name+", I realise that I am bothering you, but just one more question. I need a navigator - any idea where I can find one?";
			...
			if (CheckAttribute(pchar, "questTemp.Sharlie.Lock"))
			{
				...
				Link.l1 = "I was hoping you could answer a couple of questions.";
				Link.l1.go = "quests";
			...
			{
				dialog.text = "I am delighted to see you, sir! How may I be of service? Rum, brandy, Scotch whisky?";
				Link.l1 = "I'd like a bottle of your finest French wine and a room key.";
			...
			else
			{
				...
				if(CheckAttribute(PChar, "GenQuest.ChurchQuest_1.NeedToDialogWithBarmen") && PChar.location == PChar.GenQuest.ChurchQuest_1.CurPortManColony + "_tavern")
		        {
		            if(CheckAttribute(PChar, "GenQuest.ChurchQuest_1.NoMoneyToBarmen"))
		            {
		            	...
		            	dialog.Text = "So, captain, have you brought me "+FindRussianMoneyString(iTemp)+".";
				...
				dialog.Text = pcharrepphrase(LinkRandPhrase(LinkRandPhrase("Oh, honoured guests! Hey, you - move over and make room for a gallant captain! And be quick about it, before I throw you out, haha!","Merciful God above! If it isn't "+GetFullName(pchar)+"! I just received a new shipment of the finest wines, please come in!","Oh, "+GetAddress_Form(NPChar)+", are you having trouble? Allow me to treat you. This bottle is on the house. Trust me, it's the best wine around..."),LinkRandPhrase("Oh, it's the Captain "+GetFullName(pchar)+"! Hey, you! Show some respect to the good captain! This isn't a barn! Please excuse me, captain, their mothers clearly never taught them manners.","Well, well, "+GetAddress_Form(NPChar)+" "+GetFullName(pchar)+"! We're in for a long night, haha! Girls, you'd best have on your finest dresses!","Good afternoon, "+GetFullName(pchar)+", I am glad to see you! Please, sir, I have a request. I just bought new tables, so please, no fighting tonight."),LinkRandPhrase("Hello, captain. Make yourself at home, but keep in mind that even Captain Sharp himself minds his manners in my establishment.","O-ho-ho! Look who's here! It's "+GetFullName(pchar)+" himself! And we were just starting to get bored in your absence! How about you regale the fellows with an adventure while I open a new barrel of rum, cap'n?","O-ho-ho! It's "+GetFullName(pchar)+" himself! I hope you're not going to lure away my customers to the high seas again with tales of your grand adventures?")),LinkRandPhrase(LinkRandPhrase(""+GetFullName(pchar)+"! This old salt is always happy to see you in his establishment! Please, sir, have a seat and the girls will take care of you!","Please, captain, make yourself comfortable! Always happy to greet my favourite guest. What's your poison?","Glad to see you again, "+GetFullName(pchar)+"! Would you like a table to yourself? Or would you prefer to sit at the bar?"),LinkRandPhrase("Good afternoon, captain. There's a chill in the air, allow me to offer you some excellent mulled wine I've just made, on the house!","Hello, Captain "+GetFullName(pchar)+"! I am glad you've come to visit again. What would you like?","I am glad to have you, "+GetAddress_Form(NPChar)+" "+GetFullName(pchar)+"! I'm glad you patronise my humble establishment! We do everything we can to please."),LinkRandPhrase("Captain! Welcome, welcome! I have some magnificent d'Anjou fit for King Louis himself, and I've saved it especially for you!",""+GetFullName(pchar)+"! I am so glad you've come. Shall I drive away all these sea rats, or would you prefer them to stay? Trust me, I would gladly clear the entire tavern for you!","My God, here's the Captain "+GetFullName(pchar)+"! Hey, flirts - bring the finest tablecloth to the captain's table!")));
				Link.l1 = pcharrepphrase(RandPhraseSimple(RandPhraseSimple("Oh, I see I am remembered here... Avast, fill my glass, mate, while I take a look around...","Calm down, mate, today I'm in a good mood. Let's start with rum, shall we?..."),RandPhraseSimple("Oh... are you not too happy to have me here? I hope I misheard you, ha!","Ahoy. I hope your wine is better than your greeting. Otherwise, I might get angry, you know...")),RandPhraseSimple(RandPhraseSimple("Always glad to visit you, mate. What do you have to warm up a salty dog?","Ah, your establishment gets better with each passing day! Visiting here is always a pleasure..."),RandPhraseSimple("You haven't forgotten an old wanderer? I'm flattered, my friend.","Good to see an old friend again... Still got some rum left?")));
				Link.l1.go = "step_node";
			}
			break;
				
			case "step_node":
				dialog.Text = LinkRandPhrase("I am listening, captain.","My tavern '"+XI_ConvertString(NPChar.City+"TavernName")+"' at your service, Captain!","All ears, Cap'n! What would you like today?");
				Link.l1 = "Are there any boys on the island ready to try their luck at sea?";
				Link.l1.go = "crew hire";
				Link.l2 = "I hoped you could answer a couple of questions.";
				Link.l2.go = "int_quests";
				if (CheckAttribute(pchar, "GenQuest.LoanChest.TakeChest") && sti(pchar.GenQuest.LoanChest.TargetIdx) == sti(NPChar.index))
				{
					link.l21 = "I would like to discuss financial matters.";
				...
				if(CheckAttribute(PChar, "GenQuest.ChurchQuest_2.AskBarmen") && PChar.location == PChar.GenQuest.ChurchQuest_2.QuestTown + "_tavern")
		            	{
					link.l10 = LinkRandPhrase("Can you tell me anything about the recent robbery in the church?","What do you know about the recent robbery at the church?","Have you heard anything about the recent robbery at the church?");
				...
				{
					link.l16 = "People say you know just about everything in this colony. I want to buy "+pchar.GenQuest.Device.Shipyarder.Type+", and I was told that it had been sold in your town. Well, someone was selling it at the street market. Can you tell me anything about it?";
				...
				{
					link.l18 = "Hello, "+npchar.name+". I am looking for a caballero named Fernando Rodriguez. Did he show up in your town?";
				...
				{
					link.l19 = "I came to collect my winnings, which you kept safe for me. "+npchar.name+".";
				...
				{
					link.l20 = "I was wondering where I can find a man by the name of "+pchar.GenQuest.Marginpassenger.q2Name+"? He lives in your town.";
					link.l20.go = "Marginpassenger";
				}
				// <-- захват пассажиров
				if(!CheckAttribute(pchar,"questTemp.TimeLock"))
				{
					link.l3 = pcharrepphrase("You got a free room, mate?","Have you got a free room? I would like to stay here for a while.");
					link.l3.go = "room";
				}
		...
		case "Helen_meeting":
			...
			link.l3 = "I'd like to rest on solid ground and gather my thoughts, but not while my mother's bustling about the house.";
		...
		case "Meeting":
			...
			if(CheckAttribute(PChar, "GenQuest.ChurchQuest_1.NeedToDialogWithBarmen") && PChar.location == PChar.GenQuest.ChurchQuest_1.CurPortManColony + "_tavern")
	        {
				...
				link.l1 = "A bottle of rum for my companion at that table over there.";
				link.l1.go = "Tavern_ChurchGenQuest1_Node_1";
				break;
			}
			// <-- Квестовый генератор священника. Квест №1.
			dialog.Text = LinkRandPhrase("I am listening, captain.","What can I offer you, captain?","So, captain, what will it be?");
			...
			if(CheckAttribute(PChar, "GenQuest.ChurchQuest_2.AskBarmen") && PChar.location == PChar.GenQuest.ChurchQuest_2.QuestTown + "_tavern")
	        {
				link.l10 = LinkRandPhrase("Can you tell me anything about the recent robbery at the church?","What do you know about the recent robbery at the church?","Have you heard anything about the recent robbery at the church?");
				link.l10.go = "Tavern_GenQuest_Church_2_1";
			}
			// <-- Квестовый генератор священника. Квест №2.
			...
			if (CheckAttribute(pchar, "GenQuest.Device.Shipyarder") && NPChar.location == pchar.GenQuest.Device.Shipyarder.City + "_tavern" && pchar.GenQuest.Device.Shipyarder == "begin" && !CheckAttribute(npchar, "quest.Device"))
			{
   				link.l16 = "People say that you know just about everything in this colony. I want to buy "+pchar.GenQuest.Device.Shipyarder.Type+", and I was told that it had been sold in your town. Well, someone was selling it on the streets. Can you tell me anything about it?";
				link.l16.go = "Device_Tavern";
			}
			// <-- генератор Неудачливый вор
			...
			if (CheckAttribute(pchar, "questTemp.HWIC.Holl") && pchar.questTemp.HWIC.Holl == "JacobOnMain" && NPChar.location == pchar.questTemp.HWIC.Holl.JacobCity + "_tavern")
				...
				if (CheckAttribute(pchar, "questTemp.HWIC.Self") && pchar.questTemp.HWIC.Self == "start" && NPChar.nation == SPAIN && !CheckAttribute(npchar, "quest.HWICTalked"))
				{
					link.l18 = "Hello, "+npchar.name+". I am looking for a caballero named Fernando Rodriguez. Has he arrived in your town?";
					link.l18.go = "HWICSelfFernando_Tavern";
				}
				//<-- Голландский гамбит
				...
				if (CheckAttribute(pchar, "GenQuest.Racing.Go.Advantage") && NPChar.location == pchar.GenQuest.Racing.Go.StartCity + "_tavern")
				{
					link.l19 = "I've come to collect my winnings, which you are keeping safe for me. "+npchar.name+".";
					link.l19.go = "Race_Advantage";
				}
				// <-- гонки на гидропланах
				//Jason --> захват пассажиров
			...
			if(!CheckAttribute(pchar,"questTemp.TimeLock"))
			{
				link.l3 = pcharrepphrase("You got a free room, mate?","Do you have a free room? I would like to stay here for a while.");
				link.l3.go = "room";
			}
			Link.l4 = "I suppose I'll come back later.";
			Link.l4.go = "exit";
		break;
		...
		case "crew hire":
			...
			if (!ok)
			{
				Dialog.text = "And what do you need sailors for, captain? I don't see your ship in the port.";
            ...
            if (makeint(environment.time) > 22.0 || makeint(environment.time) < 7.0)
			{
				...
				link.l1 = "Alright. Do you have any vacant rooms?";
				link.l1.go = "room";
			...
			else
			{
                ...
                {
                    Dialog.text = "You think we serve wanted criminals here? Be thankful I am not calling the guards.";
					link.l1 = "Thanks.";
					link.l1.go = "exit";
                }
                else
                {
					...
					{
						Dialog.text = "Ah, sorry captain, you're just a bit too late. All the lads looking to sail just shipped with a gallant captain "+GetFullName(CharacterFromID(NPChar.CrewHired.PGGId))+".";
						link.l1 = "That's a pity!";
					...
					{						
						...
						{		
							if(GetPartitionAmount("CrewPayment") > 0)
							{
								...
								{
									dialog.text = "Captain, people say that you're rather stingy. There's no one here who'd like to join your crew.";
									link.l1 = "I see...";
									link.l1.go = "exit";
								}
							}
	...
	////////////////////////////////////////////////////////=============================================///////////////////////////////////////////////////////	
        case "int_quests":
			...
			//link.l1.go = "work";
			//homo 15/06/06 слухи
			link.l2 = LinkRandPhrase("Can you tell me the latest news?","What's happening in these lands?","What's new on land?");
			link.l2.go = "rumours_tavern";
			//homo
			link.l3 = "I came on different business.";
			link.l3.go = "quests";
			if(CheckAttribute(pchar,"GenQuest.EncGirl"))
			{
				if(pchar.GenQuest.EncGirl == "EncGirlFack_fighted")
				{
					link.l5 = "Do you know where I can find "+pchar.GenQuest.EncGirl.name+"?";
			...
			if(CheckAttribute(pchar,"GenQuest.CaptainComission") && NPChar.city == pchar.GenQuest.CaptainComission.City && CheckAttribute(pchar,"GenQuest.CaptainComission.Speak_Tavern"))
			{
				...
				{												
					...
					{
						link.l9 = "Can you tell me where I should look for  "+pchar.GenQuest.CaptainComission.Name+"?";
				...
				{
					link.l9 = "Do you know where I can find the captain of a patrol "+GetStrSmallRegister(XI_ConvertString(GetBaseShipParamFromType(sti(pchar.GenQuest.CaptainComission.ShipType),"Name")+"Acc"))+" "+pchar.GenQuest.CaptainComission.Name+"?";
				...
				if(pchar.GenQuest.CaptainComission.variant == "A3" && pchar.GenQuest.CaptainComission == "Begin_1")
				{
					...
					{					
						link.l9 = "Do you know anything about the captain of the patrol "+GetStrSmallRegister(XI_ConvertString(GetBaseShipParamFromType(sti(pchar.GenQuest.CaptainComission.ShipType),"Name")+"Acc"))+" "+pchar.GenQuest.CaptainComission.Name+"?";
			...
			{
				link.l10 = "Could you tell me where I can find a man called "+pchar.GenQuest.Hold_GenQuest.Name+"?";
			...
			{
				link.l11 = "I happened to come across some ship documents not far from here....";
			...
			{
				link.l12 = "Listen, I'm looking for an old friend of mine, "+pchar.GenQuest.FindFugitive.Name+" is his name. A fellow captain told me he was heading to your settlement. Have you met him by any chance?";
		...
		case "hold_genquest1":
			...
			{
				case 0:
					dialog.text = LinkRandPhrase("What did you say? "+pchar.GenQuest.Hold_GenQuest.Name+"? Hmm... Never heard of him.","Are you certain that he hails from our town? I've never heard of such a person.","There wasn't anyone like that in our little colony. Never heard of him in all my time here.");
				...
				case 2:
					dialog.text = LinkRandPhrase(RandPhraseSimple("What did you say? "+pchar.GenQuest.Hold_GenQuest.Name+"? Hmm... Never heard of him. Are you certain he comes from our village? I've never heard of such a person.","Heh-heh... Well, now only the Lord Himself knows where to look for him - in hell or in heaven. He died over a year ago, but people are still asking about him... No rest for the poor bastard..."),RandPhraseSimple("You will not find him there - in the land of the living at least. He died not so long ago - yellow fever... God rest his soul... What a stout man he used to be! When he was young, he was a great adventurer! But when death comes for you, there is not much you can do...","Oh, have you missed him? He left these parts long ago. No one knows where he went — maybe to the North American colonies, maybe back to Europe. He just gathered his belongings and made off."),"Oh, are you looking for that "+pchar.GenQuest.Hold_GenQuest.Name+" who got rich and bought himself a house in New England? You know, there were times when I sold him rum on credit - he still owes me. People are so ungrateful, you know.");
					link.l1 = "I see. Well, thank you anyway.";	
					link.l1.go = "hold_genquest4";
				break;
				
				case 3:
					dialog.text = "Well, where else would you look for him, if not the tavern? He's a regular there – drowns his sins in wine, heh-heh. Come back a bit later – if he shows up, I'll tell him to wait for you.";	
		...
		case "hold_genquest2":
			dialog.text = "How can I not be sure if I know everyone here personally. It's not the first year I've been running the tavern here. "+"I have seen them all in every possible condition. Sometimes a wife would come to pick her husband up, at times they would leave by themselves, and on some occasions I had to toss them out. 'Am I sure?!' Of course I am!";
		...
		case "CaptainComission_3":
			dialog.text = "He's already come here, so he should be somewhere around...";
			link.l1 = "Thanks.";
			link.l1.go = "exit";
		...
		case "CaptainComission_Tavern1":
			pchar.GenQuest.CaptainComission.Speak_Tavern = true;
			dialog.text = "Is there a man who doesn't know him? The entire settlement has been talking about him for several days already.";
			link.l1 = "Could you tell me more?";
			link.l1.go = "CaptainComission_Tavern2";
		break;
		
		case "CaptainComission_Tavern2":
			dialog.text = "A bit. The captain was executed, and the same can be said about some of his crew. The rest were scattered across the Caribbean, stripped of rank and position... For what? According to the judge, he had sunk a pirate during a patrol and kept the loot for himself\n"+"Here's the thing, neither the owner of this vessel nor the goods have been found ... they've been combing the local bays and inlets looking for them, but to no avail.";
		...
		case "CaptainComission_Tavern3":
			dialog.text = "Not a single one! Even under torture! I still can't understand why the governor would believe that slander so eagerly. Captain "+pchar.GenQuest.CaptainComission.Name+" had a good reputation, and his crew were well-trained and disciplined, something any admiral would envy.";
		...
		case "CaptainComission_Tavern4":
			dialog.text = "That I don't know - they've scattered to the four winds... Although... there's still one of them left, but I doubt you'd learn much from him. He was badly concussed. You know, he served as a gunner under "+pchar.GenQuest.CaptainComission.Name+". He was found unconscious in a cove two days after that accident. At first he was sent to the hospital and treated like a hero, but as the plot thickened, they threw him into the dungeon and tried to interrogate him, but then decided that he should be treated medically first, anyway.";
			link.l1 = "Is he still here now?";
		...
		case "CaptainComission_Tavern5":
			...
			dialog.text = "Yes, "+GetName(NAMETYPE_ORIG,pchar.GenQuest.CaptainComission.CanoneerName,NAME_NOM)+" is his name. He drops by from time to time, spends the pennies he earns begging on rum. Poor soul. If I see him, I'll tell him to wait here for you.";
			link.l1 = "Thank you, I'll come back later.";
		...
		case "CaptainComission_Tavern8":
			dialog.text = ""+GetAddress_Form(pchar)+", you should be careful with that 'business'. "+pchar.GenQuest.CaptainComission.Name+" is detained on suspicion of piracy, and the governor's men are now scouring the island, searching for his accomplices.";
			link.l1 = "You don't say! And what did he do?";
			link.l1.go = "CaptainComission_Tavern9";
		break;
		
		case "CaptainComission_Tavern9":
			dialog.text = "I don't know whether it's true or not, but they say that he stashed away the cargo confiscated from a passing pirate ship and didn't turn it in. And still, no one has found either that pirate or the cargo. I still can't understand why the governor would believe that slander so eagerly. Captain "+pchar.GenQuest.CaptainComission.CapName+"  had a decent reputation, and he was a great soldier. You can trust my word, "+GetAddress_Form(pchar)+".";
		...
		case "EncGirl_2":
			dialog.text = "Half the men in our settlement seem to have business with her. If our women caught her, they would toss her outside the town gates, naked.";
			link.l1 = "Oh well... "+GetSexPhrase("It seems I've joined a long queue, then. Well, if anyone else comes around asking for her, tell them to get in line behind me.","I see")+"...";
			link.l1.go = "exit";
		...
		case "EncGirl_3":
			dialog.text = "He is a frequent visitor here - he usually comes by looking for work, but right now he's not here. Come back from time to time - I'll tell him to wait here for you if he shows up.";
			link.l1 = "Thank you, I'll come back later...";
			link.l1.go = "exit";
		...
		case "EncGirl_4":
			if(sti(pchar.GenQuest.EncGirl.LoverFatherAngry) == 0)
			{
				...
				link.l1 = "Yes, it was I who helped.";
				link.l1.go = "EncGirl_5";
			}
			else
			{
				dialog.text = "Oh, there "+GetSexPhrase("he is, our benefactor","she is, our benefactress")+". Expecting a reward, I take it?";
				link.l1 = "Well, I'm fine without a reward, but your thanks alone would suffice.";
				link.l1.go = "EncGirl_6";			
			}
		break;
		
		case "EncGirl_5":
			dialog.text = "I am very grateful to you for not abandoning my son in his hour of need and for helping him find a way out of a delicate situation. Allow me to thank you, and please accept this modest sum and a gift from me personally.";
			link.l1 = "Thank you. Helping this young couple was my pleasure.";
			link.l1.go = "EncGirl_5_1";
		break;
		
		case "EncGirl_6":
			dialog.text = "Thanks? What thanks?! It's been half a year since that blockhead has been hanging around without a job - and look at him, he's got enough time for an affair! When I was his age, I was already running my own business! Pfft! A governor has a marriageable daughter - and that dunce has brought a wench without kith or kin to my house and dared to ask for my blessing!";
			link.l1 = "I suppose you don't believe in love at first sight?";
		...
		case "EncGirl_6_1":
			dialog.text = "Love? Love!? Are you mocking me or are you stupid? Shame on you for indulging the young in their caprices and acting like a procurer! Not only have you taken a girl from her home, but you have also ruined my boy's life. There will be no thanks to you. Farewell.";
		...
		case "ShipLetters_4":
			...
			{
				dialog.text = "Let me take a look! Oh! Judging by the name, this belongs to one of my patrons, quite a respected gentleman. I can personally hand these documents over to the owner. Will you give them to me?";
				link.l1 = "On second thought...";
				link.l1.go = "exit";
				link.l2 = "Take them. I'm glad I could be of service.";
		...
		case "work":
			...
			{
				dialog.text = RandPhraseSimple("I don't care whom I serve, since money has no nationality. But I will not help you, since you came under the flag of "+NationNameGenitive(sti(pchar.nation))+".","I am just a simple tavern owner, but collaborating with "+NationNameAblative(sti(pchar.nation))+" doesn't seem appealing to me.");
			...
			if (isBadReputation(pchar, 40))
			{
				...
				link.l1 = RandPhraseSimple("Oh, really, you shouldn't believe all that gossip...","I see. It's hard to make everyone keep quiet.","People are just too soft these days...");
				link.l1.go = "exit";
				break;
			}
			if (sti(Pchar.Ship.Type) == SHIP_NOTUSED)
        	{
				dialog.text = "And where is your ship? Or are you planning to carry the passengers on your back and swim?";
				link.l1 = "Hey, you've got a point...";
				link.l1.go = "exit";
				break;
			}
			dialog.text = "I might have a job if you're not afraid to visit pirate settlements or the ports of enemy nations. Are you looking for something in particular?";
			link.l1 = "That shouldn't be a problem. I suppose I could provide an escort.";
			link.l1.go = "work_1";
			link.l2 = "Do you have any passengers? I can take them wherever they wish, if they pay for it.";
			link.l2.go = "work_2";
			link.l3 = "No, such work is not for me. Thank you.";
			link.l3.go = "exit";
		break;

		case "work_1":
				dialog.text = "They usually do not ask me about escort duty. Ask the merchants in the tavern – perhaps they need your services.";
		...
		case "work_2":
    		...
    		{					
				...
				if (hrand(6) > 1)
				{
					dialog.Text = "There's a man who just came in – he was recently asking about a passing vessel. You can talk to him, if you like.";
					link.l1 = RandPhraseSimple("Who is he? Perhaps he is a scoundrel? Or, even worse, a wanted pirate?","And who is he? Will there be any trouble with him?");
					Link.l1.go = "PassangerAreYouSure";
				}
				else
				{
					dialog.text = "No, today no one has asked about it. Perhaps, another day.";
        ...
        case "PassangerAreYouSure":
		    dialog.text = LinkRandPhrase("Who could know? You asked - I answered.","Well, this is for you to solve. I would not vouch for anyone there.","All sorts come here. This is a tavern, cap'n, not the governor's manor.");
			Link.l1 = "I see. Let's find out who this man is...";
			Link.l1.go = "exit";
		...
		case "Helen_room":
			...
			else
			{
				...
				link.l2 = "I want a good, long sleep and to take my time getting up. I'll take a room for the day.";
		...
		case "room":
			...
			{
				dialog.text = "Monsieur Henri Thibaut is renting the room at the moment, and he has paid for a month in advance, so there's nothing I can do for you, captain.";
				link.l1 = "Well, that's a pity...";
				link.l1.go = "exit";
				break;
			}
			...
			if (pchar.questTemp.different == "FackWaitress_toRoom")
			{
				...
				{
					link.l1 = "Hmm... I suppose I'll come back later...";
					link.l1.go = "exit";
				}
				break;
			}
			...
			if (CheckAttribute(pchar, "GenQuest.Unwantedpostor") && !CheckAttribute(pchar, "questTemp.Sharlie.Lock") && abs(50-sti(pchar.reputation.nobility)) > 20)
			{
				...
				dialog.text = "Excuse me, captain, unfortunately there are no rooms available. The guest won't leave. And still hasn't paid me...";
				...
				{
					link.l3 = "So call the guards. What kind of guest is this? He doesn't pay, he doesn't want to move out...";
		...
		case "room_day":
			...
			link.l2 = pcharrepphrase("At that price? Are you renting royal chambers? I'd rather stay in the common room for free.","Alas, the luxury of sleeping in a bed is beyond my current means, it seems. Guess I'll have to sleep in the common room on a bench.");
		...
		case "hall_night_wait":
			if (hRand(3) == 1)
            {
                Dialog.text = "Get the hell out of here, you scoundrel! The common room may be free, but we have expectations of decent behaviour!";
		...
		case "tavern_keeper":
			...
			dialog.text = "Stop this outrageous behaviour in my tavern this instant or I am calling the guards!";
			link.l1 = "Alright, alright, I'm leaving.";
			link.l1.go = "exit_sit";
		break;
		...
		case "Tavern_ChurchGenQuest1_Node_2":
			...
			link.l1 = "Think less and work faster. Now, how much does my valiant friend owe you?";
		...
		case "Tavern_ChurchGenQuest1_Node_3":
			...
			{
				dialog.text = FindRussianMoneyString(iTemp)+", miss"+GetSexPhrase("ter","s")+" captain, and he also pawned some church books - that's all he had on him, which were of some value.";
				if(sti(PChar.money) >= iTemp)
				{
					link.l1 = "Here are your coins. Hand over the manuscripts. And be careful with them - this isn't a book of bawdy woodcuts, but Holy Scripture!";
					link.l1.go = "Tavern_ChurchGenQuest1_Node_4_1";
				}
				else
				{
			...
			{
				dialog.text = FindRussianMoneyString(iTemp)+", miss"+GetSexPhrase("ter","s")+" captain.";
				link.l1 = "I will pay off his debt and take whatever he left as collateral.";
		...
		case "Tavern_ChurchGenQuest1_Node_4_2":
			dialog.text = "No, miss"+GetSexPhrase("ter","s")+", that won't work that way.";
		...
		case "Tavern_ChurchGenQuest1_Node_4_2_1":
			dialog.text = "Because, miss"+GetSexPhrase("ter","s")+" Captain, I don't need the money. I know that captain all too well, so I never actually expected him to pay me back or take these manuscripts from me.";
		...
		case "Tavern_ChurchGenQuest1_Node_4_2_2":
			dialog.text = "In God's name - exactly, that's why, miss"+GetSexPhrase("ter","s")+". My little boy was very sick, and my wife and I made a vow to make a donation to the Church if our Blessed Lord cured the child of fever. Our Lord's mercy is without end, my boy is alive and well, and now we must keep our vow. And just about time, captain "+PChar.GenQuest.ChurchQuest_1.CapFullName+" shows up and pawns these church books. I could not allow such obscenity - paying for drinks with the Word - and therefore I decided to hand over these books to the pastor of our parish.";
			link.l1 = "Well, certainly this is a good deed, but you should also know that these books actually belong to another priest – actually, not just a priest, but a bishop and my spiritual shepherd. And he might get angry and even curse those who would dare donate stolen Church property. I would like to buy them from you and bring them safely home. You can donate the money to your parish, I'm sure God will appreciate it all the same.";
			link.l1.go = "Tavern_ChurchGenQuest1_Node_4_2_3";
		break;
			
		case "Tavern_ChurchGenQuest1_Node_4_2_3":
			dialog.text = "Mis"+GetSexPhrase("ter","s")+"... Miss"+GetSexPhrase("ter","s")+" Captain... Of course, I had no idea! I will give them back, and I will require no money in return. You just put in a word for us to the bishop - perhaps he could bless us and relieve us of our vow...";
		...
		case "Device_Trader_1":
			...
			{
				dialog.text = "Hmm... Yes, one strange fellow did indeed bring that thing to me. He didn't tell me what it was, though – just tried to exchange it for booze. Of course, I refused – I had no need for that trinket.";
		...
		case "Sunplace_Tavern":
			...
			{
				dialog.text = ""+pchar.GenQuest.Sunplace.Trader.Enemyname+"? He was there recently, and by now he should have gone to his companion - the shopkeeper. Try looking for him at the shop - surely he must be there.";
				link.l1 = "Thanks! You've helped me a lot!";
				link.l1.go = "Sunplace_Tavern_1";
			}
			else//ушел на рыбалку
			{
				dialog.text = ""+pchar.GenQuest.Sunplace.Trader.Enemyname+"? Today, early in the morning, he sailed out on his lugger for a cruise. I bet he's standing at the bulwark right now, admiring the view. If you need him, you can try to find him at sea or wait until he returns in a couple of days...";
				link.l1 = "Thanks! I suppose I won't wait - it'll be easier to find him at sea. Good luck!";
		...
		case "HWICHollJacob_Tavern":
			dialog.text = "Psssst... Why are you shouting? He's been waiting for you for quite some time. He's already drunk a full quart of rum. Go upstairs to the room, you'll find him there.";
		...
		case "HWICSelfFernando_Tavern":
			...
			{
				//DelMapTonzagAllQM();
				dialog.text = "Yes, I know that gentleman. He should be somewhere in town - I just recently saw him walking past my window.";
				link.l1 = "Thank you! I'll go look for him!";
				...
				{
					dialog.text = "Yes, he is now visiting our town. Right now he is not here - he sailed out on his brigantine. He's likely not far from here, somewhere in the waters around our island.";
		...
		case "Marginpassenger":
			if (CheckAttribute(pchar, "GenQuest.Marginpassenger.lose"))
			{
				...
				link.l1 = "Damn it!.. And what am I supposed to do with his... Well, whatever. Thanks for the information. See you, "+npchar.name+".";
				link.l1.go = "Marginpassenger_1";
			}
			else
			{
				dialog.text = ""+pchar.GenQuest.Marginpassenger.q2Name+"? Yeah, he should be somewhere in town. Look for him on the streets. But keep in mind that every day until noon he is at the governor's office, and after nine in the evening he locks himself up in his house.";
				link.l1 = "Thanks! I'll go look for him...";
		...
		case "FindFugitiveTav":
			...
			{
				dialog.text = NPCStringReactionRepeat("It seems that your skipper was telling the truth. "+pchar.GenQuest.FindFugitive.Name+" has indeed recently arrived at our settlement. Look for him on the streets during the daytime - he is usually idling his time away.","You have already asked me about that man, and I told you everything I knew!","Are you kidding me, or are you really an idiot?! You're asking the same thing for the third time already!","Just to think, how could such an idiot become captain...","block",1,npchar,Dialog.CurrentNode);
				link.l1 = HeroStringReactionRepeat("Thank you, friend, you've helped me a great deal!","Yeah, yeah, fine.","Shiver me timbers, wow, don't get so excited. I just forgot.","Well, he did, as you can see...",npchar,Dialog.CurrentNode); 
				link.l1.go = DialogGoNodeRepeat("FindFugitiveTav_1", "exit", "", "", npchar, Dialog.CurrentNode);
			}
			else
			{
				dialog.text = NPCStringReactionRepeat("No, mate, I've never heard that name before. Ask around - maybe someone knows him...","You have already asked me about that man, and I told you: I don't know!","Are you kidding me, or are you truly an idiot?! You're asking the same thing for the third time already!","Just to think, how could such an idiot become captain...","block",1,npchar,Dialog.CurrentNode);
				link.l1 = HeroStringReactionRepeat("I see. Well, thank you anyway.","Yeah, yeah, fine.","Shiver me timbers, wow, don't get so excited. I just forgot.","Well, he did, as you can see...",npchar,Dialog.CurrentNode); 
		...
		//--> Бремя гасконца
		case "Sharlie_crew":
			dialog.text = "Unfortunately, I can't help you right now - none of the people I know would serve under you. But I can give you some advice - talk to that sailor who just took the table right behind you. He and his mates have just left a merchant ship. Perhaps they will agree to go with you.";
		...
		case "Sharlie_skiper":
			dialog.text = "I cannot tell you anything specific, friend. At the moment, no navigators are frequenting my place. Try asking around the port – perhaps people know more.";
		...
		case "Unwantedpostor":
				dialog.text = "Yeah - and scare all my customers with the fact that my guards drag people out of the tavern? And some of my customers don't like being around soldiers. Makes them nervous, see? I don't want to ruin my reputation...";
				link.l1 = "Hmm, what if I solve your problem?";
				link.l1.go = "Unwantedpostor_1";
		break;
		
		case "Unwantedpostor_1":
				dialog.text = "Made up your mind? He's armed, he's some kind of professional mercenary...";
		...
		case "Unwantedpostor_2":
				...
				link.l1 = "You know, I've changed my mind. I don't feel like convincing anyone.";
				link.l1.go = "Exit";
		...
		case "Helen_day_exit":
			dialog.text = "You might even find yourself feeling sleepy after a good walk.";
			link.l1 = "Ha-ha, maybe.";
			link.l1.go = "exit";
		break;
		...
		case "Helen_rumours_tavern":
			...
			link.l1 = "What's the latest news or interesting rumours in town?";
