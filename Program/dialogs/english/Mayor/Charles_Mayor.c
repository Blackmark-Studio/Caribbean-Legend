...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("What do you want? Ask away.","I am listening, what's your question?"),"It is the second time you are trying to ask...","It is the third time you are trying to ask again...","When will this end?! I am a busy man, dealing with the colony's affairs, and you are still trying to ask something!","block",1,npchar,Dialog.CurrentNode);
			...
			{
				link.l1 = "I want to see Chevalier de Poincy. It's about my brother's debt.";
                link.l1.go = "puancie";
			}
			//<-- Бремя гасконца
		break;
		...
		case "puancie":
			dialog.text = "Aha, well, I am aware of that debt... Do you have the required sum with you?";
			if (sti(pchar.money) >= 1000000)
			{
				link.l1 = "Of course I have. How else could it be?";
		...
		case "puancie_exit":
			dialog.text = "Then come back when you have it, and don't bother the Chevalier.";
			link.l1 = "...";
			link.l1.go = "exit";
		break;
		
		case "puancie_1":
			dialog.text = "Come through the door on the right, then. The Chevalier will receive you.";
			link.l1 = "Thanks!";
