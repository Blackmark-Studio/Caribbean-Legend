...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("What do you want? Ask away.","I am listening to you, what is your question?"),"This is the second time you have tried to ask...","This is the third time you've tried to ask...","When is this going to end?! I am a busy man, working on colonial matters and you are still bothering me!","block",1,npchar,Dialog.CurrentNode);
			...
			{
				link.l1 = TimeGreeting()+" Monsieur. I am here as ordered by Governor-General Chevalier de Poincy. My task is to deliver a baron by the name of Noel Forget to Tortuga, who has arrived from the mother country with a mission to inspect the colonies. His main purpose is to establish a French West Indies Trading Company. Allow me to introduce him to you... He will explain all the details himself.";
		...
		// Jason НСО
		case "patria_portpax":
			dialog.text = "I am very glad to meet you, Captain Charles de Maure, and the Baron. I will do everything to ensure Monsieur Forget's stay in our colony is as comfortable as possible. And taking advantage of the fact that such a high-ranking Monsieur has paid me a visit, I would like to petition you regarding one matter.";
			link.l1 = "Most interesting! Tell us about your business, your Grace.";
			link.l1.go = "patria_portpax_1";
		break;
		
		case "patria_portpax_1":
			dialog.text = "In recent months, our colony hasn't been visited by any representative of the Governor-General, as if they've completely forgotten about us at Saint Kitts! And in the meantime, the Spaniards, eager to make the whole of Hispaniola purely Spanish and for whom the French settlers and buccaneers in the west of the island are a major nuisance, are preparing an attack! My patrol officers, our trading captains, and even ordinary fishermen have reported that a powerful Spanish squadron is gathering in Santiago, and that it is preparing to attack Port-au-Prince!";
			link.l1 = "Is the evidence clear enough, Your Majesty?";
			link.l1.go = "patria_portpax_2";
		break;
		
		case "patria_portpax_2":
			dialog.text = "I don't have accurate intel, but so much information from completely random people can't be mere rumours. Our colony is very important to France, we have the best plantations here, which the Baron can see for himself. To lose this colony, or even expose it to the risk of being looted, is unacceptable!";
			link.l1 = "I will take your evidence into account and inform Chevalier de Poincy. I'm sure he will take immediate measures.";
		...
		case "UV_5":
			...
			link.l1 = "I am honoured by your generosity, Excellency, though such a reward was unnecessary. Regrettably, I must now bid you farewell—the tide waits for no sailor, and my vessel requires my attention.";
			link.l1.go = "exit";
