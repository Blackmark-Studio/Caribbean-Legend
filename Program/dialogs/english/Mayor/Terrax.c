...
//--> -----------------------------Сага - Искушение Барбазона завершающие этапы---------------------------
		...
		case "pirate_threat":
			...
			if (iGPThreat != 0)
			{
				...
				dialog.text = "Ha! Getting heat from our brotherhood, huh, " + GetSexPhrase("mate", "lass") + "? Sure, I can keep them in line for a while. But it'll cost you a fair bit. " + FindRussianDublonString(iTerraxTotalTemp) + " on the barrel and it's a deal.";
