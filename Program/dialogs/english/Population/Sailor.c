...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "crew_1":
			...
			dialog.text = "There are "+int(npchar.quest.crew.qty)+" of us and we will only hire together. We can perform all basic sailor tasks."+sTemp+"";
		...
		case "crew_2":
			...
			dialog.text = ""+FindRussianMoneyString(int(npchar.quest.crew.money))+" for each. And then the common sailor's wage per month. We won't ask anything excessive, captain.";
