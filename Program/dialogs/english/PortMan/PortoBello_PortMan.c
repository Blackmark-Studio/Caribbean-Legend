...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "SharkGoldFleet_18":
			...
			dialog.text = "I'm sorry for the wait. Here are your "+int(pchar.questTemp.SharkGoldFleet)+" pieces of eight. And in this case, they themselves will pay for the answer in Caracas. Tell them that I did.";
