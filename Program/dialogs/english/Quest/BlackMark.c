void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BM_Contra_4":
			dialog.text = "No... I'll be damned, but I don't recognise any of those mugs.";
			link.l1 = "...";
		...
		case "BM_Contra_12":
			dialog.text = "Screw you! That's not going to happen. Boys, to arms!";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "BM_Irons_4":
			if (startHeroType == 4)
			{
				...
				link.l1 = "Brave, indeed. And I'm not afraid to shut your mouth if I must. It's a hot place, so I dress lightly – not to please you or your kind. The name's Helen MacArthur. My friends might call me Rumba, but you're certainly not one of them. And what was that 'I guess' about?";
				link.l1.go = "BM_Irons_5";
			}
			else
			{
				dialog.text = "I'm Tommy! Tommy Irons. I guess. And you?";
				link.l1 = ""+GetFullName(pchar)+". And what exactly do you mean by 'I guess'?";
				link.l1.go = "BM_Irons_5";
			}
		...
		case "BM_Irons_7":
			dialog.text = "Ha! You wouldn't believe it - no. The wench confessed later. Guilty conscience, or perhaps she didn't enjoy it as much as I did, hehe. Who knows what goes on in women's heads? I don't really care, ha-ha-ha!";
		...
		case "BM_Irons_8":
			dialog.text = "Exactly! People say there's something wrong with me. I feel sorry for the soldiers who died. I know how it is, I was just a grunt myself once. Didn't I tell you?";
			link.l1 = "Yes, you did. From the Ironsides. Cromwell.";
			link.l1.go = "BM_Irons_9";
		break;
		
		case "BM_Irons_9":
			dialog.text = "Oh, really? I can't remember if I did or not. Do you know how I ended up in the New World? Shall I tell you?";
		...
		case "BM_Irons_12":
			dialog.text = "What did I tell them? I told them I didn't remember. And I wasn't lying - I never knew my folks. I was raised by the streets, by labourers and servants in the slums. I joined the Revolution for their sake. Though the ingratitude of people is astonishing - if I'd lost an arm or a leg, they would've been forced to give a hero like me an immediate retirement. And by the way, I almost lost my head, literally!";
			link.l1 = "Well, how did you end up in the New World, war hero?";
			link.l1.go = "BM_Irons_13";
		break;
		
		case "BM_Irons_13":
			dialog.text = "Do you doubt it? Fighting for the common people - what's not heroic about that? I hope one day cowards like you will know what real freedom is!";
		...
		case "BM_Irons_14":
			dialog.text = "Aye. I got my resignation after the Revolution was won, and then I realised I couldn't do anything but shoot and punch people in the face. And you can't rejoin the army - they'd laugh at you, especially after I fought so hard for my resignation. Heh, it seems to me that even if I'd really lost an arm or a leg, the desk rats would still have thought I was hiding them somewhere to sew them back on later once I got my exit papers, ha-ha-ha!";
			link.l1 = "That's funny. But you still haven't told me how you ended up here.";
			link.l1.go = "BM_Irons_15";
		break;
		
		case "BM_Irons_15":
			dialog.text = "Oh, you're such a bore. Didn't they teach you patience, "+GetSexPhrase("youngster","my girl")+"? I had nothing to do back home but shoot ducks and deer, so I went to the New World. I sailed with pirates for a while for fun, and when I grew tired of the lawlessness, I became a mercenary.";
			link.l1 = "Not a very original story.";
			link.l1.go = "BM_Irons_16";
		break;
		
		case "BM_Irons_16":
			dialog.text = "Maybe you have a better one? You don't need a bodyguard, by any chance? Because you look... weak. I'm worried you won't get far, hehe. Remember, it's the entourage that makes kings. And a bad retinue can bring them down.";
		...
		case "BM_Irons_19":
			...
			link.l3 = "I can't afford it right now, as I don't carry that much in my pockets. Stay here and don't go anywhere - I'll fetch the gold from the ship and return.";
		...
		case "BM_Irons_NoHire1":
			dialog.text = "Well, you're an idiot, young "+GetSexPhrase("man","woman")+"! And completely lacking in judgement. I suggest you fix that or you won't last long. Especially on the Archipelago.";
		...
		case "BM_Irons_Wait1":
			dialog.text = "Are you serious? A bunch of soldiers just died here, genius! They'll probably send another squad soon. No, I could lock the lighthouse door and organise a defence, but do I want to? Nope.";
			link.l1 = "So what do you suggest?";
			link.l1.go = "BM_Irons_Wait2";
		break;
		
		case "BM_Irons_Wait2":
			dialog.text = "Meet me at a cave in the jungle. I'll give you a couple of days to earn enough to pay for my services – you know how to handle a blade, maybe you'll manage it.";
		...
		case "BM_Irons_Wait3":
			...
			link.l1 = "Yeah, I have to go too, just in case.";
			link.l1.go = "Exit";
			AddDialogExitQuest("BM_IronsToCave");
		break;
		
		case "BM_Irons_WaitInCave1":
			dialog.text = "Aye, there you are! I was beginning to think you didn't have it in you to make money. Sometimes I think people like you are born with it. And if they're not, they die in poverty without working a day like honest folk.";
		...
		case "BM_Irons_HireInCave1":
			...
			dialog.text = "Now we're talking! What do we do next... Captain?";
		...
		case "BM_Irons_HireInCave2":
			...
			link.l1 = "I see, so you got your resignation and forgot about respect and subordination, eh, Tommy? Don't worry, I won't hesitate to teach you a lesson again if I have to. Now let's go.";
			link.l1.go = "Irons_hire";
		break;
		...
		case "BM_IronsFirstJungle_2":
			dialog.text = "Would you happen to have an extra round of ammunition on you? Not just a bullet, but a proper paper-wrapped cartridge.";
		...
		case "BM_IronsFirstJungle_3":
			...
			link.l2 = "Not at the moment, I don't. It's not as if I carry a single cartridge in my pocket, wondering what if Tommy asks for it...?";
		...
		case "BM_IronsFirstJungle_5":
			dialog.text = "No. There's nothing special about you, after all. A good captain can always provide his crew with everything they need. So I'll go.";
		...
		case "BM_IronsFirstJungle_6":
			...
			link.l1 = "Well, to hell with you, Tommy. Goodbye.";
		...
		case "BM_IronsSecondJungle_3":
			...
			link.l2 = "I don't carry ammunition for your stupid jokes, Tommy! You could have asked for a whole batch instead of just one cartridge two weeks ago!";
			link.l2.go = "BM_IronsSecondJungle_4";
		break;
		
		case "BM_IronsSecondJungle_4":
			dialog.text = "I did! I thought that whoever claims to be my captain always provides what his crew needs.";
			link.l1 = "I'm not pretending to be anything, Tommy. I chose to be myself a long time ago. Whoever's comfortable with me, fine. If not, that's fine too.";
			link.l1.go = "BM_IronsSecondJungle_5";
		break;
		
		case "BM_IronsSecondJungle_5":
			dialog.text = "Heh, you and I are alike in that respect. But I have certain requirements for my captain. And you no longer meet them, young man. That's where we part ways.";
			link.l1 = "Are you serious? Because I didn't have a bloody paper cartridge?";
			link.l1.go = "BM_IronsSecondJungle_6";
		break;
		
		case "BM_IronsSecondJungle_6":
			dialog.text = "That's out of the question. I usually advise people to do as they please and take what they want from life. I'd advise you to think more about your people in the future. Goodbye.";
			link.l1 = "And I'd advise you to take care of your head – they've done more damage to it than you realise. Goodbye, Tommy.";
			link.l1.go = "BM_IronsJungleUhodit";
		break;
		...
		case "BM_IronsThirdJungle_3":
			dialog.text = "Actually, as my captain, it's your duty to provide me with everything I need for battle and more.";
			link.l1 = "You're confused, Tommy. It's your duty to obey your captain's orders. I always supply you all with everything – medicine, ammunition, rum. The fact that you don't take what you need in time and then act like a beggar is your fault alone!";
			link.l1.go = "BM_IronsThirdJungle_4";
		break;
		
		case "BM_IronsThirdJungle_4":
			dialog.text = "You're so clever - why haven't you achieved anything of note here so far? I'll tell you why. Because you don't think ahead, and you're never prepared for anything. You don't know what you're doing, you bore. I won't acknowledge such a person as my commander, so goodbye.";
		...
		case "BM_IronsThirdJungle_7":
			...
			link.l1 = "Old Reasley, you said... Frankie the Cuckold, wasn't it? The one you shot at the lighthouse? So, you've known each other for a long time, then?";
		...
		case "BM_IronsThirdJungle_10":
			...
			link.l1 = "And what did they do? Especially the second one, Callow. Did you sleep with his wife too? And did he also send soldiers after you?";
			link.l1.go = "BM_IronsThirdJungle_11";
		break;
		
		case "BM_IronsThirdJungle_11":
			dialog.text = "Keep your mouth shut, would you? Although... I wouldn't mind, hehe. But no. The Royalists attacked us that day. Cavalry, too. There were a lot more of them. Gabe and Frankie ran like frightened rabbits. But I stayed with the lads. I was the only one who survived. I've forgotten much of my childhood and youth, but not that.";
			link.l1 = "And you want revenge because they ran? Not everyone fights for an ideal. Everyone wants to survive. Or almost everyone. Even if someone fights for the Revolution, they might have joined by accident and regretted it.";
		...
		case "BM_IronsThirdJungle_12":
			...
			link.l1 = "What is it? Besides the fact that you lied about Frankie hunting you only because of what you did with his wife?";
		...
		case "BM_IronsThirdJungle_14":
			dialog.text = "None. Since the earthly tribunal sentenced me because of those rats, the heavenly one upstairs decided to spare me. As soon as we crossed into the Archipelago, we felt its atmosphere - our ship was boarded by pirates.";
		...
		case "BM_IronsThirdJungle_15":
			dialog.text = "That's what I said - someone upstairs decided to rescue me. What a rescue it was, hehe! You got it right - the pirates defeated those who liked to abuse bound and chained men. But it was still a fierce fight, as hot as the sun here. And our saviours suffered some casualties. So they offered everyone who wished to join them.";
		...
		case "BM_IronsThirdJungle_16":
			dialog.text = "Hell yes! Best years of my life. Jack Mills was a captain with a capital C – I hope you'll be like him one day. I sailed on his 'Crane' for about two years until...";
			link.l1 = "... until you grew tired of lawlessness, as you said? Why do you say those were the best years of your life?";
			link.l1.go = "BM_IronsThirdJungle_17";
		break;
		
		case "BM_IronsThirdJungle_17":
			dialog.text = "Eh... until I heard about those two traitors ending up in the Archipelago too. Aye, I know, I told you I was fed up with high seas piracy and all that. And I've already told you I don't care what you think. That's still true, but I didn't know you well when we first met. Didn't know how you'd react. That's why I said different things.";
		...
		case "BM_IronsThirdJungle_18":
			dialog.text = "Because Jack was a true leader, he said he wouldn't make a detour for one man, wait for him, seek revenge, or tangle with prominent officers of the British Navy instead of attacking fat merchant ships.";
			link.l1 = "Prominent officers? Frank was a civilian, I believe.";
			link.l1.go = "BM_IronsThirdJungle_19";
		break;
		
		case "BM_IronsThirdJungle_19":
			dialog.text = "Eh, he wasn't always one. He was always kind of, you know, shady. And when he tried to set someone up, he was kicked out in disgrace. He tried to sail on a trader, but honest work wasn't his thing. He ended up settling here.";
			link.l1 = "Still wouldn't call him a distinguished officer.";
		...
		case "BM_IronsThirdJungle_21":
			dialog.text = "Good point! The ship changed hands like a harbour maiden, so it saw all sorts of things. But she's still seaworthy. And Gabe's a skilled captain, damn him.";
			link.l1 = "And Jack was afraid to deal with him? Is he really as good as you say?";
		...
		case "BM_IronsThirdJungle_23":
			dialog.text = "I prefer to call it a black mark. It just sounds better. A simple black mark wouldn't have made him realise anything. But a black mark made from our silk handkerchief, which was a distinctive feature of our company – that, he'd understand. I slipped it discreetly into his pocket. Then I made sure he saw me heading to the lighthouse. You know the rest.";
		...
		case "BM_IronsThirdJungle_26":
			dialog.text = "Well, it's one thing to hear an interesting story, and another to create one yourself! So here's the plan. We'll need to leave Gabe another special black mark - I've got one made already. Then we'll follow his trail to Portland Cove, where we'll deal with him without leaving a trace.";
		...
		case "BM_IronsThirdJungle_27":
			...
			link.l1 = "Actually, I was rather interested in your story.";
		...
		case "BM_IronsThirdJungle_29":
			...
			link.l2 = "It's not without flaws, and you're leaving a lot to chance. But overall, it's doable. I'm with you, Tommy. You got rid of one, you can't let the other go, can you?";
			link.l2.go = "BM_IronsThirdJungle_Land1";	// Сухопутный вариант
			link.l3 = "I'm not getting involved in your revenge or risk my relationship with England for this adventure, where so much depends on chance, Tommy.";
			link.l3.go = "BM_IronsThirdJungle_Otkaz1";	// Отказ
		break;
		
		case "BM_IronsThirdJungle_Sea1":
			dialog.text = "You're a bold one, Captain! I'm starting to like you. But Gabe on the old 'Principio' isn't easy prey - he's far more dangerous than other captains on a ship like that.";
			link.l1 = "What do you take me for, a coward, Tommy? We'll board him ourselves, and you can have a heart-to-heart with him. Give him the black spot just before he's deposed.";
			link.l1.go = "BM_IronsThirdJungle_Sea2";
		break;
		
		case "BM_IronsThirdJungle_Sea2":
			dialog.text = "Heh, you might not be a coward, but he is, though he's a clever one. He won't attack a soldier or even a pirate with a bigger ship. If he sees anything like that on the horizon, he'll hide under the fort's wing.";
		...
		case "BM_IronsThirdJungle_Sea3":
			...
			link.l1 = "Let's hope it works, Tommy. So, a fifth-rate barque or barquentine flying Spanish or Dutch colours. Get ready to meet your old war mate!";
			link.l1.go = "exit";
			AddDialogExitQuest("BM_SeaVariant");
		break;
		
		case "BM_IronsThirdJungle_Land1":
			dialog.text = "I knew I could count on you! You might even be a better captain than Jack one day. And as for my luck... It’s got me this far, so I'll rely on it again. Shall we go, then?";
		...
		case "BM_IronsThirdJungle_Otkaz1":
			...
			link.l1 = "I suppose I'm meant to fall for that provocation and say I've changed my mind and will prove I'm a real captain, eh, Tommy? But I understand your desire for revenge. I'm not going to force you to leave the crew like Jack did. How much time do you need for that? I'll reach Jamaica by then.";
			link.l1.go = "BM_IronsThirdJungle_Otkaz2";
		break;
		
		case "BM_IronsThirdJungle_Otkaz2":
			dialog.text = "Ha ha ha, you're growing up. I almost respect you for not falling for it. But you don't have to wait and pick me up afterwards - I'll finish this myself. After all, all I ever wanted was someone willing to do something for me as my captain. So goodbye. Take care of England, ha-ha.";
		...
		case "BM_IronsJamaicaShore1":
			dialog.text = "Great, we can retreat quickly from here if the need arises. Take this – give Gabe the note and a black mark once you find out where he lives and when he's at home.";
			link.l1 = "Oh, so now you're calling the shots, Tommy. But remember, I'm still your captain. What do you plan to do while I'm in town?";
		...
		case "BM_Pyanitsa_0":
			dialog.text = "Hic! That's excellent rum! Hic... Cheers!";
				link.l1 = "Listen, mate, what's the word around town about Captain Gabriel Callow?";
		...
		case "BM_Pyanitsa_2":
			dialog.text = "Then go straight to Gabe, I tell you! There's not a more honest or brave captain in town than Gabe. Even Colonel Doyley holds him in high regard. He sails a ship that once belonged to Nicolas Sharp himself, can you believe it?";
		...
		case "BM_Pyanitsa_3":
			...
			link.l1 = "A Spanish prize ship, is it? Why?";
			link.l1.go = "BM_Pyanitsa_4";
		break;
		
		case "BM_Pyanitsa_4":
			dialog.text = "When was the last time you saw a pink one with your own eyes, eh? I know what I'm saying, eek!";
			link.l1 = "Well, I don't know if the ship's design is that unusual.";
			link.l1.go = "BM_Pyanitsa_5";
		break;
		
		case "BM_Pyanitsa_5":
			dialog.text = "But it is! No one would command such junk now, with all the new designs around! They stopped building them in shipyards almost t-thirty years ago! Nic sailed her himself, I tell you.";
		...
		case "BM_Pyanitsa_7":
			dialog.text = "Trad... Trad-trad-tradition, eek! Nic himself never renamed her after fleeing from a Spanish plantation in Cuba. He never wanted to forget the experience - and neither did the Spaniards! Let me tell you, that battle near the coast of Tendales...";
			if (startHeroType == 4)
			{
				link.l1 = "Tendales, right? Huh, the last time I heard that name was when I was a kid. I didn't think anyone still knew or remembered those now abandoned rocks.";
		...
		case "BM_Pyanitsa_8":
			dialog.text = "Or was it, eek, Highrock? N-no, definitely not there... Anyway, it doesn't matter! Nic fought and won in that pink, an unbelievable victory against the brig Cuttlefish, sent after him by Desmond Ray Beltrop, Pirate Baron. They spilled each other's blood for a long time until Nic cut down Desmond himself.";
			if (startHeroType == 4)
			{
				link.l1 = "Shiver me timbers, that's impressive! Although, you wouldn't expect anything else from Nicholas. Eh, the Sharps and the Beltrops are always together, then apart – apparently, history really does repeat itself from time to time.";
				link.l1.go = "BM_Pyanitsa_9";
			}
			else
			{
				link.l1 = "Impressive. So, how did Sharp part with the ship? Did he sell her at the shipyard?";
				link.l1.go = "BM_Pyanitsa_9";
			}
		break;
		...
		case "BM_Pyanitsa_10":
			dialog.text = "Oh, but the Navy was interested! Practical chaps. They saw a ship under the English flag but with a Spanish name and got curious. Nic died a few years later, but his ship kept going, changing hands, always in a bloody way.";
		...
		case "BM_Pyanitsa_11":
			...
			link.l1 = "When is he home? Sounds like he's a busy man.";
		...
		case "BM_Callow1":
			...
			else
			{
				...
				link.l1 = "Surprise, Gabe! I was told you were cautious, even cowardly. Greed has clouded your judgement, hasn't it? No merchant would seek out boarding as I did.";
		...
		case "BM_IronsClone2":
			...
			link.l1 = "I ran like hell to bring aid! But I was overtaken by another bloody force! Charles' damned supporters were everywhere! They had me pinned down, I nearly died! Good thing they thought I was dead. But do you know what I saw, Gabe?!";
			link.l1.go = "BM_IronsClone3";
		break;
		
		case "BM_IronsClone3":
			dialog.text = "What is it, Tom? Are you willing to make up any story you can to keep this man believing you?!";
		...
		case "BM_IronsClone9":
			if (startHeroType == 4) 
			{
				dialog.text = "Heh, you're right! Damn right! Thanks for helping me out with this one. You know, I thought you were just some spoiled girl in a flashy outfit who got a ship for a joyride. But you're a damn good captain! I bet you'd give Jack a run for his money.";
			}
			else
			{
				dialog.text = "Heh, you're right! Damn right! Thanks for helping me out with this one. You know, I think you're as good a captain as Jack. Or even better!";
			}
			link.l1 = "Oh, now you're flattering me. Thank you. I suppose.";
		...
		case "BM_IronsClone10":
			...
			link.l1 = "I wouldn't say I like the way you're putting it, even though I'm glad you generally think of me as a good captain. But... the chain of command, Tommy, the chain of command.";
		...
		case "BM_IronsClone11":
			...
			else
			{
				...
				link.l1 = "Heh. Maybe. It's better to be your friend than your enemy. And since etiquette clearly isn't your thing, I suppose I'll just have to get used to it.";
				link.l1.go = "BM_IronsClone12";
			}
		break;
		...
		case "BM_IronsClone13":
			dialog.text = "It's a black MARK, you dickhead. You know, I'm starting to think that as soon as I embroidered the skull and bones on this scarf, it started bringing me luck. I can't explain it. Take it. Also... if you want, you can always borrow my trusty sword and armour... what's left of it, ha-ha! It'll come in handy! You'll go far. And I want to witness it. I don't want you getting killed by a stray bullet.";
		...
		case "BM_IronsPinkPotopil1":
			dialog.text = "Well, you did a fine job with that ancient vessel, Captain! And though I wanted to finish Gabe off with my own hands, I will not anger the Creator by belittling this victory.";
		...
		case "BM_IronsPinkPotopil2":
			if (startHeroType == 4) 
			{
				...
				link.l1 = "Only in your wildest dreams, Tommy. And it's Helen, not Ellie. But I suppose you can call me Rumba now if you stop with the flattery.";
			}
			else
			{
				...
				link.l1 = "Oh, you flatter me. Thank you for the comparison as well, I suppose.";
			}
		...
		case "BM_GabeHouseGood1":
			...
			link.l1 = "I apologise for disturbing your rest, Captain Callow. My name is "+GetFullName(pchar)+", and I come on behalf of one of your old comrades-in-arms.";
		...
		case "BM_GabeHouseGood3":
			...
			link.l1 = "I apologise, but it's not for you to call him a scoundrel. You fled the battlefield and slandered Tom. Perhaps you later repented and became an exemplary officer here in the Archipelago, but that doesn't change the past.";
		...
		case "BM_GabeHouseGood5":
			dialog.text = "So, Thomas claims I ran and then slandered him? Well, you should know it was the other way round! When the King's cavalry approached, Tom said he was going for reinforcements. So we didn't retreat - we waited. Our whole company was killed! If we hadn't waited for the reinforcements he promised, we could have withdrawn and survived! In the end, it was just me, Frankie, and damn Thomas who survived.";
		...
		case "BM_GabeHouseGood6":
			...
			link.l1 = "So you won't go? You realise what that means. The laws of honour are written for everyone.";
			link.l1.go = "BM_GabeHouseGood7";
		break;
		
		case "BM_GabeHouseGood7":
			dialog.text = "I do, of course. And that's why I'll go. We need to finish what our republican court couldn't because of Tom's past military honours. And you... you seem like a decent sort. I'd advise you to choose your acquaintances more wisely. Don't get involved with Tom and his kind.";
			link.l1 = "But Thomas is my subordinate now, an officer on my ship. "+GetSexPhrase("I'll keep an eye on him and won't let him disgrace himself further if he survives his encounter with you.","")+"";
		...
		case "BM_GabeHouseGood_Tommi1":
			dialog.text = "Eh, if Tom managed to convince you with his tale, he'll have no trouble doing it again.";
			link.l1 = ""+GetSexPhrase("But by the laws of honour, I can't betray him. I'm","I'm")+" responsible for my men... I will not be like him. And I'll be more careful and critical of him from now on, if he survives.";
			link.l1.go = "BM_GabeHouseGood_Tommi2";
		break;
		
		case "BM_GabeHouseGood_Tommi2":
			dialog.text = "It's a tough decision. But I won't try to change your mind. Well, goodbye, "+GetSexPhrase("sir","miss")+" - I still have to prepare to meet Tom.";
		...
		case "BM_GabeHouseGood_Gabe1":
			...
			link.l1 = "Hmm, help you defeat Thomas? Is there much honour in such a duel? You can settle it yourselves, and I'll stay out of the way.";
		...
		case "BM_GabeHouseGood_Gabe4":
			dialog.text = "Glad to hear it, "+pchar.lastname+"! I realise it may not be easy for you to make such a decision, but I assure you, you've made the right choice. And to ensure it, I'm going to help you with something else.";
		...
		case "BM_GabeHouseNeutral1":
			...
			if (startHeroType == 4)
			{
				...
				link.l1 = "Helen MacArthur. And keep your desires in check, Mr. Callow. I'm a decent girl. Our climate makes me feel hot, even at night. Weren't you ashamed to say that to a strange girl? I've been told you're an exemplary officer.";
		...
		case "BM_GabeHouseNeutral2":
			dialog.text = "Do you greet strangers differently at this hour?";
			link.l1 = "I was told you're not at home at other times.";
			link.l1.go = "BM_GabeHouseNeutral3";
		break;
		
		case "BM_GabeHouseNeutral3":
			dialog.text = "Of course I'm not - I have service, duty, and honest labour, words that seem unknown to you, judging by your appearance.";
		...
		case "BM_GabeHouseNeutral5":
			...
			link.l1 = "I don't care. Save your tales for Doyley and all those naive simpletons. If you're as brave and honourable as they say, you'll accept the challenge and come now. So, do you accept it?";
		...
		case "BM_IronsJamaicaJungle1":
			if (CheckAttribute(pchar, "questTemp.BM_GabePlan"))
			{
				...
				link.l1 = "Anyone would be nervous seeing a man with a musket running at them - I didn't recognise you at first. What are you doing here, Tommy?";
				link.l1.go = "BM_IronsJamaicaJungle_GabePlan_2";
			}
			else
			{
				dialog.text = "How did it go? Hey, hey, why are you looking at me like that? You scared me, hehehe.";
				link.l1 = "Who's scaring whom! Who's running off like that?! We agreed to meet the guests in the cove!";
				link.l1.go = "BM_IronsJamaicaJungle2";
			}
		break;
		
		case "BM_IronsJamaicaJungle_GabePlan_2":
			dialog.text = "Heh, well, perhaps. I grew tired of waiting – for our dear guests and for you. And I decided this place was better suited for a proper ambush. After all, I'm a hunter, not a duellist.";
			link.l1 = "I see.";
			link.l1.go = "BM_IronsJamaicaJungle_GabePlan_3";
		break;
		
		case "BM_IronsJamaicaJungle_GabePlan_3":
			dialog.text = "Aye. So, did you leave my gift at Gabe's house? Took you long enough. I'd be a lot faster if I could get into town. What's got your eyes wandering, Captain? What's wrong?";
		...
		case "BM_IronsJamaicaJungle_GabePlan_VD1":
			dialog.text = "Heh, I get it - I'm not entirely sure it'll work myself. This is the first time something this big has ever happened to you, huh? It's alright, it happens. I've got it all worked out. If the soldiers come without Gabe, we just leave. If they come with Gabe, I'll put a bullet between his eyes, and again, we just leave. And if a ship comes to the bay, we run to Maroon Town - they won't dare go there, and then we decide what to do next.";
		...
		case "BM_IronsJamaicaJungle_GabePlan_4":
			...
			link.l1 = "No, what are you talking about? Why would I even speak to him?";
		...
		case "BM_IronsJamaicaJungle_GabePlan_6":
			...
			link.l1 = "No. Not exactly. Put the gun down, Tommy. I promise you, nothing irreparable needs to happen. You might work in the quarries, perhaps. I'll ask Gabe to show mercy. I'll even ask Colonel Doyley if I have to.";
		...
		case "BM_GabePlan_TommiMertv":
			dialog.text = "Well, I see you've already done it, "+GetSexPhrase("sir","miss")+". And I was gathering a squad, thinking that having the numerical advantage would make Tom think twice and lay down his arms.";
		...
		case "BM_GabePlan_TommiMertv_Mir":
			...
			link.l1 = "Hmm, and what is that? Tom is already defeated, after all.";
		...
		case "BM_GabePlan_TommiMertv_Mir2":
			...
			if (CheckCharacterItem(PChar, "blade_40"))
			{
				link.l2 = "Ah, of course. Please. I didn't mean to steal it. I won't lie though - I'd like to keep it. But here you are, Captain Callow.";
		...
		case "BM_GabePlan_TommiMertv_Soglasen":
			dialog.text = "Anyone would have wanted to keep this beauty! Thank you for returning her to me. Many people would have been stubborn in your place.";
		...
		case "BM_GabePlan_TommiMertv_Obmen":
			dialog.text = "I'm not interested. Just return the rapier, and we'll part on good terms, "+GetSexPhrase("Mr.","miss")+" "+pchar.lastname+".";
			link.l1 = "I take it this rapier is dear to you because you like weapons with history, am I right? I have one just like it, and this is the one you'd rather carry than keep in a drawer.";
			link.l1.go = "BM_GabePlan_TommiMertv_Obmen2";
		break;
		
		case "BM_GabePlan_TommiMertv_Obmen2":
			dialog.text = "Is that so? Well, I can't promise we'll come to an agreement, but I'm listening. I am indeed interested in weapons with history. But this rapier was a gift from the Colonel. That's why it's so precious to me.";
		...
		case "BM_GabePlan_TommiMertv_Obmen3":
			...
			link.l1 = "I'm glad we could come to an agreement. I suppose that's goodbye, Captain Callow?";
			link.l1.go = "BM_GabePlan_TommiMertv_Platok";
			RemoveCharacterEquip(pchar, BLADE_ITEM_TYPE);
		...
		case "BM_GabePlan_TommiMertv_Poteryal":
			dialog.text = "WHAT?! How could you... How could you lose an entire bloody rapier?! You're an idiot!";
			link.l1 = "Calm down! It's just a rapier. You'd never use it anyway. Tom is dead - isn't that the only thing that matters now?";
			link.l1.go = "BM_GabePlan_TommiMertv_Poteryal2";
		break;
		
		case "BM_GabePlan_TommiMertv_Poteryal2":
			dialog.text = "Just a rapier?! It was my treasure! A gift from Colonel Doyley himself! I don't care that I never used it!";
		...
		case "BM_GabePlan_TommiMertv_Otkaz":
			...
			link.l1 = "I would agree, but you don't use it anyway. It'll just hang on a nail in your room. Whereas with me, it'll find a worthy use. Colonel Doyley isn't going to check if you've misplaced it, is he?";
		...
		case "BM_GabePlan_TommiMertv_Otkaz2":
			...
			link.l1 = ""+GetSexPhrase("I'm not one of your toy soldiers","I am not one of your harbour whores")+", to take orders from you. I'm a ship's captain, just like you. The rapier stays with me, whether you like it or not.";
		...
		case "BM_GabePlan_TommiMertv_Platok":
			dialog.text = "Here, take this. I don't need it at all. Let it be your memento of the day. Try to be a little less gullible from now on. And don't let any scoundrels like Thomas drag you into their dirty business.";
			link.l1 = "Heh, are you giving me the black spot, Captain Callow?";
			link.l1.go = "BM_GabePlan_TommiMertv_Platok2";
			GiveItem2Character(PChar, "talisman15");		//Предмет Чёрная Метка
		break;
		
		case "BM_GabePlan_TommiMertv_Platok2":
			dialog.text = "Well, neither of us is a pirate, are we, "+pchar.name+"? Let it serve as a reminder. Take care, the Archipelago needs men like you. "+GetSexPhrase("Perhaps I'd suggest joining the Navy and write a recommendation to Colonel Doyley...","")+"";
			link.l1 = "I regret I cannot accept your offer, Captain.";
			if (startHeroType == 3)
			{
				link.l1 = "Hm. I will give it a thought. A really good one.";
			}
			if (startHeroType == 4)
			{
		...
		case "BM_GabePlan_TommiMertv_Platok3":
			dialog.text = "Suit yourself. Well, goodbye. "+GetSexPhrase("Mr.","miss")+" "+pchar.lastname+". You deserve to carry what remains of the Ironsides. Farewell.";
			link.l1 = "Farewell, sir.";
			link.l1.go = "exit";
			AddDialogExitQuest("BM_GabePlan_CallowDruzhba");
		break;
		...
		case "BM_GabePlan_TommiMertv_Konflict":
			...
			link.l1 = "You've been stalling deliberately, gathering your 'best men'. What for? To apprehend a single man? You should have grabbed a few soldiers patrolling the city and come to my aid at once!";
			link.l1.go = "BM_GabePlan_TommiMertv_Konflict2";
		break;
		
		case "BM_GabePlan_TommiMertv_Konflict2":
			dialog.text = "Bringing cannon fodder?! Tom wasn't just a city guard like them. He had completely different training and experience - he's a bloody Ironclad, just like me! How do you not realise that?";
			link.l1 = "Oh, on the contrary, I do realise it. That's why you and I were here - to cross blades with Tom, allowing the boys to capture him alive. Besides, you're Ironclad, too. Same company, even. Were you so afraid to fight him in person?";
			link.l1.go = "BM_GabePlan_TommiMertv_Konflict3";
		break;
		
		case "BM_GabePlan_TommiMertv_Konflict3":
			dialog.text = "How dare you accuse me of cowardice, young "+GetSexPhrase("man","miss")+"! Ask anyone, and they'll tell you in detail about the feats I've accomplished for this city.";
			link.l1 = "I'm not finished yet. I'm beginning to wonder if these ‘feats’ were accomplished by your own hands. You wanted Tom and me to kill each other so you could take all the glory. You've done that before, haven't you?";
			link.l1.go = "BM_GabePlan_TommiMertv_Konflict4";
		break;
		
		case "BM_GabePlan_TommiMertv_Konflict4":
			dialog.text = "I've had enough of your accusations, "+GetSexPhrase("Mr.","miss")+" "+pchar.lastname+". You want conflict? You'll have it. Right now.";
		...
		case "BM_GabePlan_GazgovorTommiAndGabe_1":
			dialog.text = "";
			link.l1 = "Gabe! It's been so long, so many bleak midwinters! And look at you - still got that same smug look, damn you!";
		...
		case "BM_GabePlan_GazgovorTommiAndGabe_2":
			dialog.text = "Thomas! I should be pleased, for today I shall finally accomplish with my own hands what our justice system has failed to do for years. And since I am in good spirits, I will allow you to lay down your arms and come with us. You may even be sent back to penal servitude. In that case, I shall personally escort you there.";
			link.l1 = "Heh, make me! You think a couple of blokes standing next to you will stop me!!!";
		...
		case "BM_GabePlan_GazgovorTommiAndGabe_7":
			...
			link.l1 = "Unfortunately, he's right. Lay down your weapons. No one has to die today. I'll put in a good word for you myself so that you won't be hanged. You could even return to an honest life someday.";
			link.l1.go = "BM_GabePlan_GazgovorTommiAndGabe_8";
		break;
		
		case "BM_GabePlan_GazgovorTommiAndGabe_8":
			dialog.text = "That's not for you to decide! And certainly not you! Who needs enemies with a commander like that! Another bloody rat.";
		...
		case "BM_GabePlan_GazgovorTommiAndGabe_9":
			dialog.text = " A place in your crew, on your ship, would be a start, if only you were willing to stand up for your men! But that doesn't matter anymore. Damn you, all of you! I'll spill your cowardly guts, you little rat. And you, Gabe, I'll try to take you with me...";
		...
		case "BM_GabePlan_GabeWin_1":
			dialog.text = "Congratulations, "+GetSexPhrase("young man","young miss")+"! I'm impressed that you managed to make Thomas feel as if everything was going according to his plan - he had a nose for treachery.";
		...
		case "BM_GabePlan_GabeWin_3":
			dialog.text = "...as if he were the injured party here. It was to be expected. Remember, Charles, a monster can feel pain. But it doesn't stop being a monster. Many criminals are often sincerely convinced of their righteousness and innocence.";
		...
		case "BM_IronsJamaicaJungle2":
			dialog.text = "It took you long enough. So I thought I'd do a bit of recon. Anyway, I think it's better to ambush them here instead of playing fancy duelists on the beach. I hope you managed to find Gabe's house and leave everything in plain sight?";
			link.l1 = "Of course I did, what do you take me for, an idiot? I'm actually your captain, Tommy. What would that make you if you served an idiot?";
			link.l1.go = "BM_IronsJamaicaJungle3";
		break;
		
		case "BM_IronsJamaicaJungle3":
			dialog.text = "Ha-ha-ha-ha, you wouldn't believe how often I've had to deal with nonsense like that in the service! But in our case, fortunately, that's not the situation. All right, then. We're expecting company. Ready?";
		...
		case "BM_GabeJungle1":
			...
			link.l1 = "Of course it's really me, or were you expecting someone else, Gabe? Heh, you look pale, as if you've seen a ghost. You're also fatter than you were back in Old England.";
		...
		case "BM_GabeJungle2":
			...
			link.l1 = "Ha-ha-ha, now we're talking! You know, you've actually disappointed me, Gabe. Again! You clearly needed to bring more men with you just to handle me alone. And there are two of us! Or was that all they could spare you, you coward?";
			link.l1.go = "BM_GabeJungle3";
		break;
		
		case "BM_GabeJungle3":
			dialog.text = "Enough! I don't see the point in us talking anymore.";
		...
		case "BM_IronsJamaicaJungle4":
			...
			link.l1 = "Well, are you satisfied, Tommy? You know, a lot of people only get worse after they take their revenge.";
			link.l1.go = "BM_IronsJamaicaJungle5";
		break;
		
		case "BM_IronsJamaicaJungle5":
			dialog.text = "Ha, did you read that somewhere? I never understood such weaklings. Bah! Am I satisfied? I'm so happy I could piss myself! Those bastards were the root of my greatest misfortunes!";
			link.l1 = "I am happy for you. Is there no one else you need to take revenge on? Am I to expect more paper cartridge jokes from you?";
			link.l1.go = "BM_IronsJamaicaJungle6";
		break;
		
		case "BM_IronsJamaicaJungle6":
			dialog.text = "Calm down, Gabe was the last. And as for the jokes – don't worry, there won't be any more, at least not as far as you're concerned.";
			link.l1 = "Shall we go back to the ship then?";
			link.l1.go = "BM_IronsJamaicaJungle7";
		break;
		
		case "BM_IronsJamaicaJungle7":
			dialog.text = "We'd be back on her anyway, whether I still have someone to take revenge on or not. Wait a minute, though...";
			link.l1 = "Oh, so it's not over yet...";
			link.l1.go = "BM_IronsJamaicaJungle8";
		break;
		
		case "BM_IronsJamaicaJungle8":
			dialog.text = "It is, it is. There's something I want to tell you. It's something I say to very few people. And I won't say it again. If you laugh at me, I'll be very cross with you.";
		...
		case "BM_IronsJamaicaJungle9":
			dialog.text = "Good. So. I'm very grateful that you decided to help me instead of doing what Jack did. You're a true friend, Captain. Thank you. Also... if you want, you can borrow my trusty sword, and my armour... What's left of it, ha-ha!";
		...
		case "Irons_officer":
			...
			{
				Link.l1 = "Tommy, looks like this is where our paths diverge.";
			...
			{
				Link.l4 = "Tommy, I'd like to ask you something very serious. There's one... a stone idol of the Redskins. And I'm going to need help. I can only ask my closest friends for this, like you. Newcomers or those I don't trust much yet won't do.";
			...
			{
			    Link.l11 = "Tommy, stop counting the seagulls. Have you tallied all the cargo? Give me a full report and a forecast.";
				...
				if (startHeroType == 4)
				{
					Link.l11 = "Tommy, could you please report everything about the ship?";
					Link.l12 = "Tommy, I'm getting rather weary. Could you stock up on certain goods at each port?";
				}
				if (pchar.sex == "man" && pchar.rank >= 15)
				{
					Link.l11 = "Prepare a report on the condition of the ship and everything aboard, Tommy.";
				...
				if (pchar.sex == "man" && pchar.rank >= 25)
				{
					...
					Link.l12 = "I need you to buy these goods during our stops at each port.";
				}
			}
			//////
			Link.l1 = "Listen carefully to my orders!";
			if (startHeroType == 4 && CheckAttribute(pchar, "questTemp.BlackMarkQuestCompleted"))
			{
				Link.l1 = "Someone is, for sure. But for now, listen to my orders.";
			}
			if (startHeroType == 4 && !CheckAttribute(pchar, "questTemp.BlackMarkQuestCompleted"))
			{
				Link.l1 = "Listen to my orders... Tommy. ";
			}
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
			...
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
				Link.l1 = "Listen to my orders, Tom.";
			}
		...
		case "QMASTER_1":
			...
			Link.l1 = "This isn't the army, Tommy. But fine, I get it, I won't force you.";
			if (startHeroType == 4)
			{
			...
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
				dialog.text = "Look, I'm not a scribe. No one has ever required this of common soldiers like me, not even in the army. Let's not change that rule.";
				Link.l1 = "Alright, let's not.";
			}
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
				dialog.text = "The only thing I can count is how many of our enemies I've shot, ha-ha-ha. And even then I lose count. I'm a simple soldier, you know. Who the hell knows about the ship - I've been a landlubber most of my life.";
		...
		case "QMASTER_2":
			dialog.text = "What do you take me for, some back-alley quartermaster? We had nothing but contempt for those soft-cocked cowards back home. I may not be nobility, but I've still got my pride.";
			link.l1 = "Alright, alright, if you won't, then you won't.";
			link.l1.go = "exit";
			if (startHeroType == 4)
			{
				dialog.Text = "Listen, I was a simple, honest soldier, not a supply officer, my girl. I don't know much about it and I don't want to start learning. It's like asking you to assemble and disassemble a musket against the clock.";
			...
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
				dialog.text = "No, I couldn't. Perhaps you've forgotten, or don't know this at all, so I'll explain. For you, this would be a routine task, but in our army, we don't treat supply and rear services very well. Please don't count me among them.";
				Link.l1 = "Ha-ha, good, good.";
			}
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
				dialog.text = "Look, I respect you, of course, but I'm not going to go against myself and do something I can't do or can't stand. I barely learned to count back then, and now you want me to be a proper supplier. By the way, we didn't like them – they skimp on ammunition, water, food, and its freshness.";
				Link.l1 = "Hm, alright, let's forget about it.";
			}
		break;
		
		case "stay_follow":
            dialog.Text = ""+GetSexPhrase("Oh, an order, huh? You like the drill and all those army things, don't you? I'd rather you just tell me what needs to be done.","You're like a sergeant or something. It doesn't suit you - you're far too beautiful for that. You wouldn't have survived a day in the army. But I'm listening.")+"";
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
				dialog.text = "Apparently, you really are a big fan of uniforms, drills, and all that. But alright, go on.";
			}
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
            ...
            Link.l1 = ""+GetSexPhrase("Don't go anywhere and don't do anything - just observe, understand? I know you.","Stay right where you are, do you understand me?")+"";
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
            ...
            Link.l2 = ""+GetSexPhrase("Follow me and don't get distracted by anything – stray wives or suddenly appearing old war comrades included.","Stay close, alright? I'd like you to watch my back.")+"";
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
			...
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
				Link.l2 = "Follow me, unless you've stopped for some reason.";
			}
			...
			if(CheckAttribute(NPChar, "equip.gun"))
			{
				if(CheckAttribute(NPChar, "chr_ai.gun.bulletNum") && sti(NPChar.chr_ai.gun.bulletNum) > 1)
				{
					...
					if (pchar.sex == "man" && pchar.rank >= 15)
					{
						Link.l3 = "I need you to use different ammunition in the upcoming fight.";
					}
					if (pchar.sex == "man" && pchar.rank >= 25)
					{
						Link.l3 = "You'll be using different ammunition in the next battle.";
					}
				}	
			}
			if(CheckAttribute(NPChar, "equip.musket"))
			{
				...
				Link.l6 = "I'd like you to keep a certain distance between yourself and your enemies.";
		...
		case "SetGunBullets":
			Dialog.Text = ""+GetSexPhrase("What kind of projectiles? I hope you've crafted each one with care, because who knows where they'll land, hehe.","I'll shoot anything for you. Whatever it is, but never blanks, hehe. ")+"";
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
				dialog.text = "I sense something interesting is brewing! All right, what kind?";
			}
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
				dialog.text = "Fighting in again... Okay, what kind?";
			}
        ...
        case "Boal_Stay":
            ...
            Link.l1 = ""+GetSexPhrase("Hey, watch it! We'll figure something out if it comes to that.","Well, you're not just going to stand there and watch, are you? If you think your captain is as wonderful as you say, you'll do something about it.")+"";
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
				dialog.text = "Even aiming for the head? Okay, okay, don't look at me like that, I get it.";
				Link.l1 = "I hope so.";
			}
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
				dialog.text = "Don't be afraid, no one will get through.";
        ...
        case "Boal_Follow":
            ...
            dialog.Text = ""+GetSexPhrase("Very funny. But I take your point.","Oh, don't you worry, I've always got your back, hehe.")+"";
            Link.l1 = ""+GetSexPhrase("Good.","God, you're insufferable, Tom.")+"";
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
				dialog.text = "Well, I'm trying to remember something very important. And then I realise that I don't even know what it is, since I lost my memory back then, so nothing will come of it. Okay, let's go.";
				Link.l1 = "Witty, I must say.";
			}
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
				dialog.text = "Well, I'm standing here because you ordered me to do so yourself earlier. I'm coming, I'm coming.";
				Link.l1 = "Hmm, all right, all right.";
			}
            Link.l1.go = "Exit";
        break;
		...
		case "TargetDistance":
			...
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
				dialog.text = "Alright, what distance? But let me remind you that I won't be able to fire accurately and slowly at more than twenty metres in the heat of battle.";
			}
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
				dialog.text = "Okay. What? Remember that beyond... well, we're not little anymore, you and I know that.";
			}
			link.l1 = "";
			Link.l1.edit = 3;
		...
		case "TargetDistance_1":
			...
			if (iTemp < 0)
			{
				...
				if (pchar.sex == "man" && pchar.rank >= 15)
				{
					dialog.text = "Not your worst joke. Maybe one day you'll even stop being such a sourpuss, heh-heh.";
					Link.l1 = "Oh well.";
				}
				if (pchar.sex == "man" && pchar.rank >= 25)
				{
					dialog.text = "Ha-ha-ha, good joke.";
					Link.l1 = "Actually, I just... all right.";
				}
				link.l1.go = "exit";
				break;
			}
			if (iTemp == 0)
			{
				dialog.text = "Well, then I'll just stand still and hold my ground. If you fight them from too far away, that's your neck on the line, hehe.";
				link.l1 = "Don't be sarcastic; holding your ground is exactly what I want you to do from now.";
				if (pchar.sex == "man" && pchar.rank >= 15)
				{
					dialog.text = "Heh, you could have just told me to hold the line, instead of talking about distances and numbers.";
					Link.l1 = "Well, the main thing is that you understood me.";
				}
				if (pchar.sex == "man" && pchar.rank >= 25)
				{
					dialog.text = "Got it, I'll hold the line here. Then bring them closer so I can shoot.";
					Link.l1 = "Certainly.";
				}
				link.l1.go = "exit";
			...
			if (iTemp > 20)
			{
				dialog.text = "Look, I know you'd like every shot I take to be like the one at the lighthouse, but that's not going to happen. It was a good position there. Calm and steady. You can't replicate that in the heat of battle.";
				link.l1 = "Hmm. Then keep twenty yards away.";
				if (pchar.sex == "man" && pchar.rank >= 15)
				{
					dialog.text = "I know you'd like that, all the guys would like that, but like that time at the lighthouse, it won't work anymore. I'll need a good spot, and for no one to get to me, otherwise my nerves will give out.";
					Link.l1 = "Hmm, okay.";
				}
				if (pchar.sex == "man" && pchar.rank >= 25)
				{
					dialog.text = "I've certainly honed my skills since then, but the impossible will remain impossible - in the heat of battle, I could never repeat that shot from the lighthouse. Even with a wheellock rifle.";
					Link.l1 = "And the impossible is possible, Tommy. But all right, no means no.";
				}
				link.l1.go = "exit";
				npchar.MusketerDistance = 20.0;
				break;
			}
			dialog.text = RandPhraseSimple("Very good. I'll maintain that distance exactly, but if we're fighting inside a tavern or cave, I'll step outside to keep it, hehe.","I'll try. But decks and confined spaces might dictate their own terms.");
			link.l1 = ""+GetSexPhrase("Not funny, Tommy. Behave appropriately, and no jokes or your stupid pranks.","I know that, Thomas, I'm not stupid.")+"";
			if (pchar.sex == "man" && pchar.rank >= 15)
			{
				dialog.text = "I'll try to remember.";
				Link.l1 = "Alright, I'm counting on you.";
			}
			if (pchar.sex == "man" && pchar.rank >= 25)
			{
	...
	// на Тайясаль
		case "tieyasal_1":
			dialog.text = "Help with what, steal it? But why? I'm flattered, of course, but you could have said everything a long time ago. Go on, spit it out.";
			link.l1 = "Watch your mouth, huh? Well, damn it – I don't really care how you express yourself, as long as you're on my side. So, that idol. Through it, you can... magically travel to another place. Don't look at me like that – I know how it sounds. But I've been through this before and seen it all with my own eyes. It's... safe if you drink one elixir.";
			link.l1.go = "tieyasal_2";
		break;
		
		case "tieyasal_2":
			dialog.text = "I see you've had a few drinks already. Although, no, you seem sober. And they say I always talk nonsense...";
			link.l1 = "Are you coming with me or not? The idol is supposed to lead us to an ancient Mayan city, and who knows what awaits us there? You are one of the few I believe I can rely on in a difficult moment. And now such a moment has come.";
		...
		case "tieyasal_4":
			...
			link.l2 = "I doubt you have the balls to shoot them, you bold one, if you're afraid to go near the idol.";
			link.l2.go = "tieyasal_6";
		break;
		
		case "tieyasal_5":
			dialog.text = "Oh, well, well, don't pout. All right, if you come back after dancing around that idol, then I'll think about it next time.";
		...
		case "tieyasal_6":
			dialog.text = "I'm not afraid, don't get me wrong. But I'm used to trusting my gut feeling, it's never let me down over the years. And now it's telling me that nothing good will come of this. And anyway... Oh well, you'll get offended.";
		...
		case "tieyasal_7":
			...
			link.l1 = "Now you've proven yourself, Tommy. I needed the most loyal people. And now I see that you're not one of them. I'm going there. And you... do whatever you want.";
		...
		case "tieyasal_9":
			dialog.text = "Shiver me timbers! Are you serious? Well, perhaps it's for the best. I don't want to be with wet blankets who don't even understand jokes. In that case... farewell, Your Excellency.";
		...
		case "SharlieEpilog_Irons_1":
			dialog.text = "Ha. Would you look at that, you've learned how to joke. Almost like me. But I won't bite that bait, don't even hope.";
			link.l1 = "You don't get it – this isn't a joke. I'm heading to Europe, to see my father. You can stay here and wait... but I don't know how long it will take.";
			link.l1.go = "SharlieEpilog_Irons_2";
		break;
		
		case "SharlieEpilog_Irons_2":
			dialog.text = "Yeah, you're not that good at joking with a face like that. So you're kicking me out? After I saved your skin? After everything I did for you?";
			link.l1 = "Don't be so dramatic, Tommy. You were doing your job – and getting paid for it. I'll admit, you're good at what you do. And if you choose to wait, I'd be glad to have you aboard again. But for now...";
			link.l1.go = "SharlieEpilog_Irons_3";
		break;
		
		case "SharlieEpilog_Irons_3":
			dialog.text = "How generous, goddamn it. Well, thanks, Captain Traitor, sir. Let’s put it in the book — 'a loyal dog can wait for his master, if he doesn’t die of boredom'.";
			link.l1 = "Don’t take it personally. It’s just how things turned out.";
			link.l1.go = "SharlieEpilog_Irons_nothing";
			link.l2 = "I get that you’re angry. I wouldn’t be thrilled either. I’ll pay you an extra month’s wage on top of what you’re owed. I hope you don’t hold it against me.";
			link.l2.go = "SharlieEpilog_Irons_salary";
			link.l3 = "I know this came out of nowhere, and you’ve got every reason to be mad. I’m willing to pay you triple your monthly wage on top of what you're due.";
			link.l3.go = "SharlieEpilog_Irons_salary_X3";
		break;
		
		case "SharlieEpilog_Irons_nothing":
			dialog.text = "To hell with how things turned out. And to hell with you. I regret ever getting involved with you. And you know what? You’re not kicking me out – I’m leaving on my own.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Irons_exit";
		break;
		
		case "SharlieEpilog_Irons_salary":
			dialog.text = "Keep your pennies for beggars. I don't need your charity.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Irons_exit";
			//
		...
		case "SharlieEpilog_Irons_salary_X3":
			dialog.text = "Triple wage? Now that's generous... I'm touched. Hand it over. I'll buy the lads a drink in the tavern — in honor of Captain Charles de Mor: the model of loyalty, the symbol of friendship, the shining example for all.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Irons_exit";
			//
