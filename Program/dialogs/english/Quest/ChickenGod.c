...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
        ...
        case "native_1":
			dialog.text = "Golden doubloons open all paths and make white men happier. Wouldn't you know?";
			if (HasSubStr(pchar.model, "Sharle")) {
				dialog.text = dialog.text+" I can almost smell the weathered air of Versailles, where you were let in with such a squeak.";
			}
			link.l1 = "Don't talk to me like that, red face. It's true that I'm new here, though I don't know how you found out. I could shoot you right where you stand and get any girl for the night to make up for the inconvenience.";
			link.l1.go = "native_var1";
			link.l2 = "I don't know who told you that nonsense, but you speak rather smoothly, I'll give you that. It's the first time I've seen such an educated native.";
			if (HasSubStr(pchar.model, "Sharle")) {
				link.l2 = link.l2+" Versailles, my arse!";
			}
			link.l2.go = "native_var2";
		break;
		
        case "native_var1":
			dialog.text = "No, Captain, you don't know anything. I'm perfectly safe here... for now. However, since we've become so familiar so quickly, let's try again. Drink?";
			link.l1 = "I can do that, you've definitely piqued my interest.";
        ...
        case "native_play":
			dialog.text = "Considering the purpose of this place, your comment, Captain, quite worries me! I've been stuck here for almost a month now. I've tried everything I can think of, and I'm ready to climb the wall out of sheer boredom and pointlessness.";
			link.l1 = "Leave then. Visit a church for a change... though they won't let you in.";
			link.l1.go = "native_play_1";
		break;
		
        case "native_play_1":
			dialog.text = "It's not that simple, as I'm obliged to spend another twenty-four hours in this brothel, according to my... contract.";
			link.l1 = "Sounds dreadful, of course, but you'll get no sympathy from me. An exclusive brothel rental for a month is a dream come true!";
			link.l1.go = "native_play_2";
		break;
		
        case "native_play_2":
			dialog.text = "Fear your desires, Captain. I don't know how you got here, because I was supposed to spend this month alone. Alone with women and wine, but by the third day or so, I could only manage the wine. And today was the day I grew sick of that as well.";
			link.l1 = "And what do you want me to do? Share a bunch of girls and wine with you?";
        ...
        case "native_cards_loss_1":
			dialog.text = "You weren't even supposed to be here, captain. But if you yearn to find out what it was all about... look for an ancient temple on the continent. And bring plenty of tuunich kaane'. Here, take one.";
			link.l1 = "An adder stone? A stone with a hole certainly fits the location. Thanks, Agueybana";
        ...
        case "native_cards_win":
			...
			link.l1 = "Yeah, that's the first time I've ever seen anyone get that excited about a route like this. Where did you get all that money, by the way?";
        ...
        case "native_cards_win_2":
			dialog.text = "I suggest this time we play dice and raise the stakes a bit. I also have a story to tell you, so please rent a room upstairs for both of us. Too many ears here! I'd appreciate it if you could go to the Madame and pay for the room. My credit, unfortunately, does not extend to you.";
			link.l1 = "Rent a room? For two? Here? Damn you, Agueybana! I am out of here!";
			link.l1.go = "native_cards_rematch_decline";
			link.l2 = "Oh, what the hell. This story will end either as a good anecdote or a very expensive bloodbath. My sword stays with me, so no funny business, ha-ha! Wait here, I'll sort this out.";
        ...
        case "native_dice":
			dialog.text = "So?";
			link.l1 = "I sincerely hope you called me here just for booze and gambling.";
        ...
        case "native_dice_win":
			...
			link.l2 = "You're strange, Agueybana. Now, if I don't leave this place at once, my reputation as a nobleman and as a man will be irreparably damaged. Give me my silver and let's go our separate ways.";
        ...
        case "native_dice_loss":
			...
			link.l1.go = "native_dice_story";
			link.l2 = "Fuck you, Agueybana! I've had enough of this!";
			link.l2.go = "native_dice_loss_not_story";
		break;
		
        case "native_dice_story":
			dialog.text = "As much as I can, captain. I'm not sure I'm allowed to, but still, you've brightened my last few days... In this brothel, I mean.";
        ...
        case "native_dice_story_1":
			...
			link.l1 = "A worthy biography. I suddenly have the urge to shoot you, Agueybana, and leave you to rot in this sour, wine-scented dump.";
        ...
        case "native_dice_story_3":
			dialog.text = "I've seen your ships – marvels of human genius – and I've wanted one for myself. I've seen your women in tight corsets, and dreamed of taking one off myself. I've watched even the lousiest of your commandants wield power beyond the dreams of any of our leaders. I've heard stories about Europe and the huge stone houses where people live instead of merely surviving. And I've had it all! Moreover, I've even been to Europe and all that in the past year!";
			link.l1 = "You've had too much wine, chief. The only ticket to Europe for you would be in chains, to the delight of the Vatican and the street performers. What you're talking about is simply impossible in the world we live in.";
			link.l1.go = "native_dice_story_4";
		break;
		
        case "native_dice_story_4":
			dialog.text = "That is the world we live in, captain. I have already been told that our world is wrong, imaginary, and that anything is possible.";
			link.l1 = "And who was the smart-arse who told you that? Apparently they don't just let you into brothels, but asylums too!";
			link.l1.go = "native_dice_story_5";
		break;
		
        case "native_dice_story_5":
			dialog.text = "Now we're getting to the point of my story. You know how things work here, don't you? The Spanish and English pay for our prisoners of war with guns, tools and gunpowder. I paid for my tribesmen with your money. Why do you think that is?";
			link.l1 = "I feel like you're about to enlighten me.";
			link.l1.go = "native_dice_story_6";
		break;
		
        case "native_dice_story_6":
			dialog.text = "Only the gods can fulfil our deepest and most shameful desires. If you can't live the life you want, then ask them to interfere with fate. Only they can fulfil our deepest and most shameful desires. This is the way. But here's the trouble: almost all of our gods are already dead, and even if they weren't, they were never interested in gold anyway. Luckily, nature abhors a vacuum, and a new god has appeared in one of the old pyramids. He doesn't care who you are: local or European, villain or hero - just pay and you'll get what you asked for! All the tribes know that, and some of your people too. I've paid the price in gold and lived like one of you. It'll be a year tomorrow.";
			link.l1 = "What god? To Europe and back in a year? And the highlight of your trip was some lousy brothel in the Caribbean? Oh, what the hell. Sounds like a drunkard's tale, and I'll buy it as such. Let's have a drink and get on with your story.";
        ...
        case "native_dice_story_7":
			...
			link.l1 = "You haven't lived in our world long enough, Agueybana. Every booze-inspired fable, especially one told drunkenly in a brothel, must end with a moral. We should certainly philosophise before properly finishing our salon.";
			link.l1.go = "native_dice_story_8";
		break;
		
        case "native_dice_story_8":
			dialog.text = "How do they usually end?";
			link.l1 = "You don't know? Depends on the participant's gender, of course! Fistfight the men, take the women to bed. Sometimes fashion dictates the other way around, though. So what's the moral of your fable? Money doesn't buy happiness? Boring!";
			link.l1.go = "native_dice_story_9";
		break;
		
        case "native_dice_story_9":
			dialog.text = "That's not the moral of my fable, as you put it. But since you started it, I feel the need to say that I do not agree with your point. On the contrary, I believe that money buys happiness and makes people better.";
			link.l1 = "Nonsense! You seem to be contradicting yourself now. You amassed a significant fortune through the trade of your own people. Do you recall the total amount you profited from? Nearly thirty thousand gold coins? Take a moment to reflect, but it's clear to me that money didn't buy you happiness. It did buy you this fine suite though.";
        ...
        case "native_dice_story_11":
			dialog.text = "You know, captain, I truly appreciate this conversation. Let me clarify once more: money makes life and people better, but only those who already possess a spark of virtue.";
			link.l1 = "Hear, hear! So, no spark for you, eh?";
			link.l1.go = "native_dice_story_12";
		break;
		
        case "native_dice_story_12":
			dialog.text = "No. I was the chief of my people and, unlike money, power definitely corrupts men. You know what, captain? I look at you now and I realise that you will face the same dilemma some day.";
			link.l1 = "Has your god also given you the gift of foresight? Then you should go to Santiago, I've heard they're particularly interested in all kinds of mediums and fortune tellers.";
			link.l1.go = "native_dice_story_13";
		break;
		
        case "native_dice_story_13":
			dialog.text = "Let's finish our... ahem, salon without resorting to fisticuffs or bedding, please. I failed to find a moral for my story, so I'd like to propose a toast instead.";
        ...
        case "native_dice_story_14":
			dialog.text = "Here's to our desires always matching our needs. Thank you, Captain, that's a fitting end to... our evening. If you ever wish to test the truth of my tale, go to the continent and find an ancient temple there. Bring with you a hundred and thirteen tuunich kaane'. I have ninety-nine left - take them, and farewell!";
			link.l1 = "A pile of stones with holes? Suits the place well enough. Thank you for the evening, Agueybana. Will I see you again?";
        ...
        case "native_dice_win_not_story":
			dialog.text = "I understand, captain. For better or worse, I'll give you a tip about the treasure. After all, you've brightened my last days... In this brothel, I mean. Search for an ancient temple on the mainland and bring a pile of tuunich kaane' there. Here, take one.";
			link.l1 = "An adder stone? How charming, and a stone with a hole definitely fits the location. I've had enough of your treatment!";
			link.l1.go = "native_dice_not_story";
		break;
		
        case "native_dice_loss_not_story":
			dialog.text = "I get that you are upset, captain. For better or worse, I'll give you a tip on the treasure. After all, you've brightened my last days... In this brothel, I mean. Search for an ancient temple in the great land and bring a pile of tuunich kaane' to it. Here, take one.";
			link.l1 = "An adder stone? How charming, and a stone with a hole definitely fits the location. I have had enough of your treatment!";
			link.l1.go = "native_dice_not_story";
		break;
		
        case "native_dice_not_story":
			dialog.text = "Goodbye, captain.";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "joruba":
			dialog.text = "Another one? Oh for fuck's sake, I'm so sick of all of you!";
		...
		case "joruba_1":
			dialog.text = "Eh? Yes, right. Bow before me, mortal! Behold the power of my pyramid!";
			link.l1 = "(screams desperately)";
			link.l1.go = "joruba_2";
		...
		case "joruba_2":
			dialog.text = "That's right. Welcome to my humble factoría, captain.";
		...
		case "joruba_3_next":
			dialog.text = "I commend you for your persistence. What's your next move, captain? How do you feel about doing some trading?";
			link.l1 = "W-what are you?";
			link.l1.go = "joruba_4";
		break;
		
		case "joruba_4":
			dialog.text = "It doesn't matter what I am, it's the function I perform that matters. At this point in time, I'm conducting trade deals with the inhabitants of this rathole for mutual benefit.";
		...
		case "joruba_6":
			...
			link.l1 = "You mentioned trading. What sort of trade do you mean?";
		...
		case "joruba_7":
			dialog.text = "I give people what they need most.";
			link.l1 = "You grant wishes? Like a genie from a fairy tale? Good Lord, what's going on here?!";
			link.l1.go = "joruba_7_1";
		break;
		
		case "joruba_7_1":
			dialog.text = "Don't be absurd! I only help people get what they came to this world for in the quickest and most pleasant manner.";
		...
		case "joruba_7A_1":
			dialog.text = "It wasn't me who sold his tribe for a couple of thousand pounds of gold, it wasn't me who poured barrels of liquor down his throat, and I certainly did not force him to catch every disease, known and unknown, from hundreds of whores. He asked me to turn him into a white aristocrat, so I did. As his destiny commanded me.";
			link.l1 = "You grant wishes? Like a genie from a fairy tale? Good Lord, what's going on here?!";
			link.l1.go = "joruba_7A_2";
		break;
		
		case "joruba_7A_2":
			dialog.text = "Don't be absurd! I only help people get what they came to this world for in the quickest and most pleasant manner. Agueybana was supposed to save his people from the yoke of the European invaders, but instead he drooled over the commandant's daughter's corset far too much and decided to pawn his own.\nFrom then on, the only meaning left in his life was to realise the depth of his mistake and start over soon. A year in Europe, cirrhosis, and the time you two spent in a brothel must have helped. But I'll admit, he had a great holiday, ha ha!";
		...
		case "joruba_9A":
			dialog.text = "Not too bad, captain. Either you're clever or as dumb as a donkey, but your odds just went up a little. The price won't be an issue.";
			link.l1 = "Do you need to kill someone? I don't do that.";
			link.l1.go = "joruba_10";
		break;
		
		case "joruba_9B":
			dialog.text = "Because your purpose in this life is to put holes in a good friend of mine, ha ha!";
			link.l1 = "Do you need someone killed? I don't do that.";
			link.l1.go = "joruba_10";
		break;
		
		case "joruba_10":
			dialog.text = "First, you do. Second, we will conduct four major transactions, and four more minor ones. Each will make you much stronger and increase your chances in this cruel and strange world. If you complete every deal, I guarantee that one day you'll be able to go out and fight gods on equal terms, not to mention ordinary mortals.";
			link.l1 = "Sounds like fun. Tell me about it.";
			link.l1.go = "joruba_11";
		break;
		
		case "joruba_11":
			dialog.text = "Smart choice! Usually my speeches end with people being carried off to Blueweld with a suspected heart attack, but you're holding up pretty well. Here's the task list: a few errands of a bartering nature that I expect you to handle. No deadlines, hehe.";
			link.l1 = "Curious. I'll read the list later. Anything else?";
			link.l1.go = "joruba_12";
		break;
		
		case "joruba_12":
			dialog.text = "Yes, the first major transaction. Two thousand doubloons is the price.";
			link.l1 = "Maybe I'll bite... But that's a lot of money! Why do you need so much? Can I pay in pesos?";
			link.l1.go = "joruba_13";
			link.l2 = "Are you mad? I could buy a frigate with that money!";
			link.l2.go = "joruba_insult";
		break;
		
		case "joruba_13":
			dialog.text = "The pyramid is in need of repair - the masonry sometimes falls on the heads of customers and that's bad for business. My men patch it up every day, but our organisation needs an urgent injection of money from the outside to fix the situation for good. As for pesos - I don't fancy them much, since their exchange rate is rather volatile.";
			link.l1 = "You are being quite unfair to honest pesos... Wait a minute, you're not alone here?";
			link.l1.go = "joruba_14";
		break;
		
		case "joruba_14":
			dialog.text = "No, I'm just the facade of a serious organisation. So, are you in?";
			link.l1 = "I'll think about it, but first, I'd like to know what I'm getting for such a hefty sum.";
			link.l1.go = "joruba_15";
		break;
		
		case "joruba_15":
			dialog.text = "Why ruin the surprise? Besides, just treat that money as a tax. Your most valuable acquisition will be unlocking the next deals. The rewards will be godly. Unique too, mind you, as you won't find them anywhere else!";
			link.l1 = "Fine. What's your name again?";
			link.l1.go = "joruba_16";
		break;
		
		case "joruba_16":
			dialog.text = "Aruba the Magnificent. One last thing, "+pchar.name+", entry to the pyramid is permitted only once a day. Don't keep other clients waiting and don't bother me for no reason.";
			link.l1 = "I don't see a queue forming... Farewell, your majesty.";
			link.l1.go = "exit";
		...
		case "joruba_wait":
			dialog.text = "Ah, captain. What do you have for me?";
		...
		case "joruba_p1":
			dialog.text = "Not bad, I'll put that gold to good use. Here, a little trinket once owned by a very virtuous Taíno chief. Helps carry piles of gold. Certainly helped him, heh-heh...";
			link.l1 = "Thank you, and I hope I won't regret it. What's the next deal?";
			link.l1.go = "joruba_p1_1";
			link.l2 = "Wait a minute. I gave you a pile of gold and got a lump of clay in return? Well, I want a refund!";
			link.l2.go = "joruba_insult";
		...
		case "joruba_p1_1":
			...
			link.l1 = "Why, are you unwell?";
			link.l1.go = "joruba_p1_2";
		break;
		
		case "joruba_p1_2":
			dialog.text = "My soul is. See, priests avoid my humble pyramid since that incident with the Inquisition, so we have to rely on more traditional methods. I need, well, my factoría needs fifteen magarosa plants to stay operational.";
		...
		case "joruba_p1_3":
			...
			link.l1 = "No promises, but I wish you good health and hope that my reward for the herb will be worthwhile.";
			link.l1.go = "exit";
		...
		case "joruba_p2_1":
			dialog.text = "Oh, you two will meet. Now, I hope you're not one of those pompous arseholes who disdain manual labour? If so, you're out of luck, because the second part of the reward is the schematics for double-charged ammo.";
			if (pchar.HeroParam.HeroType == "HeroType_4") {
				link.l1 = "Oh, I love those. But what's unique about them? A double powder charge is nothing new, so I conclude that you obviously haven't left your pyramid since the days of that museum machete.";
			} else {
		...
		case "joruba_p2_2":
			dialog.text = "Don't be a smartarse and listen! Any idiot can put two piles of gunpowder in a barrel and risk going blind, getting their face burned or breaking their nose. I offer you a little magic trick: check the quality of the powder carefully, grind it to the right consistency, put in a bullet or buckshot, and spice it up with a chopped doubloon. The bang will tear even a cuirass to shreds!";
			link.l1 = "Shooting money, eh? So much like you.";
			link.l1.go = "joruba_p2_3";
		break;
		
		case "joruba_p2_3":
			dialog.text = "You are insufferable! Fine, grab a hand mortar, and a dozen grenades for it as well. If you are so damn smart, you'll acquire the grenade schematics on your own in no time!";
		...
		case "joruba_p2_4":
			dialog.text = "You are not going to like it. I need a ship... no, I need the ship. You know, one with a story behind her.";
			link.l1 = "Why? You're not even a captain.";
			link.l1.go = "joruba_p2_5";
		break;
		
		case "joruba_p2_5":
			dialog.text = "None of your business! You'd better focus on your reward, because I could demand you clean this pyramid from top to bottom for this, and you'd still owe me!";
			link.l1 = "You're definitely not a captain, otherwise you'd know that a ship needs a pier or a bay to dock. How the hell do you expect me to get a ship into your pyramid?!";
			link.l1.go = "joruba_p2_6";
		break;
		
		case "joruba_p2_6":
			dialog.text = "Have you noticed a giant lake behind my pyramid by any chance? That's right. Just dock the right ship in the squadron nearby and my men will do the rest. Now get out of here, you're holding up the line.";
			link.l1 = "But of course. Goodbye!";
			link.l1.go = "exit";
		...
		case "joruba_p3":
			...
			link.l1 = "Drop your smart-arse act and give me my reward!";
			link.l1.go = "joruba_p3_1";
			switch (sti(sld.BaseType)) {
				case SHIP_MAYFANG:
					dialog.text = "What about the other two? Couldn't you save them for yourself? Heh-heh.";
				break;
				...
				case SHIP_FRIGATE_L:
					dialog.text = "Shit, I'm impressed you didn't want to keep her for yourself. Now that's what I call a ship with a story! Damn it, William... I really wish you would return home and found a great bank like you always dreamed.";
				break;
				...
				case SHIP_CORVETTE_QUEST:
					...
					dialog.text = "Will you look at this! You are a disgrace to your commission, "+sTemp+"!";
				break;
				
				case SHIP_POLACRE_QUEST:
					dialog.text = "Charlie Prince decided to get rid of the incriminating evidence in my old pyramid? I approve!";
				break;
				
				case SHIP_ECLIATON:
					dialog.text = "Good luck explaining to your superiors the loss of the flagship, Admiral. Oh, pardon me, Governor-General.";
				break;
				...
				case SHIP_ELCASADOR:
					dialog.text = "Good call! I love the Castilians, you know. Maybe I'll return her to them when I'm done.";
				break;
				
				case SHIP_HIMERA:
					dialog.text = "Truly, you lack a heart, Captain. This ship reeks of treachery. I'll take her.";
				break;
				...
				case SHIP_PINK:
					...
					{
						dialog.text = "Aye, this ship may have a history... but wasn't it a bit too easy to obtain? Oh, what the hell. Alright, Cap, I'll let this one slide, since you did a great job with those tasks from my list. I'll take it. Brings back some memories of my youth at least.";
					}
				break;
		...
		case "joruba_p3_PinkOtkaz":
			dialog.text = "Aye, this ship may have a history... but wasn't it too easy to obtain? No way! You still have a ton of unfinished work on the list. Once you've done that, we'll discuss this sacrifice again.";
			link.l1 = "...";
			link.l1.go = "exit";
		break;
		
		case "joruba_p3_1":
			dialog.text = "I bless you, "+GetFullName(pchar)+". May the sea be favourable to you. Now, let's discuss the next transaction...";
			link.l1 = "Wait, what? Even yokel idiots don't fall for such nonsense in our age of reason! I didn't put a centime in your charity box, I gave you a full-fledged warship!";
		...
		case "joruba_p3_2":
			dialog.text = "Any ship you command will from now on be blessed with a stronger hull, while your enemies will suffer the opposite. Also, time at sea will pass more slowly for you. And if that's not enough for you to bring this whole shithole to its knees, you'd better go to your daddy and demand a refund!";
			link.l1 = "If it doesn't work, I swear I'll come back here tonight and burn your pyramid down! Now, tell me about the next deal!";
		...
		case "joruba_p3_3":
			...
			link.l1 = "Probably because the witch purge is still a thing?";
		...
		case "joruba_p3_5":
			dialog.text = "And how many have you killed, eh? Wait, I'll even tell you the exact number: you personally have killed "+(Statistic_AddValue(pchar,"Solder_s",0)+Statistic_AddValue(pchar,"Citizen_s",0)+Statistic_AddValue(pchar,"Warrior_s",0)+Statistic_AddValue(pchar,"Solder_g",0)+Statistic_AddValue(pchar,"Citizen_g",0)+Statistic_AddValue(pchar,"Warrior_g",0))+" people! You have piled a mountain of corpses on the altar of your ambition and lust for wealth! ";
			if (HasSubStr(pchar.model, "Sharle")) {
				dialog.text = dialog.text+"Your brother's debt has already killed more people than an average European war! ";
			}
			dialog.text = dialog.text+"Don't even start moralising with me here, especially since I'm not going to judge you. The success of some will always be paid for by the tragedies of others, and the gods, oh, the gods, they'll be watching and collecting their share!";
			link.l1 = "I can't give you an answer right now... I need to get out of here.";
			link.l1.go = "joruba_p3_6";
		break;
		
		case "joruba_p3_6":
			dialog.text = "An urgent need to clear your head? All right, but first, listen to me. I will grant you power and complete control over your body and mind, if you bring me a man of great worth. Not an extra, not a faceless grey mouse from the streets or a rat from the stinking bilges. Bring me a man who follows you and plays an important role in your tragicomedy.";
			link.l1 = "One of my officers? You can't sink any lower, Aruba! If word of this gets out...";
			link.l1.go = "joruba_p3_7";
		break;
		
		case "joruba_p3_7":
			dialog.text = "I'll take care of secrecy as I always do. And before you start whining again, I'll let you know that there is another way.";
			link.l1 = "What's that supposed to mean? So I don't have to drag my own people to the altar?";
			link.l1.go = "joruba_p3_8";
		break;
		
		case "joruba_p3_8":
			dialog.text = "No, but you won't like the alternative. If you don't want to pay in blood, you can pay in gold. Three thousand doubloons and a clear conscience. Money can do that and more – I love it!";
			link.l1 = "Goodbye, Aruba. I don't want to talk to you anymore.";
		...
		case "joruba_p4":
			dialog.text = "Let's do this quickly before the Spanish Inquisition shows up. Sangre u oro?";
			if (PCharDublonsTotal() >= 3000)
			{
				link.l1 = "Gold it is. Here's your three thousand, although I can't imagine how you could possibly spend such an enormous amount in this wilderness.";
		...
		case "joruba_p4_1":
			dialog.text = "...";
			link.l1 = "Are you done? Let's talk about my reward.";
		...
		case "joruba_p4_off":
			...
			link.l1 = "No, I don't. I'll be back for my reward in an hour.";
			link.l1.go = "exit";
		...
		case "joruba_o6_money":
			dialog.text = "Excellent choice. I hate cleaning all that blood from the altar, so gold is preferable. Here, take this potion – a gift from a good friend of mine.";
		...
		case "joruba_p4_reward_1":
			dialog.text = "Talk to me anytime you wish to change your destiny.";
			link.l1 = "But what exactly does it mean for me?";
			link.l1.go = "joruba_p4_reward_2";
		break;
		
		case "joruba_p4_reward_2":
			dialog.text = "Power over yourself! Try it sometime and you'll love it. In the meantime, let me tell you about the next transaction. The most important one.";
			link.l1 = "I'm not sure it's worth it anymore!";
			link.l1.go = "joruba_p4_reward_3";
			link.l2 = "Come on, spit it out already.";
			link.l2.go = "joruba_p4_reward_3";
		break;
		
		case "joruba_p4_reward_3":
			dialog.text = "You have the opportunity not only to change your destiny, but to stand alongside the geniuses and gods of our time. Aye, you can change your body and mind as much as you wish now, but you will never rise above your own limits, for an ordinary person can't excel at everything. What I'm suggesting is that you break those boundaries.";
			link.l1 = "What's it going to cost me? More blood? Gold?";
		...
		case "joruba_p4_reward_4":
			...
			link.l1 = "I'll give it some thought.";
			link.l1.go = "joruba_p4_reward_5";
		break;
		
		case "joruba_p4_reward_5":
			dialog.text = "You know where to find me. And don't hesitate to visit me anytime you wish to change your destiny.";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "joruba_o2":
			dialog.text = "First of all, that's my wife, not a bride. Secondly, you have a problem with the Castilians, not me. And finally, I've already taken her and dismissed your men. And as for honourable intentions... Look at me, am I not the very model of a decent gentleman? Tlazolteotl, bless him, that he too may one day know a real woman. Or a man.";
			link.l1 = "Sod you, Aruba!";
			link.l1.go = "exit";
		...
		case "joruba_o3":
			dialog.text = "Not bad, thank you. Frankly, I don't really need it, but perhaps I'll wear it in some salon or whatever. In the name of Ishtar, I bless you. Now go and sin.";
		...
		case "joruba_o4":
			dialog.text = "I'll take them. What? I need dead men in my crew just like you do, except that unlike you, I can't go around taverns recruiting. Now, Bast, bless the hero for his future endeavours.";
			link.l1 = "What a strange feeling...";
			link.l1.go = "exit";
		...
		case "joruba_o5":
			dialog.text = "Yeah, we'll have to scatter them again, because people lose them all the time, and we need customers. Freya, protect this great rock collector.";
			link.l1 = "What a strange feeling...";
			link.l1.go = "exit";
		...
		case "joruba_o6_off":
			...
			dialog.text = "So be it. Here, take this potion – a gift from a good friend of mine.";
			link.l1 = "The taste is not bad at all...";
		...
		case "joruba_final":
			dialog.text = "Ahoy-hoy! At last, it's all over!";
			link.l1 = "Huh?";
			link.l1.go = "joruba_final_1";
		break;
		
		case "joruba_final_1":
			dialog.text = "We're finished here, Captain. The deals are sealed, everyone's satisfied, and there's no room for refunds. Our office is closing down and relocating.";
			link.l1 = "Wait a moment, Aruba. I've given you plenty of gold, paid in blood, brought women and prisoners to this devilish lair. I can handle supernatural events that apparently occur in the Caribbean. But our 'transactions' with you defy all logic. Please explain.";
		...
		case "joruba_final_3":
			...
			link.l1 = "That's a sudden change of heart. I was expecting a story, but all I've heard so far are the meaningless rants of a vile little god in a dusty pyramid.";
		...
		case "joruba_final_4":
			...
			link.l1 = "You're welcome. However, that still doesn't explain your peculiar way of speaking and almost divine powers. If you're so all-powerful, you could have conjured your own ship, crew, and gold long ago!";
		...
		case "joruba_final_6":
			dialog.text = "Well... that's simply what I do. See you in the new world, "+GetPersonaName()+". Truly something new next time, I hope. Thank you and goodbye.";
			link.l1 = "No, I don't ever want to see you again.";
			link.l1.go = "exit";
		...
		case "ChickenGod_TheInquisition_1":
			dialog.text = "In the name of the Spanish Inquisition, state your name!";
		...
		case "ChickenGod_TheInquisition_2":
			dialog.text = "... This joke is always on point, even though it led quite a few innocent Christians to the stake.";
			link.l1 = "...";
		...
		case "ChickenGod_TheInquisition_4":
			dialog.text = "Do you know a certain señor Aruba?";
		...
		case "ChickenGod_TheInquisition_5":
			...
			link.l1 = "This señor just left us on a ship a few minutes ago.";
		...
		case "ChickenGod_TheInquisition_9":
			dialog.text = "Since the case will probably be closed, I can entertain you with a little story.\nRumours of this place have been circulating all over the Main for some time. We had received reliable reports that a number of individuals who had left a significant mark on the history of the region had made regular visits here in the past.\nHowever, Santiago began to pay real attention to these rumours after the Panama incident.\nA certain Indian had made quite a stir in that glorious city and even gave several sermons of a rather philosophical nature. Unfortunately, the inhabitants of Panama drew rather superficial conclusions and convinced themselves that this pyramid contains untold treasures and grants any wish.\nHeresy of the purest kind, of course... so we had to open proceedings against some Panamanian residents and this Indian, Aguebana.";
		...
		case "ChickenGod_TheInquisition_11":
			dialog.text = "Drunkenness killed him. However, his death did not solve our problems, for heresy had taken root all over the archipelago, and hundreds of people went on a kind of pilgrimage to this ancient temple.";
			link.l1 = "I've never seen crowds of people here before... So what, were you going to invade Aruba and put him on trial?";
			link.l1.go = "ChickenGod_TheInquisition_12";
		break;
		
		case "ChickenGod_TheInquisition_12":
			dialog.text = "Of course not, my son. The judgment of the Inquisition is harsh but fair. There must be a good reason for a trial. No, I was only going to collect señor Aruba's testimony and deliver it to Santiago.";
