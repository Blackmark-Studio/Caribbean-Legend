void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "WildRose_Chimiset_64_2":
			...
			link.l1 = "You know, it occurred to me that Orelie seemed to be waiting for us, like she knew we’d come to her. The old woman could have died a day earlier or later, but it happened almost right after she told us something important about Mary’s father.";
			link.l1.go ="WildRose_Chimiset_65";
			AddCharacterExpToSkill(pchar, "sneak", 100);
		break;
		...
		case "WildRose_Alonso_12":
			...
			dialog.text = "And I'm damn glad to see you, Cap'n! Some bastard must've told him you were coming — we got hit with a hail of grapeshot halfway through. I managed to retreat with a handful of men, and we rushed to the port to warn you. Luckily, the watchman on duty saw me in the skiff I bought in a hurry and figured things out quick. He gathered the men fast — and we came here to back you up.";
			link.l1 = "Thank you, my friend... "+sld.name+" died because of me... I led you straight into a trap.";
			link.l1.go = "WildRose_Alonso_13";
		break;

		case "WildRose_Alonso_13":
			dialog.text = "No one knew it was a trap. You did the right thing — we should've been more cautious.";
			link.l1 = "Still... I should've seen it coming. I never should've gone into that tavern.";
			link.l1.go = "WildRose_Alonso_14";
		break;

		case "WildRose_Alonso_14":
			dialog.text = "Too late now, Cap'n. What are your orders?";
			link.l1 = "Our men's bodies must be buried with full honors. Bury Northwood too, far away in the jungle. No one must know this place, especially Mary. So take only the most trusted men.";
			link.l1.go = "WildRose_Alonso_15";
		break;

		case "WildRose_Alonso_15":
			dialog.text = "Consider it done.";
			link.l1 = "Mary and I will come aboard later. We need some time alone.";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_261":
			...
			{
				dialog.text = "My God, "+pchar.name+"... I still can’t, I just can’t believe it. My father... He’s a monster... Why would he do this to me? He killed "+sSname+"! Has he truly gone insane?";
				link.l1 = "A mutiny on the 'Cornwall', escape across the Atlantic, a storm, the death of his mother, and a journey through those idols’ portals – without the Comanche elixir! Trials more than worthy. And still, it would’ve been better if he hadn’t come out of that hell alive.";
			}
			else
			{	
				dialog.text = "My God, "+pchar.name+"... I still can’t, I just can’t believe it. My father... He’s a monster... Why would he do this to me? Has he truly gone insane?";
				link.l1 = "He had to endure terrible torments. The mutiny on the 'Cornwall', the Atlantic escape, the storm, your mother’s death... I can't imagine how he survived the idol portals without the Comanche elixir – but that’s what shattered his mind.";
			}
