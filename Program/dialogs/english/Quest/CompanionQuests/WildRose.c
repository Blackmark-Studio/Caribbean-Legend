void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Mary_2":
			...
			link.l1 = ""+npchar.name+"? Were you following right on my heels?";
			link.l1.go = "Mary_3";
		break;
		
		case "Mary_3":
			dialog.text = "And it seems it wasn’t for nothing, alright! What happened here?";
		...
		case "Mary_4":
			dialog.text = "My God...";
			link.l1 = "Yeah, poor thing, looks like she suffered before she died. Wouldn’t wish that kind of end on anyone...";
			link.l1.go = "Mary_5";
		break;
		
		case "Mary_5":
			dialog.text = "And who's that, her husband? What the hell are they doing in the jungle?! Haven't they heard about the runaway slaves?";
		...
		case "Mary_7":
			dialog.text = "Too late, "+pchar.name+". Looks like we've already been spotted. Take a look over there.";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "Naemnik_1":
			...
			{
				link.l1 = "Very clever. But you must not be very good at counting – unlike those poor souls, we’re not alone here at all.";
				link.l1.go = "Naemnik_2";
			}
			else
			{
				link.l1 = "Well, things will be a bit trickier with us, you better believe me...";
		...
		case "Naemnik_3":
			dialog.text = "Yes to all your questions. For more than two days, we chased them all over the island with the soldiers. Then the bastards split up. Some retreated toward the cave—the guards went after them—while the rest made a run for the bay. Because of their ambush half a mile west from here, we lost a few men, and while we were coming to our senses and regrouping, they had their fun with that fool of a girl...";
			link.l1 = "...";
		...
		case "Naemnik_5":
			dialog.text = "Well, they're clearly not garrison soldiers. If it weren't for those layabouts, we'd have caught the scoundrels yesterday—and that fool and his wife would still be alive...";
		...
		case "Naemnik_12":
			dialog.text = "Are you deaf or something, lady? I told him to shut his trap. Our Jerry can spin tall tales for hours – he’s got quite the knack for it, alright! Bishop wanted to cut out his tongue and make him eat it, but then he changed his mind – and that was a mistake, damn it!";
			link.l1 = "...";
		...
		case "Naemnik_14":
			dialog.text = "Listen, boy, tell your girlfriend that people, even runts like this one, have not just a first name, but a last name too. I've heard plenty of times that pretty women can be as dumb as a sack of straw, but damn if I've ever seen...";
			link.l1 = "...";
		...
		case "Naemnik_15":
			dialog.text = "That's exactly what I'm about to give you, alright!";
		...
		case "Naemnik_18":
			...
			link.l1 = "I strongly doubt that. But I hope now you’re smart enough to take your words back.";
		...
		case "Naemnik_19":
			...
			link.l1 = "So, you’ve finally shown your true colors. You weren’t much of an actor, alright.";
			link.l1.go = "Naemnik_bitva";
		break;
		
		case "Naemnik_22":
			dialog.text = "You, mister, are quite the contradiction – so peaceful, and yet such a boor. Still, I wonder, are you going to beg forgiveness from that redheaded madcap?";
			link.l1 = "Her name is Mary Casper, and if you don’t right now...";
		...
		case "Naemnik_23":
			...
			link.l1 = "You know what else happens? Fools like you, who only know about honor from hearsay, treat ladies as if they were born in a stable. But then, what should I expect—when your head’s full of sawdust, there’s no room for manners, alright.";
			link.l1.go = "Naemnik_24";
		break;
		
		case "Naemnik_24":
			dialog.text = "Well, well... What a cheeky little worm. Tell me, mate, is your girl any good in a hammock?  Though, I’m quite sure she’s not— and I’d be happy to see for myself...";
			link.l1 = "So you’ve given yourself away. That didn’t last long, did it. Prepare to fight!";
			link.l1.go = "Naemnik_bitva";
		break;
		...
		case "Djerry_2":
			dialog.text = "He sure did. Thanks to that bastard, my back is covered in scars. But the worst part was, he could forbid us from drinking water whenever he felt like it.";
		...
		case "Djerry_4":
			dialog.text = "Yeah, sure, ha-ha. And then William Bishop will have me skinned alive – heard about that from a black fellow on the plantation... Bishop doesn’t waste time with runaways – doesn’t matter if you’re black or white.";
			link.l1 = "I'm afraid you'll have to go back to the plantation one way or another...";
			link.l1.go = "Djerry_5";
			link.l2 = "So, you’re not going back to the plantation willingly, alright?";
			link.l2.go = "Djerry_6";
		break;
		
		case "Djerry_5":
			dialog.text = "You're quite the joker – has anyone ever told you that, "+GetAddress_Form(NPChar)+"?";
			link.l1 = "No jokes, "+npchar.name+". You think I ended up here by accident? I went into the jungle to track down your squad, bring you back to the plantation—and maybe earn a bit of gold. But you're the only one left. You're not worth much, so maybe I'll let you go. But tell me—what were you even thinking? You're all alone. The rest are dead. What are you hoping for, damn you? Hiding in the hills and bushes until you catch a bullet, die of fever, or end up as jaguar food?";
			link.l1.go = "Djerry_8";
		...
		case "Djerry_6":
			dialog.text = "You're quite the joker – has anyone ever told you that, "+GetAddress_Form(NPChar)+"?";
			link.l1 = "No jokes, +npchar.name+. You think I ended up here by accident? I went into the jungle to track down your squad, bring them back to the plantation - and make a little coin. But now only you remain. You won't fetch much, so I might let you go. But tell me - what on earth were you thinking? You're alone. Everyone else is dead. What are you hoping for, damn you? Hiding in the mountains and bushes until you get shot, die of fever, or become jaguar food?";
			link.l1.go = "Djerry_8";
		...
		case "Djerry_9":
			dialog.text = "I think I'll take my chances with the dons – smugglers and pirates often drop anchor at Tobago. Oh, I see you disapprove of my choice, "+GetAddress_Form(NPChar)+". I served my country faithfully – but what am I to do, now that she’s sent me to the quarries?";
			link.l1 = "I'm not judging, "+npchar.name+". Everyone has their own path. Now grab plenty of powder and shot – and get going. Before the soldiers show up.";
		...
		case "Mary_11":
			dialog.text = "...";
			link.l1 = ""+npchar.name+", is something bothering you? You said goodbye to your namesake awfully quickly, alright.";
			link.l1.go = "Mary_12";
		break;
		...
		case "Mary_13":
			dialog.text = "After what I heard from Bishop’s lackey, I have no doubt those poor souls died by his hand. But before that… Casper – were you really listening to what he was saying?";
			link.l1 = "And what didn’t sit right with you, darling?";
			link.l1.go = "Mary_14";
		break;
		
		case "Mary_14":
			dialog.text = "He claims there's a boat hidden on the beach. But over twenty people escaped from the plantation. So the boat must be pretty big, alright? Jerry's a navy deserter, he knows full well it's not easy to handle a big vessel all by himself, alright...";
			link.l1 = "All he’ll have to do is set the sail and hold the course – the wind will do the rest. Alright, he’s taking a real risk, but maybe a death at sea truly is better than at the hands of a planter’s executioner.";
			link.l1.go = "Mary_15";
		break;
		
		case "Mary_15":
			dialog.text = "Alright. But now I realize there’s something else that doesn’t add up... According to him, he and his friends watched from afar as the mercenaries abused that poor girl...";
			link.l1 = "Instead of running straight for my boat... Alright, I get what you’re getting at, "+npchar.name+". Maybe I should ask Mr. Casper a couple more questions...";
		...
		case "Mary_21":
			dialog.text = "Vile scoundrel! We saved his life, and he! So what does that make us, "+pchar.name+"? So it turns out...";
			link.l1 = "Alright, "+npchar.name+", there’s no one left alive who knows the truth about what happened...";
			link.l1.go = "Mary_22";
		break;
		
		case "Mary_22":
			dialog.text = "We should get out of here, "+pchar.name+". If the soldiers find us here, we're in for trouble, alright.";
		...
		case "Mary_23":
			...
			link.l1 = "I won’t argue, darling. I could use a drink myself. Let’s stop by the ‘Irish Cuckold’.";
			link.l1.go = "exit";
		...
		case "Barmen_1":
			...
			{
				link.l1 = "Knocked, and that’s something, alright. Now out with it—what do you want from me?";
				link.l1.go = "Barmen_2";
			}
			else
			{
				link.l1 = "Good thing you thought to knock, mate. If you’d just barged in, you’d be tumbling down the stairs by now.\nWhat are you staring at? Out with it—why’d you drag yourself in here?";
				link.l1.go = "Barmen_2";
			}
		break;
		...
		case "Lewis_2":
			dialog.text = "Don't remember? Ah, I see... My face was smeared with blood and dust, I was horrified myself when I saw my reflection in the mirror just a few hours ago...";
			link.l1 = "...";
		...
		case "Lewis_7":
			...
			link.l1 = "Stand up, "+GetAddress_Form(NPChar)+". You're not to blame. No one could have stood alone against so many scoundrels.";
			link.l1.go = "Lewis_8";
		break;
		...
		case "Lewis_10":
			dialog.text = "It was Jerry Casper and the other fugitives who did this. You shouldn’t have blamed Bruce Primer and his men.";
			link.l1 = "Bishop’s mercenaries?";
			link.l1.go = "Lewis_11";
		break;
		
		case "Lewis_11":
			dialog.text = "Alright. Bruce was certainly a scoundrel and did plenty of dirty work for Bishop – but he was never a rapist.";
			link.l1 = "Didn't seem that way to me. But I won't argue with you, "+npchar.name+". However, since you were conscious and saw everything, you could have stood up and...";
			link.l1.go = "Lewis_12";
		break;
		
		case "Lewis_12":
			dialog.text = "Forgive me, "+GetAddress_Form(NPChar)+". You can call me a miserable coward – but I just couldn’t move, I was so terrified. When those scoundrels blocked the way for Susie and me, at first I just screamed at the top of my lungs, hoping someone would come to help.";
		...
		case "Lewis_14":
			dialog.text = "Alright, "+GetAddress_Form(NPChar)+". I came to thank you for that. Even if at first you believed him...";
			link.l1 = "Bruce Primer put a lot of effort into this. He should really watch what he says...";
			link.l1.go = "Lewis_16";
			ChangeCharacterComplexReputation(pchar, "nobility", 1);
		break;
		...
		case "Lewis_15":
			dialog.text = "Alright, "+GetAddress_Form(NPChar)+". I came to thank you for that. Even if at first you believed him...";
			link.l1 = "Bruce Primer put quite a bit of effort into this. He really should watch what he says...";
			link.l1.go = "Lewis_16";
			AddCharacterExpToSkill(pchar, "Leadership", 100);
			ChangeCharacterComplexReputation(pchar, "nobility", -1);
		break;
		...
		case "Lewis_19":
			dialog.text = "Your wife was right. I’ve seen it for myself more than once, alright. And "+pchar.name+" me too.";
			link.l1 = "...";
		...
		case "Lewis_20":
			dialog.text = "...";
			link.l1 = "That's right. However, I don't think this is the time for philosophical talk. Doubt it'll help you, "+npchar.name+". Only time can help with something like that.";
			link.l1.go = "Lewis_21";
		...
		case "Mary_33":
			dialog.text = "I know this is really stupid...";
			...
			link.l1.go = "Mary_34";
			link.l2 = "That's right, darling. That damned Jerry could've used a fake last name, that's all.";
			link.l2.go = "Mary_35";
		break;
		...
		case "Mary_36":
			dialog.text = "And Caspers, well, we're just people with no name, no family, alright? I suppose I should be giving thanks to our Lord every day that you even noticed me, and not some puffed-up...";
		...
		case "Mary_43":
			...
			link.l1 = "And you decided to return my feelings?";
			link.l1.go = "Mary_44";
		...
		case "Mary_48":
			dialog.text = "Eric, the man who raised me, always said so. But if that's true—why did no one on the Island ever tell me about my parents, not even mention them? I once asked Donald Greenspy about it, but he didn't give me any clear answer.";
			link.l1 = "Or maybe he just didn’t want to talk.";
			link.l1.go = "Mary_49";
		break;
		
		case "Mary_49":
			dialog.text = "See? I thought the same thing, alright. You know, I used to just live my life without really thinking about it. But yesterday, when we ran into that bastard Jerry... I asked myself—who was my father? My mother? Why did no one ever tell me about them, as if they never even existed? What if my father was just as much a scoundrel as that Jerry?";
			link.l1 = "It doesn't matter at all, "+npchar.name+". You were raised by other people – and they did it well.";
			link.l1.go = "Mary_50";
		...
		case "Mary_50":
			dialog.text = "But it matters to me, "+pchar.name+", alright. I want to, I have the right to know who my parents were. Don't you agree with that?";
			link.l1 = "Of course I agree, there’s no other way. But if you want to learn anything about your father and mother, it has to be on the Island of Justice. After all, you don’t even know their names, do you?";
			link.l1.go = "Mary_52";
			AddCharacterExpToSkill(pchar, "Fortune", 100);
		break;
		
		case "Mary_51":
			dialog.text = "But it matters to me, "+pchar.name+"Yeah, alright. I want to know, I have the right to know who my parents were. Don’t you agree with that?";
			link.l1 = "Of course I agree, there’s no other way. But if you want to learn anything about your father and mother, it has to be on the Island of Justice. After all, you don’t even know their names, do you?";
			link.l1.go = "Mary_52";
		...
		case "Mary_52":
			dialog.text = "That's right, darling. No one ever mentioned them around me, alright.";
			link.l1 = "So, it’s too soon for us to go digging through the city archives of the English colonies. First, we’ll have to return to that ship graveyard and try to find some trace of your lineage there.";
			link.l1.go = "Mary_53";
		break;
		...
		case "Mary_54":
			...
			// dialog.text = "In the end, for more than twenty years, I couldn’t have cared less about it...";
			link.l1 = "...";
			link.l1.go = "Mary_55";
		break;
		
		case "Mary_55":
			dialog.text = "So I can put up with it a little longer, alright.";
			link.l1 = "I can see this matters to you, and you need it, "+npchar.name+". So I’ll try not to keep you waiting. Now, let’s go, we need to get back to the ship. I feel better about you there, at least.";
			link.l1.go = "exit";
		...
		case "Mary_61":
			...
			link.l1.go = "Mary_62";
			link.l2 = "I seriously doubt it – everything here is held together by nothing but a promise. And by the Mechanic’s genius.";
			link.l2.go = "Mary_63";
		break;
		...
		case "Mary_64":
			dialog.text = "But this place... It's like another world, alright? Can you imagine, some of those who arrived here not so long ago claim that time here flows almost three times faster than on the Mainland...";
			link.l1 = "Ha-ha, so how old does that make you then?";
			link.l1.go = "Mary_65";
		break;
		
		case "Mary_65":
			dialog.text = "I was being serious, alright. "+pchar.name+", alright!";
			link.l1 = "Alright, but seriously, it's time to get down to business. Is there anyone among the Narwhals who's older than Greenspy?";
			link.l1.go = "Mary_66";
		break;
		
		case "Mary_66":
			dialog.text = "Mmm, no, I don't think so. But I already told you he didn't say anything when I asked him about it.";
			link.l1 = "And yet, I have no other ideas about who could help us make sense of what happened twenty years ago. At least, not for now. So, we're setting course for the 'Esmeralda'.";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("WildRose_Etap2_IslandOfJustice_2");
		break;
		
		case "Schmidt_1":
			dialog.text = "Ah, "+pchar.name+" and Mary, what a meeting! Glad to see you here... alive and well, heh-heh. In the past month, two or three ships have wrecked near the outer ring — the sea’s damn restless these days. Alright, and don’t go barging into a locked door — you’ll break the lock, and I’ll be the one fixing it. You’re here to see Donald, right?";
			link.l1 = "And a good day to you, friend. To himself. But judging by the locked door, he’s either moved to another ship, or he doesn’t want to see old friends.";
			link.l1.go = "Schmidt_2";
			DelLandQuestMark(npchar);
		break;
		
		case "Schmidt_2":
			dialog.text = "Neither, haha. Greenspy is on the outer ring right now, training.";
			link.l1 = "Drills? Really? Is he getting ready for a new war with Rivadose?";
			link.l1.go = "Schmidt_3";
		break;
		
		case "Schmidt_3":
			dialog.text = "It never really stopped, "+pchar.name+". There just haven't been as many brawls lately as there used to be. But still, in Sancho's tavern, someone ends up getting punched in the face every now and then... and sometimes a knife gets drawn, too.";
		...
		case "Schmidt_4":
			...
			link.l2 = "Drills are all well and good, but won’t they put the already shaky truce at risk? And how long has Greenspy been drilling the lads already?";
		...
		case "Schmidt_7":
			dialog.text = "Is my cabin on the 'Ceres Smitty' still free? Or has someone already moved in?";
			link.l1 = "...";
		...
		case "Mary_71":
			...
			link.l1 = "Of course! You handled those two so well, I thought—maybe I’d end up in their place myself!";
			link.l1.go = "Mary_72";
			DelLandQuestMark(npchar);
		break;
		...
		case "Mary_72":
			...
			link.l1 = "It feels like that meeting was destined for me by fate itself.";
			link.l1.go = "Mary_73";
		break;
		
		case "Mary_73":
			dialog.text = "Do you really think so, darling?";
			link.l1 = "Of course, my love. And ever since then, I thank her every day for bringing me straight to the 'Ceres Smithy'.";
			link.l1.go = "Mary_74";
		break;
		...
		case "Mary_75":
			...
			link.l1 = "Unlike anyone I’ve ever known before. Your grace, your voice... and that red doublet. I never stood a chance against you. I’ll admit, I’ve always wondered: why that, exactly? Why the red doublet, and not a dress, or a shirt, or a corset?";
			link.l1.go = "Mary_76";
		break;
		...
		case "Mary_76":
			...
			link.l1 = "And when he finally suited you, you remembered him?";
			link.l1.go = "Mary_77";
		break;
		
		case "Mary_77":
			dialog.text = "A few years ago, wandering around the ring, I stumbled upon a book about a dashing captain in a red coat. He feared nothing, fought hundreds of enemies for the love of his life, and knew no fear. That’s when I tried him on for the first time. He gives me confidence...";
		...
		case "Mary_82":
			...
			link.l1 = "And I'm with you, "+npchar.name+". Well, shall we go to Donald? We’ll have plenty to talk about, alright.";
			link.l1.go = "exit";
		...
		case "Grinspy_1":
			...
			link.l1 = "Well, you've got plenty of energy of your own, as we've seen. How did the training go?";
		...
		case "Grinspy_2":
			...
			link.l1 = "And what, may I ask, inspired you to such feats? Got bored on the Island, alright?";
			link.l1.go = "Grinspy_3";
		break;
		
		case "Grinspy_3":
			dialog.text = "Hmm, I can hear a hint of displeasure in your voice, "+pchar.name+". I can understand his reasons, of course...";
		...
		case "Grinspy_4":
			...
			link.l1 = "And this is how you repaid me for all my efforts! Seems they’re right – a true warrior finds no peace in the world.";
			link.l1.go = "Grinspy_5";
			link.l2 = "And I have to say, I was counting on your good sense far more than on that of the pirates or the Rivadans.";
			link.l2.go = "Grinspy_6";
		break;
		
		case "Grinspy_5":
			dialog.text = "Let me finish. Alright, we managed to keep the peace – but our differences haven’t gone anywhere. At least, not with those black-skinned heathens. Last week, one of the Narwhals was killed in a tavern brawl. But we didn’t let it slide either...";
			link.l1 = "Yeah, yeah, that's exactly how it always starts, alright.";
		...
		case "Grinspy_7":
			...
			link.l1 = "Did you decide to scare the Rivadans with your teachings?";
		...
		case "Grinspy_9":
			dialog.text = "Maybe I would’ve shared it with the Admiral, but since he thinks he’s the cleverest one around, I don’t want to look like a fool either. My plan worked, by the way, so there.";
		...
		case "Grinspy_11":
			...
			link.l1 = "I might drop by to see him while we’re here—unless, of course, he decides to start one of his sermons in return, ha-ha.";
		...
		case "Grinspy_12":
			dialog.text = "If anyone can convince him to keep the blacks in check, it's you, "+pchar.name+". But judging by your faces, you’re not here to chat about politics. Out with it, what do you want?";
			link.l1 = "...";
		...
		case "Grinspy_15":
			dialog.text = "Tell me about them, please, alright. You knew them! I asked you about them once before, but you didn't answer my questions...";
			link.l1 = "...";
		...
		case "Grinspy_18":
			dialog.text = "I arrived on the Island just under twenty years ago, already after you were born. You were just a little thing, running and crawling under tables and stools, giving poor Eric Udette no peace at all... Of course, I asked him where such a restless creature had come from – and he told me you were born on the Island a few years back. He never said a word about your father or your mother. And if he did – well, I either didn’t remember it, or I’ve forgotten...";
			link.l1 = "...";
		...
		case "Grinspy_19":
			dialog.text = "So many years have passed... I understand, Donald, alright.";
			link.l1 = "...";
		...
		case "Grinspy_20":
			dialog.text = "It's a pity Erik isn't with us – he ended up in this place long before I did. By the way, when he used to talk about your latest antics, he often mentioned Aurelie Bertin. That old lady absolutely adored you, I remember that well... I never really wondered about it, but I think she was already on the Island when you were born. Maybe she can help you?";
			link.l1 = "...";
		...
		case "Grinspy_21":
			dialog.text = "Maybe. A good reason to pay her a visit – I can’t even remember the last time I stopped by. Didn’t turn out too well, alright.";
			link.l1 = "...";
		...
		case "Grinspy_23":
			dialog.text = "Quiet, Donald, you'll bring trouble on us! Aurélie will outlive us all, alright.";
			link.l1 = "...";
		...
		//
		case "Jillian_1":
			dialog.text = "Merciful Lord, my heart nearly jumped out of my chest. You can't just go around scaring people like that, alright?..";
			link.l1 = "...";
		...
		case "Jillian_2":
			dialog.text = "Jillian! Didn’t expect to see you here, alright. What are you doing here? And where’s Aurelie?";
			link.l1 = "...";
		...
		case "Jillian_8":
			dialog.text = "This is about my parents. Aurélie might have known them. It's really important to me, Jillian, alright.";
			link.l1 = "...";
		...
		case "Jillian_11":
			dialog.text = "Poor Aurélie! Is there really no one on the Island who can help her?";
			link.l1 = "...";
		...
		case "Jillian_12":
			dialog.text = "You know yourself there’s no real doctor here. And what could you do, alright? Old age, as they say, spares no one...";
			link.l1 = "...";
		...
		case "Jillian_13":
			dialog.text = ""+pchar.name+", maybe bring someone from our ship along?";
		...
		case "Jillian_15":
			dialog.text = "Chimisetu? The black sorcerer? "+pchar.name+", are you serious?";
			link.l1 = "Never better. Whether he's black or white is the last thing on my mind right now. I don't know who else can help Aurélie. I doubt you do either. So just step aside and don't you dare get in my way.";
			link.l1.go = "Jillian_16";
			link.l2 = "More than that. Neither Brother Julian’s prayers nor any medicine can help Aurelie. Chimisette is our last hope.";
			link.l2.go = "Jillian_17";
		break;
		
		case "Jillian_16":
			dialog.text = "I can't believe my ears! But that's... a godless man!";
			link.l1 = "And this is a dying woman, who’s just a step away from forgetting her own name. Alright, he’s a sorcerer, but I’ve heard they’re capable of a lot, a whole lot. And if he can bring her mind back—does it really matter now what faith he follows?";
		...
		case "Jillian_17":
			dialog.text = "I can't believe my ears! But that's... a godless man!";
			link.l1 = "And this is a dying woman, who’s one step away from forgetting her own name. Alright, he’s a sorcerer, but I’ve heard they’re capable of all sorts of things, all sorts, alright. And if he can bring her mind back—does it really matter now what faith he follows?";
			link.l1.go = "Jillian_18";
			AddCharacterExpToSkill(pchar, "Repair", 100);
		break;
		
		case "Jillian_18":
			dialog.text = ""+pchar.name+", listen, I care about Aurelie too... God is my witness – I’m doing everything I can to ease her suffering! But are you really going to let that black heretic perform his ritual in this cabin? What if he sets the ship on fire, or decides to sacrifice someone during it?";
			link.l1 = "We won't let that happen, "+npchar.name+", I assure you.";
			link.l1.go = "Jillian_19";
		break;
		
		case "Jillian_19":
			dialog.text = "And I assure you both, if anyone finds out about this... Do you have any idea what will happen here? The other townsfolk won't like it, and the narwhals especially!";
			link.l1 = "You're right about that. We shouldn't drag Chimiseta here, we should take Aurelie to him.";
		...
		case "Jillian_20":
			...
			link.l1 = "Well, sometimes all we can do is hope for a miracle, alright. And, Jillian...";
			link.l1.go = "Jillian_21";
		break;
		
		case "Jillian_21":
			dialog.text = "What else?";
			link.l1 = "I hope you'll keep this to yourself. You're a smart woman, and you've judged everything right... The unrest on the Island could easily turn into bloodshed, and nobody wants that, do they?";
			link.l1.go = "Jillian_22";
			link.l2 = "Not a word to anyone, understood? We’ve put our trust in you – don’t give us a reason to regret it. I think you realize that if our plan stops being a secret, there’ll be a bloodbath on the Island like nothing it’s ever seen.";
		...
		case "Jillian_24":
			...
			link.l1 = "You don't have to worry, "+npchar.name+", we'll be extremely careful.";
		...
		case "Jillian_26":
			...
			{
				dialog.text = "Aurelie is ready. You can take her.";
		...
		case "Oreli_1":
			dialog.text = "Young people, where... where are we going?! This is a Rivadose ship! Where is Eric?!";
			link.l1 = "Eric made friends with Eddie Black, didn’t you know?";
			link.l1.go = "Oreli_2";
		break;
		
		case "Oreli_2":
			dialog.text = "What are you saying, boy! Erik can't stand black folks, alright!";
			link.l1 = "Well, would you look at that! Alright, let's go and ask him what the devil he's doing here, then!";
			link.l1.go = "exit";
		...
		case "Eddy_1":
			...
			link.l1 = "And hello to you, "+npchar.name+" . I wish I could just stop by for a mug of rum, but I’m afraid I have urgent business with you—or rather, with Chimisetu.";
			link.l1.go = "Eddy_2";
			DelLandQuestMark(npchar);
		break;
		
		case "Eddy_2":
			dialog.text = "We are forever in your debt, my friend. We'll do everything we can.";
			link.l1 = "Alright, if that's how it is. Because I have no one else left to count on.";
			link.l1.go = "Eddy_3";
		break;
		
		case "Eddy_3":
			dialog.text = "Which of these ladies do you need help with, "+pchar.name+"?";
			link.l1 = "I can't tell if you're being serious or just joking, "+npchar.name+", but I’m not in the mood for jokes. It’s Aurélie who needs help, of course.";
		...
		case "Eddy_4":
			dialog.text = "Eric! ERIC! Show yourself, you old rascal! What’s this nonsense?! Get your scrawny ass over here right now!";
			link.l1 = "...";
		...
		case "Eddy_5":
			dialog.text = "So it’s true, then... My people told me that this wreck’s got a screw loose. Now I see they weren’t lying. But I still don’t quite get what you want from Rivadose...";
		...
		case "Chimset_1":
			...
			link.l1 = "I’ll be brief, Chimisette. Aurélie has the information Mary and I need. But due to her condition, which, if I understand correctly, is simply a matter of age, we... can’t get this knowledge from her, nor can we be sure it would be accurate. I’ve heard of the wonders both Indian and African shamans are capable of – that’s why I’ve come to ask for your help, Chimisette.";
		...
		case "Chimset_6":
			dialog.text = "The moment this woman comes to, I'll perform a quick ritual I've prepared for in advance...";
			link.l1 = "Will it at least slow the disease down, if not stop it altogether?";
			link.l1.go = "Chimset_7";
		break;
		
		case "Chimset_7":
			dialog.text = "Not exactly. It will force her to summon every ounce of her strength just to keep her sanity for as long as she can.";
		...
		case "Chimset_14":
			...
			link.l1 = "I hope I won’t have to trouble you any further... Mary, Aurelie, we need to get back to the 'Pluto'.";
		...
		case "Oreli_13":
			dialog.text = "Aurelie, I asked her to tidy up here while you were away. No need for you to strain your back with those bad knees...";
			link.l1 = "...";
		...
		case "Oreli_22":
			dialog.text = "Of course, Aurelie! How could you ever think otherwise?";
			link.l1 = "...";
		...
		case "Oreli_23":
			dialog.text = "Sigh, I look at the youth these days and... no, no, we never acted like that with our elders. But that doesn’t apply to you, of course. I just wanted to say it’ll be easier if I answer your questions one at a time, rather than all at once...";
			link.l1 = "...";
		...
		case "Oreli_24":
			dialog.text = "I understand, Aurélie. Whatever you wish, alright. So, you were on the Island when I was born? If it happened here, of course...";
			link.l1 = "...";
		...
		case "Oreli_27":
			dialog.text = "Something like that. Back then, things were a bit different here — the San Jeronimo was still afloat, the outer ring of ships was maybe half as small, if not twice... And that's still far from all the ships that remain above water! Let me tell you, young people, if you ever look down on a clear day, you'll be shocked at how many shipwrecks lie down there...";
			link.l1 = "...";
		...
		case "Oreli_31":
			...
			link.l1 = "Do you find this funny, Aurélie?";
			link.l1.go = "Oreli_32";
			link.l2 = "And you haven't lost your sense of humor over the years, Aurélie.";
			link.l2.go = "Oreli_33";
			CharacterTurnByChr(CharacterFromID("LSC_Oreli"), CharacterFromID("Mary"));
			CharacterTurnByChr(CharacterFromID("Mary"), CharacterFromID("LSC_Oreli"));
		break;
		...
		case "Oreli_34":
			dialog.text = "It's alright, Aurélie. Please – go on, alright. What happened to my parents after I was born?";
			link.l1 = "...";
		...
		case "Oreli_38":
			dialog.text = "Mother died, and I was left with my father? But then why did everyone say I was raised by Eric Udett? And...";
			link.l1 = "...";
		...
		case "Oreli_40":
			dialog.text = "Sorry, Aurélie, I got carried away, alright. My father, he survived a shipwreck too, didn't he?";
			link.l1 = "...";
		...
		case "Oreli_42":
			dialog.text = "At least tell me his name, alright!";
			link.l1 = "...";
		...
		case "Oreli_43":
			...
			link.l1 = "So, you don’t remember? Alright, "+npchar.name+"?";
			link.l1.go = "Oreli_44";
			CharacterTurnByChr(CharacterFromID("LSC_Oreli"), CharacterFromID("Mary"));
			CharacterTurnByChr(CharacterFromID("Mary"), CharacterFromID("LSC_Oreli"));
		break;
		...
		case "Oreli_48":
			dialog.text = "He may have been a good husband, alright. I never claimed otherwise, let me point that out. Don’t try to twist my words, boy!";
		...
		case "Oreli_51":
			dialog.text = "Bodies of the murdered are not always found – the seasoned ones sink them, tying cannonballs or stones to their arms and legs, or wrapping them with chain shot. And the crabs at the bottom finish the job. Still, the victims’ belongings resurface sooner or later, one way or another.";
		...
		case "Oreli_53":
			dialog.text = ""+pchar.name+"God be with you – I can’t even remember his name, and you’re asking me questions like that! If anything did happen, I never heard talk of that thing ending up with anyone else on the Island. Back then I was working as a tavern maid, and hardly any gossip slipped past me. But that doesn’t mean I knew absolutely everything.";
		...
		case "Oreli_54":
			...
			link.l1 = "Tartanas, tartanas... Nothing is impossible. If we knew his name, we could check the colonial archives from those years. But it would be much easier if we had the type and name of the ship he 'arrived' on.";
			link.l1.go = "Oreli_55";
		break;
		...
		case "Mary_94":
			dialog.text = "Are you trying to remember every English name that starts with ‘J’? Aurélie only mentioned Geoffrey and John, alright.";
		...
		case "Mary_97":
			dialog.text = "But what should we do then, "+pchar.name+"? Talk to Aurélie again? We’ve already gotten everything we could out of her, don’t you think?";
			link.l1 = "Not with Aurélie. With Donald.";
			link.l1.go = "Mary_98";
		break;
		
		case "Mary_98":
			dialog.text = "And how is he supposed to help us? He said himself that in 1638 he was nowhere near the Island of Justice, alright.";
			link.l1 = "But there were other narwhals here, alright?";
			link.l1.go = "Mary_99";
		break;
		
		case "Mary_99":
			dialog.text = "I don’t really get what you’re getting at.";
		...
		case "Grinspy_31":
			...
			link.l1 = "Hello, "+npchar.name+". Could be better – for now, we’re wandering as if in this cave of secrets and mysteries. But I feel the way out is close, alright.";
		...
		case "Grinspy_34":
			dialog.text = "And left your daughter? That's a strange thing to do.";
			link.l1 = "That's right. But no one except this very Mr. J. can explain it.";
		...
		case "Grinspy_37":
			...
			link.l1 = "Greenspy, Greenspy... Don't forget you're still warming that chair only because of me. So do me a favor – don't test my patience.";
		...
		case "Grinspy_39":
			dialog.text = "Hmm...";
			link.l1 = "Ships occasionally wash up on the outer ring. Some sink right away, others stay afloat for a while—they get searched, and everything valuable is stripped from them. I don’t know about the Rivadans, but I doubt the Narwhals fight over every trinket they find on board—most likely, everything goes into a common pool, then they make a full inventory, and only after that do they divide the loot.";
			link.l1.go = "Grinspy_40";
			AddCharacterExpToSkill(pchar, "Commerce", 100);
		break;
		
		case "Grinspy_40":
			dialog.text = "You're not stupid, "+pchar.name+". Unlike many people here. Alright, that's pretty much how it goes. Personally, I can't stand all this paperwork, but it was done back in Alan Milrow's days, and even by those who led the Narwhal clan before him. We keep these records—and more than that: we even log the ships that the Rivados or pirates reached first. But in those cases, of course, we have no idea who or what was on board...";
		...
		case "Grinspy_41":
			dialog.text = "Maybe so. I can't say for sure. And I never will.";
			link.l1 = "Now I don't understand what you mean, "+npchar.name+".";
			link.l1.go = "Grinspy_42";
		break;
		
		case "Grinspy_42":
			dialog.text = "Logs of the lost ships. When Layton Dexter became Admiral after Dodson left, he took those documents from us.";
			link.l1 = "Just took it and confiscated it? And you didn’t object?";
		...
		case "Grinspy_43":
			...
			link.l1 = "Not the most useless notes, alright.";
			link.l1.go = "Grinspy_44";
		break;
		
		case "Grinspy_44":
			dialog.text = "I'm telling you, it's just a tradition, mainly to keep our clan from tearing each other's throats out over loot from the ships. A vessel washes up, we strip it of everything we can, make a list, split some of it, stash the rest in our holds – that's all there is to it. Why clutter up the cupboards? Now there's a bit more space in them – I suppose I should even thank the Admiral for that.";
			link.l1 = "Alright, got it. Then we're setting course for 'San Augustin'. But maybe we'll drop by to see you again, "+npchar.name+".";
			link.l1.go = "exit";
        ...
        case "WildRose_Dexter_2":
            dialog.text = "And important enough for you – judging by how worked up you look.";
            ...
            link.l2 = "Just a bit out of breath, that's all. You see, I don't just sit in a chair all day. But you, I see, can barely stand on your feet anymore, ha-ha-ha!";
        ...
        case "WildRose_Dexter_5":
            dialog.text = "Ahem... "+pchar.name+", I’m not quite following you, alright?";
        ...
        case "WildRose_Dexter_6":
            dialog.text = "So, that fool Greenspy actually sent you after them? What a nerve.";
        ...
        case "WildRose_Dexter_7":
            dialog.text = "Why not tell me, then? As you might have guessed, I couldn’t care less about the ships themselves. And honestly, I don’t care much about the treasures packed in their holds either. There’s enough here for everyone, as long as you don’t get greedy – that’s how I see it. What really interests me is the weapons: muskets, sabers… cannons, in the end. Alright, those clever ones even take those sometimes. The empty-headed blacks aren’t smart enough for that, but the narwhals...";
            link.l1 = "And you decided to see just how ready the people of Greenspy are for a new round of conflict?";
            link.l1.go = "WildRose_Dexter_8";
        break;

        case "WildRose_Dexter_8":
            dialog.text = "And to hint that me and my crew are keeping our eyes open. The message is pretty clear, but considering the circus Donald put on with those drills, I wouldn’t be surprised if he’s decided I’m after his money.";
            link.l1 = "Yeah, I can see things aren’t exactly going the way you hoped. And what about Rivadose? Is Black Eddie causing any trouble?";
        ...
        case "WildRose_Dexter_9":
            ...
            link.l1 = "So it brings you pleasure.";
            link.l1.go = "WildRose_Dexter_10";
        break;

        case "WildRose_Dexter_10":
            dialog.text = "That's just it, no, curse me if I lie! The black-skinned ones have gone quiet, holed up on their ships...";
        ...
        case "WildRose_Dexter_12":
            dialog.text = "Alright. But sometimes, there’s just no wind at all. Dead calm – and there’s nothing any skipper can do about it. You just sit on the quarterdeck, stare at the water, and wonder what the hell is going to happen next. It’s the same with Eddie and his pal Chimiset – they’re up to something, I can feel it in my bones, and it’s no good, I swear by thunder!";
            link.l1 = "Maybe you should get off your backside and have a face-to-face talk with Edward. Or better yet, get the three of you together, bring Donald along too, and have an honest conversation. That’s a far better idea than drowning the Island in blood all over again. But alright... Let’s get back to why I came here.";
        ...
        case "WildRose_Dexter_14":
            dialog.text = "A noble cause – I myself once tormented myself with thoughts of who my own father was. But I’m afraid I can’t help you.";
            link.l1 = "And why is that, if you don't mind me asking?";
            link.l1.go = "WildRose_Dexter_15";
        break;

        case "WildRose_Dexter_15":
            dialog.text = "No secrets from you, "+pchar.name+". It's not about me at all, it's about Donald—he only gave me the papers from 1651 onwards. I asked about any older records, at least from the previous decade, and he told me there were no other documents. That's all he inherited from Alan Milrow in this regard—or so he said.";
            link.l1 = "I don't think he had any reason to lie.";
            link.l1.go = "WildRose_Dexter_16";
        break;

        case "WildRose_Dexter_16":
            dialog.text = "I think so too, friend. Considering he handed me the new records without a single question. In fact, it seemed to me he was even somewhat glad to get rid of that junk... Who knows, maybe Milrow just got rid of papers from decades past... Burned them, or maybe...";
        ...
        case "WildRose_Dexter_17":
            ...
            link.l2 = "I always thought he was more the knife-and-axe type than all that bureaucracy. Surprised he could even read, alright.";
		...
		case "WildRose_Betancur_2":
			...
			link.l1 = "Don’t be scared, "+npchar.name+", it's not your fault, alright. We're just a bit tired of running around these creaking shipwrecks. And it's a stifling day, don't you think?";
			link.l1.go = "WildRose_Betancur_3_1";
			link.l2 = "This heat isn’t giving us any extra strength, alright. And on top of that, we had to run all over the Island looking for you – we could really use your help.";
			link.l2.go = "WildRose_Betancur_3_2";
		break;

		case "WildRose_Betancur_3_1":
			dialog.text = "Ahem, alright, a gentle breeze would be just perfect right now. So, what can I do for you?";
		...
		case "WildRose_Betancur_12":
			dialog.text = "Alan Milrow. Alright, we talked about it back when he wasn’t busy drawing up plans to wipe out the Rivadans, and later the pirates too. He was a clever guy, with some remarkable talents.";
		...
		case "WildRose_Betancur_15":
			dialog.text = "Those records from 1638 are there, right? Please, tell me they are, alright!";
			link.l1 = "...";
		...
		case "WildRose_Betancur_19":
			dialog.text = "Please. Make yourself comfortable, take a look around...";
		...
		case "WildRose_Mary_101":
			dialog.text = "Here, "+pchar.name+", look, alright! Joshua and Teresa Casper! I can't believe it – we did it, we really did, alright! And the ship's name is 'Wrangler'! Now we can find out everything about my father – who he was, how he ended up here...";
		...
		case "WildRose_Betancur_22":
			dialog.text = "They were already bad, as I recall. Now I remember, "+pchar.name+" - I was actually nearby the 'Ceres Smithy' when they were brought aboard... Alright, I was on the 'Esmeralda'—with Aurelie Bertin, I think. And Chimiset was there too—the shaman of those black heathens, for some reason he came to the shop. At first I thought those two sailors were already dead—but they only died a day later...";
		...
		case "WildRose_Betancur_23":
			dialog.text = "I'm not involved in this, "+pchar.name+". It's all Alan, it's his doing – hardly any of those cuirassiers could have grasped the true value of these records. After all, it's documents like these that let us piece history back together!";
		...
		case "WildRose_Chimiset_21":
			...
			link.l1 = "With a request, "+npchar.name+"... Or rather, with a question.";
		...
		case "WildRose_Chimiset_25":
			dialog.text = "Yeah, we crawled into a hole in the hold... That’s where I passed out again, I was so weak. I came to when Asana started screaming – he was being torn apart by a giant crab that had climbed onto the same ship we’d washed up on. And I just stood there watching, knowing I’d be next – frozen with fear and helplessness, I couldn’t move an inch.";
		...
		case "WildRose_Chimiset_38":
			dialog.text = "So, I owe you my life, alright?";
			link.l1 = "...";
		...
		case "WildRose_Chimiset_40":
			dialog.text = "Mother's dead, alright.";
			link.l1 = "...";
		...
		case "WildRose_Chimiset_44":
			dialog.text = "There's no point, Mary. All you have to do is look in the mirror – you and she are like two peas in a pod. Only your eyes came from your father.";
			link.l1 = "...";
		...
		case "WildRose_Chimiset_53":
			...
			link.l1 = "If there’s anything left to figure out. Julian might not even know about it – but we’ll get to the bottom of it, alright. Thank you, Chimiset.";
		...
		case "WildRose_Julian_1":
			...
			link.l1 = "Hello, Brother Julian. I'm afraid listing all our sins would take far too long – time we, alas, do not have. But rest assured – as good Catholics, we attend church in every port.";
			link.l1.go = "WildRose_Julian_2_1";
			link.l2 = "Greetings, Brother Julian. With a prayer to our Lord, we, as good Catholics, begin our day and end it the same way.";
			link.l2.go = "WildRose_Julian_2_2";
			DelLandQuestMark(npchar);
		break;

		case "WildRose_Julian_2_1":
			dialog.text = "Good Catholics, living together under one roof without being married... That's practically blasphemy, my son. And let me remind you, that's a mortal sin!";
		...
		case "WildRose_Julian_2_2":
			dialog.text = "Good Catholics, living together under one roof without marriage... That's akin to blasphemy, my son. And let me remind you, that's a mortal sin!";
			link.l1 = "And doesn’t the Scripture say that love covers all sins?";
			link.l1.go = "WildRose_Julian_3";
			AddCharacterExpToSkill(pchar, "Leadership", 100);
		break;
		...
		case "WildRose_Julian_13":
			dialog.text = "But I was baptized, Brother Julian. Eric Udett told me about it.";
			link.l1 = "...";
		...
		case "WildRose_Mary_114":
			dialog.text = "Cecile Gallard's son. Oh, I just remembered! She raised me, though she was never particularly warm. Probably because I survived and Fabian didn’t. He died a few months after he was born, alright.";
		...
		case "WildRose_Mary_115":
			dialog.text = "She’s not much younger than Aurelie, "+pchar.name+". All we can do is hope that at least she's got her head on straight. But what are you planning to ask her, alright?";
			link.l1 = "Well, since she was your nursemaid, she might have known some details from Padre Domingo about his talk with Joshua. Who else would he have told, if not her? Maybe Aurélie or Eric too. But I think we’ve squeezed everything we could out of the first, and the second won’t be telling anyone anything anymore.";
		...
		case "WildRose_Sesil_3":
			dialog.text = "This is about my parents, Cécile. We’ve already learned everything we could about my mother... She died right after I was born. But my father... he vanished without a trace just a few days later. We tend to think he didn’t die, alright.";
			link.l1 = "...";
		...
		case "WildRose_Sesil_4":
			dialog.text = "Well, sending a man like him to the next world must've taken some doing, alright...";
			link.l1 = "...";
		...
		case "WildRose_Sesil_9":
			dialog.text = "Alright, it doesn't matter. Please, go on, Cécile.";
			link.l1 = "...";
		...
		case "WildRose_Sesil_10":
			...
			link.l1 = "Cutthroat? That’s a bit harsh, don’t you think, Mrs. Gallard? We’re talking about a man here, an officer who’s just lost his wife...";
		...
		case "WildRose_Sesil_16":
			dialog.text = "Because that's what her mother wanted, that's why. When the girl was taken from her womb, she whispered a name – Mary. I wasn't there to witness it, but Aurélie Bertin was present at the birth. You can ask her if you want...";
			link.l1 = "So you went with your mother’s wishes, then.";
			link.l1.go = "WildRose_Sesil_17";
		break;

		case "WildRose_Sesil_17":
			dialog.text = "And how could it have been any different, alright – the so-called father just vanished into thin air, didn’t he?";
		...
		case "WildRose_Sesil_18_1":
			dialog.text = "He never mentioned anything like that. Alright, just think about it yourself, "+npchar.name+", if you were planning to escape from prison, would you go telling the first stranger you met? That guy definitely wouldn’t, I’ll tell you that.";
		...
		case "WildRose_Sesil_18_2":
			dialog.text = "He never mentioned anything like that. And just think about it, alright, "+npchar.name+", if you were planning to escape from prison, would you go telling the first stranger you meet about it? That guy definitely wouldn’t, I’ll tell you that.";
		...
		case "WildRose_Mary_136":
			dialog.text = "Do you really think he’s dead? That he ended up in the hands of the Spanish in Cuba, or was killed on the Island of Justice?";
			link.l1 = "I try to look the truth in the eye, "+npchar.name+". Back in those years, there was at least some connection with the Island, alright, smugglers sailed there on their tartans with enviable regularity. If he had managed to leave the Island, I have no doubt he would have come back for you after some time.";
		...
		case "WildRose_Mary_143":
			dialog.text = "I don’t understand any of this. I don’t even know who else could shed any light on him. The more we try to find out about my father, the deeper we sink into this swamp of secrets and mysteries, alright.";
		...
		case "WildRose_Mary_144":
			dialog.text = "Northwood? But he’s dead, alright. You don’t really think the report filed when the 'Cornwall' arrived in St. John’s is full of lies, do you?";
			link.l1 = "Oh, that naivety of yours, "+npchar.name+"... I'm starting to think this whole story is soaked through with lies. Think about it: Joshua Casper was a model officer – plenty of awards and not a single reprimand. That just doesn't fit with what we learned about him on the Island of Justice, where he sent two men to their graves without a second thought, don't you think?";
			link.l1.go = "WildRose_Mary_145";
		break;

		case "WildRose_Mary_145":
			dialog.text = "He fought for the life of his wife, my mother, "+pchar.name+"!";
			link.l1 = "Of course, but let's think about it—where did she even come from? And more importantly, why did he hide his marriage from the Admiralty? A soldier to the core, a man devoted to duty and regulations—otherwise his record wouldn't be so spotless—and then suddenly, something like this.";
		...
		case "WildRose_Mary_147":
			...
			link.l1 = "And there’s clearly something off about this Rupert Northwood, alright. Nearly half the crew died in that battle, but strangely enough, not a single officer—except him. And why did your mother, before she died, call out to Rupert and not to her own husband, Joshua?";
		...
		case "WildRose_Mary_149":
			...
			link.l1 = "If there are any answers to be found, it's on the Island of Justice – there’s nowhere else left with people, except maybe across the ocean, who ever knew your parents, even if only for a moment. I think we should talk to Aurélie Bertin again – maybe she'll remember something else we can hold on to.";
		...
		case "WildRose_Mary_151":
			...
			link.l1 = "And if we decide to keep searching – not on the dusty shelves of the Admiralty, but here, in the Archipelago – we’ll need more than just a name, and a false one at that, alright.";
			link.l1.go = "WildRose_Mary_152";
		break;

		case "WildRose_Mary_152":
			dialog.text = "You know, all this gives me goosebumps, alright. Maybe it’s because it’s all so... thrilling, or maybe it’s the thought that my father might not have been so different from that bastard on Bishop’s plantation.";
			link.l1 = "Anyway, I promise we’ll do everything we can to get to the bottom of this. So let’s not waste any time. Let’s go!";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_161":
			...
			link.l1 = "I hope Aurélie is in her cabin, and we won't have to search the whole Island looking for her...";
			link.l1.go = "exit";
		...
		case "WildRose_Jillian_31":
			dialog.text = "Oh, you're here again. Well, hello... What is it, do you need Aurelie again?";
			link.l1 = "...";
		...
		case "WildRose_Jillian_37":
			dialog.text = "Well, I suppose the thought of being questioned by you again makes her uneasy. But since when have you ever cared about other people's troubles, alright?";
			link.l1 = "...";
		...
		case "WildRose_Jillian_41":
			dialog.text = "What a nervous creature, always on edge when things don't go her way, right?";
			link.l1 = "There's no need to provoke her for no reason, "+npchar.name+". You know she doesn’t wear that blade just for show.";
			link.l1.go = "WildRose_Jillian_42";
		break;
		
		case "WildRose_Jillian_42":
			dialog.text = "And you would have let that happen, "+pchar.name+"?";
			link.l1 = "You just haven’t seen Mary in a fight, "+npchar.name+". Otherwise, they wouldn’t fool themselves into thinking that anyone or anything could ever stop her. We’ll meet again.";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_163":
			...
			link.l1 = "Honestly, I don’t really care what came between you two, though I have a pretty good guess what her name was. Or rather, what it used to be. Do you really want to talk about it?";
			link.l1.go = "WildRose_Mary_164_1";
			link.l2 = "Did you and Jillian have a falling out? Or should I say, over someone?";
			link.l2.go = "WildRose_Mary_164_2";
		break;

		case "WildRose_Mary_164_1":
			dialog.text = "Hmm, not really, no.";
			link.l1 = "Whatever you say. Now let's go find Aurelie.";
		...
		case "WildRose_Mary_164_2":
			...
			link.l1 = "As you say, darling. Then let's go look for Aurelie.";
			link.l1.go = "WildRose_Mary_165";
			AddCharacterExpToSkill(pchar, "sneak", 100);
		break;
		...
		case "WildRose_Oreli_62":
			dialog.text = "Oh-oh, young people, you really have no pity for an old lady. But I felt that you would come. This is about your parents again, isn’t it, Mary, alright?";
			link.l1 = "...";
		...
		case "WildRose_Oreli_63":
			dialog.text = "Please, Aurélie. I know it's hard for you to remember after all this time, but try just once more for me, alright.";
			link.l1 = "...";
		...
		case "WildRose_Oreli_69":
			...
			link.l1 = "I see. Clearly, their love was mutual... Well, thank you, Aurélie. You’ve been a great help to us.";
		...
		case "WildRose_Oreli_70":
			...
			link.l1 = "We did promise not to trouble you for long. Take care of yourself, "+npchar.name+". Take care.";
		...
		case "WildRose_Oreli_73":
			dialog.text = "What is it, Aurélie? A hat?..";
			link.l1 = "...";
		...
		case "WildRose_Oreli_75":
			dialog.text = "Aurelie... You kept it all these years! And... and you didn’t throw it away, didn’t sell it... Thank you, thank you! You have no idea how much this means to me, alright!";
			link.l1 = "...";
		...
		case "WildRose_Oreli_77":
			dialog.text = "There's no better moment, Aurelie! I'll try it on right now, alright!";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_166":
			...
			link.l1 = "You're beautiful. And the hat... it hasn't gone out of style yet, so it looks wonderful too, alright.";
			link.l1.go = "WildRose_Mary_167";
		break;
		
		case "WildRose_Mary_167":
			dialog.text = "Really? I’m so glad you like it, alright!";
		...
		case "WildRose_Mary_168":
			dialog.text = "...";
			link.l1 = "Thank you once again, Aurélie – you made this day a little brighter! All the best, have a good rest.";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_178":
			...
			link.l1 = "If he survived, of course. But I don't agree with you. He probably didn't speak Spanish fluently, which means he had no business on Cuba or Hispaniola. He could speak French and head to Tortuga or one of the colonies in the Lesser Antilles. Or he might have settled on the Main, under the wing of his countrymen. We really could spend months searching for him—and there's no guarantee we'll succeed.";
		...
		case "WildRose_Mary_179":
			...
			link.l1 = "I never suggested that, "+npchar.name+". We don't need to look for him ourselves – it's better to turn to someone with connections. It worked once before, so why not try it again?";
		...
		case "WildRose_Mary_182":
			...
			link.l1 = "Alright, let's go see our friend. Doesn't seem like too much of a challenge for him, if you ask me.";
		...
		case "WildRose_Jillian_52":
			dialog.text = "Oh, so you haven't heard. I see... Aurélie Bertin passed away last night.";
			link.l1 = "...";
		...
		case "WildRose_Jillian_54":
			dialog.text = "No, Mary. Aurelie died in her sleep. I went to see her today, to bring her some ointments for her joints, made by Brother Julian – and that's when I found her. She was lying on her bed, with a strange smile on her face. But she was already pale and cold.\nThis past week, the old woman wasn't herself, I even thought that the illness the black sorcerer had driven out had returned. But her mind was clear enough, and it seemed she wasn't delirious.";
			link.l1 = "...";
		...
		case "WildRose_Jillian_56":
			...
			link.l1 = "We'll stay, Jillian. Aurélie has done so much for Mary, we simply can't do otherwise. If no one objects, we'll hold the procession on our ship. We'll bury her at sea, with all due honors.";
		...
		case "WildRose_Chimiset_62":
			dialog.text = "Are you talking about Aurelie’s death? I can see that you are. Of course I’ve heard. She lived on the ‘Pluto’, and that’s practically Rivadose turf. And people on all the other ships can’t talk about anything else.";
		...
		case "WildRose_Chimiset_64_2":
			...
			link.l1 = "You know, it occurred to me that Aurelie seemed to be waiting for us, like she knew we’d come to her. The old woman could have died a day earlier or later, but it happened almost right after she told us something important about Mary’s father."link.l1.go ="WildRose_Chimiset_65";
			AddCharacterExpToSkill(pchar, "sneak", 100);
		break;
		...
		case "WildRose_Chimiset_65":
			...
			link.l1 = "I didn't... Wait a second. That ritual you performed in the hold of the 'Protector'... it didn't slow down Aurelie's illness, did it? So what did you actually do?";
			link.l1.go = "WildRose_Chimiset_66";
		break;

		case "WildRose_Chimiset_66":
			dialog.text = "You can fill a river with stones, but that won't stop its flow. I knew you needed something important from Aurelie – and that you wouldn't reach it right away. But how long your journey would take, I couldn't tell. So I built a dam, calling on all her life force to hold back the sickness until she fulfilled her purpose. And the moment that happened, the barrier collapsed...";
			link.l1 = "So it turns out, Aurelie... at the moment of her death, she wasn't herself at all, she wasn't aware of herself – just as we thought?";
		...
		case "WildRose_Chimiset_68_1":
			dialog.text = "Because I decided to help you, my friend, to learn what you needed to know, and to let her fulfill her purpose. If I had told you what awaited her, you might not have gone through with it—and Aurélie would have taken her secrets with her to the grave. What good would that have done? She would have died for nothing. Like an antelope brought down by a lion, but left uneaten and abandoned for the vultures instead.";
			link.l1 = "Destiny, purpose... You're quite the maker of fates, "+npchar.name+". God in human form.";
			link.l1.go = "WildRose_Chimiset_69";
			AddComplexSelfExpToScill(100, 100, 100, 100);
		break;

		case "WildRose_Chimiset_68_2":
			dialog.text = "Because I decided to help you, my friend, to learn what you needed, and to let her fulfill her destiny. If I had told you what awaited her, you might not have gone through with it—and Aurélie would have taken her secrets with her to the grave. What good would that have done? She would have died for nothing. Like an antelope brought down by a lion, but left uneaten and abandoned to the vultures instead.";
		...
		case "WildRose_Mary_192":
			dialog.text = "You’ll tell me, alright?";
		...
		case "WildRose_Mary_193":
			dialog.text = "I haven't heard such determination in your voice for a long time, "+pchar.name+". But alright, we've got other things to worry about, alright. The funeral will be held tomorrow, at sunset, at seven o'clock.";
		...
		case "WildRose_Mary_202":
			dialog.text = "Well, nobody invited Kurana or Rivadose. Abbott, that pompous, disgusting turkey, said he had more important things to do than bury a Catholic woman, and Lauderdale and Musket mumbled something similar. Cassel, that brute, just said he wouldn’t come. But everyone else is here.";
		...
		case "WildRose_funeral_3":
			dialog.text = ""+pchar.name+", let's get to the cabin quickly, alright. I'm about to burst into tears... I don't want anyone to see me like this.";
		...
		case "WildRose_Mary_211":
			...
			link.l1 = "Alright – and more than once.";
			link.l1.go = "WildRose_Mary_212";
		break;

		case "WildRose_Mary_212":
			dialog.text = "Eric used to say that a lot. I think he meant his family. I never asked him about them—I always thought there’d be time for that. And then he died, alright. Now Aurélie is gone too—and only now do I realize how little time and attention I gave her. Far less than she deserved.";
		...
		case "WildRose_Mary_213":
			dialog.text = "Maybe so, alright. And Eric often said – and Aurelie agreed with him – that any place is, first and foremost, its people. Not the houses, the trees, the roads – but the people. When you think of some spot on the map, the first thing you remember is the people who live there. Or who once did.";
			...
			link.l2 = "I'd argue with that. When I think back to, say, Paris – what comes to mind are the sights of the streets, the smells... As for people, I only remember a handful – the rest have almost faded from my memory, even though it's only been a few years.";
			link.l2.go = "WildRose_Mary_214_2";
		break;

		case "WildRose_Mary_214_1":
			dialog.text = "I think Erik and Aurelie talked about the Island, alright. And about the people who used to live here—a long, long time ago. I was just a child and didn’t understand any of it, but now—I see it all clearly. After all, Antonio, Cecile... and a few Rivadans like Chimisette have been here longer than I have—but I was never close to any of them. As for the rest: Erik, Aurelie, Alan, and so many others—they’re all dead.";
		...
		case "WildRose_Mary_214_2":
			dialog.text = "I think Erik and Aurelie talked about the Island, alright. And about the people who used to live here—long, long ago. I was just a child and didn’t understand any of it, but now I see it all so clearly. After all, Antonio, Cecile... and some of the Rivados, like Chimiseta, have been here longer than I have—but I was never close to any of them. As for the rest: Erik, Aurelie, Alan, and so many others—they’re all gone.";
		...
		case "WildRose_Mary_216":
			dialog.text = "Didn’t you feel it, "+pchar.name+"? Just now, when we were standing by Aurelie's grave.";
			link.l1 = "What exactly?";
		...
		case "WildRose_Mary_217":
			...
			link.l1 = "Alright, I felt something like that too. But maybe it’s just the mood? I mean, it is a funeral after all...";
			link.l1.go = "WildRose_Mary_218_1";
			link.l2 = "You're exhausted, "+npchar.name+". Get some rest – it’ll feel easier. And really, can anyone feel any different at a funeral, alright?";
		...
		case "WildRose_Mary_219":
			...
			link.l1 = "Dexter gets nervous whenever Greenspy tries to meddle with the drills – and who can blame him?";
			link.l1.go = "WildRose_Mary_220";
		break;

		case "WildRose_Mary_220":
			dialog.text = "This won't end well, alright.";
			link.l1 = "If that's the case, then today wasn't just the funeral of Aurélie Bertin, but of this... City of Abandoned Ships as well.";
			link.l1.go = "WildRose_Mary_221";
		break;

		case "WildRose_Mary_221":
			dialog.text = "Cities of Abandoned Ships?";
			link.l1 = "Forgive me, Mary, but I just can’t bring myself to call this place the Island of Justice.";
		...
		case "WildRose_Mary_231":
			dialog.text = "Rupert Casper? Joshua Northwood, alright?";
		...
		case "WildRose_BanditBeliz_1":
			...
			link.l1 = "Jerome Sauvernier? What the hell is going on here?!";
			link.l1.go = "exit";
		...
		case "WildRose_BanditBeliz_2_1":
			dialog.text = "...";
			link.l1 = "That too. Now spill it: what the devil made you attack us – and together with Sovereignet, no less...";
			link.l1.go = "WildRose_BanditBeliz_3";
		break;

		case "WildRose_BanditBeliz_3":
			dialog.text = "Your Sovereign is a greedy, cowardly bastard. All it took was for Casper to give him a good thrashing, then promise him some coin – and right away, he scribbled that letter like a good little boy, ahem...";
		...
		case "WildRose_BanditBeliz_6":
			...
			link.l1 = "Alright then. Now you can die as much as you want. And I’m off.";
		...
		case "WildRose_Mary_255":
			...
			{
				link.l3 = "Hercule. He knows exactly how these things are done, alright.";
			...
			{
				link.l99 = "Alonso. He’s quick with a blade, and he’s no fool, alright.";
		...
		case "WildRose_Tichingitu_1":
			...
			link.l1 = "My friend, you have an important task ahead of you. A gang of scoundrels is hiding out in Chetumal Bay. You need to track them down and wipe them out. We’ll approach by sea on our ship.";
		...
		case "WildRose_Duran_1":
			dialog.text = "Did you call for me, Cap'n?";
		...
		case "WildRose_Duran_2":
			dialog.text = "";
			link.l1 = "We need to gather a squad of fighters and lead them through the jungle to Chetumal Bay. There, a gang led by some Rupert Casper is lying in wait for us. They want to give us an unpleasant surprise. But in fact, we'll be the ones surprising them—more precisely, you will. You'll attack them on my signal. Any questions?";
			link.l1.go = "WildRose_Duran_3";
		break;

		case "WildRose_Duran_3":
			dialog.text = "I hate trudging through the jungle. But, as they say, orders are orders. I'll meet you there, I guess, sometime around noon tomorrow.";
		...
		case "WildRose_Tonzag_1":
			dialog.text = "I'm listening, Captain.";
		...
		case "WildRose_Tonzag_2":
			...
			link.l1 = "Almost got it. You need to lead a squad of our men from the ship, take them through the jungle to Chetumal Bay. There, you'll set up an ambush for the gang that, I believe, will be waiting for us there.";
			link.l1.go = "WildRose_Tonzag_3";
		break;

		case "WildRose_Tonzag_3":
			dialog.text = "I thought you were talking about something serious, Captain. But here you are, almost suggesting a trip to the tavern. By noon tomorrow, just consider us there.";
		...
		case "WildRose_Irons_1":
			dialog.text = "Ha, Cap, why are you so serious – like you’re off to a funeral or something?";
			link.l1 = "Still joking around, Tommy? Want me to make a joke too? You won't be getting your pay this month. Or next month, for that matter. Why so tense all of a sudden?";
			link.l1.go = "WildRose_Irons_2";
		break;

		case "WildRose_Irons_2":
			dialog.text = "And I can't even make a joke...";
			link.l1 = "Everything in its own time, Tommy. You’ve still got a lot to learn. Now listen to me carefully: gather your crew and head through the jungle to Chetumal Bay. Once you get there, wait for my signal.";
			link.l1.go = "WildRose_Irons_3";
		break;

		case "WildRose_Irons_3":
			dialog.text = "Trekking through the jungle? We won’t get there before noon tomorrow, alright.";
			link.l1 = "So, we’ll meet there tomorrow at noon. Don’t engage without orders, don’t abandon your post. Got it? I see you do. Now, get to it.";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("WildRose_Etap6_LifeAfterDeath_14");
		break;
		...
		case "WildRose_Longway_2":
			dialog.text = "...";
			link.l1 = "You’ll lead a squad of our men through the jungle to Chetumal Bay. There might be an encounter with the enemy there, so make sure your people are ready, alright.";
		...
		case "WildRose_Mary_256":
			dialog.text = "Charles, did you see that, alright?";
		...
		case "WildRose_Mary_257":
			dialog.text = "Still, we haven’t been turned into a sieve just yet. And no one’s even trying to, alright.";
		...
		case "WildRose_Rupert_3":
			...
			{
				dialog.text = "Alright, I've seen plenty in my long and difficult life. Every time I think nothing can surprise me anymore – and every time I'm wrong. So, you actually survived out there... And you even kept Teresa's hat. I never thought I'd see it again.";
				link.l1 = "...";
				link.l1.go = "WildRose_Rupert_3_1_add";
			}
			else
			{
				dialog.text = "Alright, I’ve seen a lot in my long and difficult life. Every time I think nothing can surprise me anymore – and every time I’m wrong. So, you did survive there after all, Julia...";
				link.l1 = "...";
		...
		case "WildRose_Rupert_3_2":
			dialog.text = "Aurelie gave it to me before her... passing.";
			link.l1 = "...";
		...
		case "WildRose_Rupert_3_3":
			dialog.text = "How touching... I'm about to cry. And here I thought they'd buried Teresa along with it. She never parted with it for a second since I gave it to her. Your mother, even though she was just a serving girl, had so much adventure in her that it was practically pouring out of her ears. When I found her during the capture of the Fleur-de-Lys, I knew at once Teresa would be crazy about her. She looked funny in that hat, but she didn't care: she only took it off to sleep. But you, Julia, it really suits you.";
			link.l1 = "...";
			link.l1.go = "WildRose_Rupert_3_add";
			CharacterTurnByChr(CharacterFromID("WildRose_Rupert"), CharacterFromID("Mary"));
			CharacterTurnByChr(CharacterFromID("Mary"), CharacterFromID("WildRose_Rupert"));
		...
		case "WildRose_Rupert_5":
			dialog.text = "Hmm, is that so. So those scoundrels ignored my words and took matters into their own hands. Well, you couldn't expect anything else from those Catholic dogs.";
			link.l1 = "...";
		...
		case "WildRose_Rupert_9":
			dialog.text = "Like you’d ever understand, alright...";
			link.l1 = "Doesn’t seem like you’re happy to see your daughter, Mr. Casper. Especially since you admitted she’s yours yourself.";
		...
		case "WildRose_Rupert_11":
			...
			link.l1 = "Not just before that. We know about the 'Cornwall', and its cargo, and about Joshua Casper, whose name you borrowed for a while, and his surname—seems you’ve kept that one for good.";
		...
		case "WildRose_Rupert_15":
			dialog.text = "Tell me, "+pchar.lastname+", does she always throw such tantrums? She gets it from her mother. Teresa was a wonderful girl, the best I’ve ever met. But she did love to weep and make a scene, alright... What can I say... Irish.";
		...
		case "WildRose_Rupert_18":
			dialog.text = "You blame me for mother's death?! You... So what am I guilty of: being born, alright? Fine, father, "+pchar.name+", alright - tell us everything, and then we’ll turn around and leave. And I’ll never show myself to you again, since you... (starts sobbing).";
			link.l1 = "...";
		...
		case "WildRose_Rupert_19":
			dialog.text = "Alright, you’re the spitting image of Teresa. I feel like I’m twenty years younger, ha-ha. Damn you. I never wanted to remember any of this… So, if by the end of this tale I decide to put a bullet in your forehead, darling—well, you’ll have only yourself to blame.";
		...
		case "WildRose_Rupert_20": //
			dialog.text = "I know what it's worth, boy. That's not the same thing. But how could someone like you understand that? Alright, let's get to the point. You want to know everything about me? Well, here goes. I was born on a farm near Eastbourne—a small town on the shore of the Channel—in 1611. Maybe a year earlier or later—my old mum always mixed up the dates, which isn't surprising, considering how much booze she poured down her throat.";
		...
		case "WildRose_Rupert_21":
			...
			link.l1 = "I've heard about that. Those men showed no mercy to anyone. How did you manage to survive?";
			link.l1.go = "WildRose_Rupert_22_1";
			link.l2 = "I know about their atrocities. They spared no one—neither the old nor the young. All the more amazing that you made it out of there.";
			link.l2.go = "WildRose_Rupert_22_2";
		break;

		case "WildRose_Rupert_22_1":
			dialog.text = "That night, those papist bastards burned down several farms, including ours. I managed to get out, but my mum, who’d stuffed herself with cider so much she couldn’t haul her fat arse off the bed, burned right there in it. It was her own fault, of course – but still, she was my mother.";
		...
		case "WildRose_Rupert_22_2":
			dialog.text = "That night, those papist bastards burned down several farms, ours included. I managed to get out, but my mum, who’d stuffed herself with cider so much she couldn’t drag her fat arse out of bed, burned right there in it. Her own fault, of course – but she was still my mother.";
		...
		case "WildRose_Rupert_26":
			dialog.text = "Oh, yes... Joshua Casper... You couldn't find a bigger bastard on the whole damn fleet, alright. It's been so many years, and that scoundrel still haunts my dreams.";
		...
		case "WildRose_Rupert_27":
			dialog.text = "That cruel bastard drilled the crew so hard, people would drop overboard from sheer exhaustion. Since you know his name and that he was the commander of the 'Cornwall', you must have seen his papers—shining like a cat’s licked backside, alright.   Our heroic Joshua had a whole box full of medals. Plenty of naive lads like you wanted to serve under him—say what you will, but he cut down you frog-eaters like a sharp sickle through wet grass after rain, alright—but once they found themselves on the 'Cornwall', they realized their mistake real quick.   We were dead tired of putting up with it, "+pchar.lastname+". Some even wrote petitions for transfers – but they vanished on the shelves of the Admiralty, or in its furnaces. Still, life gave us a chance – they didn’t transfer us off the 'Cornwall', but someone else onto it. John Lawson – Cromwell’s favorite, you must have heard of him.";
			link.l1 = "...";
			link.l1.go = "WildRose_Rupert_28";
		break;

		case "WildRose_Rupert_28":
			dialog.text = "He already knew how to kiss ass back then — and maybe he and Casper would’ve hit it off, alright, but I didn’t let that happen. I set up little Johnny, and clueless Joshua, not knowing what was going on, beat the poor kid with his cane in a fit of rage.";
			link.l1 = "A real humiliation for an officer. And Lawson told your father everything?";
			link.l1.go = "WildRose_Rupert_32";
		break;

		case "WildRose_Rupert_32":
			dialog.text = "Of course. But, you see, the system can't devour itself. The whole thing was hushed up – Lawson was offered an early promotion, and Joshua and the 'Cornwall' were pushed into the shadows – we were transferred from London to Plymouth, down south in England. We could have kept terrorizing you, frog-eaters, but the 'Cornwall' was turned into a supply ship, hauling military cargo to Dundalk, a small Irish town.";
			link.l1 = "And that's where you met Teresa?";
			link.l1.go = "WildRose_Rupert_33";
		break;

		case "WildRose_Rupert_33":
			dialog.text = "On our very first visit there. Teresa O'Fatt, as I mentioned, was a waitress at one of the local taverns. Three days were enough for us to realize we were made for each other. I think you'll understand me here, "+pchar.lastname+", alright?";
			link.l1 = "I suppose so.";
			link.l1.go = "WildRose_Rupert_34_1";
			link.l2 = "Looking at you now, you wouldn't think you know the meaning of the word 'love'.";
		...
		case "WildRose_Rupert_38":
			dialog.text = "Teresa was found first. Casper had already poured himself a good dose of whiskey, so he was deaf to any pleas, simply ordering the girl thrown overboard. No matter how I begged, he just laughed himself breathless—damn it, I’m telling you this and I can still hear his laughter in my head...";
		...
		case "WildRose_Rupert_39":
			...
			link.l1 = "After that, you certainly decided not to return to England. You’d all be facing the noose there.";
			link.l1.go = "WildRose_Rupert_40";
		break;
		
		case "WildRose_Rupert_40":
			dialog.text = "I was sure I could take the 'Cornwall' across the ocean. Out here, no one knew our faces, and that gave us a chance to start a new life. It wasn't hard to convince the other officers—my authority mattered less than the contents of a couple of chests the ordinary sailors knew nothing about. The crew decided—Joshua Casper had to stay alive. A handful of us officers agreed to buy us some time and sacrifice one of the chests.\nBut some bastard let slip about the second chest—and that split the crew.";
			link.l1 = "They’ve started a mutiny against you now?";
			link.l1.go = "WildRose_Rupert_45";
		break;

		case "WildRose_Rupert_45":
			dialog.text = "No, but the number of those willing to continue serving our glorious king dropped sharply. There weren’t many eager to turn pirate either. So we found a middle ground – we decided to drop anchor in one of the French ports. There, we planned to sell the ship, split the money from the sale and whatever was in the chest, and then go our separate ways.";
		...
		case "WildRose_Rupert_46":
			dialog.text = "I no longer cared where we made landfall: Teresa, though she put on a brave face, was feeling just like any pregnant woman would after three months of constant rocking. And, just as three months ago, I had nothing against the company of Catholics—as long as I could stay by her side.";
		...
		case "WildRose_Rupert_47":
			dialog.text = "By the time things on board the 'Cornwall' reached a boiling point, we had already made it halfway with a favorable wind, which by then wouldn’t let us change course for Saint Christopher...";
		...
		case "WildRose_Rupert_50":
			dialog.text = "Holding sobbing Teresa close, I prayed to the Lord with all my heart, begging Him to send us salvation. And He truly did help us, alright.";
		...
		case "WildRose_Rupert_64_1":
			dialog.text = "Tartana? Ha-ha-ha... Alright, that was my plan. I thought I'd gotten lucky. The head of the prison guard turned out to be a former officer of the English Navy, and he took pity on me. He told me all about the Cuban smugglers' tartanas, and that they were planning to have me executed. I suppose you could call him a man of honor—he was the one who offered to let me go, so I could leave my fate to chance.";
			link.l1 = "I don't understand... If not on tartans, then how did you leave the island?";
			link.l1.go = "WildRose_Rupert_68";
			AddCharacterExpToSkill(pchar, "leadership", 100);
		break;

		case "WildRose_Rupert_64_2":
			dialog.text = "Tartane? Ha-ha-ha... Alright, that was my plan. I thought I got lucky. The head of the prison guard turned out to be a former officer of the English Navy, and he took pity on my misfortune. He was the one who told me about the Cuban smugglers’ tartanes, and that they were planning to execute me. Maybe you could call him a man of honor—he offered to let me go himself, so I could leave my fate to chance.";
			link.l1 = "I don't understand... If not on tartans, then how did you leave the island?";
			link.l1.go = "WildRose_Rupert_68";
			AddCharacterExpToSkill(pchar, "sneak", 100);
		break;
		...
		case "WildRose_Rupert_68":
			dialog.text = "If you just shut up and listen, you'll understand. I was swimming towards the tartanas, swimming for a long time—until I saw a light beyond the wall of rain. It was something absolutely unbelievable, damn it. It shone like the sun on the deck of one of the half-sunken galleons, and I headed straight for it. Not knowing yet that I was making the worst mistake of my life. I climbed out of the water using the boarding ladder—and found myself face to face with the light. It sparkled above a golden statue and...";
			link.l1 = "The idol of Kukulkan. Alright, back then 'San Jeronimo' hadn’t sunk yet...";
		...
		case "WildRose_Rupert_79":
			...
			link.l1 = "Everyone else is to blame, Northwood... Everyone but you. Still, I get it – years of humiliation and torment, and now you’re stuck in these woods. Hard not to lose your mind, alright?";
