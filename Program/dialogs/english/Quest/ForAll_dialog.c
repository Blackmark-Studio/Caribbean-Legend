void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		//встретил в городе
		case "PortmansCap":
			dialog.text = "Good day. My name is "+GetFullName(npchar)+". I am the captain of "+GetStrSmallRegister(XI_ConvertString(RealShips[int(npchar.Ship.Type)].BaseName+"Acc"))+" '"+npchar.Ship.name+"'.";
		...
		case "PortmansCap_3":
			...
			{
				dialog.text = "Great timing, I haven't started a new one yet, so I'll pay you as much as I can. "+FindRussianMoneyString(int(npchar.quest.money))+" and accept a few pieces of my personal jewellery.";
			...
			else
			{
				if (int(npchar.quest.stepsQty) < 5)
				{
					...
					dialog.text = "Hm, you know, I have already started a new logbook. Nevertheless, the old one still holds value for me. So I'll pay you "+FindRussianMoneyString(int(npchar.quest.money))+" and accept a few pieces of my personal jewellery.";
		...
		case "PortmansCap_inDeck_3":
			dialog.text = "I can pay you "+FindRussianMoneyString(int(npchar.quest.money))+" and some of my jewels. That is all I can afford.";
...
//<-- поисковые квесты дворян
		...
		case "SCQ_Slave_1":
			...
			dialog.text = ""+npchar.quest.SeekCap.capName+" of the "+GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName+"Voc"))+" named "+npchar.quest.SeekCap.shipName+". I'll pay you  "+FindRussianMoneyString(int(npchar.quest.money))+", plus all my jewels."; // belamour gen
		...
		case "SCQ_RapeWife_1":
			...
			dialog.text = "I am not rich, but it will be my pleasure to give you all the valuables I possess! If you free my wife and bring her to me, I will pay you "+FindRussianMoneyString(int(npchar.quest.money))+", plus all my jewels.";
		...
		case "SCQ_Friend_1":
			...
			dialog.text = "I can pay you "+FindRussianMoneyString(int(npchar.quest.money))+" and I will give you all my jewels. This is all I can afford right now.";
		...
		case "SCQR_manSlave":
			dialog.text = "Excellent, I was right about you! So, as I promised you, here are your "+FindRussianMoneyString(int(npchar.quest.money))+" and jewels. Thank you for your help.";
		...
		case "SCQR_manRapeWife":
			dialog.text = "Oh my God! You have saved us! Please, take your "+FindRussianMoneyString(int(npchar.quest.money))+" and jewels. And know that we shall pray for you forever!";
		...
		break;
		case "SCQR_manFriend":
			dialog.text = "Splendid!... Here, take "+FindRussianMoneyString(int(npchar.quest.money))+" and jewels. And thank you, Captain.";
		...
		case "SCQ_Hasband_1":
			...
			SetSeekCapCitizenParam(npchar, int(npchar.nation));
			dialog.text = "Exactly! You understand what I'm talking about. You look like a "+GetSexPhrase("brave captain","brave girl")+", so I want to ask you to find my husband. I am willing to pay you "+FindRussianMoneyString(int(npchar.quest.money))+", plus I shall give you all my jewels.";
		...
		case "SCQ_Revenge_7":
			...
			SetSeekCapCitizenParam(npchar, PIRATE);
			dialog.text = "Everything I have. I will give you my jewels and "+FindRussianMoneyString(int(npchar.quest.money))+"! Deal?";
		...
		case "SCQ_Pirates_5":
			...
			SetSeekCapCitizenParam(npchar, PIRATE);
			dialog.text = "Not much, "+FindRussianMoneyString(int(npchar.quest.money))+" and all of my jewels... But I shall pray for your soul forever!";
		...
		case "SCQR_womanHasband":
			dialog.text = "Oh, God, I am so grateful! And yes, take your "+FindRussianMoneyString(int(npchar.quest.money))+". And thank you again!";
		...
		case "SCQR_womanRevenge":
			dialog.text = "Excellent! Well, take your "+FindRussianMoneyString(int(npchar.quest.money))+" and jewels. Farewell...";
			link.l1 = "Farewell. ";
			link.l1.go = "SCQ_exit";
			sTemp = "SCQ_" + npchar.index;
			pchar.quest.(sTemp).over = "yes"; //снимаем прерывание смерть горожанина-квестодателя
		...
		case "SCQR_womanPirates":
			dialog.text = "Sure it's him! Oh God, captain, I am so grateful. Take your "+FindRussianMoneyString(int(npchar.quest.money))+". I will pray for you every day of my life!";
			link.l1 = "Sounds good...";
			link.l1.go = "SCQ_exit";
