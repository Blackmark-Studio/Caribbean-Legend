...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "licence_1":
			...
			dialog.text = "For "+FindRussianDaysString(int(fQty))+"? Very good. It will cost you "+FindRussianDublonString(int(npchar.quest.lcc_summ))+". Are those terms acceptable?";
