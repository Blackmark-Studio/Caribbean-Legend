...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		{
			dialog.text = "Ahoy mate, chain shot my arse! What brings you here?";
			link.l1 = "Chain shot your...what? Oh, never mind, just wanted to say hello.";
			link.l1.go = "exit";
			link.l2 = "Greetings, Mr. Knippel. Ha, I see why they call you Knippel. Anyway, there are rumours that you used to serve with the English Navy. I have a fine ship and a skilled crew. I'd like to offer myself and my ship to the service of the English Crown... er... Commonwealth. Can you give me some advice or recommend me to someone, or perhaps help me in that matter?";
		...
		if (CheckAttribute(pchar, "questTemp.HWIC.Holl"))
		{
			if (pchar.questTemp.HWIC.Holl == "toKnippel")
			{
				...
				link.l1 = "Greetings, Mr. Knippel. Ha, I see why they call you Knippel. There are rumours that you used to serve in the English Navy, which is why I want to ask you for help...";
				link.l1.go = "Dominica";
				DelLandQuestMark(npchar);
				break;
			}
			dialog.text = "Chain shot my arse! What do you want, mate?";
		...
		if (CheckAttribute(pchar, "questTemp.HWIC.Eng"))
		{
			...
			{
				dialog.text = "Ahoy, captain, I've heard some rumours about a silver convoy being intercepted...";
			...
			{
				dialog.text = "I am glad to see you, cap'n! My commander Richard Fleetwood was going to come here to get to know you himself, but an accident happened yesterday evening... Someone tried to kill him right in the middle of the street, chain shot my arse!";
		...
		break;
			...
			dialog.text = "Ahoy, chain shot my arse! What brought you here?";
...
//-------------------------------------------за Голландию--------------------------------------------------	
		case "Dominica":
			dialog.text = "Ah, is that so? And how can an old sailor, grounded long ago, help you, mate?";
			link.l1 = "See... I'm just an ordinary captain and I make regular voyages between Martinique and Curacao. I've been attacked twice by the ghost ship not far from Martinique... But here's the thing, she's no Fata Morgana or Flying Dutchman. I was able to tear her sails with ordinary cannonballs!";
		...
		case "Dominica_2":
			...
			link.l1 = "Mathias Beck, the governor of Curacao, just brushed my complaints aside. He said that the tales of the ghost ship are nonsense and my watchmen were drunk on grog. The governor of Martinique promised to send a patrol there, but his eyes told me that he couldn't be bothered to do a thing.  I can't return to Martinique while that bastard pirate 'ghost' is prowling around. My ship is small, as is my crew, and it's likely that we won't survive a third encounter with him...";
			link.l1.go = "Dominica_3";			
		break;
		
		case "Dominica_3":
			dialog.text = "'Tis a crying shame, mate. But how can I help you?";
		...
		case "Dominica_4":
			dialog.text = "Between Barbados and Martinique? Ha! A fat and rich trade lane. It sounds very much like something that bilgerat would do.";
			link.l1 = "I am not rich or fat, and I don't have money to bribe a naval captain for a military escort. But, if Sir Fleetwood is hunting for this bilge rat already, could you please tell him where he could find this 'Flying Dutchman'?";
			link.l1.go = "Dominica_5";			
		break;
		
		case "Dominica_5":
			dialog.text = "You have done a good thing by coming here. I will tell your story to the right men, chain shot my liver! Soon, you will be able to trade with Martinique again.";
			link.l1 = "I hope that God will hear your words! Thank you for listening to me, Charlie. I do hope for the best. Farewell, and dodge the chain shot!";
...
//----------------------------------------------за Англию--------------------------------------------------	
		case "Knippel_check"://начинаем проверять нашего ГГ по всем статьям
			if(makeint(PChar.reputation.nobility) < 48)//низкая репа
			{
				...
				dialog.text = "Merry Old England doesn't need services from rogues, chain shot my arse! Respectfully, you can fuck right off.";
			...
			{
				dialog.text = "Cap'n, I'll be blunt. You couldn't sail your way out of a wet sack. Come back when you have more skill in navigation, savvy?";
		...
		case "Knippel_task"://первое задание
			...
			DelMapQuestMarkCity("SentJons");
			dialog.text = "Ah ha! I see your spirits are high, captain! Soon, fire will follow! Now listen closely. The Dutch West India Company's silver fleet left Willemstad on Curaçao one or two days ago. It is sailing to Philipsburg. There are only a few ships in the fleet this time. A single galleon with the silver in her cargo hold, along with two escorts. Intercept the silver fleet, capture the East Galleon with the silver cargo, and bring her to Antigua. You can sink the escorts, they're expendable. Chain shot their livers, yar!";
		...
		case "Knippel_task_1":
			dialog.text = "Some advice, cap'n. The trade lane from Curacao to Sint Maarten lies not far from the shores of St. Christopher. I would advise preparing an ambush there. Prepare yourself and your ship well for this engagement. Tangling with the West India Company is no walk in the park with a pretty girl.";
			link.l1 = "I know what I'm getting into, but I appreciate your candour, Mr. Knippel. I'll be back with the Dutch silver.";
		...
		case "HollConvoy_Check"://начинаем проверять
			...
			if (iHal > 0)
			{
				...
				{
					dialog.text = "No need to tell me what happened. I was informed about everything while the customs agent was inspecting your ship... You failed to bring back all the silver, chain shot my arse! I know exactly how much silver was on that East Indiaman, down to the very peso. This mission's purpose was not only to test your battle skills but also your honesty. You have failed the latter. Get out of my house, swabbie!";
			...
			{
				dialog.text = "Avast, matey. I don't see the Dutch East Indiaman in your squadron. I told you to bring her here as a prize. You sold her and tried to keep the money for yourself, eh?";
		...
		case "HollConvoy_noShip":
			dialog.text = "No one makes a fool of Charlie Knippel! I clearly remember what I told you and what I didn't. You have broken the terms of our deal, and no honest Englishman will work with you. There is no place for scoundrels here. Get out of my house, swabbie!";
			link.l1 = "To hell with you then, simpleton!";
			link.l1.go = "HollConvoy_fail";
		break;
		...
		case "Fleetwood_house":
			dialog.text = "I've been asking myself the same thing... Some bastard threw ground pepper in Cap'n Fleetwood's eyes and stabbed him in the chest before Richard even managed to draw his blade. The murderer hoped to finish the cap'n with a single thrust, since he didn't have time for another, but he failed. Cap'n Fleetwood always wears a cuirass under his coat\nThe filthy scum, chain shot his liver, managed to flee and go to ground. It looks like he has friends in town. The only detail the cap'n remembers is that the assassin has only one eye. It won't help us much though, there are plenty of Cyclops like him roaming the docks these days\nRichard has lost a lot of blood and the pepper has irritated his eyes so badly that he is almost blind now...";
			link.l1 = "Ground pepper? That's an expensive way to blind someone. Fleetwood must have really angered someone. I am sorry for your captain. Has the search for the attacker turned anything up?";
			link.l1.go = "Fleetwood_house_1";
		break;
		
		case "Fleetwood_house_1":
			dialog.text = "Cap'n Fleetwood's marines have searched the whole town and the local bays, but they didn't find a thing, chain shot their necks! If we failed to find him right after the attack, there's no hope of finding the bastard now. Cap'n Fleetwood has a lot of enemies... But, cap'n, my commander wants to see you anyway despite the incident. He's resting at his house now, so let's go to him. Follow me!";
		...
		case "Knippel_ToOfficer":
			dialog.text = "Listen, Cap... Cap'n Fleetwood is safe and in good hands now. I want to help you take revenge on the bastard who attacked him. I offer you my services as a gunnery officer. I'm not much good at fencing, too old for that, but I can knock the topgallants off a merchantman at a thousand paces.";
		...
		case "hired":
			dialog.text = "Ahoy, captain! Need something?";
			link.l1 = "No, nothing.";
			link.l1.go = "exit";
		...
		case "MC_GoAway":
			...
			{
				dialog.text = "You are a complete buffoon, chain shot my arse! You failed to do an elementary task - to capture the 'Mirage' without losing the 'Valkyrie'\nOur crew won't serve under your command any longer. We are sure that Sir Fleetwood will approve our decision, he likes idiots as little as we do.";
				link.l1 = "To hell with you and your master!";
				link.l1.go = "exit";
			}
			if (pchar.questTemp.HWIC.Eng == "GotoBridgetown" || pchar.questTemp.HWIC.Eng == "SeekVanBerg")
			{
				dialog.text = "You are a complete idiot, chain shot my arse! We have wasted too much time solving your personal problems\nOur crew won't serve you any longer. We are sure that Sir Fleetwood will approve our decision, he likes idiots as little as we do.";
				link.l1 = "To hell with you and your master!";
				link.l1.go = "exit";
			}
			if (pchar.questTemp.HWIC.Eng == "VanBergFailInWorld")
			{
				dialog.text = "You are a complete idiot, chain shot my arse! You were told to play a lone merchant on the 'Valkyrie', and what did you do? You scared the pirate off with your flotilla!\nWe are sure that Sir Fleetwood will approve our decision, he likes idiots as little as we do.";
				link.l1 = "To hell with you and your master!";
				link.l1.go = "exit";
			}
			if (pchar.questTemp.HWIC.Eng == "MirageTake")
			{
				dialog.text = "You are a complete idiot, chain shot my arse! Did you decide to waste our time doing anything but capturing the 'Mirage' and sailing to Antigua?\nOur crew won't serve you any longer. We are sure that Sir Fleetwood will approve our decision, he likes idiots as little as we do.";
			link.l1 = "To hell with you and your master!";
			link.l1.go = "exit";
			}
		...
		case "OnCuracao_1":
			dialog.text = "Cap'n, listen... There's no need to go anywhere now.";
			link.l1 = "What are you talking about? This is nonsense!";
			link.l1.go = "OnCuracao_2";	
		break;
		
		case "OnCuracao_2":
			dialog.text = "I have a letter from Cap'n Fleetwood for you. And the money. But this money is not for Abigail's father, it's for you. Two hundred thousand pesos. Read the letter and try not to judge him too harshly...";
		...
		case "OnCuracao_4":
			dialog.text = "Did you read it, cap'n? I'll be frank. I'm ashamed of Cap'n Fleetwood and what he did, chain-shot his... ah, damn this. Rodenburg was enraged when he learned about Abigail's romance with Richard. Foot patrols are scouring Curacao and there are Company military ships cruising the local waters. We need to get the hell out of here.\n Captain, do you need a gunner? I don't need luxury - just a normal sea ration on a regular basis. I'm not much good at fencing, too old for that, but I can knock the topgallants off a merchantman at a thousand paces.";
			link.l1 = "Well, damn, I'd like to see you pull that off, Mr. Knippel. Welcome to the crew!";
			link.l1.go = "Knippel_hire";
			link.l2 = "I regret helping you English scoundrels in the first place. I don't know how to get out of this mess now. Walk your own road, I've had enough of surprises.";
...
//------------------------------------------------против всех-----------------------------------------------
		case "Knippel_abordage":
			...
			link.l1 = "Dutch ship? Haha! Don't make me laugh, 'Dutchman'. I attacked your brigantine to capture you, dear Charlie. Welcome to my cargo hold. We'll have a talk about where you were sailing and why...";
		...
		case "Knippel_prisoner":
			...
			link.l1 = "Relax, sermonizer. You preach like a Puritan. You'd better see to the state of your own soul first.";
		...
		case "Knippel_prisoner_2":
			dialog.text = "Do you want to kill me? Fitting for a bastard like you. *spits* Damn you!";
		...
		case "Knippel_officer":
			dialog.text = "Ahoy, captain, chain shot my arse!";
			...
			{
				dialog.text = "Cannonball to my liver, Cap’n. I ain’t settin’ foot on land again. Last time I was throwin’ dice in the tavern, some bastard cleaned out my pockets down to the last coin.";
				Link.l1 = "Ha-ha, you sure you didn’t just lose it all at the table, "+npchar.name+"? Doesn’t matter anyway... I wanted to talk to you. I’ve decided to sail to Europe — as a passenger, aboard someone else’s ship. I don’t know when I’ll be back. I won’t ask you to wait, and I won’t drag you along either.";
				Link.l1.go = "SharlieEpilog_Knippel_1";
				break;
			}
			if (CheckAttribute(pchar, "questTemp.Dolly_Tieyasal") && !CheckAttribute(npchar, "quest.Tieyasal"))
			{
				Link.l4 = "Mr. Knippel, I am going to the ancient lost Indian city of Tayasal. Let me be clear, this is going to be a very dangerous journey and also an unusual one – we need to get there through this... magic idol. Will you join me?";
				Link.l4.go = "tieyasal";
			}
			...
			{
			    Link.l11 = "Mr. Knippel, give me a full report on the ship.";
		...
		/////////////////////////// ответы для казначея ///////////////////////////////////
		case "QMASTER_1":
			dialog.Text = "Sink me... The guns are all right, we replace the ones that explode and keep our powder dry and safe. What kind of report did you expect, Captain? I am an old cannoneer, not a purser. Chain shot my arse, I am the best cannoneer in the Caribbean though, mind you!";
			Link.l1 = "No arguing here, Mr. Knippel, you do know your trade. I will find a purser myself, don't you worry.";
			Link.l1.go = "exit";
		break;	

		case "QMASTER_2":
			dialog.text = "You want old Charlie to trade his gun deck for the quarterdeck? Captain, I sink ships, I don't haggle for every peso. And I'm certain they'll cheat me in the very first colony we try this.";
		...
		case "Companion_TaskChange":
			dialog.Text = "So what is your wish?";
			Link.l1 = "I would prefer you not to exchange your ship for another after boarding. Your ship is too valuable.";
	...
	// на Тайясаль
		case "tieyasal":
			dialog.text = "I have grown really attached to you during my service, "+pchar.name+", and I don't leave my cap'n in the lurch. I'd follow you through hell if need be. I'm with you!";
			link.l1 = "Thank you, Mr. Knippel! I'm glad I was right about you.";
			link.l1.go = "tieyasal_1";
		break;
		
		case "tieyasal_1":
			dialog.text = "When will we start, blast my eyes?";
		...
		case "SharlieEpilog_Knippel_1":
			dialog.text = "Well, that's a damn shame, cannonball to my rig. I wouldn’t mind seein’ Europe, truth be told.";
			link.l1 = "Didn’t expect to hear that from you. Well then, welcome aboard the pinnace '"+GetShipName("Ulysse")+"'. If you're up for it, we could pay a visit to our old pal Richard Fleetwood. I’m sure you’ve got something to say to him.";
			link.l1.go = "SharlieEpilog_Knippel_2";
		break;

		case "SharlieEpilog_Knippel_2":
			dialog.text = "No, sir. To hell with Richard. Don’t wanna hear his name, let alone see his face.";
			link.l1 = "As you wish, "+npchar.name+", as you wish. We set sail in two weeks. I’m throwing a farewell bash. Hope you’ll join us.";
			link.l1.go = "SharlieEpilog_Knippel_3";
		break;

		case "SharlieEpilog_Knippel_3":
			dialog.text = "May a cannonball snap my neck if I say no, Captain!";
			link.l1 = "Excellent. Then I’ll see you at the tavern once I’ve wrapped everything else up.";
			link.l1.go = "exit";
			NextDiag.TempNode = "Knippel_officer";
		...
		case "Man_FackYou":
			dialog.text = LinkRandPhrase("You are a "+GetSexPhrase("Thief, mister! Guards, seize him","Thief, girl! Guards, seize her")+"!!!","Just look at that! The moment my back was turned, you decided to check my chest! Catch the thief!!!","Guards! Robbery! Catch the thief!!!");
			link.l1 = "Damn it!";
			link.l1.go = "exit";
