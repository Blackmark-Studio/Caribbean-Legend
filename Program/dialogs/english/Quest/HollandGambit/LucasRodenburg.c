	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			if (CheckAttribute(pchar, "questTemp.HWIC.CanTake") && !CheckAttribute(pchar, "questTemp.HWIC.CanTake.Holl"))
			{
				...
				link.l1 = "I hear that you are hiring captains.";
		...
		if (CheckAttribute(pchar, "questTemp.HWIC.Holl"))
		{
			...
			{
				dialog.text = "Ah, kapitein, there you are! I didn't see you coming, I have just finished reading Ridderbrock's letter. You made quite an impression. He calls you the 'guardian of merchants and scourge of pirates. God's gift to the Company!' What do you say to that?";
				link.l1 = "I'd prefer to remain just an ordinary captain. An ordinary, yet wealthy captain.";
			...
			if (pchar.questTemp.HWIC.Holl == "SantiagoTripFinal")
			{
				...
				dialog.text = "Ah, kapitein! I admit I was starting to worry. How did it go?";
				link.l1 = "It was not without trouble, but I'll tell you about that later. Business first. Señor "+GetFullName(sld)+" told me to tell you the following: 'this man has to die.' Then Geraldi will consider the incident settled. Also, he said that this decision is the will of their family.";
			...
			{
				dialog.text = "Glad to see you, kapitein! It's good that you came to see me.";
				link.l1 = "Good day, mynheer. I take it you have another Company job for me?";
			...
			if (pchar.questTemp.HWIC.Holl == "JacobTakeShip")
			{
				...
				{
					dialog.text = "I told you to moor your ship. Are you too stupid or ignorant to follow direct orders?";
					link.l1 = "Neither, mynheer. I am on my way.";
					link.l1.go = "exit";
				}
				else
				{
					dialog.text = "So, you have moored your ship. Now I will lend you my xebec. Are you ready to begin this mission immediately? My ship is well equipped and ready to sail, so there is nothing left for you to worry about.";
					link.l1 = "Yes, of course. I am ready, Mynheer Rodenburg.";
			...
			if (pchar.questTemp.HWIC.Holl == "MirageTake")//а вот теперь начинается дурдом с перебором кораблей
			{
				...
				{
					dialog.text = "Kapitein... I am already aware of your voyage.";
				...
				if (iMir == 0 && iMef == 0)//а это вообще плохо
				{
					...
					dialog.text = "Here you are, Kapitein... I already know everything about your journey.";
					link.l1 = "Is that so? So you must know that...";
			...
			{//опять начинаем проверять корабли
				...
				{
					dialog.text = "I was informed of your arrival, kapitein. I also know that you lost my Mirage in battle.";
					link.l1 = "You are well informed, Mynheer Rodenburg. Despite all my efforts, we weren't able to save her.";
			...
			if (!CheckAttribute(pchar, "questTemp.HWIC.Holl.LucasMoney") && pchar.questTemp.HWIC.Holl == "AbbyAgreeMarried")
			{
				...
				link.l1 = "Not only that, I have solved your other problems as well. I have found the island and Señor Shneur's lost fortune. Solomon is happy and Abigail will say yes to your proposal. Congratulations, mynheer!";
				link.l1.go = "Abby_2";
				DelLandQuestMark(npchar);
				break;
			}
			if (pchar.questTemp.HWIC.Holl == "NotFindAbbyIsland")
			{
				...
				link.l1 = "Yes. I had a talk with Abigail and her father. There is a problem, mynheer: her father's lost fortune. Abigail feels unworthy of you, she fears people's gossip and whispers if she, as a dowryless girl, were to marry a gentleman such as yourself. I hope that you understand.";
				link.l1.go = "Abby_6";
				DelLandQuestMark(npchar);
				break;
			}
...
//------------------------------------------------1 задание--------------------------------------------
		case "Holl_start":
			...
			link.l1 = "I am the captain "+pchar.name+", my ship and  can be of use to you.";
		...
		case "Holl_start_1":
			...
			dialog.text = "Very well, we shall see the colour of your mettle. All right, Kapitein whatever-your-name-is, do you know Balthazar Ridderbrock? No? How fortunate. Greedy, grumpy, hot-tempered fools like him are a rare sight.\nBut it seems that such remarkable qualities were not enough for the man, so he was clever enough to offend a filibuster by the name of "+GetName(NAMETYPE_ORIG,pchar.questTemp.HWIC.Holl.PirateName,NAME_NOM)+" in the local tavern and called the guard on him the very moment the offended party touched a sword...";
			link.l1 = "...and they had the pirate hanged with the first free rope?";
		...
		case "Holl_start_3":
			...
			link.l1 = "I suppose my good fortune is about to end. When will I meet Mynheer Ridderbrock?";
			link.l1.go = "Holl_start_4";			
		break;
		
		case "Holl_start_4":
			dialog.text = "Imminently. The good people of Philipsburg are awaiting a shipment of sugar, one which our mutual acquaintance Ridderbrock promised to deliver. I don't consider the man worth the leather of his boots, but alas, he works for us, so get yourself to the harbor office. Find Ridderbrock there and tell him that I ordered him to set sail immediately.\nYou shall shadow him, and... escort him to Philipsburg in one piece. I don't want "+GetName(NAMETYPE_ORIG,pchar.questTemp.HWIC.Holl.PirateName,NAME_NOM)+" to send the Company's reputation to the bottom of the Caribbean along with his cargo.";
...
//----------------------------------------------задание 1а--------------------------------------------	
		...
		case "SantiagoTrip_1":
			...
			link.l1 = "I suppose I should be honoured. What's the matter?";
			link.l1.go = "SantiagoTrip_2";
		break;
		
		case "SantiagoTrip_2":
			sld = characterFromId("Santiago_usurer");
			dialog.text = "I cannot give you exact details, but be aware that this is not my job, it is the Company's, so you have a chance to get into our good graces, which I assure you are very profitable.\nSail to Santiago in Cuba and deliver this package to Don "+GetFullName(sld)+". He holds a high position at Geraldi's bank and he is also my... our business partner. You are to deliver this gold to him, which I will give you right now. I trust your honesty, kapitein. Well, if not your honesty, then your survival instinct. The Company always finds those who try to steal from us.";
		...
		case "SantiagoTrip_3":
			...
			dialog.text = "At the moment, I do not doubt you. Trust me, I wouldn't even be talking to you about this matter if I did. Know that we wasted a lot of time lining this job up, so you have only fifteen days to deliver."+sTemp+"\nMy message and package must be delivered on time. This is vital, boy. Hurry, but be careful, this isn't going to be an easy job.";
		...
		case "SantiagoTrip_4":
			...
			dialog.text = "Let's just say that I have my suspicions. Don't worry, if you do it as quickly as you did the last job, then you will have a chance to become a valuable agent for the Company's delicate matters.";
			link.l1 = "All I have to do is deliver this letter and money to the banker in Santiago within fifteen days? Doesn't sound too difficult on the surface.";
			link.l1.go = "SantiagoTrip_5";
		break;
		
		case "SantiagoTrip_5":
			dialog.text = "Not so fast, boy... I take it you don't quite grasp the gravity of this situation. Doing this job will make me very much obliged to you. On the other hand, failing it will make me very pissed off. In that case, I'll piss on you. Do we understand each other, kapitein "+GetFullName(pchar)+"?";
			link.l1 = "Point taken. You have my word. I will do my best to keep you in a good mood.";
		...
		case "SantiagoTrip_8":
			dialog.text = "'Has to die'... just like that. I didn't see that coming. Hm. You have done your job well, kapitein. Now give me a debrief.";
			link.l1 = "Nothing special... it was a milk run.";
			link.l1.go = "SantiagoTrip_9";
			link.l2 = "I was stunned and kidnapped by a man in Santiago. He was very interested in your business with Geraldi. I managed to escape, but had to kill him first. The only clue he left was the name of some man called Gaston. I have no idea what it was all about.";
			link.l2.go = "SantiagoTrip_10";
			link.l3 = "I was stunned and kidnapped by a man in Santiago. He was very interested in your business with Geraldi. I managed to escape, but I had to kill him first. I wasn't able to get anything out of him before I sent him to hell.";
		...
		case "SantiagoTrip_10":
			dialog.text = "What! Kidnapping... Wait, though... Gaston! I see... I suppose. Alas, my boy, you've been dragged into a sordid affair. We're in uncharted waters, so we'll have to see how it unfolds. I'm glad you made it out alive.\nLet's talk about more pleasant things – accept this reward, it's well deserved.";
			link.l1 = "Working for the Company is quite profitable";
			link.l1.go = "SantiagoTrip_12";
		break;
		
		case "SantiagoTrip_11":
			dialog.text = "Nonsense! Kidnapping you... I do have some suspicions, though. You'll learn more if you continue working for me. You are lucky, and I am glad that you made it.\nLet's talk about more pleasant things – accept this reward, it's well deserved.";
			link.l1 = "Working for the Company is quite profitable";
			link.l1.go = "SantiagoTrip_12";
		break;
		...
		case "SantiagoTrip_12":
			...
			dialog.text = "Exactly, my boy! You can become a well-compensated agent of the Company if we continue to work together. Now go, take a rest from your voyage. You have lived up to my expectations. I would be truly grateful if you came back in a week, we still have a lot of work to do.";
...
//-----------------------------------------------2 задание--------------------------------------------
		case "JacobBerg":
			dialog.text = "You are clever, captain. Exactly. Well, let's discuss the details of the upcoming mission...";
			link.l1 = "I am all ears.";
			link.l1.go = "JacobBerg_1";			
		break;
		
		case "JacobBerg_1":
			dialog.text = "I have a very serious and important mission for you, and I expect you to do everything according to my instructions. As you know, the relationship between the United Provinces and England is... not cordial. The Brits are convinced that they alone should rule the world. The problem is - not everyone tends to agree with such a claim. Wherever they sail to do business, rest assured that the Dutch West India Company has already been there first.\nWe Dutch have the largest trade fleet in the world, and our military squadrons can defend the Republic's interests both here and abroad. The English envy us for our trading power, and they are doing what they can to sabotage the Company's activities. Now, there is a certain English navy captain named Richard Fleetwood. Despite being a commissioned officer of the Commonwealth, he is currently operating as a pirate. He attacks and plunders any ship daring to sail under the Dutch flag in the Caribbean. He explains his actions as countermeasures to the 'ghost ship' which sinks English traders. He claims that this 'ghost ship' is a privateer sailing under a Dutch letter of marque.\nHave you heard about the 'ghost ship', kapitein?";
			link.l1 = "You can hear that kind of nonsense in any tavern. Just buy some rum for an old boatswain and you'll hear any story you want...";
			link.l1.go = "JacobBerg_2";
		break;
		
		case "JacobBerg_2":
			dialog.text = "This matter is no drunkard's fantasy. I have investigated the actions of this 'ghost ship'. I found out that she is a ship of wood and canvas, crewed by ordinary men, a ketch named 'Mirage'. She is under the command of a man named Jacob van Berg, who is passing her off as the legendary 'Flying Dutchman'.";
			link.l1 = "Van Berg? That's a Dutch surname. A bona fide 'Flying Dutchman', eh?";
			link.l1.go = "JacobBerg_3";
		break;
		
		case "JacobBerg_3":
			dialog.text = "Correct. Jacob van Berg is a Dutchman, originally from Leiden. But the Republic sentenced him to the gallows a long time ago. He is a criminal on the run, a pirate who acts only in his own interests. Richard Fleetwood is hunting van Berg. This fact we'll use against that insolent Englishman.\nI would prefer not to kill Fleetwood outright, though he deserved it long ago. Death would not be enough for him. I want not only to kill him, but also to destroy his name and honour. That is what I want. That will also teach the other arrogant English swine a lesson.\nLet's talk details.";
			link.l1 = "Mynheer, this is starting to sound like something personal...";
			link.l1.go = "JacobBerg_4";
		break;
		
		case "JacobBerg_4":
			dialog.text = "That is none of your concern. You will follow orders, then you get paid. I have found out where Jacob van Berg lurks with his 'Mirage', thanks to my agent. He operates out of a city in the southern Spanish Main. Go to him and find out where he has moored his ghost ship\nThen kill him, find his 'Mirage', take her as a prize, and deliver her back here. You must capture the 'Mirage', don't even think about sinking her.";
			link.l1 = "Sounds simple enough. Where should I look for van Berg?";
			link.l1.go = "JacobBerg_5";
		break;
		
		case "JacobBerg_5":
			dialog.text = "All details will be provided to you by my agent. His name is Longway, a Chinese man. I am providing you with my personal ship, the xebec 'Meifeng', for this mission. Longway is her captain, but he will take orders from you.\nGo to the local harbour office and moor all your vessels there. Return to me once it's done.";
			link.l1 = "Fine, I will visit the harbour master. I won't make you wait for too long.";
			link.l1.go = "exit";
		...
		case "JacobBerg_6":
			dialog.text = "Longway is waiting for you outside. He will show you your new ship and give you some information regarding van Berg's location. Good luck, kapitein, and don't let me down. Remember that you must bring the 'Meifeng' back to me, so try not to sink her while taking the 'Mirage'.";
			link.l1 = "On my way!";
		...
		//дурдом продолжается
		case "Jacob_lostMir":
			dialog.text = "You incompetent fool. You have failed your mission to capture the pirate vessel. All my plans are ruined. I am taking 'Meifeng' away from you. Get out, we no longer need you.";
		...
		case "Jacob_failFull":
			dialog.text = "My God, you are truly a rare specimen. An incompetent bungler AND an idiot. You failed to capture the Mirage and lost the Meifeng along with it. Get the fuck out of my office!";
			link.l1 = "I'm leaving.";
			link.l1.go = "exit";
...
//----------------------------------------------3 задание-------------------------------------------------
		...
		case "Fleetwood_2":
			dialog.text = "A word of advice, kapitein. Do not drop anchor at St. John's. Land at one of the island's bays and walk to the city through the jungle, otherwise John won't talk to you. If you draw too much attention to yourself, he will pretend he doesn't know you. Also, be careful at sea - the 'Mirage' is notorious among the English colonies, so avoid their warships and settlements if you don't want to be set upon by a pack of sea wolves. That is all. God be with you.";
			link.l1 = "Aye aye.";
		...
		case "Fleetwood_complete":
			...
			{
				dialog.text = "You have returned, kapitein... Do you have Richard Fleetwood's logbook?";
				link.l1 = "Unfortunately, I didn't. I managed to board the Valkyrie and kill the man in hand-to-hand combat, but I didn't find his journal. One of his men set fire to the magazine and we only had seconds to escape with our lives.";
				link.l1.go = "Fleetwood_complete_1";
				break;
			}
			dialog.text = "You have returned, kapitein... Do you have Richard Fleetwood's logbook?";
			link.l1 = "I did. Here it is. I managed to board the Valkyrie, although it was a near-run thing. The bastard fired his magazine at his ship and blew it sky high. We barely got away with our lives.";
			link.l1.go = "Fleetwood_complete_2";
		break;
		
		case "Fleetwood_complete_1":
			AddMoneyToCharacter(pchar, 100000);
			dialog.text = "That is a damn shame, it would have answered many questions we have. It is of no matter now. You killed that insolent English dog and that's what matters most. Here is your reward - 100,000 pesos. I am taking the 'Mirage' from you, we are going to return this ship to England.";
			link.l1 = "What the devil?! She's a fine ship, I wanted to keep her!";
		...
		case "Fleetwood_complete_3":
			dialog.text = "My boy, you are an excellent soldier, but trust me and my experience in matters of politics. Remember what I said about Fleetwood? I am going to nail his name and reputation to a millstone and fling it into the depths. And these arrogant nobles from Port Royal will have to swallow and choke.\nWe are going to make Richard Fleetwood the captain of the 'ghost ship' Mirage, a werewolf playing the two nations of England and the Netherlands off against each other, plundering, pillaging, and murdering peaceful citizens of both just to make himself rich! What a travesty! I have already prepared evidence and witnesses, but the 'Mirage' will serve as the main event of my perfect play.";
		...
		case "Fleetwood_complete_5":
			...
			link.l1 = "That does take the sting out of my losses a bit. I am honoured. By the way, mynheer, where has Longway gone?";
			link.l1.go = "Fleetwood_complete_6";
		break;
		
		case "Fleetwood_complete_6":
			dialog.text = "Longway suddenly disappeared right after I ordered him to sail to Dominica. I suspect that English agents may have set upon him... or perhaps not. I am investigating.";
			link.l1 = "I see. His help at Dominica would have been most welcome. Fleetwood and his 'Valkyrie' made a fearsome pair. I hope that Longway is still alive... Tot ziens, mynheer!";
		...
		case "Fleetwood_fail_1":
			...
			link.l1 = "I suppose I'll just go fuck myself then! Thanks for nothing!";
			link.l1.go = "exit";
		...
		case "LucasAward":
			dialog.text = "Kapitein "+GetFullName(pchar)+"! For eliminating Richard Fleetwood, a dangerous state criminal, for exposing the treacherous English conspiracy against the Republic, for bravery and courage, you are awarded one thousand golden doubloons on behalf of the Dutch Republic!\nYou are also to receive this valuable navigation tool - the dream of any naval officer.";
...
//--------------------------------------------------4 задание----------------------------------------------
		...
		case "Abby_0":
			...
			link.l1 = "Ha! Of course I remember that, Mynheer Rodenburg. Isn't that an officially recognized fact, after all? I won't waste any time then, I'll go pay your beloved a visit at once.";
			link.l1.go = "Abby_1";			
		break;
		...
		case "Abby_2":
			dialog.text = "Have you really found the island where Solomon stashed his gold? This is excellent! I was starting to think you could accomplish any task... Did you find anything else in the stash?";
			...
			{
				link.l1 = "There was an interesting item - a jade skull. I gave it to Solomon, and he said it was a family heirloom. He also mentioned that you were planning to buy it from him...";
				link.l1.go = "Abby_4";
			}
		break;
		...
		case "Abby_5":
			dialog.text = "I don't have any job worthy of a kapitein like you at the moment. But don't leave Curacao for too long, soon I will need your services again.";
...
//-------------------------------------------5 задание-------------------------------------------------
		case "Merdok":
			dialog.text = "Yes, exactly so. My friend, sometimes it's hard to tell who is your friend and who is your enemy. Sometimes you fail to notice when your closest associate becomes your nemesis. Our mutual acquaintance from St John's, John Murdock – also known as Johan van Merden – is a former agent of the Company who has sold himself to the English Navy.\nHis latest mission is to eliminate one of the Company's brightest stars... you.";
		...
		case "Merdok_2":
			dialog.text = "One more thing, kapitein. Once Johan is dead, search his corpse, the house, and the basement. He has an archive—a fat ledger in which he wrote some damning notes during his work for the Company. This information will destroy us all if our enemies find it.\nFind that accursed archive and deliver it to me, and I will pay extra for it. Now go. Godspeed, Kapitein "+pchar.name+", and try to return in one piece. The Republic needs you!";
			link.l1 = "I promise you, mynheer, to return in one piece. That is most assuredly in my best interest!";
			link.l1.go = "Merdok_3";
		break;
		...
		case "Merdok_4":
			dialog.text = "Excellent, captain! I am glad, I truly am. Did you find his archive?";
			...
			link.l2 = "No. I looked everywhere for it but found nothing.";
			link.l2.go = "Merdok_5";
			DeleteAttribute("SentJons_TownCave", "box2");//если не нашли шифр - уже и не найдем
		break;
		
		case "Merdok_5":
			dialog.text = "That's a pity for sure, but I am fine with that. I am sure that Johan didn't have enough time to give it to the English, otherwise we'd already have nooses around our necks... It's likely that he hid it in some secret stash... let it stay there forever! I congratulate you, kapitein, on the successful conclusion of our mission!";
			link.l1 = "Gratitude!";
			link.l1.go = "Merdok_6";
		...
		case "Merdok_book_2":
			...
			if (IsCharacterPerkOn(pchar, "Trustworthy"))
			{
				...
				link.l1 = "(Trustworthy) I apologise. My only fault was not checking the archive myself beforehand.";
		...
		case "VD_Merdok_book_3":
			dialog.text = "So, it's a lack of care or curiosity rather than dishonesty or a secret agenda? Do you think it was already like this when you found it?";
		...
		case "Merdok_6":
			dialog.text = "We did well, you and I, kapitein. It is no exaggeration to say that none of this would have happened without you. You will reach incredible heights in your career if you continue to serve the Republic, perhaps even be ennobled.";
			link.l1 = "I suppose this is goodbye, Mynheer Rodenburg.";
			link.l1.go = "Merdok_7";
		break;
		
		case "Merdok_7":
			dialog.text = "It is goodbye, "+pchar.name+". I have accomplished everything I wanted here, so I am departing for home to Amsterdam in a week. My new wife Abigail and my father-in-law Solomon will accompany me. Peter Stuyvesant has already found a new Company vice-director, so talk to him if you need anything\nFor your service I present you the Meifeng. She is yours now, kapitein, you deserve her.";
			link.l1 = "Thank you, Mynheer Rodenburg. I have grown quite attached to the Meifeng and have already started to consider her my own.";
			link.l1.go = "Merdok_8";
		break;
		
		case "Merdok_8":
			dialog.text = "And now I have to ask you to leave me, my boy. I have a lot of things to do before we set sail... Visit me in Amsterdam one day! We will share a drink and remember the good old times...";
...
//----------------------------------------------за Англию------------------------------------------------------
		...
		case "Lucas_abordage_1":
			...
			dialog.text = "From the depths of hell I will shit in your mouth! I just set the cargo hold ablaze and the fire will soon spread to the gunpowder magazine! Our ships are grappled in close quarters so there is no hope of escape! You will burn or feed the sharks!";
...
//----------------------------------------------против всех--------------------------------------------------
		case "LucasPrisoner":
			dialog.text = "Why are you here, you bastard? Here to mock me? Perhaps you will finally tell me what your role is in this play. It was you who captured the brigantine, correct? Was this your plan from the beginning?";
			link.l1 = "I am here to deliver a message, Lucas Rodenburg. Best regards from John Merdock, the man you betrayed. You were my assignment, and I completed it. Farewell for now.";
		...
		case "LucasPrisoner_1":
			...
			link.l1 = "Save your breath for the hangman's court, Rodenburg.";
