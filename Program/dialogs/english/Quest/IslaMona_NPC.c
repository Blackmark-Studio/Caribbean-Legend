void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Himenes":
			dialog.text = "Ha-ha-ha! Señor Jesucristo! Glory to Santiago the Protector! Glory to the Virgin Mary! We are saved! Ha-ha-ha!";
			link.l1 = "Spaniards! To arms!";
			link.l1.go = "Himenes_1_1";
			link.l2 = "Hello. I understand you're having some trouble? Who are you?";
		...
		case "Himenes_2":
			dialog.text = "Ha-ha! Señor, my name is Rodrigo Jimenez. I am a surveyor and, by fate's will, el jefe of these unfortunate people.";
			link.l1.go = "Himenes_3";
		break;
		
		case "Himenes_3":
			dialog.text = "We... were landed here. But, señor, we are not criminals! Ha-ha-ha-ha!";
			link.l1 = "What's funny?";
			link.l1.go = "Himenes_4";
		break;
		
		case "Himenes_4":
			dialog.text = "Ah... I apologise, señor! It's my affliction, since childhood I've laughed when I'm very nervous. Ha.";
			link.l1 = "And you were chosen as the leader?.. Fine. People don't just land on uninhabited islands for no reason, señor. Care to explain? I'm giving you only one chance.";
		...
		case "Himenes_5":
			...
			link.l1 = nationManName[int(pchar.BaseNation)]+". Is that so important? Let's not worry about my name for now.";
			link.l1.go = "Himenes_6";
		break;
		
		case "Himenes_6":
			dialog.text = "Indeed, being recognised as heretics by the Catholic Spanish Church, we must appear before the righteous court of the Holy Inquisition. That's why your nationality is so important to us. A Spanish captain would be obliged to surrender us to the local authorities. We wouldn't survive such a thing again! Ha-ha!";
			if (int(pchar.BaseNation) == SPAIN) dialog.text = "Ha-ha-ha-ha-ha-ha! Such is our luck, well, there is nothing for us to lose anyway. "+dialog.text;
		...
		case "Himenes_7":
			dialog.text = "No, I swear to you! Our community was engaged in crafts and trade in the glorious city of Cadiz for fifty years. Everything was going well, we even acquired a ship and a licence for trading with the colonies of our Empire. Now I understand that back then we crossed some line and were completely unprepared for our new competitors... and their methods.";
			link.l1 = "You didn't trade with someone in Europe and, as a result, the entire community got stranded on a deserted island in the Caribbean? And here I thought I had problems...";
		...
		case "Himenes_9":
			dialog.text = "Yes! Ha-ha-ha! On our own ship! We were heading to Curaçao to build a new home and a new business. However, we underestimated the persistence of the Inquisition and paid dearly for it. Their courier intercepted us not far from here and ordered the captain to take us back home...";
			link.l1 = "Damn!";
			link.l1.go = "Himenes_10";
		break;
		
		case "Himenes_10":
			dialog.text = "There's more! Ha! Our captain didn't want to bother taking us back across the Atlantic or releasing us from his responsibility at the nearest port. And, making a truly Solomon-like decision, he gave us food, landed us here, and that was that.";
			link.l1 = "A tragic story indeed, no doubt about it. Let's summarise: you can't go home, friendly colonies will report you, and foreign ports won't welcome you either - there's no end to the war in this region. What are your plans?";
		...
		case "Himenes_11":
			...
			link.l1 = "I don't think so, there's a better island.";
		...
		case "Himenes_14_1":
			dialog.text = "New World! Indeed, we are here. Back home, they say pirates are real demons and not even human. Eating children, raping women, and skinning good Catholics alive. Is that true?";
			link.l1 = "It depends on the day of the week. Let's discuss this another time. I'm looking for people. Hardworking and capable individuals willing to live far from civilisation for several years. Would you be interested in something like that?";
			link.l1.go = "Himenes_15";
		break;
		
		case "Himenes_14_2":
			dialog.text = "Too bad, since I'm already a criminal, I'd like to see at least one pirate.";
			link.l1 = "Perhaps you'll have such an opportunity again. Let's discuss it another time. I'm looking for hardworking and capable individuals willing to live far from civilisation for several years. Would you be interested in something like that?";
			link.l1.go = "Himenes_15";
		break;
		...
		case "Himenes_15":
			...
			link.l1 = "I, Captain "+GetFullName(pchar)+", I give you my word. ?";
			link.l1.go = "Himenes_16";
		break;
		
		case "Himenes_16":
			dialog.text = "Ha-ha! We are saved! So be it! We are several families, about 30 people. All are literate, skilled in crafts and commerce.";
		...
		case "Himenes_18":
			dialog.text = "Nice to meet you, Señor Rodgar. It seems we'll have to live and work together for quite some time... Goodness, how do you stand this heat?";
			link.l1 = "";
		...
		case "Himenes_20":
			dialog.text = "If you don't mind, I'll step in: Captain, give us a day to settle in and quickly inspect the inventory and land. I'm sure Señor Rodgar has plenty of ideas about what to do with this patch of land. I think we'll make a good team.";
		...
		case "Himenes_24":
			dialog.text = "Captain, this is a nightmare. Your house is not bad, of course. But otherwise... It's impossible to live in these huts, surrounded by overgrowth, and Señor Rodgar doesn't even know what's happening at the other end of the island!! Unbelievable! Ha-ha!";
			link.l1 = "Are you nervous, or are you actually laughing about this right now?";
			link.l1.go = "Himenes_25";
		break;
		
		case "Himenes_25":
			dialog.text = "Of course, it's funny! What have they been doing all these years? First of all, we need to finish building a couple of houses and repair these huts to an acceptable condition. People need to live decently in order to work diligently. Also, I'll ask the pirates to conduct a full reconnaissance of the island. Perhaps this place is rich not only in rocks and sand. When everything is done, I'll be able to tell you exactly what to do with this land.";
		...
		case "Himenes_27":
			...
			link.l1 = "I'm inclined to believe you! Just don't accidentally build a cathedral here. Will I have to haul a lot of material here every time?";
			link.l1.go = "Himenes_28";
		break;
		
		case "Himenes_28":
			dialog.text = "No, these materials will sustain us for a while, but we'll still need to bring in some things later on. If you want to avoid such troubles in the future, bring twice as many materials.";
			link.l1 = "Well, you've convinced me. I'll see what I can do. Any deadlines?";
			link.l1.go = "Himenes_29";
		break;
		
		case "Himenes_29":
			dialog.text = "No, sir. But I kindly ask you not to delay - this is work that needs to be done to move things forward. And people need somewhere to live too. Load the materials into the warehouse and don't forget to inform me when everything is ready. Oh, I almost forgot! Talk to Mr Rodgar about exploring the island.";
			link.l1 = "Agreed!";
		...
		case "Himenes_31":
			...
			{
				link.l1 = "Hello, Jiménez. Check the warehouse.";
				link.l1.go = "Himenes_32_1";
			}
			else // не привез товары на стройку
			{
				link.l1 = "Hello, Jiménez. My men have scoured the entire island. What do you say?";
		...
		case "Himenes_32_1":
			...
			dialog.text = "You've handled this responsibility with flying colours! If you're ever in Cadiz, come work for me as a storekeeper!";
			link.l1 = "I'm on my way! Tell me, compadre, what will you do now?";
		...
		case "Himenes_32_2":
			dialog.text = "Señor Captain, let us first deal with housing and supplies. We will make plans afterward. I await the goods from your list at the warehouse.";
			link.l1 = "Alright, I understand. First, we need to build houses and tidy up this place. The goods will arrive soon.";
			link.l1.go = "Himenes_33";
		break;
		
		case "Himenes_32_3":
			dialog.text = "Captain, let us first deal with housing and supplies. We can make plans later. I am waiting for the goods from your list at the warehouse. And your pirate friend is also awaiting provisions and medicine.";
			link.l1 = "Alright, I understand. First, we need to build houses and tidy up this place. The goods will arrive soon. And for my pirate friend as well.";
			link.l1.go = "Himenes_33";
		break;
		...
		case "Himenes_34_1":
			dialog.text = "Give us six months, Captain, and you won't recognise this place.";
		...
		case "Himenes_36":
			...
			{
				link.l1 = "Don't worry, we'll figure it out. I'll handle this.";
				link.l1.go = "Himenes_35";
			}
		break;
		...
		case "Himenes_38":
			dialog.text = "Señor Captain! What do you think? Ha-ha-ha?";
			link.l1 = "It's much better. Report, Jiménez!";
			link.l1.go = "Himenes_39";
		break;
		
		case "Himenes_39":
			dialog.text = "Now you can actually live here! We've cleaned up and rebuilt all the houses, except yours, of course. Not very luxurious, but no worse than in our Belize.";
			link.l1 = "Belize has long belonged to England, Jiménez.";
			link.l1.go = "Himenes_40";
		break;
		
		case "Himenes_40":
			dialog.text = "I'm not sure if the houses know about it, Captain, ha ha!";
			link.l1 = "Now you have a place to live, and the settlement looks civilised. What's next?";
			link.l1.go = "Himenes_41";
		break;
		
		case "Himenes_41":
			dialog.text = "Look around, talk to Señor Janssen, and come back to me. We'll discuss the results of the island reconnaissance and our plans.";
			link.l1 = "Since when did you start calling Rodgar that? Weren't you constantly at odds?";
		...
		case "Himenes_44":
			dialog.text = "Captain. Señor Janssen.";
			link.l1 = "Come on, tell me the results of the island reconnaissance.";
			link.l1.go = "Himenes_45";
		break;
		
		case "Himenes_45":
			dialog.text = "Yes, Captain. I personally inspected some places with our prospector. Well, what can I say... Isla Mona is a poor, tiny, and rather unremarkable island. There is very little space for construction, the landscape is difficult, steep, and there is almost no fertile land. Three beaches, one flooded cave, dense thickets, a couple of parrots, a herd of goats, and us...";
		...
		case "Himenes_46":
			dialog.text = "Ha-ha-ha-ha! I would ask, Señor! Ha-ha! You didn't let me finish!";
			link.l1 = "";
		...
		case "Himenes_48":
			dialog.text = "";
			link.l1 = "Fine, alright, calm down and carry on. You know, I've invested a lot in this place.";
			link.l1.go = "Himenes_49";
		break;
		
		case "Himenes_49":
			dialog.text = "And not in vain! There is enough fresh water in the cave, enough soil to grow fruit-bearing trees, and goats can be bred. With fishing and the efforts of your comrades, the food issue will be resolved very quickly.";
			link.l1 = "So, you won't need to bring more food here? Not bad. I hoped that this place could survive without my constant care. Let's continue.";
			link.l1.go = "Himenes_50";
		break;
		
		case "Himenes_50":
			dialog.text = "You are right about everything, Señor. But that's not all the news! Firstly, Señor Rodgar has come up with the idea of building a tavern. I don't know what it will bring you, but this rogue is up to something.";
		...
		case "Himenes_58":
			dialog.text = "I agree with the pirate, señor. I don't understand you, captain. The whole economy of this region is based on slave labour, and it will remain so for many years to come. How are we any better?";
			link.l1 = "I will make a decision. In the meantime, tell me why you need a musket? And why exactly one?";
			link.l1.go = "Himenes_59";
		break;
		...
		case "Himenes_62":
			dialog.text = "forty measures each month. And the gold is for the future. One day you will take us from here, remember your promise? Any work must be paid for, and with your doubloons, we will pay hunters and craftsmen for their work in the settlement. Thus, we will have trade, and with it – civilisation!";
		...
		case "Himenes_63":
			...
			link.l1 = "So, what's the story with the tavern? Why not build a theatre?";
		...
		case "Himenes_65":
			dialog.text = "Captain, I warned him that you wouldn't like the idea of the house. But it's the only option. You have the largest house in... ahem, the town, we'll rebuild the ground floor into a hall, set up tables and a kitchen. We'll store drinks and food in the cellars beneath the house. We have people to cook and play music. The second floor will remain yours, and we won't touch it. We'll move all your things from the ground floor upstairs ourselves.";
			link.l1 = "Alright. So what exactly will the tavern offer us?";
			link.l1.go = "Himenes_66";
		break;
		
		case "Himenes_66":
			dialog.text = "We'll bring some culture to life, and you'll have the chance to keep about three hundred people in reserve right in the heart of the Caribbean.";
		...
		case "Himenes_68":
			dialog.text = "It's simple. We'll clear Governor's Bay of reefs, install signal lights, and build a pier. Señor Janssen claims that you'll be able to shelter three ships in the bay, or one first-class ship. And it will be more pleasant for you to return here, not dragging the dinghy along the beach every time.";
		...
		case "Himenes_69":
			...
			link.l1 = "That's all for now. I'll be back once I've decided what to build.";
			link.l1.go = "Himenes_70";
		break;
		
		case "Himenes_70":
			dialog.text = "Señor Captain, take this document. I took the liberty of writing down all the details so as not to repeat them a dozen times. Study it, bring the materials, and set the task.";
		...
		case "Himenes_72": // нода Хименеса строителя и управляющего факторией
			...
			{
				dialog.text = "Señor Captain, we need 10 slaves to work in the factory - I told you, haven't you forgotten?";
				if (GetSquadronGoods(pchar, GOOD_SLAVES) >= 10)
				{
					link.l1 = "Already delivered. Unload them and begin production.";
			...
			dialog.text = "So, Señor Captain, what do you say?";
			...
			{
				link.l3 = "Start building the plantation. It's time to recoup the investment.";
				link.l3.go = "Himenes_plantation";
			}
			if (CheckAttribute(pchar, "questTemp.IslaMona.Plantation.Slave") && IslaMona_CheckSlave())
			{
				link.l4 = "Rodrigo, the most valuable specialists and equipment have been delivered to the factory. You can start working.";
			...
			{
				link.l5 = "Rodrigo, have we finished our grand construction?";
			...
			{
				link.l5 = "Rodrigo, I’ve brought your church items.";
		...
		case "Himenes_harbour":
			...
			{
				dialog.text = "I'm afraid there aren't enough materials in the warehouse. Please, check the list again.";
		...
		case "Himenes_harbour_2":
			...
			{
				link.l1 = "It's dark, Rodrigo! We nearly crashed into your praised pier! Well done for lighting it up at least!";
				link.l1.go = "Himenes_harbour_3";
			}
			else
			{
				link.l1 = "Not bad, Rodrigo! It may seem like a small thing, but it's nice to walk along these planks to the shore. And the bay has become easier to navigate. So, I suppose now I can accommodate more ships in this little bay?";
		...
		case "Himenes_harbour_4":
			...
			dialog.text = "Yes, Captain. I must say, there's a certain pride in it. Feel free to let me know how you'd like to proceed with our big construction project.";
			...
			{
				link.l1 = "Speaking of construction. My factory should be finished by now as well. Right, Rodrigo?";
		...
		case "Himenes_tavern_3":
			...
			link.l1 = "Only now do I realise that you two share the same name! Ha-ha-ha! A Spaniard and a pirate, with the same name, built a tavern on a deserted island and are drinking together as if the Indian gods will devour everyone and end the world by sunrise! Ha-ha! I'm with you!";
		...
		case "Himenes_plantation_4":
			dialog.text = "Captain, almost everything is ready to begin operations. Housing for workers, a warehouse for raw materials, a processing area – a worthy factory has been built. We've already marked the most promising trees for logging in the jungle. Bring fifteen workers and the agreed inventory – 15 shackles and muskets – and we'll start working.";
			link.l1 = "We? You mean the slaves?";
			link.l1.go = "Himenes_plantation_5";
		break;
		
		case "Himenes_plantation_5":
			dialog.text = "Ha! Slaves will cut, settlers will process, and pirates will guard. Everyone will have work - you've embarked on a serious enterprise, Captain.";
			link.l1 = "Almost like the promised land, eh. Wait for the goods, it's time for me to go hunting.";
		...
		case "Himenes_plantation_7":
			...
			link.l1 = "Rodgar... I mean, Rodrigo! Firstly, they might leave. And secondly, if you met someone else on Turks, your fate wouldn't be any better.";
			link.l1.go = "Himenes_plantation_8";
		break;
		
		case "Himenes_plantation_8":
			dialog.text = "I know that very well, Captain. And I haven't forgotten it. Let me tell you about the operation of this factory. Starting next month, on the fifteenth day, we'll deliver forty logs of processed bacout. Of course, you don't have to come for each delivery every month - all batches will be stored and waiting for you right here, at the factory.";
		...
		case "Himenes_plantation_9":
			...
			link.l1 = "Do I have to collect all the goods at once? And what about the price, remind me?";
		...
		case "Himenes_plantation_10":
			...
			link.l1 = "Indeed, I agree! Thank you, Rodrigo. Let's get to work!";
		...
		case "Himenes_plantation_12":
			dialog.text = "Excellent! Now we'll get back to work!";
			link.l1 = "Good.";
		...
		case "Himenes_bacaut":
			dialog.text = "Of course, captain, take it. We have the following batches ready for the next shipment: "+int(pchar.questTemp.IslaMona.Factory.Part)+", that's "+int(pchar.questTemp.IslaMona.Factory.Goods)+" logs. Therefore, you owe us "+int(pchar.questTemp.IslaMona.Factory.Dublon)+" doubloons, "+int(pchar.questTemp.IslaMona.Factory.Bottle)+" bottles of rum, and "+int(pchar.questTemp.IslaMona.Factory.Bottle)+" bottles of wine, do you have all that?";
			...
			{
				link.l1 = "It seems I don't have everything. I'll bring it at once.";
				link.l1.go = "Himenes_73";
			}
		break;
		...
		case "Himenes_bacaut_1":
			...
			{
				dialog.text = "Excellent. We'll transport the bacout from the factory to your warehouse, from where you can collect it whenever you wish.";
		...
		case "Himenes_church_1":
			dialog.text = "Captain, it's awkward for me to ask about this... You've already invested a considerable sum in this place!";
			link.l1 = "A brothel?";
		...
		case "Himenes_church_2_2":
			...
			dialog.text = "You see right through me, captain. Yes, we have decent housing and pay, the sea and entertainment, families and friends. But still, something is missing, you understand?";
			link.l1 = "I can imagine.";
			link.l1.go = "Himenes_church_3";
		break;
		...
		case "Himenes_church_5":
			...
			link.l1 = "So, did the holy fathers of the Inquisition have any reason to persecute you? Are you heretics?";
			link.l1.go = "Himenes_church_6";
		break;
		
		case "Himenes_church_6":
			dialog.text = "By canonical law, we are the worst of heretics. We don't believe that communicating with God necessarily requires an intermediary from this world.";
			link.l1 = "From this world?";
			link.l1.go = "Himenes_church_7";
		break;
		
		case "Himenes_church_7":
			dialog.text = "Captain, we are not Satanists, and our community is not a sect. We are Christians, like you, but we see things from a very broad perspective. Too broad, according to some very educated and worthy people. If you ever find it in your heart to be open and understanding, then I will tell you more. But for now, just take this list. Just in case.";
			link.l1 = "You should have told me about this earlier, Rodrigo. I don't want to come back one fine day and find a witch's Sabbath or the birth of a new faith on my land! While you wait - I will make a decision.";
		...
		case "Himenes_church_10":
			...
			link.l1 = "I'll only regret it if you build something completely shoddy.";
			link.l1.go = "Himenes_church_10_1";
		break;
		
		case "Himenes_church_10_1":
			dialog.text = "Captain, all building materials are in stock! We will begin construction once you bring the listed luxury items. They will be used for jewellery and ritual tools. Again, thank you very much, Captain! Muchas gracias!";
		...
		case "Himenes_church_10_3":
			...
			if(sAdd == "")
			{
				dialog.text = "Muchísimas gracias, captain! Everything is ready, we are starting construction. Come back in a couple of months for the first service. Oh, and one more thing, the grapes are ripe! We'll make homemade wine, have a celebration, and feast in your honour!";
			...
			else
			{
				...
				link.l1 = "Sure, just give me a bit more time, please. Honestly, if it weren't for the candles, I'd think you were going to bury a treasure.";
		...
		case "Himenes_church_13":
			...
			link.l1 = "And here I thought you had got rid of that idiotic habit.";
		...
		case "Himenes_church_17":
			...
			{
				dialog.text = "Only three of them made it to us, and only one survived. The captain himself! Apparently, a very senior naval officer. But he can't help us yet - he'll have to stay in bed for at least a couple more days. By the way, captain, we heard gunshots and judging by your appearance, you did too.";
			...
			{
				dialog.text = "Only three of them made it to us, and only one survived. The captain himself! Apparently, a very serious naval officer. But he can't help us yet - he'll have to stay in bed for at least a couple more days.";
				if (i >= 50) 
				{
					link.l1 = "Last time, I left quite a few of my people here on guard duty, so there should have been a lot more of you than fusiliers. Why didn't you just throw them all back into the sea at once?";
					link.l1.go = "Himenes_church_17_1";
				}
				else 
				{
					link.l1 = "Fine, let's solve this problem. The plan is this: I'll lure them out for an open assault, and we'll do it right now. There's no point in delaying. Get ready with buckshot and muskets, pirates at the gates, the rest stay at home - and sit tight.";
		...
		case "Himenes_church_18":
			...
			link.l1 = "I know, Rodrigo. But you didn't let me finish: if even one enemy manages to break through the gates, you must all rush at him from every side. And in battle, your chances of catching a bullet or a shard diminish. Any more questions?";
		...
		case "Himenes_church_20":
			dialog.text = "Well done! It's unfortunate, of course, that such a fate befell your compatriots. But I'm grateful that once again you've taken our side.";
			link.l1 = "It wasn't easy, Rodrigo. Ordinary people would call it betrayal, and they'd be right.";
			link.l1.go = "Himenes_church_20_1";
			link.l2 = "This is my land, Rodrigo. It must always be defended, no matter who from.";
		...
		case "Himenes_church_20b":
			dialog.text = "It's unfortunate, of course, that such a fate befell your compatriots. But I'm grateful that once again you've taken our side.";
			link.l1 = "It wasn't easy, Rodrigo. Ordinary people would call it betrayal, and they'd be right.";
			link.l1.go = "Himenes_church_20_1";
			link.l2 = "This is my land, Rodrigo. It must always be defended, no matter who from.";
			link.l2.go = "Himenes_church_20_2";
		...
		case "Himenes_church_22":
			dialog.text = "Firstly, we built the church. It'll take a moment, come in. There's something to see. You've done a great deed, captain. It may not seem like it to you, but being able to communicate with God is very, very important for us. From this day on, we call Isla Mona our hogar.";
			link.l1 = "Home, sweet home? I'll definitely take a look. Did I carry all those candles for nothing?";
		...
		case "Himenes_church_24":
			dialog.text = "Everything's ready for the celebration. Well, almost: we need to tidy up here, bury the bodies of those unfortunate souls... So come to the church tomorrow and we'll begin.";
		...
		case "Himenes_church_26":
			dialog.text = "And one more thing, captain. Before the celebration, go and deal with the prisoner first. The decision must be made, and I understand it will be unpleasant either way.";
		...
		case "Himenes_church_29":
			dialog.text = "Everyone's here! Señor, we don't know what you originally wanted from this place, or how you see it for yourself now. For us, it was first a forced refuge, and now it has become a true home. Your sailors, pirates, and runaway Spanish heretics live here. Anywhere else on earth, we would have already cut each other's throats. But here, we are friends, we work, and we enjoy life. Isla Mona is not the final destination on the map of this world for any of us, but perhaps here we will spend the happiest and most fruitful years of our lives. And this is your achievement, your land, and your people. Muchas gracias, "+pchar.name+"!";
			link.l1 = "";
		...
		case "Himenes_church_31":
			dialog.text = "Alright, alright. Captain, we've gathered gifts for you – a multitude of useful and simply pleasant things. Some we brought with us, and some we made ourselves. Accept this gift with a pure heart, and the rest we'll give you through our hard work.";
			link.l1 = "Thank you... I didn't expect this. There are so few bright moments and simple acts of humanity in my odyssey... It means a lot to me, believe me.";
		...
		case "Himenes_church_32":
			...
			link.l2 = "Yes, let's savour this wonderful moment a little longer.";
		...
		case "Himenes_74":
			...
			link.l1 = "By the way, I see you've almost stopped laughing wildly at everything and nothing. The fresh air of the Caribbean?";
			link.l1.go = "Himenes_75";
		break;
		
		case "Himenes_75":
			dialog.text = "More like Rodgar's corrupting influence. Watching him, I learned to send everything to hell.";
			link.l1 = "";
		...
		case "Himenes_79":
			dialog.text = "No, I'd rather keep drinking rum and glaring at you.";
			link.l1 = "";
		...
		case "Himenes_82":
			dialog.text = "Better... don't ask. A month... I won't be drinking. Oh. I have news! The captain... has come to his senses.";
			link.l1 = "The only surviving Spaniard?";
			link.l1.go = "Himenes_83";
		break;
		
		case "Himenes_83":
			dialog.text = "Hic! Ouch! Yes, they put him in the factoría, in a house under guard.";
		...
		case "Himenes_85":
			dialog.text = "I took a swim, and everything's as good as new! We'll live and work. I'll try to keep the factoría running for as long as possible. Well, and do repairs, minor construction work. Maybe even decide about children with mine.";
			link.l1 = "Happy for all of you! It was a very nerve-racking, costly... and wonderful adventure, and I'm glad it worked out for us. Good luck to everyone, and to those of us setting sail, even more luck!";
		...
		case "Capral":
			...
			{
				link.l1 = "Corporal, stand down! "+GetFullName(pchar)+", captain of the French Navy. I order you to escort me to your commanding officer. Carry out the order!";
				link.l1.go = "Capral_1";
			}
			else
			{
				link.l1 = ""+GetFullName(pchar)+", captain of the ship called '"+pchar.ship.name+"Arrived on this island entirely by chance – for possible repairs and to replenish fresh water supplies.";
				link.l1.go = "Capral_3";
			}
		break;
		...
		case "Capral_1":
			...
			{
				dialog.text = "I beg your pardon, Captain. You're not in uniform, so I am obliged to check your officer's commission.";
				link.l1 = "See? Satisfied? Now - hurry and carry out the order, corporal!";
			}
			link.l1.go = "Capral_2";
		break;
		...
		case "Capral_3":
			...
			link.l1 = "Requisition the ship Charles Prince? I don't think so!";
			link.l1.go = "Capral_5";
		...
		case "Capral_6":
			if (CheckCharacterItem(pchar, "patent_fra"))
			{
				dialog.text = "Captain, the path to the enemy camp is to our right. I'll escort you.";
		...
		case "FraOfficer":
			if (CheckCharacterItem(pchar, "patent_fra"))
			{
				dialog.text = "Captain "+GetFullName(pchar)+"! Thank God! Allow me to introduce myself - Lieutenant "+GetFullName(npchar)+". A great admirer of yours! I don't know what you're doing on this miserable piece of land, but you're just in time!\nI must say, Captain, you have become very popular among our officer corps. Although many are annoyed by your... 'special' style of service, everyone agrees that your commission makes our fleet stronger. We are currently in a complete stalemate, so the assistance of someone like you cannot be overestimated!";
				link.l1 = "What can I do? And what's going on here?";
				link.l1.go = "FraOfficer_1";
			}
			else
			{
				dialog.text = "Captain "+GetFullName(pchar)+". Your name has been mentioned several times in the fleet reports. And always in a rather dubious light. However, now you have a chance to break this less honourable trend and serve the motherland.";
				link.l1 = "What can I do? And what's going on here?";
		...
		case "FraOfficer_1":
			dialog.text = "We were on the 'Warrior', a routine mission - hunting down particularly bold Spanish raiders. The case is generally very simple: the spy provides the area and data on the target, and you catch it from beyond the horizon. There's nothing special to tell, and it all ended very badly: the Spaniards found us first and attacked, despite the fact that they were on a corvette themselves. If we had something more serious, we wouldn't have gone to the bottom with them... but at least we managed to blow up their whole hull. Only my squad survived. The Castilians, however, also had some survivors. But not for long, haha!";
			if (CheckAttribute(pchar, "questTemp.IslamonaSpaOfficer"))
			{
				link.l1 = "The frigate 'Warrior'? Captain Shocke is dead?";
		...
		case "FraOfficer_2":
			dialog.text = "We found a settlement on the island – quite a populated bandits' den for – just listen – pirates and Spaniards. Unbelievable! You know, usually these bastards only cut and hang each other, but here – behold: in the very centre of the archipelago, they work together like a family to extract buccaneer's wood. Have you seen the pier they've built for themselves? Guests don't come to this lot on rowboats. Our task is extremely clear: with your help, we capture the settlement, take the buccaneer's wood and prisoners, and you take everyone to Capsterburg. Meanwhile, the authorities will figure things out for themselves... And while they're figuring it out, we'll deal with the buccaneer's wood and celebrate properly with the other officers from my home squadron!";
			link.l1 = "What has stopped you from taking the settlement yourself by now?";
		...
		case "FraOfficer_3":
			...
			dialog.text = "What stopped us?! We have only twelve fusiliers and seven sailors. All are tired and worn out. We saved only five muskets, each with just one cartridge at best! "+sTemp+"";
			link.l1 = "But do you have a plan?";
			link.l1.go = "FraOfficer_4";
		break;
		
		case "FraOfficer_4":
			dialog.text = "Listen, we didn't waste any time. First of all, we took over this factory, capturing some food and water supplies, and most importantly - a full warehouse of buccaneer's wood and more than a dozen slaves! We wouldn't have been able to guard the slaves anyway, so we immediately conducted reconnaissance by force, sending them to attack their former masters under the cover of our muskets. That's how we found out that the bandits have weapons in stock.";
		...
		case "FraOfficer_5":
			dialog.text = "No, but you can go to the bandits under a flag of truce. Your arrival means their lair is exposed, and now the king's soldiers have a ship and reinforcements. Well, while they're all ears and trying to gauge the situation, you'll get as close to the gun as possible, toss a hand grenade under it, and don't let yourself be killed until our men and yours arrive. If you're not sure you can manage it, try sending one of your men instead.";
			link.l1 = "Let me first go to them without a bomb and offer them a chance to surrender. I'll look around, gauge their mood and strength, and sow doubt in their hearts. If they don't surrender, then I'll go to them again, but with a bomb.";
		...
		case "FraOfficer_6":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "... and by that time, they'll already be used to you, so it'll be easier to carry out the sabotage! Clever! Well, I wouldn't expect anything less from you, Captain. Proceed when you're ready. But still, here... It might come in handy.";
			link.l1 = "";
		...
		case "FraOfficer_8":
			dialog.text = "There was a prolonged battle with the Spaniards in this area. Both ships went down, and the survivors ended up here. Mostly French, but some of our enemies managed to survive as well. And you don't need to know more, sorry, Captain. Confidential information, you understand.";
			link.l1 = "Understood.";
		...
		case "FraOfficer_9":
			...
			link.l1 = "What has stopped you from taking the settlement on your own by now?";
			link.l1.go = "FraOfficer_3";
		break;
		
		case "FraOfficer_10":
			dialog.text = "Here you are! Any news?";
			link.l1 = "Is this an honour guard?";
			link.l1.go = "FraOfficer_11";
		break;
		
		case "FraOfficer_11":
			dialog.text = "Obviously, a decision will be made shortly regarding our next actions. I wouldn't want to have to search for my people all over the island to issue new orders.";
			if (CheckCharacterItem(pchar, "patent_fra"))
			{
				link.l1 = "Excellent initiative! You'll have your orders. I've conducted reconnaissance: the enemy is weak, and the cannon is out of ammunition. I order you to attack the bandits' lair immediately, Lieutenant. Stop nursing your hands. Just another day in the fleet. Execute!";
				link.l1.go = "FraOfficer_12";
			}
			else
			{
				link.l1 = "In my opinion, you could have taken them right after the 'slave' reconnaissance by force. Their defence is laughable, just a couple of serious fighters. No need to overthink - we could have been drinking trophy wine while sitting on a mountain of ironwood.";
		...
		case "FraOfficer_14":
			dialog.text = "And these are the results of your reconnaissance? I understand that it might be strange to expect too much from a non-military person, but I need facts! Facts, Captain, not your opinion!";
		...
		case "FraOfficer_15":
			dialog.text = "";
			link.l1 = "Right now, there's a surviving captain of a Spanish ship you sank with us. An experienced commander who will soon recover. If you delay, he'll recover and organise the defence by the book of military science, and then we'll have a tough time. We need to hurry - I repeat, they are weak and demoralised.";
			link.l1.go = "FraOfficer_15_1";
			link.l2 = "Reinforcements are coming soon – to seize the buccaneer's wood. I don't think it's a bluff: you saw the docks and the pile of goods ready for delivery in the factory warehouse yourself. We need to hurry – I repeat, they are weak and demoralised. If you delay, you'll be waiting for the arrival of a pirate ship.";
			link.l2.go = "FraOfficer_15_2";
			link.l3 = "Nearly half of the inhabitants of this hole are women. You haven't even been fighting the militia: there have been no more than a dozen fighters against you all this time. They are weak and demoralised.";
			...
			link.l5 = "Think about the trophies and glory, Lieutenant! A solo victory over a Spanish raider, capturing a bandit's nest and a unique source of buccaneer's wood – all of this calls for commanding your own ship! I repeat, they are weak and demoralised, it's time to crush them!";
		...
		case "FraOfficer_18":
			if (CheckCharacterItem(pchar, "patent_fra")) dialog.text = "And I, fool that I am, admired you! A-agh! The pride of France, Captain "+GetFullName(pchar)+"!! You are unworthy of your patent!!!";
		...
		case "FraOfficer_20":
			dialog.text = "Are you ready, Captain? Your crew looks worthy!";
			link.l1 = "Thank you, Lieutenant. Shall we begin?";
			link.l1.go = "FraOfficer_21";
		break;
		
		case "FraOfficer_21":
			dialog.text = "Yes, let's proceed at once!";
			link.l1 = "...";
		...
		case "Alonso":
			...
			link.l1 = "The order stands. Boys, follow me, we need to clear our home of unwanted guests. The prize is mine, all the trophies are yours!";
			link.l1.go = "Alonso_1";
		break;
		...
		// испанский офицер
		case "SpaOfficer":
			dialog.text = "Greetings, señor. Are you the owner of this land? Allow me to introduce myself, Grand Francisco de Alba, former captain of the 'Perro Marino' corvette.";
			link.l1 = "Yes, this is my land. I am "+GetFullName(pchar)+", captain of the ship '"+pchar.ship.name+"'. Grand? We've never had such distinguished guests here before.";
			link.l1.go = "SpaOfficer_1";
		break;
		
		case "SpaOfficer_1":
			dialog.text = "Oh, Monsieur "+GetFullName(pchar)+"! Your name is well known. You see, lately your name has been cropping up so often in the Casa de Contratación reports that I was seriously expecting orders to deal with you.";
			link.l1 = "Deal with me?";
			link.l1.go = "SpaOfficer_2";
		break;
		
		case "SpaOfficer_2":
			dialog.text = "I think there's no point in pretending. My job is to seek out and destroy the enemies of Spain and King Philip on all the seas of the globe.";
		...
		case "SpaOfficer_5":
			...
			link.l3 = "Welcome aboard my ship, Grand. I will put you ashore at the Santiago lighthouse when the time comes. I hope you will keep your word.";
			link.l3.go = "SpaOfficer_8";
		break;
		
		case "SpaOfficer_6":
			dialog.text = "I understand, señor. Well, in any case, I am already dead in that battle together with my men. It's a good ending.";
			link.l1 = "";
		...
		case "SpaOfficer_7":
			dialog.text = "I admit, I don't like being half-hearted. But there is no dishonour in being a prisoner, so I accept your gift of life and will live in peace with these kind and apparently very happy people. Nevertheless, if I ever leave this place, I will owe you nothing.";
			link.l1 = "";
		...
		// мужское население
		case "island_man":
			dialog.text = LinkRandPhrase("Greetings! How are you, Captain? Things are going well for us.","Working for the community is the greatest joy!","Your island is wonderful, Captain, and we'll do everything we can for its prosperity.");
			...
			if(CheckAttribute(pchar,"questTemp.IslaMona.TownStage"))
			{
				...
				{
					case 0:
						dialog.text = RandPhraseSimple(RandPhraseSimple("Don't take it as impudence, señor, but living here is impossible.","Anything is better than sitting in the Inquisition's cells..."),RandPhraseSimple("Thank you for saving us, Captain.","Are these... pirates your friends?"));
						link.l1 = "...";
						link.l1.go = "island_man_1";
					break;
					
					case 1:
						dialog.text = RandPhraseSimple(RandPhraseSimple("It's not bad here! Just a bit dull.","Captain, good to see you. Drop by sometime!"),RandPhraseSimple("Someone found skulls on the beach and brought them to the morning meeting. Is it always like this here?","I'll tell you a secret, Señor Jiménez obviously benefits from the fresh air and safety of this place."));
						link.l1 = "...";
						link.l1.go = "island_man_1";
					break;
					
					case 2:
						dialog.text = RandPhraseSimple(RandPhraseSimple("It's not bad here! Just a bit dull.","Captain, good to see you. Drop by sometime!"),RandPhraseSimple("Someone found skulls on the beach and brought them to the morning meeting. Is it always like this here?","I'll tell you a secret, Señor Jimenez obviously benefits from the fresh air and safety of this place."));
						link.l1 = "...";
						link.l1.go = "island_man_1";
					break;
					
					case 3:
						dialog.text = RandPhraseSimple(RandPhraseSimple("God bless you, Captain!","Once a week, we put on performances on the beach and in the tavern. Drop by sometime."),RandPhraseSimple("Your sailors are constantly bringing us all sorts of trinkets in exchange for fresh food. Thank you for encouraging this.","It's amazing how this place hasn't been discovered yet. I hope it stays that way."));
						link.l1 = "...";
						link.l1.go = "island_man_1";
					break;
				}
		...
		case "island_man_2":
			dialog.text = "Thank you, señor. Thanks to you, we've seen the real New World. God bless you!";
			link.l1 = "";
		...
		// женское население
		case "island_woman":
			dialog.text = LinkRandPhrase("Safety and peace - that's what I like about this place!","A wonderful paradise! Well, almost...","We're happy to have found a new home here, after so many hardships.");
			link.l1 = LinkRandPhrase("I'm happy for you and your community.","Yes, I like this little island too.","It's good to know that you're satisfied.");
			...
			if(CheckAttribute(pchar,"questTemp.IslaMona.TownStage"))
			{
				...
				{
					case 0:
						dialog.text = LinkRandPhrase("Oh... Hello.","Señor, who are those... rough men with weapons?","Thank you for saving us, Captain.");
						link.l1 = "...";
						link.l1.go = "island_woman_1";
					break;
					
					case 1:
						dialog.text = LinkRandPhrase("Our men did a great job - the houses are excellent. But we worked hard too!","Señor Captain, don't worry: the women of our small clan are not afraid of difficulties and temporary discomfort.","Such air here! And the sea! You feel closer to God!");
						link.l1 = "...";
						link.l1.go = "island_woman_1";
					break;
					
					case 2:
						dialog.text = LinkRandPhrase("Our men did a great job - the houses are excellent. But we worked hard too!","Señor Captain, don't worry: the women of our small clan are not afraid of difficulties or temporary discomfort.","Such air here! And the sea! You feel closer to God!");
						link.l1 = "...";
						link.l1.go = "island_woman_1";
					break;
					
					case 3:
						dialog.text = LinkRandPhrase("Come back more often, Señor Captain. I'm always happy to see you.","Señor Rodgar is an amazing storyteller. You could listen to him talk forever!","Hehe. They say someone in our group is already expecting an addition to the family. Life goes on even on Isla Mona!");
						link.l1 = "...";
						link.l1.go = "island_woman_1";
					break;
				}
		...
		case "island_woman_2":
			dialog.text = "You... Muchas gracias, señor! Come by more often...";
			link.l1 = "";
		...
		case "fort_pirate":
			...
			{
				dialog.text = dialog.text = RandPhraseSimple(RandPhraseSimple("Everything's fine, Cap!","Slaves are under control, don't worry."),RandPhraseSimple("You don't have to worry, mutiny is out of the question.","Thank you for the rum! We'll get to work!"));
			}
			else
			{
				dialog.text = dialog.text = RandPhraseSimple(RandPhraseSimple("Spaniards? We didn't expect this from you.","Now we have to walk all the way to the beach just to sleep in peace!"),RandPhraseSimple("Why did you decide on all this - eh, Cap?","The boss trusted you then - and he wasn't wrong. We'll believe in you again."));
			}
			link.l1 = "...";
		...
		// посетители таверны
		case "citizen_tavern":
			dialog.text = LinkRandPhrase("After back-breaking labour, it's not a sin to have a drink or two...","I'm almost done and heading home; the wife must be waiting...","Ah, it's nice to relax in our tavern after work! We're all grateful to you, captain!");
			link.l1 = LinkRandPhrase("Enjoy your drink, compadre, ha-ha!","Relax, mate, just don't overdo it, or the wife will scold you, ha-ha!","Take it easy, mate, life is not all about work!");
		...
		case "sailor_tavern":
			...
			dialog.text = RandPhraseSimple(RandPhraseSimple("Captain, nice place you've got here!","Imagine if we were to suddenly find ourselves devoid of rum. You'd surely procure more, wouldn't you?"),RandPhraseSimple("I've dreamed of a holiday like this for a long time. I'd love a brothel though... just a wild thought, Cap.",sTemp));
			link.l1 = "...";
		...
		case "sailor_town":
			dialog.text = RandPhraseSimple(RandPhraseSimple("Thank you for the time off, Captain.","Nice place you've built up here - you have a knack for keeping things in order, Captain."),RandPhraseSimple("Fresh food, booze, solid ground underfoot. It's a dream.","I'd like to stay here a little longer."));
			link.l1 = "...";
		...
		// рабы
		case "slave":
			dialog.text = RandPhraseSimple(RandPhraseSimple("I'm so tired - I can barely stand.","No strength left to live like this!"),RandPhraseSimple("This work is too hard for me.","The overseers left no living cell on my skin!"));				
			link.l1 = "";
			link.l1.go = "slave_1";
		break;
		...
		case "HouseWoman":
			dialog.text = LinkRandPhrase("Señor, welcome!","Hello, captain. Will you stay?","Are you here for me? Please, come in, just ignore the mess, señor.");
			link.l1 = "...";
