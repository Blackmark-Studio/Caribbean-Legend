void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		{
			dialog.text = "You were detained for attempting to transfer and sell contraband. Considering your assistance to the authorities and your position, you will spend in prison only "+FindRussianDaysString(int(pchar.questTemp.JailTemp2))+". Besides, all the money you've earned by smuggling -"+FindRussianMoneyString(int(pchar.questTemp.JailTemp1))+" will be taken away and put in the town treasury. Have a good time, captain!";
			link.l1 = "";
		...
		//<-- Сомнительное предложение
			dialog.text = "You have been detained for committing a crime, and you will be held in prison for "+FindRussianDaysString(int(pchar.questTemp.JailTemp2))+". Besides, you will be fined for "+FindRussianMoneyString(int(pchar.questTemp.JailTemp1))+". Have a pleasant time, captain!";
			link.l1 = "";
			link.l1.go = "Jail_officer_take_1";
			NextDiag.currentnode = "Jail_officer_free";
		break;
