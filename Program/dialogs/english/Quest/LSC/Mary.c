...
void ProcessDialogEvent()
{
	...
	// --------------------------------------вернулся на Остров---------------------------------------------
		...
		case "return_2":
			...
			{
				dialog.text = "No, I'm not cold. I'm just... I don't want to talk about it here. Come to my cabin later. I want to talk with you alone, all right? Are you going to see Nathaniel now?";
				link.l1 = "Yes. I have to take Danielle to him. I won't be long. I'll see you soon, Mary.";
			}
			link.l1.go = "return_3";
		break;
	...
	// --> Мэри вне LSC
		...
		case "LongHappy_9c":
			...
			dialog.text = "I think, "+int(pchar.questTemp.LongHappy.MarryMoney)+" pesos will be enough, all right. "+int(pchar.questTemp.LongHappy.MarryRum)+" barrels of rum - nothing worse than running out of drink! As soon as you collect everything, come to the tavern. I'll figure out the rest.";
