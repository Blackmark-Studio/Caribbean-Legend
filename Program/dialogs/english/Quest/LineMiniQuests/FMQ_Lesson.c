...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "contra_1":
			...
			link.l1 = ""+FindRussianQtyString(int(pchar.questTemp.FMQL.Sanl))+" of ironwood, "+FindRussianQtyString(int(pchar.questTemp.FMQL.Silk))+" of ship silk, "+FindRussianQtyString(int(pchar.questTemp.FMQL.Rope))+" of rope and "+FindRussianQtyString(int(pchar.questTemp.FMQL.Oil))+" of resin.";
			link.l1.go = "contra_2";
		break;
