void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LEDR_Gonsalo_27":
			...
			link.l1 = "Looks like this was the bishop's chest. I fou"+GetSexPhrase("ёл","ла")+" there's something in it. Take a look.";
		...
		case "LEDR_Gonsalo_34_share":
			dialog.text = "If that's the case - I won't say no. Everyone needs money, and I need it now more than ever. No one's going to take me on as a sailor anymore - I'm too old for that. So thank you, Captain, for not turning me away."+GetSexPhrase("ся","ась")+", like the others.";
