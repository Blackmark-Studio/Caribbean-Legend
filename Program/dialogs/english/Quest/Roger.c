...
void ProcessDialogEvent()
{
	...
	case "merida_head_8":
		...
		case "spy_sailor_1":
			...
			dialog.text = "Yes, Captain. Three ships. The flagship is " + ship1 + ", the other two are " + ship2 + " and " + ship3 + ".";
		...
		case "carpenter_4":
			...
			link.l1 = "I have your ex-captain's log! We've got a few items from Freyja's wreckage. Thanks to the log I have found this island and this... gourd of yours.";
		...
		case "ShipStock_2":
			...
			dialog.Text = "So, we are to stay here a"+XI_ConvertString(RealShips[int(chref.Ship.Type)].BaseName+"Acc")+" named '"+chref.Ship.Name+"'. Right?";
			Link.l1 = "Right.";
