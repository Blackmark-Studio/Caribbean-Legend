...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "After_boarding":
			dialog.text = "Thanks for your help, captain!";
			link.l1 = "My God... You are even more beautiful than I imagined!";
			link.l1.go = "After_boarding_1";
		break;
		
		case "After_boarding_1":
			dialog.text = "To hell with my beauty! Do you know how much grief it has caused me? I'd cut off my own nose if it wouldn't ruin my reputation. That bastard wouldn't let me leave the corvette alive, kept saying that I 'knew too much.' Then yesterday he told me he was tired of waiting and was going to take me against my will\nYou couldn't have arrived at a better time! But where are my manners, my name is Helen McArthur. My papa used to call me Rumba because I kept accidentally breaking the fine china that he had 'acquired', so that's what my crew call me now.";
			link.l1 = "My name is "+GetFullName(pchar)+" and I'm here to rescue you. I've been scouring the Caribbean for several days, searching for you for the sake of Ms. Gladys.";
			link.l1.go = "After_boarding_2";
		break;
		
		case "After_boarding_2":
			dialog.text = "Ms Gladys!? How is she?";
			link.l1 = "Worried sick about you. But you'll see her soon, we're sailing to Blueweld. You can tell me everything that's happened to you on the way there.";
			link.l1.go = "After_boarding_3";
		break;
		
		case "After_boarding_3":
			dialog.text = "To be honest, "+pchar.name+", I'd like to have some food and a nap right now. I'm exhausted after all those days I spent on that monster's ship...";
		...
		case "Return_blueveld":
			...
			dialog.text = "Captain de Maure, I thank you again from the bottom of my heart for your timely rescue. You must visit me and my mother. Our house is not far from here, on your left as you come from the pier. And know this "+pchar.name+", I will never forgive you if you sail away without saying goodbye!";
			link.l1 = "The pleasure was all mine, Ms McArthur. I shall be sure to call upon you!";
		...
		case "Helena_wait":
			dialog.text = "Ah, there you are, Captain de Maure! I'm so glad you're here, I have so many questions for you.";
			link.l1 = "I'm sorry, Ms. McArthur, but we must delay our conversation a little. I need to gather more information before I can provide satisfactory answers. For now, I ask that you do not show yourself on the street. I hope your wait will not be long. Trust me and wait.";
			
			if (CheckAttribute(pchar, "questTemp.HelenDrinking.CanDrink")) {
				link.l1.go = "drinking_refuse";
				link.l2 = "You said yourself that you wouldn't forgive me if I didn't drop by.";
		...
		case "Helena_hire":
			dialog.text = "Ah, there you are, my captain! Your eyes tell me you've got news for me!";
			link.l1 = "Captain Svenson told me that you wish to sail with me. I appreciate your interest, and Ms. Gladys mentioned that you have missed the sea. Welcome aboard, Ms. Helen McArthur!";
			link.l1.go = "Helena_hire_1";
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_friend"))
			{
				link.l2 = "Captain Svenson told me that you wish to sail with me. I appreciate your interest, and Ms. Gladys mentioned that you have missed the sea. Welcome to my crew, Ms. Helen Sharp!";
		...
		case "Helena_hire_1_1":
			dialog.text = "...Yes?";
			link.l1 = "Jan Svenson and I have discovered that you are the rightful heir to Isla Tesoro. Yes, it's true, don't shake your head! I have half of the map which proves your claim. It won't be easy, but Jan and I will do our best to help you become the rightful owner.";
			link.l1.go = "Helena_hire_1_2";
		break;
		
		case "Helena_hire_1_2":
			dialog.text = ""+pchar.name+", are you serious? It's not kind to tease a poor girl like that! How could I possibly have the right to own an entire island?!";
			link.l1 = "I am absolutely serious, Ms. McArthur. And I am going to help you reclaim your birthright. Let's set sail now!";
			link.l1.go = "Helena_hire_6";
		break;
		
		case "Helena_hire_2":
			dialog.text = "W-what did you say? Helen Sharp? Why Sharp?";
			link.l1 = "Helen, you are the daughter of Beatrice Sharp and the sole heir of the Sharp dynasty. This is half of the map that has been kept by Ms Gladys all these years. It's proof of your claim to Isla Tesoro. It won't be easy, but Jan Svenson and I will do our best to help you inherit your grandfather's island.";
		...
		case "Helena_hire_5":
			dialog.text = ""+pchar.name+", you might call me naive, but I will tell you anyway. When I was a young girl, a gypsy woman told me: 'Your fate will lie in the hands of the man who will not take the widow's coin, who returns the dead man's gold, and who names the mother.'\nI thought it was all nonsense back then, but somehow you've managed to fulfil every part of the prophecy. There is no way you could have known about that!";
		...
		case "sea_bomb":
			dialog.text = "Captain "+pchar.name+"! I have an idea...";
			link.l1 = ""+npchar.name+"? It's not safe here, and I told you to stay on the ship...";
			link.l1.go = "sea_bomb_1";
		break;
		
		case "sea_bomb_1":
			dialog.text = "Charles, there's so much gunpowder packed into this old tub that if it blows up, the whole island will fly straight to St. Peter's front door! It makes no difference whether you tell me to hide or not, so listen to me!";
			link.l1 = "Fine, speak quickly!";
			link.l1.go = "sea_bomb_2";
		break;
		
		case "sea_bomb_2":
			dialog.text = "The corvette and the frigate. They don't recognise Knive's ship as hostile. We can use their complacency against them. Let's take a few barrels of gunpowder, set a fuse and sail to the ships\nThey'll let us get close, we'll light the fuse, drop the barrel onto one of them and sail away as fast as we can. And then we'll watch a spectacular explosion... What do you say?";
			link.l1 = "An improvised fire ship... very cunning! Your plan is mad enough that it just might work... if we can get close enough without being recognised.";
		...
		case "sea_bomb_3":
			...
			link.l1 = "Fine. Let's get on with this! Lads! Take three barrels of gunpowder! We're going to get the hell out of here! I love your imagination, "+npchar.name+"... I would never have come to this idea myself.";
		...
		case "fugas":
			...
			link.l1 = "Jackman's ship is at Sabo-Matila Cove, the heavy frigate 'Centurion'. This ship once belonged to the Hawkes, so there must be important items and documents in Jackman's cabin...we must board it.";
			link.l1.go = "fugas_1";
		break;
		
		case "fugas_1":
			dialog.text = "Easier said than done. How are you going to do that on our polacre? They outman and outgun us.";
			link.l1 = "You are right. Jackman has at least twice as many men as we do, and all of them are experienced fencers. It would be madness to attack them without a preliminary bombardment. But protracted fighting is not the best option either. So I've been thinking about what to do.";
			link.l1.go = "fugas_2";
		break;
		
		case "fugas_2":
			dialog.text = ""+pchar.name+", they haven't recognised us as enemies yet, just like those idiots back at Turks... We can try our trick again...";
		...
		case "fugas_3":
			...
			link.l1 = "Ha! Your feminine ingenuity continues to amaze me! Instead of a fireship, you suggest a fougasse? Do you think it could work?";
			link.l1.go = "fugas_4";
		break;
		
		case "fugas_4":
			dialog.text = "And why not? Their freeboard is higher than ours, but two or three men aided by a pulley could easily hoist and throw a fully loaded barrel. We'll call out - 'Here's some free rum from Knive!' And the barrels will explode before they can even react.";
			link.l1 = "The exploding grapeshot will turn his best men on deck into mince... Damn, it sounds tempting.";
			link.l1.go = "fugas_5";
		break;
		
		case "fugas_5":
			dialog.text = "Let's throw five barrels at once from the quarterdeck to the poop. "+pchar.name+", we have the element of surprise. They won't suspect a thing yet! And then we will immediately sail away before they have a chance to board us.";
			link.l1 = "Well, let's try. They must not identify us before we get those explosive barrels onto their deck... It won't be easy to get close. Jackman is not as great a fool as Ghoul was.";
			link.l1.go = "fugas_6";
		break;
		
		case "fugas_6":
			dialog.text = "Let's risk it, "+pchar.name+"! Like I said before, what have we got to lose?";
	...
	// --> разговор по итогам Саги
		case "result":
			...
			if (sti(pchar.questTemp.Saga.HelenRelation) < 6)
			{
				...
				link.l1 = "Aye, it's a pity to part with you, but such are the whims of fate. You have much more important responsibilities now than serving on my ship.";
				link.l1.go = "result_1";
			}
			else
			{
				if (CheckAttribute(pchar, "questTemp.HelenDrinking.Mary")) {
					dialog.text = "I'd love to be able to stay on your ship. Close to you... But it's impossible. Be happy, Charles. And she had better be worthy of you!";
					link.l1 = "I'm sorry, Helen.";
					link.l1.go = "result_mary";
				} else {
					dialog.text = "It's so strange, "+pchar.name+"! I've just become the owner of an entire island, but I don't feel like the Queen of Isla Tesoro... I suppose the new head of the Brethren will manage the colony better than I could. I have a lot to learn.";
		...
		case "result_mary":
			...
			link.l1 = "Of course... Helen, we will meet again on Isla Tesoro. Shall I take you to your island?";
			link.l1.go = "result_12";
		break;
		
		case "result_1":
			dialog.text = "You are right... Look, I saved my share of the plunder while sailing on your ship. Take it and don't even try to refuse my offer - I don't want to be in your debt.";
			link.l1 = "Hey now, just wait a moment...";
			link.l1.go = "result_2";
		break;
		
		case "result_2":
			dialog.text = "I know what you are going to say. Sure, your help was much more significant than this meagre chest of treasure. But this is all I have got in my possession right now and I must repay you. Take it, if you don't take it yourself I will leave it in your cabin.";
		...
		case "result_3":
			...
			dialog.text = "No need for that, "+pchar.name+". I will get to the island myself. I've got my sword and pistol with me, that will suffice for a while... I am sure that the Queen of Isla Tesoro need not worry about income once I get there.";
		...
		case "result_4":
			dialog.text = "Enough of that, even in jest. I'm still Helen to you. But that is not all I wanted to say. I have found my father again, though it was a bit strange. He has paid for my inheritance with his good name as an English nobleman, and that troubles me. The English Commonwealth hunts him and I don't want you, "+pchar.name+", to take part in it.";
			link.l1 = "Come to your senses, Helen! He is a bandit and a pirate!";
			link.l1.go = "result_5";
		break;
		
		case "result_5":
			dialog.text = "Pirate? And who the hell are you to say something like that? He is my father and that's what matters to me! And I, the daughter of a bandit and a pirate, don't give a damn what English justice thinks of him. If you try to harm my father in any way, I will forget everything good you have done for me, know that. Consider this a warning.";
			link.l1 = "Is that so? Actually, girl, you'd better be more polite. I didn't hear any complaints from you about my piratical attitude when I was saving your pretty skin from the hands of that rapist Donovan, or when we were sharing the profits of our captures!";
			link.l1.go = "result_6";
		break;
		
		case "result_6":
			dialog.text = "I... I'm sorry. I take it back, forgive me. I lost my head... But still, I'd like to remain your friend, which would be impossible if you start chasing my father.";
			link.l1 = "Understood. But don't you ever dare threaten me, woman. You should know by now from sailing on my ship that I fear no one and nothing. I especially will not tolerate disrespect from a woman – Pirate Queen or not. I may be a gentleman, but even my patience has its limits. Now that is settled, farewell. I wish you luck.";
			link.l1.go = "result_8";
		break;
		
		case "result_7":
			dialog.text = "Thank you... Perhaps we will meet again, "+pchar.name+"...";
			link.l1 = "And why not? I will visit Isla Tesoro more than once in the future. See you there... Goodbye, Helen.";
			link.l1.go = "result_8";
		break;
		...
		case "result_9": // вот тут - ключевой момент, если игрок нашёл Мэри - выбирай, какая девушка милее
			dialog.text = "I am sure. "+pchar.name+", I'd like to stay on your ship if you'll let me. To stay with you...";
			if (CheckAttribute(pchar, "questTemp.LSC.Mary") && pchar.questTemp.LSC.Mary == "alive")
			{
				...
				link.l2 = "(choose Helen) It's more than I could have hoped for, Helen. Of course I don't want to lose you, but it would be better for you to go to Isla Tesoro. Who knows where my fate will lead me yet. Right now, I have war, political intrigues, and uncertainty ahead of me.";
				link.l2.go = "result_15";
			}
			else
			{
				link.l1 = "It's more than I could hope for, Helen. Of course I don't want to lose you, but it would be better for you to go to Isla Tesoro. Who knows where my fate will lead me yet. Right now, I have a war, political intrigues, and uncertainty ahead of me.";
				link.l1.go = "result_15";
			}
		break;
		
		case "result_10":
			dialog.text = ""+pchar.name+"! Don't lie to me. You just don't want to... Tell me, who is she? It's that red-haired strumpet from the City of Abandoned Ships, am I right?";
			link.l1 = "Helen! I'm trying to tell you what I think is best for you! How can you not understand that?!";
			link.l1.go = "result_11";
		break;
		
		case "result_11":
			dialog.text = "Oh sure, of course you are... And how was she able to charm you, huh? What does she have that *I* don't?! Is she really that good? Eh, "+pchar.name+"... Well, it's your decision, I have nothing left but to go to my island. I can't stand between you two\nThank you for everything you've done for me, Charles. You are the best man I've ever met. I hope we can remain friends?";
			link.l1 = "Of course... Helen, I will see you again on Isla Tesoro. Do you want me to take you there?";
			link.l1.go = "result_12";
		break;
		
		case "result_12":
			dialog.text = "No need. I will buy a new ship. I have saved enough money to buy and equip a schooner while serving under your command. I will sail a new 'Rainbow' again.";
			link.l1 = "I am glad, Helen, that you were so... thrifty. But sailing on a schooner doesn't suit the Pirate Queen of Isla Tesoro. Soon, you should get a frigate of your own.";
		...
		case "result_15":
			dialog.text = "My fate has been tied to yours ever since we met. Don't you understand that? "+pchar.name+"? I will follow you to the ends of the earth!";
		...
		case "result_17":
			dialog.text = ""+pchar.name+", I have always wanted to tell you that you are the greatest man I have ever met! You have done so much for me that I will never be able to repay you. I want to stay with you. Forever. I will marry you if you want... I love you.";
		...
		case "result_18":
			dialog.text = ""+pchar.name+", dear... Hold me! I have been waiting for this moment for far too long!";
	...
	// -------------------------------------------- провалы саги ------------------------------------
		case "failcenturion":
			...
			link.l1 = "Yes, Helen, you are all safe. But 'Centurion' was sunk, and so were all the documents that could help us find your mother's grave and prove your right to claim Isla Tesoro... Eh... Now I will have to storm Tortuga on my own...";
			link.l1.go = "failcenturion_1";
		break;
		
		case "failcenturion_1":
			dialog.text = ""+pchar.name+", don't worry so much. There's nothing we can do about it. Don't worry about me either, I'll be fine without that island. Thank you for all you've done for me!";
			link.l1 = "It sounds like you are going to... leave me, aren't you?";
			link.l1.go = "failcenturion_2";
		break;
		
		case "failcenturion_2":
			dialog.text = "Yes, my captain. I managed to collect enough money to buy and equip a schooner. I will sail my 'Rainbow' again. We will meet again in Blueweld... I am going back home.";
		...
		case "late_l1":
			dialog.text = "Well, my captain... It seems that we have failed. Farewell. I am going back home. I have earned enough money under your command to buy myself a new schooner. We will meet again at sea!";
			link.l1 = "Good luck, Helen. I am sorry for everything. Farewell.";
			link.l1.go = "failcenturion_3";
		break;
		
		case "late_l2":
			dialog.text = "Captain! Jackman is dead... So it seems my family is safe, isn't it?";
		...
		case "late_l3":
			dialog.text = ""+pchar.name+", what did the lawyer say to you?";
			link.l1 = "I have lost too much time and Isla Tesoro is now an English colony. You have been left without your inheritance, so I'll have to storm Tortuga myself... Alas, we've lost.";
			link.l1.go = "failcenturion_1";
		break;
	// <-- провалы Саги
		...
		case "cabin_sex":
			...
			{
				dialog.text = RandPhraseSimple(""+pchar.name+", I'm not feeling well today. Please don't feel bad, it's not your fault. Let's not do it today...",""+pchar.name+", dear, I've been so tired these last few days. To be honest, I just want to sleep. Forgive me. Let's do it another time.");
				link.l1 = RandPhraseSimple("Fine...","That's all right. As you wish...");
				link.l1.go = "exit";
			}
			else
			{
		...
		case "sex_after":
			dialog.text = LinkRandPhrase(RandPhraseSimple("It was wonderful, "+pchar.name+"!..","You were wonderful as always, dear..."),RandPhraseSimple("It was wonderful, Charles!","Had a wonderful time, dear!"),RandPhraseSimple("Never a dull moment with you, my captain!","You were wonderful, darling!"));
		...
		case "room_sex":
			...
			{
				dialog.text = ""+pchar.name+", you know I am always glad to... But now is not the right time - we have to catch that scoundrel Thibaut before he escapes.";
			...
			if (hrand(4) == 0) // вероятность отказа 20%
			{
				dialog.text = RandPhraseSimple(""+pchar.name+", I am not feeling well today. Please don't be upset. Let's not do it today...",""+pchar.name+", dear, I have been so tired these last few days. To be honest, I just want to sleep. Forgive me. Let's do it another time.");
				link.l1 = RandPhraseSimple("Fine...","That's all right. As you wish...");
				link.l1.go = "exit";
			}
			else
		...
		case "Helena_officer":
			...
			if (CheckAttribute(pchar, "questTemp.HelenDrinking.CutlassTraining")) {
				...
				link.l1 = "Shiver me timbers, what a grip! I see you haven't wasted any time, Helen.";
			...
			{
				Link.l4 = "Helen, I am going to visit the lost Indian city of Tayasal. I won't lie to you: this journey is very dangerous, and what's more – it involves teleportation through the idol. Will you... follow me?";
				Link.l4.go = "tieyasal";
			}
       ////////////////////////казначей///////////////////////////////////////////////////////////
			...
			{
			    Link.l11 = "Helen, give me a full report on the ship.";
			...
			if (CheckAttribute(NPChar, "IsCompanionClone"))//////////////////компаньон//////////////////////////////////////////////
			{
				...
				Link.l2 = "Helen, I need to give you a few orders.";
				...
				if (CheckAttribute(pchar, "questTemp.HelenDrinking.Rainbow") && sld.ship.type == pchar.questTemp.HelenDrinking.Rainbow && CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) {
					...
					link.l1 = "Nice vessel, isn't it? Got it for you, Helen! Just think, what kind of man in the Caribbean gives his lady a real ship, huh?";
					link.l1.go = "rainbow";
			...
			{
				Link.l2 = RandPhraseSimple("Helen, let's stay in the cabin together, just the two of us... for a few hours? What do you think?","Darling, shall we spend the next few hours tête-à-tête? Do you like the idea?");
			...
			{
				Link.l2 = RandPhraseSimple("Helen, why don't we rent a room and spend some time alone... just the two of us for a few hours? How does that sound to you?","Darling, shall we spend the next few hours tête-à-tête? We'll rent a room... what do you think?");
				Link.l2.go = "room_sex";
			}
			...
			{
				Link.l2 = "Helen, dear, may I invite you to spend some time at the tavern?";
				Link.l2.go = "special_sex";
			}
			if (CheckAttribute(pchar, "questTemp.MysteryPortRoyal_Helena")) {
				link.l4 = "Helen, it looks like I've found the last will of your admirer – Francis. He left you his inheritance.";
			...
			if (CheckCharacterItem(pchar, "pirate_cutlass") && !CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) {
				link.l4 = "I think this cutlass is yours now. Blaise is your so-called uncle...";
		...
		case "QMASTER_1":
			dialog.Text = "Charles, dear, are you ill or something? What, do you expect me to go below, sweep the hold, and start counting rats?";
			Link.l1 = "Right, sorry darling, my fault...";
			Link.l1.go = "exit";
		break;	

		case "QMASTER_2":
			dialog.text = "And I want my very own ship of the line, with a hundred guns sailing at 20 knots. I've been a captain like you all my life. Go find yourself a bloody purser and bother him with it.";
		...
		case "Companion_TaskChange":
			...
			Link.l1 = "I'd appreciate it if you refrained from swapping ships after boarding. She's too valuable to me.";
		...
		case "Companion_TaskBoardingNo":
			...
			Link.l1 = "She'll think about it... Right, as if I could give her orders anyway.";
			Link.l1.go = "exit";
	...
	//	<========//////////////////////////////////////																																			  
		...
		case "stay_follow":
			...
			if(sGun != "")
			{
				...
				{
					Link.l3 = "Change the type of ammunition for your firearms.";
		...
		case "SetGunBullets":
			Dialog.Text = "Choose the type of ammunition:";
			sGun = GetCharacterEquipByGroup(NPChar, GUN_ITEM_TYPE);
			rItm = ItemsFromID(sGun);
		...
		// --> суп из черепахи
		case "terrapin_grot":
			dialog.text = "There you are! I finally found you... That was something, my captain! I have never seen such a rooftop run and a jump from such a breathtaking height! My heart was ready to explode! One day you will kill me with these tricks of yours, dear... Oh, you're not alone... Who is this girl?";
			link.l1 = "This is Catherine Fox, daughter of Colonel Fox, commander of the famed English Maritime Regiment of Foot, the 'Sea Foxes'. We are taking her to Antigua.";
		...
		// --> калеуче
		case "on_coast":
			dialog.text = "Finally, you're awake, dear! How do you feel? You frightened me half to death...";
			link.l1 = "Helen, what happened? My head is splitting...";
			link.l1.go = "on_coast_1";
		break;
		
		case "on_coast_1":
			dialog.text = "When we entered the captain's cabin, you were lying on the floor, motionless. My heart almost stopped! The boys picked you up and dragged you back to our ship—just in time, since the dead men lying on the deck began to rise again.   What a horror! It's almost enough to make me find God! They were completely impervious to our blades and bullets! We quickly cut the ropes and tried to sail away, but a volley from their ship severely damaged ours and we lost control. Then they hoisted their sails and vanished in the blink of an eye.   Our ship ran aground, so we had to flee to this shore before the storm could destroy her. Many good people died today, but the ship survived in the end... if only I hadn't given the order to abandon her...";
		...
		case "on_coast_3":
			dialog.text = "For an entire day, I washed and dressed your wounds, gave you medicine, and poured some rum into you. Now you must get well!";
			link.l1 = "I won't die this time, darling. Although I don't feel well... blurgh....";
			link.l1.go = "on_coast_4";
		break;
		
		case "on_coast_4":
			dialog.text = "Tell me... Was it the real 'Flying Dutchman', Charles? Why did they attack us? And why didn't they shoot at us upon approach, but tried to sink us immediately after they boarded?";
			link.l1 = "Their captain needed that amulet, which I had discussed with Tuttuathapak, an Indian shaman. Why they needed it, I do not know... but as soon as their leader got the amulet, they disposed of us... God Almighty, what a wretched nightmare! A ship crewed by the living dead! Impossible to believe...";
			link.l1.go = "on_coast_5";
		break;
		
		case "on_coast_5":
			dialog.text = "Aye, now it was our turn to encounter the 'Flying Dutchman'. Gah! It makes my skin crawl! At the next port we stop at, I'm going to church, lighting a candle, and praying to our Lord Jesus Christ for our miraculous deliverance. Hell, I'm feeling so grateful that I'll even pray to some papist saints...";
			link.l1 = "I'll be right there with you, Helen. I haven't been to a proper confession in a while... But first, we have to go back to that village. I need to tell Tuttuathapak everything. That accursed ship attacked us because of the amulet! I hope that red-skinned devil has some idea why on earth those living dead might have needed it.";
			link.l1.go = "on_coast_6";
		break;
		
		case "on_coast_6":
			dialog.text = "Alright. But we must be careful – your wounds have barely healed.";
			link.l1 = "But you'll help me heal faster, won't you? I love you, Helen...";
		...
		case "tieyasal":
			...
			link.l1 = "I am very glad to hear that. I'll tell you a bit later when we go there. We need to prepare ourselves.";
			link.l1.go = "tieyasal_1";
		break;
		
		case "tieyasal_1":
			dialog.text = "I am ready, my captain! I will follow you to the ends of the Earth!";
		...
		// на Исла Тесоро
		case "islatesoro":
			dialog.text = "Oh, "+pchar.name+"! Glad to see you! What brings you here to Isla Tesoro?";
		...
		case "GoldenGirl":
			...
			link.l1 = "It's worse, Helen, much worse. The governor intends to visit an expensive courtesan, and I am supposed to accompany him as a curiosity. He promised his mistress to bring along a genuine privateer, adventurer, and all-around sea dog. So I'm in for tedious conversation, overpriced wine, and dull nobles.";
			link.l1.go = "GoldenGirl_1";
			link.l2 = "Quite the opposite, an invitation to a pleasant social event, hosted by a gentlewoman. His Excellency took me by surprise by asking me to accompany him, but to be honest, I am glad to have a chance to take my mind off work for a change.";
			link.l2.go = "GoldenGirl_5";
		break;
		
		case "GoldenGirl_1":
			dialog.text = "Aye... so the fearsome Captain Charles de Maure will dress up and dance like a pet monkey for their amusement? How sweet! I have a better idea. Let's set sail and get the hell out of here. If you're in the mood for a long-deserved holiday, let's sail to Isla Tesoro. We're always welcome there. Sunbathing, white sand, old friends, rum punch, taking our minds off things - you name it.";
			link.l1 = "Look, all this sounds fantastic, and I'd love to... but later. I promised the governor, this thing is important to the old man and...";
			link.l1.go = "GoldenGirl_2";
		break;
		
		case "GoldenGirl_2":
			dialog.text = "And what? You think your noble blood means a damn to them? I may not be of French blood, but I know all about their 'high society' and for them, Charles de Maure is not a captain whom men follow and trust with their lives. He's not a gentleman like them. Real gentlemen don't go to sea and fight in a fog of gunpowder smoke. Charles de Maure is just a curious addition to their meal. Like a pet leopard or a house negro playing dress-up! A fancy toy! Since when do you submit to such treatment?!";
		...
		case "GoldenGirl_3":
			dialog.text = "Whatever. (flicks her hair) But be warned - there is no way I am squeezing myself into a fancy dress. If you make me go, I'm wearing my breeches. I don't give a damn if all the gentlewomen in the Caribbean faint in disapproval.";
			link.l1 = "I wasn't going to make you. No point in both of us suffering. I will get through this party and then we will sail to Isla Tesoro. As a treat, I've been saving a crate of excellent Spanish Madeira in the cargo hold...";
			link.l1.go = "GoldenGirl_4";
		break;
		
		case "GoldenGirl_4":
			dialog.text = "Oh ho ho, Charles! Are you saying that I am not good enough for such esteemed company? That a girl in breeches would ruin your night? How interesting. Fine then, but don't forget to dress yourself like a fop. Monkeys in fancy dresses can touch even a courtesan's heart. Enjoy the performance!";
			link.l1 = "Helen, wait! Goddamn it... women!";
			link.l1.go = "GoldenGirl_8";
		break;
		
		case "GoldenGirl_5":
			dialog.text = "Yeah, we've earned some rest, alright. But damn me if I'm squeezing myself into a fancy dress for this. How far do you think gossip about your woman dressed like a man and a sailor will travel?";
			link.l1 = "Ah... I don't think that's a great idea. How should I put this... this isn't an event where men bring their wives or respectable ladies...";
			link.l1.go = "GoldenGirl_6";
		break;
		
		case "GoldenGirl_6":
			dialog.text = "Ha! Whores and depravity! Just wonderful - so you're going to an orgy! So why didn't you just bloody say so? You're lucky that I am not some jealous bint and won't shoot you right where you stand. At least not right now.";
			link.l1 = "Helen, please, all I'm doing is accompanying our governor, he asked me to and he was very persistent about it. There will be no fucking courtesans\nWait, that came out wrong... I mean there will be fucking of courtesans... oh Goddamn it! I am just paying my respects!";
			link.l1.go = "GoldenGirl_7";
		break;
		
		case "GoldenGirl_7":
			dialog.text = "I suggest you dress fashionably to 'pay your respects,' Captain de Maure. It's high society, after all. It's an absolute scandal to show up there without a collar and cuffs. Even for an orgy. Have fun.";
			link.l1 = "Helen, wait! Goddamn it... women!";
		...
		case "GoldenGirl_10":
			dialog.text = "Cuffs and a collar, Captain. And perhaps lace. I hear it's back in fashion again. But what do I know!";
		...
		case "GoldenGirl_13":
			dialog.text = "Do the local gentry still approve of their new monkey? Why, they say that its performance last night was legendary! Gambling over ships and whores, challenging highborn princelings to duels? Would you kindly explain what the hell is going on with you?";
			link.l1 = "Helen, let me explain! It's not that simple. Damn it, I'm sorry, but I never thought I'd have to spend the night at Madame Botot's place. I only slept there, yes, alone, I swear! And yes, I won a frigate in a card game. Imagine that?";
			link.l1.go = "GoldenGirl_14";
		break;
		
		case "GoldenGirl_14":
			dialog.text = "Well then! You are either a great liar, a saint, or a fool. We will discuss the whores and ships you won later - now tell me everything about the duel and why everyone is gossiping that you challenged a crown prince?";
			link.l1 = "Not a crown prince, only a count's bastard. He's the son of a very influential nobleman, Count de Levi Vantadour. Look, I didn't start it! He challenged me in the first place, and now I must win the duel without hurting him too much to avoid his father's wrath.";
		...
		case "GoldenGirl_15":
			...
			link.l1 = "This is why His Excellency has provided me with noble seconds. I will take only them with me - if things go belly up, at least I can prove that all went according to the duelling code and the law. I am asking you to watch over the frigate while I am gone.";
			link.l1.go = "GoldenGirl_16";
		break;
		
		case "GoldenGirl_16":
			dialog.text = "Let's make sure I've got this straight... You were gone for a whole day and night and won a whore and a frigate in a card game. And now, you're about to fight a noble whoreson whom you're not allowed to kill, while *I* just sit here and wait? How am I supposed to feel about all this?!";
			link.l1 = "Helen, listen, you have every right to be angry with me and I am truly sorry, but it's just...";
			link.l1.go = "GoldenGirl_17";
		break;
		
		case "GoldenGirl_17":
			dialog.text = "You know what, I've had enough of this. Just go and do your thing! I'll just dust your cabin and do your dirty laundry! Don't even think you're in the clear. We will talk about this when it's over. I'll take care of your new frigate, great Captain de Maure, don't you worry. Oh, and Captain de Maure, try not to die... for I'm planning on killing you myself afterwards. Now excuse me, I'm going to lock myself in my quarters and drink a bottle of that nice madeira I found in your cabin.";
			link.l1 = "Helen, just let me explain! Damn... Here we go again!";
			link.l1.go = "GoldenGirl_23";
		break;
		
		case "GoldenGirl_18":
			dialog.text = "I've heard the latest Parisian fashion demands that gentlemen win ships and courtesans in card games rather than buying them! Moreover, if one wants to make a good impression of himself, he has to challenge their previous owners to a duel. What the fuck have you gotten yourself into this time?!";
			link.l1 = "Helen, it's not that simple. Damn it, I'm sorry, but I never thought I'd have to stay the night at Madame Botot's place! Last night turned into an exhausting and brutal battle of wits. And yes, I won a bloody frigate at cards. Imagine that?";
			link.l1.go = "GoldenGirl_19";
		break;
		
		case "GoldenGirl_19":
			dialog.text = "Lovely. Does that mean you won a courtesan as well? And the frigate you won—what did you stake against it? Not our ship, you couldn't have...";
			link.l1 = "I had to. Look, it doesn't matter now, in the end I won. My opponent challenged me to a duel and accused me of cheating. He is the bastard son of an extremely influential nobleman, Count de Levi Vantadur. Which means that I will have to do my best not to kill him or hurt him too badly.";
			link.l1.go = "GoldenGirl_20";
		break;
		
		case "GoldenGirl_20":
			dialog.text = "Will he do the same? Have you lost your mind, Charles? To risk your ship, to risk your life, for some other woman?! Is she really worth it? Do I mean nothing to you?!";
			link.l1 = "Helen, there is no reason to be jealous, I swear. It just happened. I had to do it, and the governor provided me with noble officers as my seconds to ensure everything happens according to the rules. I can't take you or any of our men with me. Please take care of the frigate while I am gone.";
			link.l1.go = "GoldenGirl_21";
		break;
		
		case "GoldenGirl_21":
			dialog.text = "Just great! First, you go to an orgy with strange women and show up the next morning and I didn't even clip you for that. Now, you tell me that you nearly lost our ship in a card game but won a courtesan! And now you're about to fight for her 'honour' against some highborn whoreson whom you're not even allowed to kill! How am I supposed to feel about all this? Tell me.";
			link.l1 = "Helen, listen, you have every right to be angry with me, but let me just explain...";
			link.l1.go = "GoldenGirl_22";
		break;
		
		case "GoldenGirl_22":
			dialog.text = "You know what, I've had enough of this. Go off and fight your damn duel. I'll take care of your new frigate, great Captain de Maure, don't you worry. Now excuse me, I'm going to lock myself in my quarters and drink a bottle of that fine madeira I found in your cabin. But if something happens to you, I swear to God I will rain hellfire upon this town and bury this brothel and your beloved Excellency's palace!";
			link.l1 = "Helen, it'll be all right, trust me... Wait, where are you going?! Damn! Here we go again...";
			link.l1.go = "GoldenGirl_23";
		break;
		...
		case "GoldenGirl_24":
			...
			link.l1 = "That bastard wanted to repay me for the shame I brought upon him. I was afraid he'd do something to you! Thank God you are all right!";
			link.l1.go = "GoldenGirl_25";
		break;
		
		case "GoldenGirl_25":
			dialog.text = "I take it you had to do something to get me back? Something bad, right?";
			link.l1 = "All that matters is that you are back with me. I failed you, Helen. I am so sorry! I hope you can find it in your heart to forgive me!";
			link.l1.go = "GoldenGirl_26";
		break;
		
		case "GoldenGirl_26":
			dialog.text = "Already did. I've had a lot of time to think about what I said... I am sorry too, Charles. If only I hadn't taken your dealings with that marquis so personally. I would have set a proper watch that night, I would have been on guard. Ah! I'm just a useless woman!";
		...
		case "GoldenGirl_27":
			dialog.text = "I suppose I'd better not know exactly what you did, right? Fine, we're together again and that's what matters.";
		...
		case "GoldenGirl_28_1":
			...
			{
				dialog.text = "What a mess... I know you had no choice, but how will you explain this to Di Lu Parkes and his friends? I mean, you're a criminal now!";
				link.l1 = "I chose to pay that price, but I really had no choice. Don't you worry, I'll find a way to fix it and restore our good name. If not, then we will always be welcome at Isla Tesoro! I can manage if you are with me.";
			}
			else
			{
				dialog.text = "What a story, Charles... I believe you had no choice in the matter, but what comes next? Will that Englishman set things right, or is it war? Are you sure you don't want to come to Basse-Terre to witness them chaining that bastard?";
				link.l1 = "You know Helen, two weeks ago I would never have missed it. But today I say to hell with him! I don't even care anymore about his just punishment. We are together again, that is all that matters!";
			}
		...
		case "GoldenGirl_29":
			if (pchar.questTemp.GoldenGirl == "alarm_fin")
			{
				dialog.text = "You know that I will always be with you. Ha! It's not like it's the first time you and I ended up neck deep in the bilges. We'll make it again.";
				link.l1 = "True. Let's set sail, dear! The horizon awaits us!";
			}
			else
			{
				dialog.text = "I like your thinking, Charles! No more nobles: French, British, Spaniards - whatever. I think we've earned ourselves a holiday!";
		...
		case "GoldenGirl_30":
			...
			{
				dialog.text = "Sounds lovely! I'll go and tell the boys it's time to weigh anchor! And Charles...";
		...
		case "GoldenGirl_32":
			...
			link.l1 = "Thank God, you're alive, Helen! You have no idea how glad I am to see you again!";
		...
		case "GoldenGirl_35":
			dialog.text = "I suppose I'd better not know exactly what you did, right? Yes, we're together again and that's what matters.";
			link.l1 = "I have no secrets from you. I will tell you...";
		...
		case "GoldenGirl_36_1":
			dialog.text = "Unbelievable! Did you just say that France and England are on the brink of war with each other because of me?";
			link.l1 = "No, Helen. It's because I made a very bad mistake in judgement. But I had to bring you back and set everything right.";
			link.l1.go = "GoldenGirl_37";
		break;
		
		case "GoldenGirl_37":
			dialog.text = "That is all very touching and romantic, I am even ready to forget how it all started in the first place. Almost ready. But seriously, they arrested you because the Portuguese gave the wrong name of the damned brigantine?";
		...
		case "GoldenGirl_38":
			dialog.text = "He's gone. Right after he brought me here. I didn't want to accept the 'hospitality' of the courtesan you won, so I had Bartholomew rent a room for me. He paid for it and disappeared without saying a word. Actually, wait, no, he did leave a letter for you though!";
		...
		case "GoldenGirl_39":
			...
			link.l1 = "Damn it... I still can't believe I brought you back!";
		...
		case "LongHappy":
			...
			dialog.text = "White sand, clear green water, you, me, and good wine – Charles, this is so romantic! We should take walks like this together more often, alright!";
		...
		case "LongHappy_1":
			...
			link.l1 = "Helen, I love you. And I want to live with you every day that is allotted to me from above. Therefore, here and now, in the presence of this sea and sky, I ask you - Helen Beatrice Sharp - to grant me the honour of standing with me before man and God until death do us part. I, Charles de Maure, Chevalier de Monper, ask you - will you marry me?";
		...
		case "LongHappy_2":
			...
			{
				dialog.text = "You know, I never liked these formalities, but I'm with you until the end of the world. And as for your question, the answer is... oh, sorry, I spilled!";
				link.l1 = "Never mind, it's just wine and I never liked this shirt...";
				link.l1.go = "LongHappy_3";
			}
			else
			{
				dialog.text = "Charles, of course yes! Yes, yes, and yes again!!! But I do hope you're not planning to retire us to some dusty family castle to grow turnips until the end of our days?";
		...
		case "LongHappy_8":
			dialog.text = "Aye, there's one problem - most of our best friends, with whom we would gladly share this day, won't be allowed to enter the city, let alone the church. Therefore - let's get married here with all the important people, as expected, and then we'll sail to Isla Tesoro and have a proper celebration with our real friends. What do you think?";
			link.l1 = "Sounds good to me! I'll talk to Abbot Benoit, but we need to send out invitations and more...";
			link.l1.go = "LongHappy_9";
		break;
		
		case "LongHappy_9":
			dialog.text = "Calm down, captain. Your darling future wife will shoulder part of the burden! I'll arrange everything on Isla Tesoro and write to our friends, just tell me: how big a wedding do you want?";
			link.l1 = "Just you, me, and our closest friends. After all the official foppery here in Martinique, we'll want some genuine intimacy.";
			link.l1.go = "LongHappy_10";
			link.l2 = "Everyone must remember this day! Call everyone! No one will be left out!";
			link.l2.go = "LongHappy_11";
		break;
		
		case "LongHappy_10":
			pchar.questTemp.LongHappy.SmallMarry = "true";
			dialog.text = "Cozy and friendly - you read my mind! We'll have to visit Sharptown and I'll prepare everything. I think fifty barrels of rum and two dozen barrels of wine should be enough. Also, for food and entertainment, we'll need three hundred thousand pieces of eight.";
			link.l1 = "Remind me – why don't you manage the ship's finances again? I'll get it all. Just a quick visit to the abbot and then we set sail for Sharptown.";
			link.l1.go = "LongHappy_12";
		break;
		
		case "LongHappy_11":
			pchar.questTemp.LongHappy.BigMarry = "true";
			dialog.text = "So, you want to throw a party like real sea wolves? Alright! We'll have to visit Sharptown and I'll prepare everything. We'll need to seriously stock up – I think a hundred barrels of rum and fifty barrels of wine should be enough. And other expenses will take at least five hundred thousand pieces of eight.";
			link.l1 = "Are you inviting the entirety of the Brethren of the Coast? Oh hell, let's do it! I will get the supplies. Just a quick visit to the abbot and we set sail for Sharptown.";
			link.l1.go = "LongHappy_12";
		break;
		...
		case "LongHappy_13":
			...
			link.l1 = "Don't worry, my dear, I'll occupy myself with gainful employment... Or just have a nap on the sand. I never thought it would be easier to storm Tortuga than to plan my own wedding, for God's sake.";
		...
		case "LongHappy_15":
			dialog.text = "Did you get some rest, Charles? I have some good news and some bad news. The bad news is that the locals had so much fun last week that they accidentally burned the damn 'Old Woodpecker' tavern down! Here's the good news: the baron has promised it will be rebuilt, bigger and better than before, by the time we get back. I've made arrangements, so we can set sail.";
			link.l1 = "I hope our wedding won't leave a similar pile of ashes in town when we leave. That's a damn shame, I quite liked the 'Old Woodpecker' - cosy, intimate, with just a faint whiff of vomit and oakum! Oh well, darling, you're right - we should get going.";
		...
		case "LongHappy_17":
			dialog.text = "Jan is already in town with Gladys, can you imagine? I never thought they would actually come to my wedding! Oh, sweet Jesus! Even when we were in that dreadful Indian temple city, I wasn't as frightened as I am now!";
			link.l1 = "All is well, darling, all is well. I'm worried too – nerves are normal. Since the guests have already arrived, I should go to Father Benoit and find out when the service will begin.";
		...
		case "LongHappy_26":
			dialog.text = "";
			link.l1 = "I, Charles Henry de Maure, chevalier de Monper, take you, Helen Beatrice Sharp, to be my wife, to have and to hold, from this day forward, for better or for worse, for richer or for poorer, in sickness and in health, until death do us part. According to God's Holy Law, in the presence of God, I make this vow.";
			link.l1.go = "LongHappy_27";
		break;
		
		case "LongHappy_27":
			dialog.text = "I, Helen Beatrice Sharp, take you, Charles Henry de Maure, to be my husband, to have and to hold, from this day forward, for better or for worse, for richer or for poorer, in sickness and in health, until death do us part. According to God's Holy Law, in the presence of God, I make this vow.";
			link.l1 = "";
		...
		case "LongHappy_32":
			dialog.text = "You know – I thought this wouldn't change anything, and perhaps it hasn't – I loved you before and wanted to spend the rest of my days with you, but this day, this holy service... I am truly happy, Charles! Happier than ever before, and look at Gladys and Jan – they're radiant! There are so many joyful faces around! By the way – it's time for you to mingle with the guests and accept their congratulations. Come back when you're done, don't forget – we're expected in Sharptown.";
		...
		case "LongHappy_34":
			dialog.text = "Hello husband, have you already spoken to the guests?";
			link.l1 = "Not yet, be patient, wife, I'll be back soon.";
			link.l1.go = "LongHappy_34_1";
			link.l2 = "Yes, I've never heard so many congratulations at once. And you know what - I think most of them were sincere!";
		...
		case "LongHappy_35":
			dialog.text = "Yes, these noblemen are surprisingly sincere – I must admit, I expected more falsehood and hypocrisy. Or perhaps I'm simply so happy that I don't notice anything. But after all, our friends are waiting for us in Sharptown! When do we sail?";
			link.l1 = "Right now. We'll soar on eagles' wings straight to a friendly feast. I hope, my wife, you don't mind spending this night in our cabin?";
			link.l1.go = "LongHappy_36";
		break;
		
		case "LongHappy_36":
			dialog.text = "Oh yes, my husband, you are so romantic! And don't twitch like that, now I have the right to kiss you in public... Yes, we can go now!";
		...
		case "LongHappy_41":
			dialog.text = "I'm fine, Charles, it's all right. How is Nathan?";
		...
		case "LongHappy_44":
			dialog.text = "Charles, are you all right? Such a bloodbath! Sorry, we were stuck upstairs, there were a dozen of those bastards so I had to deal with them first!";
			link.l1 = "It's fine, I handled it. I'm glad I was able to finish that story with Jacques... at last. He got what he deserved.";
		...
		case "LongHappy_45":
			...
			link.l1 = "You're right, darling, I worry too. Go on, I'm right behind you.";
		...
		case "LongHappy_47":
			dialog.text = "Don't worry, love, Baron Tyrex will outlive us all. He's just woken up and is already buzzing, keeps calling for rum, his sabre, and the bridge - in that order.";
			link.l1 = "That's our old Marcus! Let him rest a bit while we finish here and then go back to the shore.";
		...
		case "LongHappy_49":
			...
			{
				dialog.text = "I'm so sorry, darling... First our faithful friend Tichingitu, now Gino... Barbazon should have been killed a dozen times for all he's done!";
			...
			else
			{
				...
				{
					dialog.text = "I feel so awful about Gino, Charles! When I found out, I couldn't believe it! How are you, love?";
					link.l1 = "I can't believe it either... what a way to go... I never imagined this day would turn out like this.";
				}
				else
				{
					dialog.text = "I wonder, will future historians write about the great battle of Privateer Bay? The day when the barons of the Brethren of the Coast met in open battle - I bet the Spanish Costa Garda are wiping away tears of gratitude! But, we won again! Our friends are alive, and our enemies are dead - a glorious wedding gift!";
					link.l1 = "Yes, quite a celebration, but we made it, my angel. We made it.";
				}
				link.l1.go = "LongHappy_50";
			}
		break;
		...
		case "LongHappy_50":
			dialog.text = "Come on, Dannie has found us a house here on the outskirts of town, I don't want to return to the ship now until it's been cleaned up. We'll sit and drink to those who didn't make it.";
		...
		case "LongHappy_52":
			if (CheckAttribute(pchar, "questTemp.LongHappy.Jino_died"))
			{
				dialog.text = "I feel so bad about Gino, Charles! When I found out, I couldn't believe it! How are you?";
				link.l1 = "I can't believe it either... what a way to go... I never imagined this day would turn out like this.";
			}
			else
			{
				dialog.text = "Have you seen Hawk? Dannie let me out when Gino said 'the danger is over'. I'm glad that everything is all right. Our friends are alive, and our enemies are dead - a glorious wedding gift!";
				link.l1 = "Me too, darling. And we've won. Barbazon is dead, the barons are gathering what's left of their crews. The fight is over.";
			}
		...
		case "LongHappy_53":
			...
			link.l1 = "Aye, I heard it from Jan, he's been there too. It seems to me that our dear Indian has gone on the warpath. Let's take a walk to Sabo-Matila Cove, a few people saw him leaving in that direction.";
		...
		case "LongHappy_55":
			dialog.text = "God above! That's the spirit, Tichingitu! Phew, I'm laughing my head off here! Why don't we Europeans adopt such a custom too?! Oh Charles, you're nearly asleep on your feet! Come on, Dannie has found us a house here on the outskirts - you need to get some rest.";
		...
		case "tonzag_jailed_2":
			dialog.text = "I'm perfectly fine, just let it go!\nCharles, go to hell! I hate dungeons, I hate you, and I hate this damned island! Get me out of here at once!\nSorry... I really don't like dungeons, don't touch me!";
		...
		case "tonzag_after_boarding":
			dialog.text = "My Captain, the enemy has breached the hull on the second deck and landed a boarding party. Battles are raging throughout the ship, and most of the gun crews have been knocked out! We need to rescue our crew and Hercule! Will you go, or should I?";
		...
		case "tonzag_after_boarding_1":
			dialog.text = "Aye aye, my Captain. I won't let you down, and please be careful!";
		...
		case "tonzag_after_victory":
			dialog.text = "Victory, my Captain! The landing party has been eliminated, the enemy has chosen to retreat and headed south. The ship's condition is acceptable. Crew alive: "+GetCrewQuantity(pchar)+" people. Report completed!";
			link.l1 = "Thank you, Helen, and what...";
			link.l1.go = "tonzag_after_victory_1";
		break;
		
		case "tonzag_after_victory_1":
			dialog.text = "Undress me, victor, your prize is to do whatever you please with me!";
			link.l1 = "Uh...";
		...
		case "tonzag_after_victory_2":
			dialog.text = "Oh, hi, Hercule. Sorry, you've caught us at an inopportune moment! But damn, I'm glad to see you alive and covered in someone else's blood - a natural state for you, huh!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "tonzag_dead":
			dialog.text = "Don't look, don't look, don't look... This is another world, my Captain! It can't be like this!";
		...
		case "IslaMona":
			...
			link.l1 = "This conversation is clearly going nowhere. We agreed that we would go to church tomorrow. To pray... of course.";
		...
		case "IslaMona_5":
			dialog.text = "The fact that the most scandalous couple in the Caribbean owns two entire islands! My pirate haven of Isla Tesora and your promised land - how long do you think they will last when civilisation finally comes to the West Indies?";
		...
		case "IslaMona_6":
			dialog.text = "Speaking of happiness... I'm about to go upstairs now: I need to light the candles, make the bed, perhaps write in my diary...";
			link.l1 = "I'll stay here a little longer, and then I'll come up to help you 'make the bed.'";
		...
		case "drinking_refuse":
			dialog.text = "Are you really that busy? Too bad, but I understand. I'll find something else to occupy myself with.";
			link.l1 = "";
			link.l1.go = "exit";
			NextDiag.TempNode = "Helena_wait";
		...
		case "drinking_accept_1_1":
			dialog.text = "Ha-ha! You wish! I'd have to be completely drunk!";
			link.l1 = "";
			link.l1.go = "exit";
		break;
		...
		case "drinking_in_tavern":
			dialog.text = "";
			link.l1 = "... she had many virtues, but she couldn't hold her drink. That's how we met.";
			link.l1.go = "drinking_in_tavern_1";
			link.l2 = "... my father insisted on military service. I yielded and went to Paris with a letter of recommendation. But I never reached the designated address and became an artist.";
		...
		case "drinking_in_tavern_1_1":
			dialog.text = "Lulu... With these stories, you've completely ruined Paris for me. I thought it was a city of grand living, but it just sounds like one big fancy brothel.";
		...
		case "drinking_in_tavern_1_2":
			...
			link.l2 = "(has a terrible cough)";
			link.l2.go = "drinking_in_tavern_1_4";
			link.l3 = "Uh... to each his own... I suppose?";
			link.l3.go = "drinking_in_tavern_1_4";
		break;
		
		case "drinking_in_tavern_1_4":
			dialog.text = "(laughs) Ha! You should have seen your face! Frightened? Let's have another! To Paris!";
			link.l1 = "To Paris!";
		...
		case "drinking_in_tavern_2_1":
			dialog.text = "(laughs) Well, thank you, Charles. I don't know how the rest of tonight will go, but the evening has already been wonderful. I might even let you paint my portrait. But, mind you, not in the same style as you painted your Parisian girls!";
			link.l1 = "Ha! That is, if I agree to paint you.";
			link.l1.go = "drinking_in_tavern_3";
		break;
		
		case "drinking_in_tavern_3":
			dialog.text = "Excuse me, my Captain, listening to your adventures and the lives of noble... courtesans of both sexes. Shark bite me, I'll never believe that you couldn't find something more worthwhile to do with your time! Don't even dare to tell me that all you did was smear canvases and squander your father's money. You wouldn't have survived a day with us if that were true.";
		...
		case "drinking_in_tavern_herotype_3":
			dialog.text = "";
			link.l1 = "I combined life at court with military service, but not... hehe, not quite the way my father wanted, of course. A couple of escapes through the window and one brawl later – and I became friends with the guardsmen. And naturally, I picked up a lot, toughened up my body. Older comrades taught me to take a hit, wear armour, handle a sword, and relax properly. The last part especially suited me, of course. You won't believe it, but not everyone can swing a sword from morning till noon and then drink from noon till the next morning.";
			link.l1.go = "drinking_in_tavern_4";
		break;
		
		case "drinking_in_tavern_herotype_1":
			dialog.text = "";
			link.l1 = "Do you think it was easy in the capital for a nobleman with a poor reputation and an empty purse, losing daddy's letter of recommendation on the very first day? I had to assert myself and not let anyone mock me. The fencing lessons at home were not forgotten, and I answered every sideways glance with a duel. Then I really got into it. Still, I never killed anyone, and I managed to leave Paris before running into an experienced fighter who would have finished me off.";
			link.l1.go = "drinking_in_tavern_4";
		break;
		
		case "drinking_in_tavern_herotype_4":
			dialog.text = "";
			link.l1 = "Spent a lot of time at cemeteries. Don't think anything bad - it was just a popular pastime in my social circle. For courage, we would go to a cemetery at night, put empty bottles on the fence, and shoot at them against the clock. By morning, we'd have wasted a hundred bullets and a crate of champagne. Now, of course, I'm ashamed of such behaviour, but back then the winner took a solid jackpot and received some... favours from the ladies of the court. Everything was put to use - I even dabbled a bit with gunpowder mixtures. But why none of us ever thought to learn how to make paper cartridges - I'll never know.";
			link.l1.go = "drinking_in_tavern_4";
		break;
		
		case "drinking_in_tavern_herotype_2":
			dialog.text = "";
			link.l1 = "Studied, and quite diligently – was even close to getting into the Sorbonne. Worked in an office until it became tedious, and in general – did a bit of everything. The teacher, an old friend of my father's, preferred practice to theory, so I got to see Paris from all sides and talk to all sorts of people: from bandits to nobles. All of that ended up coming in handy here.";
			link.l1.go = "drinking_in_tavern_4";
		break;
		
		case "drinking_in_tavern_4":
			dialog.text = "And... that's it? So there's still something in you, my captain. Something you haven't yet seen in yourself. To you!";
			link.l1 = "Good toast!";
			link.l1.go = "exit";
		...
		case "drinking_my_background_1":
			dialog.text = "Just under thirty, huh, Charles? For such a bold remark, you'll have to pay for the next round! All my men are dead, and I don't command a schooner anymore. Frankly, I don't know if I will ever command one again.";
			link.l1 = "I'm sorry, Helen. I didn't mean to touch a nerve. But why do you think your captain's career is over?";
		...
		case "drinking_my_background_3":
			dialog.text = "My case, Charles, is unique. My father was one of the best sailors in these parts, highly regarded by the Forest Devil, his crew worshipped him, and he loved me more than life itself.";
			link.l1 = "";
			link.l1.go = "drinking_my_background_4";
		break;
		
		case "drinking_my_background_4":
			dialog.text = "Take away even one of these things, and he would have either sent me to London to live in... civilisation, or left me to wither here like my mother. Everything worked out well at first: I wanted freedom, real freedom, Charles, and skilful command of a warship with a loyal crew gives you exactly that. And my father gave me all he could. I went out to sea with him at the age of twelve, spent the first six months chasing rats in the hold, and only then was I allowed to work with the sailors.";
			link.l1 = "Sean MacArthur made you a ship rat? Sorry, Helen, but there's no coming back from that! How did the crew take to you?";
		...
		case "drinking_my_background_6":
			dialog.text = "Yes. All the barons openly told my father he was a fool, but it was the Forest Devil who gave him his approval and shook his hand after I broke the crew's record climbing the mast. That moment will stay with me forever: the triumphant shouts of the crew and, everywhere I looked, the endless sea horizon. And my father's approving gaze—I couldn't see it, but I felt it with all my heart.";
		...
		case "drinking_my_background_12":
			dialog.text = "I didn't even understand what happened. The Dutch merchant had his vanguard - mercenaries of the Company. They decided to play it boldly and counterattacked our poop deck. And I, like a fool, without any fear for my life, stuck my blond head out. I immediately got hit with the butt of a pistol. But a moment before that, I managed to stick my rapier into some fool from the Company.";
			link.l1 = "Good Lord, what about Sean? How come he didn't kick you ashore after that?";
			link.l1.go = "drinking_my_background_13";
		break;
		
		case "drinking_my_background_13":
			dialog.text = "My father didn't come out of that battle unscathed either, and the sight of my cracked, foolish head certainly didn't help. He slowly began to decline, and probably no one noticed except me. And then he was gone. According to his will, I inherited the Rainbow with her crew and enough funds to keep the ship afloat for a year.";
			link.l1 = "And did the crew accept you as captain?";
			link.l1.go = "drinking_my_background_14";
		break;
		
		case "drinking_my_background_14":
			dialog.text = "We don't live in a fairy tale, my captain. Some met my father's will with hostility – things took an unpleasant turn\nIf even a single sailor had left the Rainbow, refusing to serve under my command, it would have been disastrous for my reputation. But Svensson intervened and set everyone straight. No one left the crew openly... back then. For seven years, I commanded my beauty, transported questionable goods for the Forest Devil, searched for treasures, lived... But now, that's all in the past.";
		...
		case "drinking_my_background_15":
			dialog.text = "I've been thinking about your life in Europe... Look, you're a city dandy, and I'm just an ordinary girl, but we've already made names for ourselves in the most dangerous corner of the world.";
		...
		case "drinking_my_background_16":
			dialog.text = "Well, I stand on my father's shoulders. I don't know about you, but perhaps your family has also had no less influence on you? Maybe you haven't realised it yet?";
			link.l1 = "I'll ask my dear brother once I get him out of prison.";
			link.l1.go = "exit";
		...
		case "drinking_game_2":
			...
			link.l1 = "Yeah, you're right, Helen. We have no privacy here.";
			link.l1.go = "drinking_game_3";
		break;
		
		case "drinking_game_3":
			dialog.text = "That's not the only thing we don't have, Charles... It's not a card game, but don't worry, I bet you're a master at it. 'Never Have I Ever' - heard of it?";
			link.l1 = "Familiar. From a past life. And do you play it often?";
			link.l1.go = "drinking_game_4";
		break;
		
		case "drinking_game_4":
			dialog.text = "Always wanted to try, but had no one to play with.";
			link.l1 = "That's a rather bold game for our first shared drink. Are you sure?";
		...
		case "drinking_game_5":
			...
			link.l2 = "Let's begin! Ladies first!";
		...
		case "drinking_game_refuse":
			dialog.text = "Too bad, but perhaps you're right. Another drink then?";
			link.l1 = "Let's begin! Ladies first!";
			link.l1.go = "drinking_game_refuse_1";
		break;
		
		case "drinking_game_refuse_1":
			dialog.text = "I've arranged it - the room upstairs is yours. It was occupied by some important French officer, but the Forest Devil's boys politely asked him to vacate the place. Go get some shut-eye - I won't let you wander the street, or worse yet, go out to sea, in this condition.";
			link.l1 = "Yes, ma'am!";
			link.l1.go = "exit";
		...
		case "drinking_game_accept":
			dialog.text = "Ha! Hic! That means you're starting!";
		...
		case "drinking_game_accept_1":
			dialog.text = "So that's how it is? I need to keep my guard up around you! (Drinks)";
			link.l1 = "";
		...
		case "drinking_game_accept_3":
			dialog.text = "";
			link.l1 = "Nicely done! Allow me, mademoiselle, to drink to you! (Drinks)";
		...
		case "drinking_game_accept_5":
			dialog.text = "And you call yourself a sailor! You know very well what kind of people we are. You never know what the voyage will bring, nor when or where you'll see land, if at all. You have to seek answers beyond maps and navigation tools! To your health! (Drinks)";
			link.l1 = "";
		...
		case "drinking_game_accept_7":
			dialog.text = "Charles! If we had met back then, I would have shot you or taken you hostage for ransom. And by the way, I have never picked up a paintbrush.";
		...
		case "drinking_game_accept_8":
			...
			link.l1 = "(Sips) Hic! Hmm... I've never had my models hit me on the head with a pistol grip.";
			link.l1.go = "drinking_game_accept_9";
		break;
		
		case "drinking_game_accept_9":
			dialog.text = "(Sips) Ugh. We're playing this game all wrong, dear. I thought we'd be drinking and getting to know each other, but instead we're exchanging barbs and... and... Hic. Damn!";
			link.l1 = "";
		...
		case "drinking_game_accept_11":
			dialog.text = "I... Hic... can't believe it. I confess, guilty - little Rumba used to hit the bottle. But I've never been in prison!";
			link.l1 = "How did you...?";
		...
		case "drinking_game_accept_13":
			dialog.text = "Come on, my dear. The last question and the last chance to outsmart me!";
			link.l1 = "No... I... Let's get some fresh air.";
			link.l1.go = "drinking_game_enough";
			link.l2 = "I've often drunk, but never like this... I've never gotten s-so drunk with a girl. I swear on my w-word, d-drinking is truly a g-great sin...";
		...
		case "drinking_game_accept_15":
			dialog.text = "Ah-ha-ha! That's hilarious! You aim high, my captain. Let it be... hic!... known to you...";
			link.l1 = "";
			link.l1.go = "drinking_game_accept_16";
		break;
		
		case "drinking_game_accept_16":
			dialog.text = "That I have the misfortune of living among an all-male crew, and I must behave carefully. I am an honest girl.";
			link.l1 = "I'm h-happy for you, H-Helen.";
			link.l1.go = "drinking_game_accept_17";
		break;
		
		case "drinking_game_accept_17":
			dialog.text = "You'll be even happier, because I won! But, to be honest, I've never gotten so drunk with a man either.";
		...
		case "drinking_game_accept_18":
			dialog.text = "Hey-hey-hey! Captain, where are you going? Are you offended, perhaps?";
		...
		case "drinking_at_svenson":
			...
			link.l1 = "Phew! Let me at least catch my breath! Are you sure about this, Helen?";
			link.l1.go = "drinking_at_svenson_1";
		break;
		
		case "drinking_at_svenson_1":
			dialog.text = "Yes, damn it, and don't stand there like a post! I need to lose myself, even if it's just for one night!";
			link.l1 = "I'm afraid after tonight, I'll be the one wanting to lose myself. Let's go before we wake up the whole town.";
			link.l1.go = "exit";
		...
		case "drinking_give_key_1":
			...
			link.l1 = "Sharp as a knife, a true smuggler! Hold on, I'll be quick.";
			link.l1.go = "exit";
		...
		case "drinking_got_whiskey_1":
			dialog.text = "I'm proud of you! Haha! First-rate Irish whiskey, 'Bushmills'! They wouldn't serve us such a drink in the tavern.";
			link.l1 = "Sounds good, but won't Svensson notice it's missing?";
			link.l1.go = "drinking_got_whiskey_2";
		break;
		
		case "drinking_got_whiskey_2":
			dialog.text = "He'll definitely notice, but he doesn't drink it himself. He seems to have saved it as a gift for his pirate friend Dodson, and Dodson has either disappeared or killed someone...";
			link.l1 = "That's terrible! Such a gift must not go to waste. Grab the barrel, and let's change the scenery!";
			link.l1.go = "drinking_got_whiskey_3";
		break;
		
		case "drinking_got_whiskey_3":
			dialog.text = "Well said, Cap. One more thing though - tell me, did you take anything else from the chest? Answer honestly.";
		...
		case "drinking_got_whiskey_believe":
			dialog.text = "Somehow I believe you... fool that I am!";
			link.l1 = "";
			link.l1.go = "drinking_get_out";
		break;
		
		case "drinking_got_whiskey_notbelieve":
			dialog.text = "Go and make sure you haven't taken anything for some reason.";
			link.l1 = "";
			link.l1.go = "exit";
			if (!HelenDrinking_RobbedSvenson()) {
		...
		case "drinking_at_fort":
			...
			link.l1 = "Phew, well, your costume is something! You must have saved a lot of money on fabric. And I... hic! I've seen a lot! But this... But this is the best thing I've ever seen.";
			link.l1.go = "drinking_at_fort_1";
			locCameraFromToPos(-1.65, 44.45, 76.64, true, -5.93, 42.10, 70.13);
		break;
		
		case "drinking_at_fort_1":
			dialog.text = "Everyone says that, but for some reason, I believe you! Do you really mean it?";
			link.l1 = "Well, of course, it very favourably accentuates your figure, although...";
			link.l1.go = "drinking_at_fort_2";
		break;
		
		case "drinking_at_fort_2":
			dialog.text = "Oh, now you've ruined everything!";
			link.l1 = "... although I have no doubt that among the common folk, it inspires awe!";
			link.l1.go = "drinking_at_fort_3";
		break;
		
		case "drinking_at_fort_3":
			dialog.text = "I'm rather in awe of this strange widespread habit among the common and not-so-common folk to wear heavy European clothing in such heat. That makes our villages look even more comical... I like my outfit, Charles. In it, I feel beautiful, and that's important for a woman.";
		...
		case "drinking_at_fort_5":
			...
			link.l1 = "Then let's squeeze in a question about your costume. I don't believe that sea dogs could take a captain seriously in such attire.";
			link.l1.go = "drinking_at_fort_6";
		break;
		
		case "drinking_at_fort_6":
			dialog.text = "And I don't believe that sea dogs, in general, can accept a woman as a captain, so my outfit probably didn't add to my problems. Or maybe it didn't have time to, since it's a new thing. I sewed it myself!\nAh-ha-ha! I used to wear one of those... what are they called? Our military still wears them! Brr... Seeing one of those now makes me feel sick.";
			link.l1 = "Uniforms?";
			link.l1.go = "drinking_at_fort_7";
		break;
		
		case "drinking_at_fort_7":
			dialog.text = "Oh, exactly, a uniform! A red uniform! Like the one that man is wearing.";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "drinking_at_fort_8":
			dialog.text = "I'm so glad! Let's have a drink!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "drinking_at_miskito":
			dialog.text = "Ugh. Look what I've got!";
			link.l1 = "Helen... Are you planning to use that... to lift your spirits?!.. Don't even think about it! Datura can completely take over a person, drain their strength, crush their will! Before you know it, you're a living corpse, and then very quickly, a dead one...";
			link.l1.go = "drinking_at_miskito_1";
		break;
		
		case "drinking_at_miskito_1":
			dialog.text = "Charles, but... right now...";
			link.l1 = "No buts. I'm sorry for being harsh, but this is no joke. I'm taking this away from you. I can't believe what you were thinking... Here, drink this and snap out of it.";
		...
		case "drinking_at_miskito_2":
			dialog.text = "I'm sorry, Charles. You're absolutely right, I know. A momentary weakness. It won't happen again. Thank you for saving me from the devil's temptation...";
		...
		case "drinking_at_miskito_3":
			dialog.text = "They respect Svensson, and some of that respect spills over to me. Our little town survives solely on Jan's deals. He shares a portion of the profits from his cocoa plantations with the redcoats, and the Miskito owe him their entire livelihood.";
			link.l1 = "How did that happen?";
			link.l1.go = "drinking_at_miskito_4";
		break;
		
		case "drinking_at_miskito_4":
			dialog.text = "When the Castilians were in charge, they didn't bother the Indians much. But after they kicked out the noble Hidalgos, our people decided to take control of the local forests. Jan resolved the matter quite decisively back then - even sent people to London! Of course, not out of the goodness of his heart: extracting cocoa in a forest where every bush hates you is a hopeless venture. But now, the Indians not only help Jan smuggle from Porto Bello to Blueweld but also cut down their own forests for a pittance. Bravo, Forest Devil, bravo!";
		...
		case "drinking_at_miskito_6":
			...
			link.l1 = "Then let's change the subject. I meant to say that you clearly fit in with this company, and they consider you one of their own.";
			link.l1.go = "drinking_at_miskito_7";
		break;
		
		case "drinking_at_miskito_7":
			dialog.text = "It just so happens that it's much easier for me to be in the company of Indians, gypsies, and other decent misfits. Mum's stews, beach bonfires, and the Rainbow's gangway - I've built myself a cosy little world, Captain. Too bad it all came crashing down just when I thought I had everything figured out.";
		...
		case "drinking_at_perlas":
			...
			link.l1 = "Yes, it's been a while since I've relaxed like this. It'll be something to remember!";
			link.l1.go = "drinking_at_perlas_1";
		break;
		
		case "drinking_at_perlas_1":
			dialog.text = "You probably think God knows what about me right now. I'm a very closed-off person by nature, Charles. I just... damn, I just wanted to feel alive! Just wanted to talk to someone!";
			link.l1 = "What about Gladys? Jan?";
			link.l1.go = "drinking_at_perlas_2";
		break;
		
		case "drinking_at_perlas_2":
			dialog.text = "All mum does is cry, and Jan seems like a different person now. Maybe I'm imagining things, I don't know, but it's as if he's ashamed of me now? Forgive me, I... (sniffles).\nThat's enough, old girl. Sorry, I got a little carried away.";
			link.l1 = "No need to apologise. I understand everything, or at least I think I do.";
		...
		case "drinking_at_perlas_4":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_friend") && !CheckAttribute(pchar, "questTemp.HelenDrinking.RobbedSvenson")) {
				...
				dialog.text = "Thank you for the evening, Captain. Who knows, perhaps we'll do it again.";
			}
		...
		case "ambush":
			dialog.text = "Thank you for bringing me here, Captain. Let's have a look around, shall we? Let's examine my inheritance.";
		...
		case "after_ambush":
			switch (pchar.questTemp.HelenDrinking.IslaTesoroAmbush) {
				case "A":
					...
					link.l1 = "What about that huge ship hauled ashore?";
				...
				case "C":
					...
					link.l1 = "There was a time like that in my life, yes. Are you impressed?";
		...
		case "after_ambush_1":
			dialog.text = "Yes, you're right. I'd love to explore it, but to be honest, Charles, I'm a little afraid of it. Let's go.";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "ambush_inresidence":
			dialog.text = "A cramped, cold hovel with absurd demands. I already feel as if I'm in a trap!";
		...
		case "ambush_inresidence_1":
			dialog.text = "No, Charles. Perhaps I am too fussy, but for now, it epitomises everything I fear and hate. I hope I'll be able to rent it out... Although, I'm not sure where I'll spend the money.";
			link.l1 = "Don't underestimate the value of rent. I don't pay rent, and often I have to come up with ways to pay my crew. You'll buy yourself a new ship, 'Rainbow II' - sounds good, don't you think?!";
			link.l1.go = "ambush_inresidence_sea";
			link.l2 = "There are many ways to spend money on yourself. Start with a personalised sword and a bottle of excellent wine. Treat yourself, Helen, you deserve it.";
		...
		case "ambush_inresidence_sea":
			if (CheckAttribute(pchar, "questTemp.HelenDrinking.Background") && pchar.questTemp.HelenDrinking.Background == "sea") {
				dialog.text = "Thank you, my captain. I'm pleased to hear that. It's especially nice to hear it a second time. You know me well.";
				pchar.questTemp.Saga.HelenRelation = sti(pchar.questTemp.Saga.HelenRelation) + 3;
				notification("Helen approves", "Helena");
			} else {
		...
		case "ambush_inresidence_land":
			if (CheckAttribute(pchar, "questTemp.HelenDrinking.Background") && pchar.questTemp.HelenDrinking.Background == "land") {
				dialog.text = "Do you think I deserve it? I've never spent money on such trifles, but I suppose there's a first time for everything. I see you won't stop trying to make me forget about the sea, eh, Captain? Maybe you're right...";
				pchar.questTemp.Saga.HelenRelation = sti(pchar.questTemp.Saga.HelenRelation) - 3;
				notification("Helen disapproves", "Helena");
			} else {
				dialog.text = "Do you think I deserve it? I've never spent money on such trifles, but I suppose there's a first time for everything.";
			}
			link.l1 = "";
			link.l1.go = "ambush_inresidence_2";
		...
		case "ambush_inresidence_2":
			...
			link.l1 = "It's as if you've changed, Helen. When we were together last time, you were... I don't know, more open?";
			link.l1.go = "ambush_inresidence_3";
		break;
		
		case "ambush_inresidence_3":
			if (sti(pchar.questTemp.Saga.HelenRelation) >= 6) {
				dialog.text = "Nothing has changed, my captain, but a lot has fallen on a poor girl's shoulders, haha! I didn't mean to offend you. I just need to think over a lot of things right now. You know, such sharp turns in life don't happen every day. And we still have plenty of time together!";
				...
				link.l1 = "I'm glad we cleared that up. Let's get out of here.";
			}
			link.l1.go = "exit";
		...
		case "ambush_inresidence_wait":
			...
			if (CheckCharacterItem(pchar, "pirate_cutlass")) {
				link.l1 = "Hey, not everything has been looted! Look, Helen! This sabre seems to be legendary, given that even the local riffraff hesitated to pocket it.";
		...
		case "ambush_inresidence_give_cutlass":
			dialog.text = "Shiver me timbers, this is... the legendary cutlass of Blaise himself! Pirates respected him too much to take the cutlass from his home even after his death. They took the money and valuables, of course, but even future gallows birds have remnants of honour...";
		...
		case "ambush_inresidence_give_cutlass_1":
			dialog.text = "Thanks for the keen observation, Charles. You've completely ruined this place for me, ha-ha!";
			link.l1 = "I think this cutlass is yours now. Blaise is your so-called uncle...";
			link.l1.go = "ambush_inresidence_give_cutlass_2";
		break;
		
		case "ambush_inresidence_give_cutlass_2":
			dialog.text = "You're making it even more terrifying, my captain. I... I can't. I'm afraid that if I accept it, my past life will come to a complete end.";
		...
		case "ambush_inresidence_give_cutlass_3":
			dialog.text = "Who could that be? Just kidding! Thank you for dispelling my dark thoughts, captain. I promise I'll train hard to become worthy of this blade!";
		...
		case "give_cutlass":
			dialog.text = "Shiver me timbers, this is... the legendary cutlass of Blaise himself! Pirates respected him too much to take the sabre from his home even after his death. They took the money and valuables, of course, but even future gallows birds have remnants of honour\nI... I can't. I'm afraid that if I accept it, my past life will come to a complete end.";
			link.l1 = "Then take it not as part of the inheritance but as a gift from a handsome man.";
			link.l1.go = "give_cutlass_1";
		break;
		
		case "give_cutlass_1":
			dialog.text = "Who might that be? Just kidding! Thank you for dispelling my dark thoughts, my captain.";
			link.l1 = "You're worthy of the finest weapon, Helen. I'm glad you like it.";
			link.l1.go = "give_cutlass_2";
		break;
		
		case "give_cutlass_2":
			dialog.text = "I promise I'll train hard to become worthy of this blade!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "arrive_1":
			dialog.text = "I slipped up by accident, ha! Glad to see you too...";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "arrive_2":
			dialog.text = "So much for sisterly solidarity! My captain, I... I was really worried and missed you so much!";
		...
		case "after_kiss":
			...
			link.l2 = "You've been waiting your whole life to meet me? I'm flattered!";
		...
		case "after_kiss_a":
			dialog.text = "Damn right! You'll tell me everything, everything! I'll be waiting for you on the ship, Captain!";
			link.l1 = "Wait!...";
			link.l1.go = "exit";
		...
		case "after_kiss_b":
			dialog.text = "Fool! Want to offend me? All right, I'm offended! Ha-ha! I'll go to the ship for now, before Danny makes more fun of me...";
			link.l1 = "Wait!...";
			link.l1.go = "exit";
		...
		case "loot_good":
			dialog.text = "My captain, what's the news? I can tell by your pale face that the lawyer has decided to throw more problems your way instead of helping.";
			link.l1 = "You're right, Helen. Loxley demanded an impressive advance, and the case itself will cost me a tidy sum. I'm going to go shake Jan - I've had enough! It's as if the Brethren decided to pass all their expenses onto me!";
		...
		case "loot_good_2":
			dialog.text = "I used to work for Jan - smuggling valuable timber all over Maine. But I'm a resourceful girl, and I set something aside for myself during all those trips.";
			link.l1 = "And Jan never found out? Clever!";
		...
		case "loot_good_3":
			...
			link.l1 = "You've already figured it all out, haven't you? Thank you, Helen, we'll definitely visit if we have the time.";
			link.l1.go = "exit";
		...
		case "loot_bad_2":
			dialog.text = "I have something stashed away in San Juan del Norte. There's a cave nearby - we'll just need to gather some sailors so we don't have to carry everything ourselves.";
			link.l1 = "You've already figured it all out, haven't you? Thank you, Helen, we'll definitely visit if we have the time.";
			link.l1.go = "exit";
		...
		case "shdn_ambush":
			dialog.text = "We have a problem! A squad of soldiers is coming this way, and they look menacing. Be careful, Charles, these aren't just ordinary coast guards - there's a French officer among them! I beg you, just don't do anything foolish!";
		...
		case "shdn_ambush_1":
			if (sti(pchar.questTemp.Saga.HelenRelation) >= 6) {
				dialog.text = "Ha, the second option sounds more enticing, but I hope you're not too full of yourself, Charles?";
			} else {
		...
		case "shdn_ambush_3":
			dialog.text = "My name is Helen MacArthur! Captain, you know who I am and whom I work for! Inform your people, especially that fancy idiot lying on the ground, of today's results, which I will now announce!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "shdn_ambush_4":
			dialog.text = "Protest? I don't care if you write to Cromwell himself. First, Monsieur de Maure did not lose his honour today.";
			link.l1 = "";
		...
		case "shdn_ambush_5":
			dialog.text = "Second, Colonel de Tavann was shot by a girl in a very spicy outfit for calling her a prostitute.";
			link.l1 = "";
			link.l1.go = "shdn_ambush_6";
		break;
		
		case "shdn_ambush_6":
			dialog.text = "Third, you immediately withdraw your soldiers and forget about what happened, unless you want the Forest Devil to hear about it.";
			link.l1 = "";
		...
		case "shdn_ambush_8":
			dialog.text = "Later, Charles. Let's get out of here before they recover from the shock. I'm shaking all over too. Shall we talk in Blueweld?";
			link.l1 = "Agreed.";
			link.l1.go = "exit";
		...
		case "duel_victory":
			...
			link.l1 = "Shiver me timbers! Not even a word of congratulations? Fine, let's go.";
			link.l1.go = "exit";
		...
		case "after_cave_1":
			dialog.text = "I don't understand duels. A man's pastime, usually ending with two corpses, and on a lucky day, even more. And honour... I believe honour is built on the desire to avoid conflict until the very end, as it rarely proves worthy. Ha! Just listen to me - I'm spouting some nonsense!";
		...
		case "after_cave_duel":
			dialog.text = "A pity you played into their hands. The colonel was clearly obsessed, and the rest were just after spectacle and some gossip material. Well, I won't rub it in - you've had enough for one day as it is.";
			link.l1 = "Yes, after duels, there's always a sense of emptiness. Enough adventure for today. What do you want to do next?";
		...
		case "after_cave_notduel":
			dialog.text = "Ugh! I just wanted to say that I'm proud of us. You showed real courage today, my captain. You didn't succumb to the hysteria of the crew, who just wanted to command you for once. You stood firm against the pretence of the red uniform and the obsession of the blue. The colonel was clearly seeking death, but got nothing more than a wound in an inappropriate place, ha-ha!";
			link.l1 = "Thank you, Helen. You steered us away from disaster brilliantly, like a true naval officer. Are you proud of yourself?";
			link.l1.go = "after_cave_notduel_1";
		break;
		
		case "after_cave_notduel_1":
			dialog.text = "Yes, I needed that. It's just a shame it was a blue uniform, and not a red one, but at least the person wearing it got what he deserved.";
			link.l1 = "That person is indeed inconsequential, I admit. Enough adventures for today. What would you like to do next?";
			if (sti(pchar.questTemp.Saga.HelenRelation) == 7 || sti(pchar.questTemp.Saga.HelenRelation) == 8) {
				link.l1.go = "after_cave_mild";
			} else {
				if (sti(pchar.questTemp.Saga.HelenRelation) < 7) {
		...
		case "after_cave_mild":
			dialog.text = "I'm heading home, my captain. Missed my mo... Gladys. Too bad she's at home right now, otherwise, I would have invited you over!";
		...
		case "after_second_kiss_1":
			dialog.text = "Oh! Pull yourself together, girl! Until we meet again, my captain.";
		...
		case "after_second_kiss_a":
			...
			link.l1 = "Until we meet again, Helen. Oh God, what a woman...";
			link.l1.go = "exit";
		...
		case "after_second_kiss_b":
			dialog.text = "Fool! Want to offend me? All right, I'm offended! Ha-ha! We'll see each other soon, my captain.";
			link.l1 = "Until we meet again, Helen. Oh God, what a woman...";
			link.l1.go = "exit";
		...
		case "after_cave_cold":
			dialog.text = "I'm heading home, Cap. I suppose the money issue with the lawyer is now sorted out? We've got tough obstacles ahead of us, so let's try to stay out of trouble from now on. Trouble will find us itself.";
			link.l1 = "Shiver me timbers, really?";
		...
		case "after_second_kiss1":
			locCameraFromToPos(4.97, 3.71, 16.06, true, 5.09, 1.25, 11.67);
			if (CheckAttribute(pchar, "questTemp.HelenDrinking.Kiss")) {
				dialog.text = "M-m-m, this one is even better than the first. Remember? By the idol?";
				link.l1 = "That's not something one forgets, dear.";
		...
		case "after_second_kiss1_1":
			dialog.text = "Damn right! Shiver me timbers! Gladys isn't home now. Want to come in?";
			...
			link.l3 = "Another time, my dear. I really want to, but today almost did me in. We'll catch up and make up for the lost time tenfold.";
		...
		case "after_second_kiss1_a":
			...
			link.l2 = "Another time, my dear. I really want to, but today nearly did me in. We'll catch up and make up for the lost time tenfold.";
		...
		case "after_second_kiss1_b":
			dialog.text = "Fool! Want to offend me? All right, I'm offended! Ha-ha! You'll have to make amends, my captain. Well! Gladys is not home now. Want to come in?";
			if (GetCharacterIndex("Mary") >= 0 && CheckAttribute(pchar, "questTemp.LSC.Mary") && pchar.questTemp.LSC.Mary == "alive") {
				link.l1 = "No, Helen. Another woman awaits me on Justice Island. I cannot do that to her.";
				link.l1.go = "after_cave_lewd_refuse_mary";
			}
			link.l2 = "Another time, my dear. I do want to, but today nearly did me in. We'll catch up and make up for lost time tenfold.";
			link.l2.go = "after_cave_lewd_refuse_head";
			link.l3 = "Inviting me over? And what will we be doing?";
			link.l3.go = "after_cave_lewd_accept";
		break;
		...
		case "after_cave_lewd_refuse_mary":
			dialog.text = "Ah, so I'm not adept enough in the art of seduction? And she is? Who is she?";
		...
		case "after_cave_lewd_refuse_head":
			dialog.text = "Oh, my captain! It's dangerous to leave a woman in such a state! I'm holding you to your word, and now go... I need to be alone and try to deal with my problem... on my own! See you on the ship!";
			link.l1 = "What a girl!";
			link.l1.go = "exit";
		...
		case "after_cave_lewd_accept":
			dialog.text = "Don't worry, my dear, I'll guide you if you get lost.";
		...
		case "after_cave_sex":
			...
			link.l1 = "And how was it? Did reality live up to your expectations?";
		...
		case "after_cave_sex_again":
			dialog.text = "Oh, now I understand! It was simply marvellous, my captain!";
		...
		case "after_cave_gladys_1":
			...
			link.l1 = "Already?! No, Helen, have mercy on me, please. Gladys's sudden appearance definitely didn't help the atmosphere.";
		...
		case "after_cave_gladys_3":
			dialog.text = "Alright, then let's just stay together for a bit. Our future is so murky and frightening, but for the first time in a long while, I'm not afraid of anything else. I know that some new fear may creep in, but not today. Not today, my captain.";
		...
		case "give_potions_1":
			dialog.text = "I know this Snake Eye - he's a good man, but a bit odd. He regularly sends people on quests for who knows what. I see that you have received that dubious honour as well.";
			if (!CheckAttribute(CharacterFromID("SnakeEye"), "quest.amulet")) {
				...
				link.l1 = "That's right, I need to bring him three amulets, or else he won't be able to help me reach Hawk's place. I can't figure out where to find them now, and time is running out.";
				link.l1.go = "give_potions_3";
			}
		break;
		
		case "give_potions_already":
			dialog.text = "Oh, what a shame! I'm glad you didn't have to run around collecting those amulets from lighthouse keepers, but I was hoping that for once I could be of use to you, hoping to prove myself.";
			link.l1 = "Nonsense, Helen. You don't need to prove anything to me.";
			link.l1.go = "give_potions_4";
		break;
		
		case "give_potions_3":
			dialog.text = "I'll help you! I admit, I was hoping that for once I could be of use to you, hoping to prove myself.";
			link.l1 = "Nonsense, Helen. You don't need to prove anything to me.";
			link.l1.go = "give_potions_4";
		break;
		
		case "give_potions_4":
			dialog.text = "Nevertheless, I want to help you. Here, take the key to my room... I mean, the chest in my room! There's not much, but it might come in handy for you. And... Charles, just try not to burst out laughing right now!";
			link.l1 = "Ahem, I wasn't going to. I see you're interested in these things?";
			link.l1.go = "give_potions_5";
		break;
		
		case "give_potions_5":
			dialog.text = "I'm a sailor, captain, just like you. In our line of work, we must do all we can to get Lady Luck on our side.";
		...
		case "upgrade_1":
			dialog.text = "Ah-ha, stop it! I once delivered a decent batch of silk to the local shipwright, so now he owes me a complete overhaul of a ship. I thought of giving him 'Rainbow' for this job, but that was not meant to be. Your vessel, on the other hand, could really benefit from such care, don't you think?";
			link.l1 = "Indeed, a splendid gift, Helen – right up your alley!";
			link.l1.go = "upgrade_2";
		break;
		
		case "upgrade_2":
			dialog.text = "I'm glad you like it. Visit him anytime and tell him I sent you. He'll do his best work.";
			link.l1 = "Definitely!";
			link.l1.go = "exit";
		...
		case "give_sex_1":
			dialog.text = LinkRandPhrase("Your lady misses you and demands your attention. May I request that a room be arranged for her, and that you devote some time to her","Reporting: your presence is required in a bed at the local tavern. Just five minutes of your time, but the crew hopes you'll stay a little longer!","Mutiny on the ship, captain! I am tasked with handing you a black mark in private. Come with me at once!");
		...
		case "give_sex_1_no":
			dialog.text = "Oh, and what would you have a poor girl do, huh? Alright, my dear, another time then.";
			link.l1 = "";
		...
		case "rainbow_2":
			dialog.text = "Oh really? Such a joker...";
		...
		case "joan":
			dialog.text = "You're the hussy yourself! Be glad Jan made an honest woman out of you, or you'd still be spreading your legs for every passer-by!";
			link.l1 = "";
			link.l1.go = "exit";
		...
		case "cutlass_training":
			dialog.text = "The cutlass fits perfectly in my hand! I don't know how to explain it... I've always struggled with other types of blades, like rapiers and swords. But this cutlass is a different story! It feels incredible! Thank you, Charles!";
		...
		case "brothel_found":
			dialog.text = "Save your stories for someone else, they won't work on me. Do I look like a naive, lovestruck fool? I mean, I AM madly in love with you, but calling me a fool would be a stretch\n Listen, darling, do as you wish, but keep in mind that you won't find a better woman than me. If you want to look for her in brothels, go ahead, but then I'll vanish from your life for good.";
			link.l1 = "Helen, I...";
			link.l1.go = "brothel_found_1";
		break;
		
		case "brothel_found_1":
			dialog.text = "I understand everything, Charles. You love only me, and these are just natural urges. Do you know what my natural urge is? Respect from my man. A woman may not be satisfied with just love, darling. Let's forget about this misunderstanding for now, but ponder my words a bit. All right?";
			link.l1 = "Fine, Helen.";
			link.l1.go = "exit";
		break;
		...
		case "MysteryPortRoyal_Helena_1":
			dialog.text = "Francis... I remember him. He always waited for my arrival in Port Royal and was a hopeless romantic. I enjoyed spending time with someone so far removed from the sea – all those poems and serenades... It was something new. A glimpse of a world I had never known. Francis was wealthy, intelligent, and handsome – quite the catch. Any local girl would have gone mad for his attention, but back then, I was more concerned about keeping the Rainbow afloat.";
			link.l1 = "It seems the sensitive soul of a poet couldn’t bear your rejection. In all his letters, he spoke only of you, recalling the places where you met. I can give you everything he left behind if you want it.";
			link.l1.go = "MysteryPortRoyal_Helena_2";
		break;
		
		case "MysteryPortRoyal_Helena_2":
			dialog.text = "I didn’t know he was ill. This all feels so foolish now. As for his gift... I’ve had enough of wills and inheritances. Trust me, I have everything I need – and more. You’d best keep it.";
