	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Benua_Delivery":
			...
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Patent") && CheckCharacterItem(pchar, "patent_fra") || CheckAttribute(pchar, "questTemp.Patria.GenGovernor") && !CheckAttribute(pchar, "questTemp.SharlieEpilog_Governor"))
			{
				if (CheckAttribute(pchar, "questTemp.Patria.GenGovernor"))
				{
					link.l3 = "I wish to notify Baron Forger and the Capsterville chancellery that I am compelled to relinquish the post of Governor-General.";
					link.l3.go = "SharlieEpilog_Benua_Governor";
				}
				else
				{
					link.l3 = "I hold a valid French patent—I wish to inform the Capsterville chancellery of my decision.";
			...
			{
				link.l6 = "I need to send word to Fadey the Muscovite in Bas-Ter.";
			...
			{
				link.l7 = "I want to notify the Houk family in Maroon Town of my journey.";
				link.l7.go = "SharlieEpilog_Benua_Houk";
			}
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Jino") && CharacterIsAlive("Jino"))
			{
				link.l8 = "I want to inform Gino Guinelli of Saint John's about my departure for the Old World.";
		...
		case "SharlieEpilog_Benua_Fadey_3":
			dialog.text = "...";
			link.l1 = "It’s done. Here you are.";
			link.l1.go = "SharlieEpilog_Benua_Delivery";
		break;
		...
		case "SharlieEpilog_Benua_Money_4":
			dialog.text = "In that case, a donation of one hundred thousand pesos will suffice. With that amount, we can organize meals for the needy for many months. If you have the required amount with you, including the church donation, we can begin right away.";
		...
		case "SharlieEpilog_Benua_Money_5":
			dialog.text = "Then your donation should amount to two hundred fifty thousand pesos. These funds will allow us to build an orphanage, which will bear your name and be sustained for some time. If you have the required amount with you, including the church donation, we can begin right away.";
		...
		case "SharlieEpilog_Benua_Money_6":
			dialog.text = "Well, it seems you’ve made good use of your time, "+pchar.name+". I believe a donation of five hundred thousand pesos will be more than enough. With that contribution, we can build a hospital and equip it for many years to come. If you have the required amount with you, including the church donation, we can begin right away.";
		...
		case "SharlieEpilog_Benua_Governor":
			dialog.text = "I sincerely regret, "+pchar.name+", that in order to meet your father you must relinquish such a high office. Still, it is heartening to see that, for you, family stands above all else.";
			link.l1 = "What troubles me is that throughout my time here, in the Caribbean, I never once took the care to send him a letter; and I intend to remedy this with a personal visit. However dazzling my success may have been, I must not forget my duty to my parent. As for the baron—I believe he will forgive such an abrupt departure: after all, I have done a great deal for the benefit of our shared state.";
			link.l1.go = "SharlieEpilog_Benua_Governor_2";
			pchar.questTemp.SharlieEpilog_Governor = true;
		break;

		case "SharlieEpilog_Benua_Governor_2":
			dialog.text = "You have made a difficult yet worthy choice, my son. Power and honors are fleeting, but duty to family and lineage is eternal. Believe me, the Lord sees your intentions and rewards not for titles, but for fidelity of the heart.";
			link.l1 = "Thank you, holy father. Your words mean a great deal to me.";
		...
		case "SharlieEpilog_Benua_Governor_4":
			dialog.text = "Excellent. I will take every measure to ensure the letters are delivered as swiftly as possible.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Benua_Delivery";
