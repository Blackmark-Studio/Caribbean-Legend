void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Cureer":
			dialog.text = "My apologies. Are you " + GetTitle(NPChar, false) + " " + GetFullName(pchar) + "?";
			link.l1 = "In person. How may I help?";
			link.l1.go = "SharlieEpilog_Cureer_1";
		break;

		case "SharlieEpilog_Cureer_1":
			dialog.text = "Oh, at last... You were rather hard to find, had to scour almost the entire archipelago. I have here for you correspondence from Abbot Benoît.";
			link.l1 = "Hmm... From the abbot? Unexpected.";
			link.l1.go = "SharlieEpilog_Cureer_2";
		break;

		case "SharlieEpilog_Cureer_2":
			dialog.text = "I was instructed to hand it to you personally. Don’t worry about payment — the abbot has already covered all my expenses in advance.";
			link.l1 = "Well then, bring it here. Thank you.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Dassen":
			dialog.text = "What are your orders, "+GetTitle(NPChar, true)+"?";
			link.l1 = ""+npchar.name+", I will not delay matters - I am leaving the archipelago. Family affairs require my presence at my father's estate.";
			link.l1.go = "SharlieEpilog_Dassen_1";
		break;
		
		case "SharlieEpilog_Dassen_1":
			dialog.text = "If I understand correctly, we are parting ways?";
			link.l1 = "Alas... I cannot act otherwise.";
			link.l1.go = "SharlieEpilog_Dassen_2";
		break;
		
		case "SharlieEpilog_Dassen_2":
			dialog.text = "Well then, it has been an honor for me to serve under the same flag with you, and I would gladly do so again, should fate allow it.";
			link.l1 = "I hope our friendship will not be broken, but only grow stronger, for we have shared many adventures together.";
			link.l1.go = "SharlieEpilog_Dassen_nothing";
			link.l2 = "For your loyalty and professionalism, I wish to pay you, as severance, one month's salary.";
			link.l2.go = "SharlieEpilog_Dassen_salary";
			link.l3 = "You have served impeccably, and I deem it necessary to reward you properly. Please accept this - here are three months' salary. You have more than earned this reward.";
			link.l3.go = "SharlieEpilog_Dassen_salaryX3";
		break;
		
		case "SharlieEpilog_Dassen_nothing":
			dialog.text = "I sincerely share this hope, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Just call me Charles. And, by the way, I have something for you.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			}
			else
			{
				link.l1 = "Well then, until we meet again, Monsieur "+npchar.lastname+". Farewell.";
		...
		case "SharlieEpilog_PikarOnUliss_D_1":
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarAlive") || CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarResurrected")){dialog.text = "You're right.";}
		...
		case "SharlieEpilog_HenriDeMonper_Mary_4":
			if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "tu vas me présenter aux autres";
			else sStr = "tu vas me présenter à notre invité";
		...
		case "SharlieEpilog_InKitchenDeMonpe_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer") || CheckAttribute(pchar, "questTemp.LSC.Mary_officer"))
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "good friends";
				else sStr = "comrade";
				dialog.text = "";
			...
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "your good friends";
				else sStr = "your friend";
				dialog.text = "";
		...
		case "SharlieEpilog_KomendantFort_5":
			dialog.text = "An excellent plan, Your Grace! However... you are, without question, a man seasoned in naval warfare, and yet it is not customary for one of your station to risk his life personally. The fleet could just as well be commanded by...";
			link.l1 = "Just as I could not endure the quiet life in Europe, so I cannot endure idle waiting on the shore while the outcome of the battle is decided. One cannot escape fate, "+GetAddress_Form(NPChar)+" "+npchar.lastname+". ";
			link.l1.go = "SharlieEpilog_KomendantFort_6";
		break;

		case "SharlieEpilog_KomendantFort_6":
			dialog.text = "So be it, then. Shall I give the order to begin the preparations?";
			link.l1 = "Proceed. And may God be with us.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Mishelle_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) sStr = " and your wife";
			dialog.text = "So you still don't get it? You died. Together with your crew"+sStr+". Some merchant you decided to rob blew up the powder magazine—just to make sure not a single coin went to the likes of you.\nSpectra sunt memoria peccatorum. You are the ghost, "+pchar.name+"... A Caribbean legend of a man consumed by greed and blind vanity. How many have you killed for gold?";
