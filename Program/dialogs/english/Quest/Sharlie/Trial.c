...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "lecrua_1":
			...
			{
				link.l1 = "I have a "+GetStrSmallRegister(XI_ConvertString(GetBaseShipParamFromType(int(RealShips[int(pchar.ship.type)].basetype),"Name")))+", her name is "+pchar.ship.name+".";
				if (6-int(RealShips[int(pchar.ship.type)].Class) < 0) link.l1.go = "lecrua_badship";
				else link.l1.go = "lecrua_2";
			}
		break;
		
		case "lecrua_noship":
			dialog.text = "Ha! Well, what kind of captain are you then if you don't have a ship? I'm sorry, monsieur, but in that case I don't have any work to offer you. All the best, give Fadey my regards!";
			link.l1 = "Hm...";
		...
		case "lecrua_repeat":
			dialog.text = "You and I have already discussed everything, monsieur. Haven't we?";
		...
		case "lecrua_3":
			...
			dialog.text = "You must deliver a small batch of gunpowder and bombs to Port-au-Prince, on French Hispaniola. The commandant has been waiting for it for some time, so don't waste any time, you have about ten days left\nRespected "+GetFullName(sld)+" will take care of delivering and loading it onto your vessel. The commandant will pay you five thousand pieces of eight for the job.";
		...
		case "florian_deck_1":
			...
			link.l1 = "Aye, I have fifteen cannons for you. The deadline was a close call, I barely made it...";
		...
		case "florian_deck_2":
			...
			{
				dialog.text = "Hm. You have a strange sense of humour, sir! For some reason, I don't see fifteen cannons being unloaded from your ship...";
		...
		case "florian_deck_3":
			dialog.text = "Nice to meet you. Let's not waste time and get these cannons aboard. This isn't going to be easy, so I'll need your men to help.";
		...
		case "florian_deck_fail":
			dialog.text = "You damn fool! If you can't even handle this simple task, you're sure to sink in the next storm. Make your way back to your ship, captain, and do something you're better at, like delivering flowers to noble ladies. Better yet, sail back to Europe and leave the New World to real men. Good day, sir!";
			link.l1 = "But...";
		...
		case "florian_deck_4":
			dialog.text = "Whew, that was thirsty work! Thank you for your service, captain! Take your reward, two hundred doubloons.";
			link.l1 = "Thank you!";
		...
		case "florian_deck_6":
			dialog.text = "I won't lie, it's dangerous. As you may already know, I'm lying in wait for a Spanish heavy galleon with a valuable cargo. The ship was put in the docks for repairs. According to my sources, she was supposed to set sail yesterday but it didn't happen\nBesides, my agent in Portobello didn't get to the rendezvous point to deliver the updates I've been awaiting. I suspect that the Spanish arrested him. I'll pay you to sneak into Portobello and find out two things: why the galleon is still there and what happened to my agent. Are you in?";
			link.l1 = "I'm afraid I lack the proper training for such an operation. I'm a gentleman, not a spy. I might get into trouble myself and I won't be able to help you.";
		...
		case "florian_deck_bye":
			dialog.text = "Well, aren't you entitled? I understand you. Goodbye then, captain, and thank you again for your help!";
		...
		case "florian_deck_7":
			dialog.text = "Aye, listen well then. My man's name is Sylvan Laforet, but in Portobello he goes by Jaime Silicio, a merchant. The galleon is named 'Alcantara'. I advise you to pass through the city gates at night, through the jungle. The Portobello guards are very suspicious these days, not to mention that Sylvan's disappearance doesn't bode well for him being alive and well. You have two days before I must get out of here, before the Spanish patrols find us. Good luck, monsieur!";
		...
		case "florian_failspy_2":
			dialog.text = "Damn. I really need some information on it. But this prize is too fat to give up! Anyway, I'll try sending another scout over there... Captain, I ask you not to leave me for now. I might need your help. Will you wait another day while I'm sniffing out information about the Alacantara?";
			link.l1 = "Of course, I'll wait! I want to make up for that failure.";
			link.l1.go = "florian_9";
			link.l2 = "I don't think so. Apparently I'm too bad at these games. I'm heading home.";
		...
		case "florian_failspy_5":
			pchar.quest.trial_spy_over.over = "yes"; //снять прерывание
			dialog.text = "How are things coming along, captain? What have you managed to find out?";
			link.l1 = "Things are going poorly, Monsieur Shoke. I'm not much of a spy, they found me out very quickly. The only thing I managed to discover was that your man, Sylvain Laforet, has been arrested and is being held somewhere.";
			link.l1.go = "florian_failspy_1";
		break;
		
		case "florian_9":
			dialog.text = "Then make your way to your ship, captain. Tomorrow at about the same time, or a little later, you'll have to visit me. Perhaps by then I'll have found something out. Don't set foot on shore, wait for me on your ship!";
		...
		case "florian_12":
			pchar.quest.trial_spy_over.over = "yes"; //снять прерывание
			dialog.text = "How are things coming along, captain? What have you managed to find out?";
			link.l1 = "It's done. Your man, Sylvain Laforet, has been arrested and is being held in jail. It's over for him.";
		...
		case "florian_13":
			...
			link.l1 = "Yes. She has been being prepared to embark for some time now, but the governor of Portobello intends to hold her at the dock. Right now he's waiting for a barquentine named the 'Puebla' to arrive from Cartagena with a cargo of gunpowder for the 'Alcantara'. According to a sailor from the galleon, they don't have enough of it and the governor fears pirates.";
		...
		case "florian_15":
			dialog.text = "Excellent work, Captain "+GetFullName(pchar)+"! I'm very pleased! Here, take your reward. You've truly earned it!";
		...
		case "florian_18":
			...
			link.l1 = "Deal! I'll be on my way to cut off Puebla!";
			link.l1.go = "florian_19";
			link.l2 = "Wait a moment, Monsieur Choquet. The fact is, I'm still... Let's just say, not particularly accustomed to naval battles. And you are the captain of a frigate; you obviously have more than one naval battle behind you. If it's not too much trouble, could you... How should I put it...";
			link.l2.go = "florian_guide_01";
		break;
		...
		case "florian_guide_01":
			dialog.text = "You would like me to give you a lesson on the tactics of naval combat? With pleasure, captain! Especially since it's in my own interest: I want to be sure that you will successfully intercept the 'Puebla'.";
			link.l1 = "No, I didn't mean it. Fine, forget it: I'm sure I won't have any trouble intercepting a barquentine.";
			link.l1.go = "florian_19";
			link.l2 = "Yes, that's exactly what I meant. I'm sure that new knowledge will do me no harm.";
		...
		case "florian_guide_03":
			dialog.text = "First, make sure your ship is repaired. If you have holes in the hull, it will not be difficult for the enemy to send you to the bottom. And if you have rags hanging instead of sails, this will significantly limit your mobility. The enemy can easily escape if the balance of power is not in his favour or, worse, catch up with you and force you into an unfavourable battle – or even board you immediately. In addition, with torn sails, you'll struggle to gain the weather gage – that is, to get upwind of your opponent, which is where you want to be.";
			link.l1 = "Weather gage, got it. Anything else?";
			link.l1.go = "florian_guide_04";
		break;
		
		case "florian_guide_04":
			dialog.text = "Make sure you have enough men. Even the most powerful ship with 42-pound cannons becomes useless if you have one gunner running to reload three cannons and there is simply no one to handle the sails. In general, I would just board such a ship immediately and seize her.";
			link.l1 = "Enough men, got it.";
			link.l1.go = "florian_guide_05";
		break;
		
		case "florian_guide_05":
			dialog.text = "Also, watch your cannons: they will wear out and explode over time. The condition of the barrels deteriorates, and if your cannons start to explode in the midst of battle, it can end very badly for you. I was not lucky at all: the batch of cannons I sailed with turned out to have several casting defects. If you had not brought a replacement in time, I would have simply abandoned the operation, since the Militant would be much inferior to the Alcantara in firepower. Tools need to be changed in time.";
			link.l1 = "Now I understand why it was so important!";
			link.l1.go = "florian_guide_06";
		break;
		
		case "florian_guide_06":
			dialog.text = "In addition to cannons, keep an eye on the amount of ammunition. Alcantara will fall to me because of this. If she has low stocks of gunpowder, she will not be able to fight a long battle – she will need to immediately go into close combat. And I will use this: my frigate is faster, a heavy galleon will not be able to get away from it. But I also don't need to come close: I will force an artillery duel at long range and then, when the gunpowder on the Alcantara runs out, I will close in, rake her with grapeshot, and board her.";
			link.l1 = "Desperate situation...";
			link.l1.go = "florian_guide_07";
		break;
		
		case "florian_guide_07":
			dialog.text = "Exactly. Keep an eye on your gunpowder and ammunition. If you run out of solid shot, you will most likely not be able to sink an enemy ship. If you run out of grape shot, you cannot hope for a boarding if you're outnumbered. If you have no chainshot or knipples, you will not be able to catch up with the enemy or get away from him if he is faster. All types of ammo are important.";
			link.l1 = "Instructive, thank you.";
			link.l1.go = "florian_guide_08";
		break;
		
		case "florian_guide_08":
			dialog.text = "And finally, depending on the type and size of your ship and the enemy ship, use the appropriate tactics. There is a trade-off at sea between firepower and speed. On a large and slow ship, there is no point in chasing a brig or a corvette to board - you still won't catch up without softening her up first with chain shot. In such cases, it's wiser to blast her apart from range and pick through the wreckage. If you still need to board such a ship, it is preferable to use a fast and manoeuvrable ship.";
			link.l1 = "...";
			link.l1.go = "florian_guide_09";
		break;
		
		case "florian_guide_09":
			dialog.text = "At the same time, don't go toe-to-toe with a ship of the line in a brig. One broadside from a monster like that will shatter the hulls of smaller ships into splinters. Use your advantage in speed and manoeuvrability, bring down her masts and rigging, then close in and rake her decks with grapeshot if you still need to board. If you need to sink her... it won't be an easy task, but it's possible. You can board her and then fire her powder magazine, but it's never shameful to flee. A good captain will save his ship and crew from certain death rather than indulge in excessive heroism. Remember, discretion and prudence are often the better part of valour.";
		...
		case "florian_guide_10":
			...
			dialog.text = "Glad to help, captain. I hope this knowledge will aid you in the future.";
		...
		case "tavern_officer":
			dialog.text = "That's an unusual accent you have there, señor. Or should I say 'monsieur'? Would you like to see Jaime Silicio? Perhaps you can share the same cell. Take him, boys!";
