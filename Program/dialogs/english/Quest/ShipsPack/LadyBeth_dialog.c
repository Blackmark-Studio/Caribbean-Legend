void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LadyBeth_DialogInCity_Second_4":
			...
			link.l1 = "Thank you, too. "+Goodbye(true)+".";
			link.l1.go = "LadyBeth_DialogInCity_Second_5";
		break;
		...
		case "LadyBeth_Alonso_2":
			...
			dialog.text = "Killed? In this venture we lost "+int(pchar.SailorDiedInBattleInfo)+" men. Don't want to seem intrusive, Captain, but... I warned you!";
