...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "NationLicenceType2":
        	...
        	dialog.text = "So, the trade licence of"+XI_ConvertString(Nations[int(npchar.LicenceNation)].Name+"Gen")+" for "+int(npchar.LicenceType)+" days, the price is "+FindRussianMoneyString(iSumm)+".";
		    link.l1 = "I agree.";
        ...
        case "patent_0":
			dialog.text = "Splendid. First of all, you have to prove your loyalty to the nation"+" by an excellent service for it. Go to any governor of"+" and complete a few of his missions. Then he will grant you a license.";
		...
		case "CityInfo":
			...
			dialog.Text = "Colony "+GetCityName(colonies[i].id)+", has belonged to "+XI_ConvertString(GetNationNameByType(int(sld.Default.nation))+"Gen")+", ransom for stopping recapture attempts is "+FindRussianMoneyString(iSumm)+".";
   			if(int(pchar.money) >= iSumm)
			{
