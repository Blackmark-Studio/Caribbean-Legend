...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Listen, has a man named Joachim Merriman been here recently? A middle-aged señor, Portuguese, with a moustache, imperial beard and piercing eyes? Perhaps he wanted to buy a ship?";
				link.l1.go = "caleuche";
			}
		break;
		...
		// калеуче
		case "caleuche":
			dialog.text = "No, Señor. Haven't seen such a client.";
