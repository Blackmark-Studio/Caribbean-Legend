	...
	// <-- хронометр Алекса
		...
		case "FDM_cabin_pay":
			...
			if (amount <= 0) // всё принес
			{
				...
				dialog.text = "So, you had to bring me "+FindRussianQtyString(int(npchar.quest.FDM_cabin.chest))+" chests, you have brought "+FindRussianQtyString(iTemp)+". I have the payment. Now it's my turn. Go and walk around. Don't worry, I'll do my best.";
				link.l1 = "Good...";
			...
			else
			{
				...
				dialog.text = "So, you had to bring me "+FindRussianQtyString(int(npchar.quest.FDM_cabin.chest))+" chests, you have brought "+FindRussianQtyString(iTemp)+". "+FindRussianQtyString(amount)+" chests left.";
