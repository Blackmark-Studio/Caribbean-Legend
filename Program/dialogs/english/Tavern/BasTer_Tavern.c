...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("What questions do you have?","How can I help you, "+GetAddress_Form(NPChar)+"?"),"What is it, "+GetAddress_Form(NPChar)+"...","This is the third time you've bothered me now...","More questions, I presume?","block",1,npchar,Dialog.CurrentNode);
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("I changed my mind...","I've got nothing to talk about at the moment."),"Umph, where has my memory gone...","Yes, it really is the third time...","No, what questions?...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
			...
			{
				link.l1 = "I'm looking for my old messmate Fernand Luc. I've got a couple of questions for him. I heard he had quite a time here a week ago...";
				link.l1.go = "terrapin";
			}
			...
			{
				link.l2 = "Good news, "+npchar.name+". I have exactly what will save your situation. One hundred bottles of excellent wine and one hundred bottles of rum. With such a shipment, your customers will once again bathe in rivers of booze. Are you ready to pay up?";
				link.l2.go = "TPZ_Tavern2_1";
			}
			if (CheckAttribute(pchar, "questTemp.TPZ_Tavern_3"))
			{
				link.l2 = "Well then, "+npchar.name+", are you ready to discuss the terms of the deal?";
				link.l2.go = "TPZ_Tavern2_11";
			}
			if (CheckAttribute(pchar, "questTemp.TPZ_Tavern_4"))
			{
				link.l2 = "So, "+npchar.name+". On my end, everything is settled and the goods are already on their way to the tavern. Shall we proceed with the payment?";
		...
		case "DTSG_BasTerTavern_2":
			dialog.text = "Not much, really. He showed up a couple of days ago. Liked it here, even rented a house on the outskirts of town. Came by often, paid regularly. And, most importantly, he behaved himself well all this time, never saying a bad word to anyone. I'm still shocked he attacked you and your friend.   I thought he might settle down here for good.";
			Link.l1 = "In a way, he did. Well, that's not much, but thank you for that, my friend. See you around.";
			Link.l1.go = "exit";
		...
		case "PZ_BasTerTavern_1":
			dialog.text = "That name means nothing to me, and generally, I don't let people like him into my establishment, nor do I take any interest in them.";
		...
		case "TPZ_Tavern_2":
			dialog.text = "Finding a reliable supplier is not easy. I tried dealing with small traders, but they’re unreliable. Sometimes the goods arrive, sometimes they don’t. With a large supplier, everything runs like clockwork — stable deliveries and high quality.";
		...
		case "TPZ_Tavern_3":
			...
			link.l1 = "I understand. Well, maybe I’ll stop by again later. Any problem can be solved with a clever approach.";
		...
		case "TPZ_Tavern2_1":
			dialog.text = "Captain, this is incredible! How did you pull this off? No matter, really. Just tell me, what do you want in exchange for such a luxurious shipment of alcohol? And will everything be in order with the paperwork?";
	    ...
	    case "TPZ_Tavern2_7":
			dialog.text = "Still too expensive, Captain. This price is higher than what I used to pay my previous supplier. Even if I agree now, in a couple of months I’ll have to go back to him once production resumes. I don’t see any reason to overpay.";
			link.l1 = "I understand. Alright. My final offer — two hundred doubloons. If that's not acceptable, then there’s no point in continuing this conversation.";
		...
		case "TPZ_Tavern3_2":
			dialog.text = "You’re my saviour, Captain! I will expect similar shipments every two weeks. I hope you’ll strictly keep to your obligations. Another dry spell like that, and my tavern won’t survive...";
			link.l1 = "No need to worry, "+npchar.name+". My representative in the city is Christian Deluce. He’ll make sure your tavern never runs out of wine or rum.";
