...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l1 = "I heard there was serious trouble on the island... Slaves?";
            ...
            {
                link.l1 = "I've heard that wretched scoundrel Bart the Portuguese has finally met justice! Is he in prison? Do you know when his execution will be? I want to come and watch, I have a bone to pick with that scum...";
                link.l1.go = "Portugal";
            }
			//--> Тайна Бетси Прайс
			...
			{
				link.l1 = "Tell me, "+npchar.name+", on the night Betsy disappeared, did you notice anyone suspicious nearby? Maybe she was talking to someone?";
			...
			{			
				sld = CharacterFromID("Villemstad_waitress");
					...
					{
						link.l1 = "Well, "+npchar.name+", it’s done – your precious waitress is back. Better start stocking up on rum again, people will be coming back soon.";
		...
		case "EscapeSlaveVillemstad_T1":
			dialog.text = "Aye, there has never been such a mess... More than a thousand negroes have revolted. Two plantations have been burned to the ground and each of their masters was murdered. The commandant is worried that the slaves might come to attack the city, so he has enforced martial law. And it all started because of two negroes, a buck named Tamango and a doe named Isauri...";
			link.l1 = "Sounds quite dramatic. Tell me the whole story, who are these negroes?";
			link.l1.go = "EscapeSlaveVillemstad_T2";
		break;
		
		case "EscapeSlaveVillemstad_T2":
				dialog.text = "Tamango and Izaura - slaves at Blenheim plantation, the first plantation burned. These two Black people loved each other. But a planter's son, Leonsio, arrived from Europe and took a fancy to the girl. He wanted to make Izaura his personal concubine. The Black man Tamango didn't take kindly to the idea and neither did Izaura, she truly loved the black devil. That Tamango was some sort of chief or something back in Africa... A giant man - darker than sin and deadly with an axe, the other Black people feared and respected him. So this man led the other slaves in an uprising. They attacked the guards at night, killed every white outside the big house, the mulattos too. Then Izaura opened the doors of the plantation and the rebels murdered everyone inside. Blenheim was burned to the ground. Then the slaves fled into the jungles and disappeared...";
			link.l1 = "Well, how's that for a story, sounds like a plot for a novel! A proper slave revolt, just like in Ancient Rome. How did you find all that out, by the way?";
			link.l1.go = "EscapeSlaveVillemstad_T3";
		break;
		
		case "EscapeSlaveVillemstad_T3":
			dialog.text = "Rumours, mynheer, the earth is teeming with them. Rum loosens tongues, all you have to do is listen...";
			link.l1 = "And how did that all end? Did they find those negros?";
			link.l1.go = "EscapeSlaveVillemstad_T4";
		break;
		
		case "EscapeSlaveVillemstad_T4":
				dialog.text = "Ha, not a chance! Until the reinforcements finally managed to arrive, nobody took a step into the jungle. Then a Company warship arrived with a unit of soldiers and they searched the island. Didn't find hide nor kinky hair of a single loose negro.";
			link.l1 = "Well, how about that! A thousand blacks all just vanished into thin air?";
			link.l1.go = "EscapeSlaveVillemstad_T5";
		break;
		
		case "EscapeSlaveVillemstad_T5":
			dialog.text = "Actually into the water.";
			link.l1 = "What are you talking about, "+npchar.name+"? You know as well as I do that negroes can't swim.";
			link.l1.go = "EscapeSlaveVillemstad_T6";
		break;
		
		case "EscapeSlaveVillemstad_T6":
			dialog.text = "He-he... oh no, those blacks aren't shark bait that quickly. The thing is, the next night after the mutiny, a barque went missing from the docks. You can paint me black and I'll play the banjo and dance for you if it wasn't at the hands of that buck Tamango and his negroes! That's why they're not on the island anymore.";
			link.l1 = "Ha, now I've heard everything, "+npchar.name+". You expect me to believe that a bunch of half-wild negros can handle sails and navigate? I'd sooner expect a ship of monkeys to come careening in from Guinea.";
			link.l1.go = "EscapeSlaveVillemstad_T7";
		break;
		
		case "EscapeSlaveVillemstad_T7":
			dialog.text = "I didn't believe it either, mynheer, but the proof is in the missing ship. Maybe one of those negroes used to serve as a steward on a ship and picked up some sailing technique. Maybe they used black magic, who knows! Stop by and visit me again, "+pchar.name+", I'll have more stories for you next time.";
		...
		case "Portugal":
			dialog.text = "Yes, that's correct. They caught that pirate. And can you believe how? He was picked up alone in a cockboat in the middle of the sea. He didn't even make a sound before he was thrown into the hold with the rats. It's really amusing, you know, that such a dangerous pirate was caught like such a lubber!";
			link.l1 = "And why was he all alone at sea?";
			link.l1.go = "Portugal_1";
		break;
		
		case "Portugal_1":
			dialog.text = "He probably decided to part ways with his lackeys, no doubt... They couldn't split the plunder fairly. Now he's in the hands of the Company itself, and those guys don't take kindly to jokes. They say he took possession of one of the Company's boats with something valuable. Apparently, it's just because they want to squeeze some information out of him that he's not already dangling from a noose.";
			link.l1 = "So, do you know when his execution will be?";
		...
		case "TBP_Tavern2_11":
			dialog.text = "Suspicious? There were always crowds of suitors around her, and each one was suspicious in his own way! She was quite the flirt, knew how to draw attention.";
			link.l1 = "That much I figured"+GetSexPhrase(""," out")+" already. But was there anyone who stood out?";
			link.l1.go = "TBP_Tavern2_12";
			DelLandQuestMark(npchar);
		break;

		case "TBP_Tavern2_12":
			dialog.text = "Hmm... Well, there was one. That evening, he gave her a pendant with gems. He sat here, eyes glued to her, hovering around all night.";
			if (CheckAttribute(pchar, "questTemp.TBP_BuyKulon"))
			{
				link.l1 = "That pendant, by any chance, wouldn't happen to be this one? (Show the cameo bought from the beggar)";
		...
		case "TBP_Tavern3_21_1":
			dialog.text = "You’ve saved my skin, captain! I had almost given up hope of seeing her again... So what actually happened? Was she really planning to run away? I didn’t dare ask her myself.";
			link.l1 = "Let’s just say she had to deal with some unfinished business from the past. But it looks like that’s all behind her now, and she’ll be back to work soon.";
			link.l1.go = "TBP_Tavern3_22_leadership_1";
			link.l2 = "Well, let’s just say she needed a little break from staring at your boring mug. Ha-ha! Don’t scowl like that, I’m only joking. Every lady should have her little secrets...";
			link.l2.go = "TBP_Tavern3_22_fortune";
			DelLandQuestMark(npchar);
		break;

		case "TBP_Tavern3_22_leadership_1":
			dialog.text = "Well, the important thing is that she’s back at work. You’ve earned your reward, captain. Here you go – one hundred doubloons, just like we agreed. And also, take this map. One of the guests left it here and never came back. From the looks of it, it leads to treasure.";
			link.l1 = "All right, I’ll check it out. Thanks.";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("TBP_BetsiBackToWork");
			AddCharacterExpToSkill(pchar, "Leadership", 100);
			AddItems(pchar, "gold_dublon", 100);
