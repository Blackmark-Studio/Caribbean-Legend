...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Take a look at these earrings, monsieur. I found them in the pocket of a bandit in the jungle. This is clearly the work of a fine jeweller which, I'm sure, is not from this wilderness. What do you say?";
			...
			{
				dialog.text = "Did you bring 40 doubloons?";
		...
		case "Sharlie":
			...
			link.l1 = "I need this man free, not behind bars. And as far as I've been informed, until this debt is repaid to you, he will not be released. I'm interested in paying off this debt.";
			link.l1.go = "Sharlie_1";
		break;
		
		case "Sharlie_1":
			dialog.text = "Aha, that changes everything. I'm also interested in getting my money back... This Folke Deluc is a strange fellow. He borrowed a relatively small sum - five thousand pesos. He simply refused to return it and started hiding. In the end, the interest grew to match the original debt, and he found himself behind bars.";
			link.l1 = "It follows that his debt has currently accumulated to ten thousand?";
			link.l1.go = "Sharlie_2";
		break;
		
		case "Sharlie_2":
			dialog.text = "Ten thousand four hundred and fifty pesos exactly, monsieur. So his freedom is priced at this amount. You're willing to pay it to me? I'm a little surprised...";
			if (sti(pchar.money) >= 10450)
			{
				link.l1 = "Don't be surprised. Here's the money.";
				link.l1.go = "Sharlie_3";
			}
			link.l2 = "Hm... A hefty sum indeed. Listen, monsieur, perhaps you and I could strike a deal? For instance, you might have something I could handle, and you could value my favour at these ten thousand five hundred...";
		...
		case "Sharlie_3":
			...
			dialog.text = "Yes, it appears that you really need this sailor if you're willing to shell out such an amount of money for him. Anyway, it's none of my business, is it, monsieur? Here is his bill of debt, now you're entitled to his debt and have the right to ask for money from him. Well, and of course, a petition for his release from prison.";
		...
		case "Sharlie_5x": // Addon 2016-1 Jason пиратскаЯ линейка 1
			...
			link.l1 = "Pity. I should bring the money to Folke then. Bye!";
			link.l1.go = "exit";
			pchar.questTemp.Sharlie = "bankskipermoney";
		break;
		
		case "Sharlie_5":
			dialog.text = "Favor? Hm... You know, monsieur, I would have given you a negative answer if you had come yesterday, but now... yes, I have something that needs to be taken care of, but I warn you, it's quite dangerous.";
		...
		case "Sharlie_6":
			...
			link.l1 = "Monsieur, danger is no stranger to me. I've already been in dangerous situations so many times. So, let's get to the details. As long as it doesn't involve taking out the entire fort's garrison single-handedly, maybe I'll be able to accomplish what you're so mysteriously alluding to.";
			link.l1.go = "Sharlie_7";
		break;
		
		case "Sharlie_7":
			dialog.text = "Fine. Listen, then. Tonight, several pirates and a prisoner will leave the pirate den at Le Francois and walk to Le Marin cove. The prisoner is a Spanish officer, and a great expert in fortification engineering. The Brits intend to use him for their own purposes, so they will send a warship to pick the man up from the cove.\nThe officer is my old friend, and I don't want him to end up as an English captive. I can't ask the local authorities to help me because we are at war with Spain. If I had more time, I would hire men capable of retaking the Spaniard... sorry, of retaking my friend, but alas!\nYou are the only man I can trust with this job. You must go to Le Marin cove and... persuade the pirates to give the prisoner to you. I doubt that they will show much cooperation, so it's up to you.";
		...
		case "Sharlie_8":
			...
			link.l1 = "I've already told you 'danger is no stranger to me' and I know which end of a sword to hold.";
			link.l1.go = "Sharlie_10";
			link.l2 = "Hm. You're right, it's dangerous. I won't attack a crew of pirates all by myself.";
		...
		case "Sharlie_9":
			...
			link.l1 = "All right. I'll bring him the money. See you later!";
			link.l1.go = "exit";
			pchar.questTemp.Sharlie = "bankskipermoney";
		break;
		
		case "Sharlie_10":
			dialog.text = "Very well. Glad to hear that. Then you should go to Le Marin cove, the pirates will be there from seven p.m. until four a.m. Don't miss them! And don't even think of using a ship! Such actions will scare them off, walk there through the jungle!\nBring the prisoner to me when you find him, I'll keep the door open. I recommend waiting until one a.m. before returning to the city, because you need to avoid the guards' attention. Be careful and good luck!";
		...
		case "Sharlie_14":
			...
			dialog.text = "Wonderful! I'm very pleased that you were able to handle it successfully. I suppose I need not know the details of the operation, do I?  So, my dear Spanish guest may now feel safe in my home...";
		...
		case "Sharlie_15":
			...
			link.l1 = "Yes, monsieur. Everything's strictly according to the agreement. Now allow me to take my leave.";
			link.l1.go = "Sharlie_4";
		...
		case "Sharlie_junglejew":
			dialog.text = "Hm. It appears you're right, these are expensive earrings and they were made in the Old World for sure... What can I say? I'll give you thirty... no, even thirty-five gold doubloons for them. Take the money, you won't get a better price.";
			link.l1 = "Thirty-five doubloons? That isn't a bad price. I agree. Here you go.";
			link.l1.go = "Sharlie_junglejew_1";
			link.l2 = "No. I think I'll keep these earrings for myself.";
			link.l2.go = "exit";
		...
		case "Del_Deluck":
			...
			dialog.text = "I know, I know, Captain. Your navigator seems to have amassed debts in nearly every French colony. Truth be told, I have known about it for a long time. I checked with my colleagues, a standard procedure you see...";
		...
		case "Del_Deluck_2":
			...
			link.l1 = "I see... You bought them knowing that I have a vital interest in him and the means to pay... This is extortion, Monsignor.";
		...
		case "Del_Deluck_3":
			...
			link.l1 = "I'm not ready to answer yet, but I'll consider it. Goodbye!";
		...
		case "Del_Deluck_5":
			dialog.text = "Excellent! You know what to do next - same as last time. Here are the documents - present them to the prison commandant. It's been a pleasure doing business with you, Captain.";
