...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "prepare_convoy_quest_3":
			...
			dialog.text = "I need to be escorted to "+XI_ConvertString("Colony"+pchar.quest.destination+"Gen")+", which is located on "+XI_ConvertString(GetIslandByCityName(pchar.quest.destination)+"Dat")+", in "+FindRussianDaysString(int(pchar.ConvoyQuest.iDay))+", and for that I'll pay you "+FindRussianMoneyString(int(pchar.ConvoyQuest.convoymoney))+". So, your decision?";
			link.l1 = "I'm in.";
