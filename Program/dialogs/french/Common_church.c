...
// Jason-------------------------------------------------Сага----------------------------------------------
		...
		case "ispoved_2":
			dialog.text = "J'espère qu'il n'y avait personne parmi ceux qui naviguaient sous le pavillon de "+NationNameGenitive(int(NPChar.nation))+"?";
        ...
        case "work":
            ...
            link.l2 = RandPhraseSimple("Je voulais parler de travailler pour le bien de l'église de "+NationNameGenitive(int(NPChar.nation))+".","Comment vont les choses dans la paroisse ? Avez-vous besoin d'aide ?");
			link.l2.go = "prihod";
