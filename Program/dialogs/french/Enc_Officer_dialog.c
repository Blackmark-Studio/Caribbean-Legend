...
void ProcessDialogEvent()
{
	...
	case "WantToRemove":
		...
		case "CompanionTravel_PrepareStart":
			dialog.Text = "Je vois. Jusqu'à "+XI_ConvertString("Colony"+characters[sti(NPChar.realcompanionidx)].CompanionTravel.ToColonyID+"Gen")+" à aller "+sti(characters[sti(NPChar.realcompanionidx)].CompanionTravel.Days)+" jours, que dois-je faire à mon arrivée?";
		...
		case "CompanionTravel_LastNode":
			Dialog.text = RandPhraseSimple("Aujourd'hui, je prends la mer de nouveau...","N'oubliez pas notre rendez-vous à "+XI_ConvertString("Colony"+characters[sti(NPChar.realcompanionidx)].CompanionTravel.ToColonyID+"Cela")+".");
				link.l2 = "..., ami.";
				link.l2.go = "Exit";
