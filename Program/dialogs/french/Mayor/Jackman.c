...
// ============================================================================
	...
	switch(Dialog.CurrentNode)
	{
        ...
        case "I_know_you_good":
			...
			link.l0 = "Jacques, je voudrais" + GetSexPhrase("","e") + " discuter de ma sécurité en mer. Les gars de la Fraternité de la Côte s'intéressent un peu trop à ma modeste personne. Tu pourrais les calmer un peu ?";
			link.l0.go = "pirate_threat";
...
//-----------------------------------------пиратская сага----------------------------------------------------
		...
		case "pirate_threat":
			...
			if (iGPThreat != 0)
			{
				...
				dialog.text = "Ha ! Les gars de notre fraternité te mettent la pression, hein, " + GetSexPhrase("pote", "ma fille") + " ? Je peux les calmer un moment. Mais ça va te coûter un joli paquet. " + FindRussianDublonString(iJackmanTotalTemp) + " sur la table, et on est d'accord.";
