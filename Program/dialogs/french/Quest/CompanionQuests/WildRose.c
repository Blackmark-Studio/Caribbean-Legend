	...
	switch(Dialog.CurrentNode)
	{
       ...
       case "WildRose_Dexter_17_2":
		...
		case "WildRose_Alonso_12":
			...
			dialog.text = "Je suis sacrément content de vous voir, capitaine ! Un salaud a dû lui souffler que vous le cherchiez — on s’est pris une volée de mitraille en plein milieu du chemin. J’ai réussi à battre en retraite avec une poignée d’hommes, on a foncé au port pour prévenir. Heureusement, la sentinelle, en me voyant sur la barque que j’avais achetée à la va-vite, a tout de suite compris. Il a rassemblé les hommes — et on est venus ici vous prêter main forte.";
			link.l1 = "Merci, mon ami... "+sld.name+" est mort par ma faute... Je vous ai envoyés droit dans un piège.";
			link.l1.go = "WildRose_Alonso_13";
		break;

		case "WildRose_Alonso_13":
			dialog.text = "Personne ne savait que c’était un piège. Vous avez bien agi — c’est à nous d’avoir été plus prudents.";
			link.l1 = "Et pourtant... J’aurais dû m’en douter. Je n’aurais jamais dû entrer dans cette taverne.";
			link.l1.go = "WildRose_Alonso_14";
		break;

		case "WildRose_Alonso_14":
			dialog.text = "C’est trop tard maintenant, capitaine. Quels sont vos ordres ?";
			link.l1 = "Il faut enterrer nos hommes comme il se doit. Enterrez aussi Northwood, quelque part dans la jungle. Personne ne doit connaître cet endroit, surtout pas Mary. Alors choisis seulement les hommes les plus fiables.";
			link.l1.go = "WildRose_Alonso_15";
		break;

		case "WildRose_Alonso_15":
			dialog.text = "Ce sera fait.";
			link.l1 = "Mary et moi monterons à bord plus tard. On a besoin d’un moment seuls.";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_261":
			...
			{
				dialog.text = "Mon Dieu, "+pchar.name+"... Je n’arrive toujours pas, je n’arrive tout simplement pas à y croire. Mon père... C’est un monstre... Pourquoi m’a-t-il fait ça ? Il a tué "+sSname+" ! Est-il vraiment devenu fou ?";
				link.l1 = "La mutinerie sur le 'Cornwall', la fuite à travers l’Atlantique, la tempête, la mort de sa mère, le passage à travers les portails de ces idoles – sans l’élixir comanche ! Des épreuves plus que dignes. Et pourtant, il aurait mieux valu qu’il ne sorte jamais vivant de cet enfer.";
			}
			else
			{	
				dialog.text = "Mon Dieu, "+pchar.name+"... Je n’arrive toujours pas, je n’arrive tout simplement pas à y croire. Mon père... C’est un monstre... Pourquoi m’a-t-il fait ça ? Est-il vraiment devenu fou ?";
				link.l1 = "Il a traversé des souffrances atroces. La mutinerie sur le 'Cornwall', la fuite à travers l’Atlantique, la tempête, la mort de ta mère... Je ne sais pas comment il a survécu au passage des portails sans l’élixir comanche – mais c’est ce qui a brisé son esprit.";
			}
