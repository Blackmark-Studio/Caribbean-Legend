...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "licence_1":
			...
			dialog.text = "Pour "+FindRussianDaysString(int(fQty))+"? Très bien. Cela vous coûtera "+FindRussianDublonString(int(npchar.quest.lcc_summ))+"Ces conditions sont-elles acceptables ?";
