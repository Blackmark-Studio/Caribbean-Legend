	...
	switch(Dialog.CurrentNode)
	{
		...
		case "blade_3":
			...
			if (PCharDublonsTotal() > 0)
			{
				...
				link.l1 = "Voici, je vous en prie. J'ai "+FindRussianQtyString(int(npchar.quest.blade_pay))+".";
		...
		case "blade_pay": // оплата
			...
			{
				dialog.text = "D'accord. J'accepte tes doublons. Tu dois m'apporter "+FindRussianQtyString(int(npchar.quest.blade_dublon))+" plus.";
