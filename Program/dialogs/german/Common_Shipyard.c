	...
	//<-- Бремя гасконца
		...
		case "ship_tunning_start" :		
			...
			{				
				...
				if(!TuningAvailable())
				{
					dialog.Text = "So lala... mal sehen, was wir hier haben... Ja - "+XI_ConvertString(RealShips[int(Pchar.Ship.Type)].BaseName)+". Ihr Schiff hat bereits die maximale Anzahl an verbesserten Eigenschaften, ich fürchte, dass weitere Arbeiten daran keinen Sinn machen und nur Schaden anrichten können.";
					Link.l1 = "Ich sehe...";
					Link.l1.go = "ship_tunning_not_now_1";
					break;
				}
		...
		case "ship_tunning_Capacity_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_Capacity_again";
				dialog.Text = "Ich benötige immer noch: Eisenholz - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Gut.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
		...
		case "ship_tunning_SpeedRate_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_SpeedRate_again";
				dialog.Text = "Ich benötige immer noch: Schiffsseide - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Gut.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
		...
		case "ship_tunning_TurnRate_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_TurnRate_again";
				dialog.Text = "Ich benötige immer noch: Seile - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Gut.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
		...
		case "ship_tunning_MaxCrew_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_MaxCrew_again";
				dialog.Text = "Ich benötige noch: Eisenholz - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Gut.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
				AddQuestUserData("ShipTuning", "sText", "I need to bring: ironwood - "+ int(NPChar.Tuning.Matherial) + ".");
		...
		case "ship_tunning_HP_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_HP_again";
				dialog.Text = "Ich benötige immer noch: Harz - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Gut.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
		...
		case "ship_tunning_rig_again_2":
			...
			{
				NextDiag.TempNode = "ship_tunning_rig_again";
                dialog.Text = "Ich benötige immer noch: Schiff Seide - "+int(NPChar.Tuning.Matherial)+".";
				link.l1 = "Gut.";
				link.l1.go = "Exit";
                AddQuestRecord("ShipTuning", "t1");
				AddQuestUserData("ShipTuning", "sText", "I need to bring: ship silk - "+ int(NPChar.Tuning.Matherial) + ".");
		...
		case "Findship_complete":
			...
			dialog.text = "Hier ist dein Geld - "+FindRussianMoneyString(int(pchar.GenQuest.Findship.Shipyarder.Money))+". Danke für die Arbeit. Vergiss nicht, mich wieder zu besuchen. Auf Wiedersehen!";
		...
		case "Device_complete_1":
			...
			dialog.text = "Für deine Bemühungen werde ich dich bezahlen "+FindRussianMoneyString(int(pchar.GenQuest.Device.Shipyarder.Money))+". Ich hoffe, das wäre eine verdiente Belohnung.";
			link.l1 = "Danke!";
		...
		case "SailsTypeChoose":
			dialog.text = "Welche Segel möchtet Ihr installieren? Im Moment habt Ihr "+GetSailsType(int(RealShips[int(Pchar.Ship.Type)].ship.upgrades.sails))+".";
		...
		case "SailsTypeChoose2":
			...
			dialog.text = "Im Moment hast du "+GetSailsType(int(RealShips[int(Pchar.Ship.Type)].ship.upgrades.sails))+", Sie haben ausgewählt "+GetSailsType(int(NPChar.SailsTypeChooseIDX))+". Die Kosten für den Ersatz betragen "+FindRussianMoneyString(int(NPChar.SailsTypeMoney))+". Weiter?";
		...
		case "SailsColorDone":
			...
			dialog.text = "Einverstanden. Wir werden die Segel in "+GetStrSmallRegister(XI_ConvertString(SailsColors[int(NPChar.SailsColorIdx)].name))+" Farbe.";
		    Link.l9 = "Danke.";
			Link.l9.go = "exit";
...
//<-- -----------------------------------------Бремя гасконца-----------------------------------------------------
		...
		case "IslaMona_7":
            dialog.text = "Also, du schuldest mir "+int(pchar.questTemp.IslaMona.Shipyarder.Money)+" Dublonen.";
		...
		case "IslaMona_money":
            ...
            dialog.text = "Tut mir nicht leid, du hast eine Kajütenablage voller Gold. Du wirst mir schulden "+FindRussianDublonString(int(pchar.questTemp.IslaMona.Shipyarder.Money))+".";
			link.l1 = "";
			link.l1.go = "IslaMona_money_exit";
		break;
