void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Node_132_4":
			...
			link.l1 = "Ich glaube nicht, dass es mehr wert sein kann als "+int(pchar.GenQuest.EncGirl.mapPrice)+" Pesos.";
