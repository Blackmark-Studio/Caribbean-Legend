...
//--------------------------------------------Похититель------------------------------------------------------
		...
		case "pirate_threat":
			...
			if (iGPThreat != 0)
			{
				...
				dialog.text = "Ha! Unsere Bruderschaft macht dir zu schaffen, was, " + GetSexPhrase("Kumpel", "Mädel") + "? Ich kann sie für eine Weile in Schach halten. Aber das wird dich ordentlich was kosten. " + FindRussianDublonString(iMarlowTotalTemp) + " auf den Tisch, und wir sind im Geschäft.";
