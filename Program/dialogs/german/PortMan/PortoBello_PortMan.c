...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "SharkGoldFleet_18":
			...
			dialog.text = "Es tut mir leid für die Wartezeit. Hier sind Ihre "+int(pchar.questTemp.SharkGoldFleet)+" Stücke von Acht. Und in diesem Fall werden sie selbst für die Antwort in Caracas bezahlen. Sag mir, dass ich es getan habe.";
