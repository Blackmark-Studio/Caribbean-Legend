	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Benua_Delivery":
			...
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Patent") && CheckCharacterItem(pchar, "patent_fra") || CheckAttribute(pchar, "questTemp.Patria.GenGovernor") && !CheckAttribute(pchar, "questTemp.SharlieEpilog_Governor"))
			{
				if (CheckAttribute(pchar, "questTemp.Patria.GenGovernor"))
				{
					link.l3 = "Ich möchte Baron Forger sowie die Kanzlei von Capsterville davon in Kenntnis setzen, dass ich gezwungen bin, das Amt des Generalgouverneurs niederzulegen.";
					link.l3.go = "SharlieEpilog_Benua_Governor";
				}
				else
				{
					link.l3 = "Ich besitze ein gültiges französisches Patent — ich möchte die Kanzlei von Capsterville über meine Entscheidung informieren.";
			...
			{
				link.l6 = "Ich muss Fadey dem Moskauer in Bas-Ter eine Nachricht zukommen lassen.";
			...
			{
				link.l7 = "Ich möchte der Familie Hawke aus Maroon Town von meiner Reise berichten.";
				link.l7.go = "SharlieEpilog_Benua_Houk";
			}
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Jino") && CharacterIsAlive("Jino"))
			{
				link.l8 = "Ich möchte Gino Guineilli aus Saint John's über meine Abreise in die Alte Welt informieren.";
		...
		case "SharlieEpilog_Benua_Money_4":
			dialog.text = "In diesem Fall wird eine Spende von hunderttausend Pesos ausreichen. Mit diesem Geld können wir noch viele Monate lang Mahlzeiten für Bedürftige bereitstellen. Wenn du den erforderlichen Betrag, einschließlich der Spende für die Kirche, bei dir hast, können wir sofort beginnen.";
		...
		case "SharlieEpilog_Benua_Money_5":
			dialog.text = "In diesem Fall sollte deine Spende zweihundertfünfzigtausend Pesos betragen. Diese Mittel werden es uns ermöglichen, ein Waisenhaus zu errichten, das deinen Namen tragen und zumindest in der Anfangszeit für seine Bedürfnisse sorgen wird. Wenn du den erforderlichen Betrag, einschließlich der Spende für die Kirche, bei dir hast, können wir sofort beginnen.";
		...
		case "SharlieEpilog_Benua_Money_6":
			dialog.text = "Nun, es scheint, du hast deine Zeit nicht vergeudet, "+pchar.name+". Ich denke, eine Spende von fünfhunderttausend Pesos wird völlig ausreichend sein. Dank eines solchen Beitrags können wir ein Hospital errichten und es für viele Jahre mit allem Notwendigen ausstatten. Wenn du den erforderlichen Betrag, einschließlich der Spende für die Kirche, bei dir hast, können wir sofort beginnen.";
		...
		case "SharlieEpilog_Benua_Governor":
			dialog.text = "Es tut mir aufrichtig leid, "+pchar.name+", dass du für das Treffen mit deinem Vater ein so hohes Amt aufgeben musst. Dennoch ist es erfreulich zu sehen, dass für dich die Familie über allem steht.";
			link.l1 = "Was mich quält, ist, dass ich während meiner gesamten Zeit hier in der Karibik nicht ein einziges Mal die Mühe auf mich genommen habe, ihm einen Brief zu schicken; und ich beabsichtige, dies durch einen persönlichen Besuch nachzuholen. So schwindelerregend mein Erfolg auch gewesen sein mag, darf ich meine Pflicht gegenüber meinem Vater nicht vergessen. Was den Baron betrifft – ich denke, er wird mir diesen abrupten Abschied verzeihen können: schließlich habe ich viel zum Wohl unseres gemeinsamen Staates beigetragen.";
			link.l1.go = "SharlieEpilog_Benua_Governor_2";
			pchar.questTemp.SharlieEpilog_Governor = true;
		break;

		case "SharlieEpilog_Benua_Governor_2":
			dialog.text = "Du hast eine schwierige, aber würdige Entscheidung getroffen, mein Sohn. Macht und Ehren sind vergänglich, doch die Pflicht gegenüber Familie und Geschlecht ist ewig. Glaube mir: Der Herr sieht deine Absichten und belohnt nicht Titel, sondern die Treue des Herzens.";
			link.l1 = "Ich danke Ihnen, heiliger Vater. Ihre Worte bedeuten mir viel.";
		...
		case "SharlieEpilog_Benua_Governor_4":
			dialog.text = "Ausgezeichnet. Ich werde alle Maßnahmen ergreifen, damit die Briefe so schnell wie möglich zugestellt werden.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Benua_Delivery";
