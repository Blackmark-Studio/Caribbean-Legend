void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Cureer":
			dialog.text = "Entschuldigen Sie. Sind Sie " + GetTitle(NPChar, false) + " " + GetFullName(pchar) + "?";
			link.l1 = "Persönlich. Womit habe ich die Ehre?";
			link.l1.go = "SharlieEpilog_Cureer_1";
		break;

		case "SharlieEpilog_Cureer_1":
			dialog.text = "Ah, endlich... Sie zu finden war nicht einfach, ich musste fast den ganzen Archipel absuchen. Ich habe eine Korrespondenz von Abt Benoît für Sie.";
			link.l1 = "Hm... Vom Abt? Das kommt unerwartet.";
			link.l1.go = "SharlieEpilog_Cureer_2";
		break;

		case "SharlieEpilog_Cureer_2":
			dialog.text = "Mir wurde befohlen, es Ihnen persönlich zu übergeben. Um die Bezahlung brauchen Sie sich nicht zu kümmern — der Abt hat im Voraus alle meine Auslagen gedeckt.";
			link.l1 = "Na schön, geben Sie’s her. Ich danke Ihnen.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Dassen":
			dialog.text = "Welche Befehle habt Ihr, "+GetTitle(NPChar, true)+"?";
			link.l1 = ""+npchar.name+", ich will nicht lange drum herumreden - ich verlasse den Archipel. Familienangelegenheiten erfordern meine Anwesenheit auf dem Anwesen meines Vaters.";
			link.l1.go = "SharlieEpilog_Dassen_1";
		break;
		
		case "SharlieEpilog_Dassen_1":
			dialog.text = "Wenn ich Euch richtig verstehe, trennen sich unsere Wege?";
			link.l1 = "Leider... Ich kann nicht anders handeln.";
			link.l1.go = "SharlieEpilog_Dassen_2";
		break;
		
		case "SharlieEpilog_Dassen_2":
			dialog.text = "Nun, es war mir eine Ehre, unter derselben Flagge wie Ihr zu dienen, und ich würde es mit Vergnügen erneut tun, wenn das Schicksal es zulässt.";
			link.l1 = "Ich hoffe, unsere Freundschaft wird nicht zerbrechen, sondern nur noch gefestigt werden, denn wir haben viele Abenteuer miteinander geteilt.";
			link.l1.go = "SharlieEpilog_Dassen_nothing";
			link.l2 = "Für Eure Loyalität und Professionalität möchte ich Euch als Abfindung einen Monatslohn auszahlen.";
			link.l2.go = "SharlieEpilog_Dassen_salary";
			link.l3 = "Ihr habt tadellos gedient, und ich halte es für notwendig, Euch gebührend zu belohnen. Nehmt dies an - hier sind drei Monatslöhne. Ihr habt Euch diese Belohnung mehr als verdient.";
			link.l3.go = "SharlieEpilog_Dassen_salaryX3";
		break;
		
		case "SharlieEpilog_Dassen_nothing":
			dialog.text = "Diese Hoffnung teile ich aufrichtig, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Nennt mich einfach Charles. Und übrigens habe ich noch etwas für Euch.";
		...
		case "SharlieEpilog_Dassen_salary":
			dialog.text = "Ich danke Euch, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Nennt mich einfach Charles. Und übrigens habe ich noch etwas für Euch.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
		...
		case "SharlieEpilog_Dassen_salaryX3":
			dialog.text = "Ich bin Euch sehr dankbar, "+GetTitle(NPChar, true)+", Ihr seid allzu großzügig zu mir.";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Nennt mich einfach Charles. Und übrigens habe ich noch etwas für Euch.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
		...
		case "SharlieEpilog_Dassen_Governor":
			dialog.text = "Ihr habt mein Interesse geweckt, "+pchar.name+".";
			link.l1 = "Ich habe Euch für das Amt des Gouverneurs von Isla Mona empfohlen. Schon bald wird ein entsprechendes Schreiben aus der Kanzlei eintreffen, und ich hoffe sehr, dass Ihr es nicht ablehnen werdet. Diese Insel bedeutet mir sehr viel, und ich wäre glücklich, Euch an der Spitze ihrer Verwaltung zu sehen.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_1";
		break;
		
		case "SharlieEpilog_Dassen_Governor_1":
			dialog.text = ""+UpperFirst(GetAddress_Form(NPChar))+"... "+pchar.name+"... Das ist äußerst unerwartet...";
			link.l1 = "Und dennoch. Wie lautet Eure Antwort?";
			link.l1.go = "SharlieEpilog_Dassen_Governor_2";
		break;
		
		case "SharlieEpilog_Dassen_Governor_2":
			dialog.text = "Dies ist ein Angebot, das man nicht ablehnt. Ich nehme es mit Vergnügen an und verspreche, alles für den Wohlstand dieser Insel und das Wohlergehen ihrer Bewohner zu tun.";
			link.l1 = "Ausgezeichnet, mein Freund! Dann erwarte ich Euch in der Taverne, bei dem Fest zu Ehren meiner Abreise. Alonso wird Euch benachrichtigen, sobald alles bereit ist.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_3";
		break;
		
		case "SharlieEpilog_Dassen_Governor_3":
			dialog.text = "Das werde ich mir keinesfalls entgehen lassen, Monseigneur.";
			link.l1 = "";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		
		case "SharlieEpilog_Dassen_Tavern":
			dialog.text = "Das werde ich mir keinesfalls entgehen lassen, "+pchar.name+".";
			link.l1 = "Ausgezeichnet, mein Freund. Dann treffen wir uns dort. Alonso wird Euch wissen lassen, wann wir bereit sind zu beginnen.";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		...
		case "SharlieEpilog_PikarOnUliss_D_1":
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarAlive") || CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarResurrected")){dialog.text = "Du hast recht.";}
		...
		case "SharlieEpilog_HenriDeMonper_Mary_4":
			if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "mi presenterai agli altri";
			else sStr = "mi presenterai al nostro ospite";
		...
		case "SharlieEpilog_InKitchenDeMonpe_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer") || CheckAttribute(pchar, "questTemp.LSC.Mary_officer"))
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "gute freunde";
				else sStr = "kampfgefährte";
				dialog.text = "";
			...
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "deine guten freunde";
				else sStr = "deinen freund";
				dialog.text = "";
		...
		case "SharlieEpilog_KomendantFort_5":
			dialog.text = "Ein ausgezeichneter Plan, Euer Gnaden! Doch… Ihr seid zweifellos ein in Seeschlachten gestählter Mann, und dennoch ziemt es sich für jemanden Eures Standes nicht, das eigene Leben zu riskieren. Die Flotte könnte ebenso gut von … befehligt werden.";
			link.l1 = "So wie ich das stille Leben in Europa nicht ertragen konnte, so kann ich auch das müßige Warten am Ufer nicht ertragen, während sich das Schicksal der Schlacht entscheidet. Dem Schicksal entkommt man nicht, "+GetAddress_Form(NPChar)+" "+npchar.lastname+". ";
			link.l1.go = "SharlieEpilog_KomendantFort_6";
		break;

		case "SharlieEpilog_KomendantFort_6":
			dialog.text = "Wie Ihr wünscht. Erlaubt Ihr mir, den Befehl zur Aufnahme der Vorbereitungen zu geben?";
			link.l1 = "Beginnt. Und Gott sei mit uns.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Mishelle_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) sStr = " und deiner Frau";
			dialog.text = "Hast du es immer noch nicht begriffen? Du bist tot. Zusammen mit deiner Mannschaft"+sStr+". Ein gewöhnlicher Händler, den du ausrauben wolltest, hat die Pulverkammer in die Luft gejagt – nur damit kein einziger Groschen Leuten wie dir in die Hände fällt.\nSpectra sunt memoria peccatorum. Du bist der Geist, "+pchar.name+"... Die Legende der Karibik erzählt von einem Mann, den Gier und blinder Hochmut verschlungen haben. Wie viele hast du für Gold getötet?";
