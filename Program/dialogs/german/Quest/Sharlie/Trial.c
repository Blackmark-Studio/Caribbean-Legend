...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "lecrua_1":
			...
			{
				link.l1 = "Ich habe ein "+GetStrSmallRegister(XI_ConvertString(GetBaseShipParamFromType(int(RealShips[int(pchar.ship.type)].basetype),"Name")))+", ihr Name ist "+pchar.ship.name+".";
		...
		case "florian_deck_5":
			...
			dialog.text = "Aber das ist noch nicht alles, Kapitän. Möchten Sie weitere 75 goldene Doppel-Escudos verdienen?";
