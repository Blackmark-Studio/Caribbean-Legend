...
// Блеквуд разговаривает с ГГ перед битвой на Каймане
		...
		case "LadyBeth_Alonso_2":
			dialog.text = "Getötet? In diesem Abenteuer haben wir "+int(pchar.SailorDiedInBattleInfo)+" Mann verloren. Ich will nicht aufdringlich wirken, Kapitän, aber... ich habe Sie gewarnt!";
