    ...
    switch(Dialog.CurrentNode)
	{
		...
		case "GiveMeSomeMoneyToo":
            ...
            if (iMoney >= 25000)
            {
                ...
                link.l1 = "Für Sie, Offizier, habe ich 25000 Pesos! (" + attrName + " " + iTemp + "%)";
            ...
            if (iMoney >= 12000)
            {
                ...
                link.l2 = "Wie wäre es mit 12000 Pesos? (" + attrName + " " + iTemp + "%)";
            ...
            if (iMoney >= 5000)
            {
                iTemp = iBaseChance / 2 - 10;
                if (iTemp > 100) iTemp = 100;
                link.l3 = "Ich denke, dass 5000 Pesos werden genug sein. (" + attrName + " " + iTemp + "%)";
