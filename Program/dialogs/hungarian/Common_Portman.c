...
//-------------------------------- квест доставки судового журнала до рассеяного кэпа ---------------------
		...
		case "SeekShip_good_1":
			dialog.text = "Kész vagyok kifizetni neked a jutalmadat. A képezi a " + FindRussianMoneyString(makeint(sti(npchar.quest.chest)*15000)) + " ládákban. Sajnos ennél többet nem tudok fizetni.";
...
*/		
		...
		case "ShipStock_3": // hasert новый кейс выбора для оффов
			...
			dialog.text = "Rendben. Bármikor visszaviheted a hajódat, amikor csak akarod.";
			Link.l1 = "Köszönjük!";
			Link.l1.go = "exit";
		break;
