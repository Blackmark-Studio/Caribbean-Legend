...
// boal -->
#define CARDS_RULE  "A szabályok egyszerûek.  Blackjack. 36 lap, a hatostól az ászokig. Az ász 11 pontot ér, a királyok - 4, Lord (lovag) - 3, Nobile (lábas katona) - 2, a többi ugyanolyan értékû, mint meg van írva. A célod, hogy 21 pontot szerezz\nClick egy paklira, hogy még egy kártyát elvehess. Minden kártya egy-egy tét. Kattints a jobb felsô sarokban lévô portrékra, hogy befejezd a köröd. Legalább három tétre elegendô pénzre van szükséged, ha játszani akarsz. Nyomd meg az esc vagy a keresztet, ha végeztél."
#define DICE_RULE   "Craps. Minden játékosnak ötöt. Mind az ötöt vagy bármelyiket feldobhatod, de csak egyszer. Minden kocka egy tét. A célod a maximális pontszám elérése.\nHere goes combinations: duó (2), két duó (2+2), hármas (3), teljes (3+2), négyzet (4), utca (kockák egy sorban) és póker (5). \nKattints egy csészére a dobáshoz, kattints egy kockára, hogy eldobd az adott kockát, kattints egy portréra, hogy befejezd a körödet (hogyha nem kell eldobnod, vagy nincs elég pénzed hozzá)."
...
string RandSwear()
{
	switch (rand(14))
	{
		...
		case 8:
			return "Mindenki hódoljon! ";	// стандартное пиратское "motherfucker"
		break;
...
string RandPhraseSimple(string Var1, string Var2)
{
	...
	{
		case 0:
			return /*"Elsô kiválasztott mondat" + */ Var1;
		break;

		case 1:
			return /*"Második kiválasztott mondat" + */Var2;
		break;
	}
	return "HIBA";
}
...
string LinkRandPhrase (string Var1, string Var2, string Var3)
{
	...
	switch(RandP)
	{
		...
		case 2:
			...
			return /*"Harmadik mondat kiválasztva" + */Var3;
...
string NationKingsCrown(ref Character)
{
    switch(sti(Character.nation))
	{
		...
		break;
		case FRANCE:
            return "Francia korona";
		break;
		case SPAIN:
            return "Spanyol korona";
		break;
		case HOLLAND:
			return "Holland Királyság";
		break;
		case PIRATE:
			return "A partvidék testvérei";
		break;
	}
}
string NationKingsName(ref NPChar)
{
    switch(sti(NPChar.nation))
	{
		...
		break;
		case FRANCE:
            return "Ôfelsége XIV. Lajos, Franciaország";
		break;
		case SPAIN:
            return "Ô Katolikus Felsége, IV. Fülöp von Habsburg.";
		break;
		case HOLLAND:
			return "Ôfelsége III. Vilmos, Hollandia";
		break;
		case PIRATE:
			return "A partvidék testvérei";
		break;
