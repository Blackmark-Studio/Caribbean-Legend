void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ShipyardsMap_4":
			dialog.text = "Mmm, meglio così... Bene! Passami "+FindRussianMoneyString(int(pchar.questTemp.different.ShipyardsMap.sklad)*1000)+", e lascerò la porta del cantiere navale aperta durante il giorno seguente.";
