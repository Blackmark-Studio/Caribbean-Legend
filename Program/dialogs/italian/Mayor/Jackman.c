...
// ============================================================================
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			link.l0 = ""+npchar.name+", vorrei" + GetSexPhrase("", "a") + " parlare della mia sicurezza in mare. I ragazzi della Fratellanza della Costa sembrano troppo interessati alla mia umile persona. Potresti calmarli un po'?";
...
//-----------------------------------------пиратская сага----------------------------------------------------
		...
		case "pirate_threat":
			...
			if (iGPThreat != 0)
			{
				...
				dialog.text = "Ah! I ragazzi della nostra fratellanza ti stanno dando del filo da torcere, eh, " + GetSexPhrase("amico", "amica") + "? Posso tenerli a bada per un po’. Ma ti costerà caro. " + FindRussianDublonString(iJackmanTotalTemp) + " sul tavolo, e siamo d’accordo.";
