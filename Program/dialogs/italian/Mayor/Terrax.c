...
//--> -----------------------------Сага - Искушение Барбазона завершающие этапы---------------------------
		...
		case "pirate_threat":
			...
			if (iGPThreat != 0)
			{
				...
				dialog.text = "Ah! I ragazzi della nostra fratellanza ti stanno dando del filo da torcere, eh, " + GetSexPhrase("amico", "amica") + "? Posso tenerli a bada per un po’. Ma ti costerà caro. " + FindRussianDublonString(iTerraxTotalTemp) + " sul tavolo, e siamo d’accordo.";
