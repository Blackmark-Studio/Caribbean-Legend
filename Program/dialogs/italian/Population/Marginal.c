...
//----------------------------------------захват пассажиров для выкупа------------------------------------------
			...
			case "passenger_2":
				...
				dialog.text = "Sarebbe molto imprudente imbrogliarti, cane di mare. Vivo in questa città e non ho bisogno di problemi. Solo per "+int(pchar.GenQuest.Marginpassenger.Dublon)+" darò informazioni complete per i dobloni. Guadagnerai molto di più.";
