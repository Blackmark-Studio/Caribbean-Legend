...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "SharkGoldFleet_18":
			...
			dialog.text = "Mi dispiace per l'attesa. Ecco i tuoi "+int(pchar.questTemp.SharkGoldFleet)+" pezzi di otto. E in questo caso, pagheranno loro stessi per la risposta a Caracas. Dimmi che l'ho fatto.";
