void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Escort_choice"://первые развилки - выбираем между городом, бухтой и необитайкой
			...
			switch (hrand(2))
			{
				case 0://город дружественный
					...
					dialog.text = "Vorrei chiederti di scortarmi fino a "+XI_ConvertString("Colony"+pchar.GenQuest.Escort.Trader.City+"Gen")+"   entro "+FindRussianDaysString(int(pchar.GenQuest.Escort.Trader.DaysQty))+". Ti pagherò "+FindRussianMoneyString(int(pchar.GenQuest.Escort.Trader.Money))+".";
				...
				case 1://бухта
					...
					dialog.text = "Vorrei chiederti di scortarmi fino a "+XI_ConvertString(pchar.GenQuest.Escort.Trader.Shore+"Gen")+", non lontano da "+XI_ConvertString("Colony"+pchar.GenQuest.Escort.Trader.City+"Gen")+"   entro   "+FindRussianDaysString(int(pchar.GenQuest.Escort.Trader.DaysQty))+". Ti pagherò "+FindRussianMoneyString(int(pchar.GenQuest.Escort.Trader.Money))+".";
				...
				case 2://необитайка
					...
					dialog.text = "Vorrei chiederti di scortarmi fino a "+XI_ConvertString(pchar.GenQuest.Escort.Trader.Shore+"Gen")+" che si trova a "+XI_ConvertString(pchar.GenQuest.Escort.Trader.Island)+", in "+FindRussianDaysString(int(pchar.GenQuest.Escort.Trader.DaysQty))+". Ti pagherò "+FindRussianMoneyString(int(pchar.GenQuest.Escort.Trader.Money))+".";
		...
		case "EscortTrader_complete_2":
			dialog.text = "Sì, osservazione assai saggia... Tieni, prendi il tuo "+FindRussianMoneyString(int(pchar.GenQuest.Escort.Trader.Money))+" e addio.";
