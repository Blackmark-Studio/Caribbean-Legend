	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Benua_Delivery":
			...
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Patent") && CheckCharacterItem(pchar, "patent_fra") || CheckAttribute(pchar, "questTemp.Patria.GenGovernor") && !CheckAttribute(pchar, "questTemp.SharlieEpilog_Governor"))
			{
				if (CheckAttribute(pchar, "questTemp.Patria.GenGovernor"))
				{
					link.l3 = "Desidero informare il barone Forger e la cancelleria di Capsterville che sono costretto a lasciare l’incarico di governatore generale.";
					link.l3.go = "SharlieEpilog_Benua_Governor";
				}
				else
				{
					link.l3 = "Sono in possesso di un valido brevetto francese — desidero notificare alla cancelleria di Capsterville la mia decisione.";
			...
			{
				link.l6 = "Devo far recapitare un messaggio a Fadey il Moscovita, a Bas-Ter.";
			...
			{
				link.l7 = "Desidero informare la famiglia Houk di Maroon Town del mio viaggio.";
				link.l7.go = "SharlieEpilog_Benua_Houk";
			}
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Jino") && CharacterIsAlive("Jino"))
			{
				link.l8 = "Vorrei notificare a Gino Guinelli di Saint John's la mia partenza per il Vecchio Mondo.";
		...
		case "SharlieEpilog_Benua_Money_4":
			dialog.text = "In tal caso, una donazione di centomila pesos sarà sufficiente. Con questo denaro potremo offrire pasti ai bisognosi per molti mesi. Se hai con te la somma necessaria, inclusa la donazione alla Chiesa, possiamo iniziare subito.";
		...
		case "SharlieEpilog_Benua_Money_5":
			dialog.text = "In tal caso, la tua donazione dovrà ammontare a duecentocinquantamila pesos. Questi fondi ci permetteranno di costruire un orfanotrofio che porterà il tuo nome e ne sosterrà le necessità, almeno inizialmente. Se hai con te la somma necessaria, inclusa la donazione alla Chiesa, possiamo iniziare subito.";
		...
		case "SharlieEpilog_Benua_Money_6":
			dialog.text = "Ebbene, pare che tu non abbia perso tempo, "+pchar.name+". Credo che una donazione di cinquecentomila pesos sarà più che sufficiente. Grazie a un contributo simile potremo costruire un ospedale e dotarlo di tutto il necessario per molti anni. Se hai con te la somma necessaria, inclusa la donazione alla Chiesa, possiamo iniziare subito.";
		...
		case "SharlieEpilog_Benua_Governor":
			dialog.text = "Mi rincresce sinceramente, "+pchar.name+", che per incontrare tuo padre tu debba lasciare un incarico così elevato. Eppure è confortante vedere che, per te, la famiglia viene prima di tutto.";
			link.l1 = "Ciò che mi tormenta è che, durante tutto il tempo trascorso qui, nei Caraibi, non mi sono preso la briga di inviargli nemmeno una lettera; e intendo rimediare con una visita personale. Per quanto il mio successo sia stato vertiginoso, non devo dimenticare il dovere verso mio padre. Quanto al barone — credo che potrà perdonare un congedo così improvviso: dopotutto, ho fatto molto per il bene del nostro Stato comune.";
			link.l1.go = "SharlieEpilog_Benua_Governor_2";
			pchar.questTemp.SharlieEpilog_Governor = true;
		break;

		case "SharlieEpilog_Benua_Governor_2":
			dialog.text = "Hai compiuto una scelta difficile, ma degna, figlio mio. Il potere e gli onori sono effimeri, mentre il dovere verso la famiglia e il casato è eterno. Credimi, il Signore vede le tue intenzioni e ricompensa non i titoli, ma la fedeltà del cuore.";
			link.l1 = "La ringrazio, santo padre. Le sue parole significano molto per me.";
		...
		case "SharlieEpilog_Benua_Governor_4":
			dialog.text = "Eccellente. Adotterò ogni misura affinché le lettere vengano consegnate nel più breve tempo possibile.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Benua_Delivery";
