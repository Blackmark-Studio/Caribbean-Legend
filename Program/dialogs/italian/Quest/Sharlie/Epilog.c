void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Cureer":
			dialog.text = "Mi scusi. Lei è " + GetTitle(NPChar, false) + " " + GetFullName(pchar) + "?";
			link.l1 = "In persona. A cosa devo l'onore?";
			link.l1.go = "SharlieEpilog_Cureer_1";
		break;

		case "SharlieEpilog_Cureer_1":
			dialog.text = "Ah, finalmente... Trovare voi non è stato facile, ho dovuto quasi attraversare tutto l’arcipelago. Ho una corrispondenza per voi dall’abate Benoît.";
			link.l1 = "Hmm... Dall’abate? Non me lo aspettavo.";
			link.l1.go = "SharlieEpilog_Cureer_2";
		break;

		case "SharlieEpilog_Cureer_2":
			dialog.text = "Mi è stato ordinato di consegnarvela di persona. Non preoccupatevi per il pagamento — l’abate ha già coperto tutte le mie spese in anticipo.";
			link.l1 = "Bene, datemela allora. Vi ringrazio.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Dassen":
			dialog.text = "Quali sono gli ordini, "+GetTitle(NPChar, true)+"?";
			link.l1 = ""+npchar.name+", non mi dilungherò - lascio l’arcipelago. Le faccende di famiglia richiedono la mia presenza nella tenuta di mio padre.";
			link.l1.go = "SharlieEpilog_Dassen_1";
		break;
		
		case "SharlieEpilog_Dassen_1":
			dialog.text = "Se ho capito bene, ci stiamo separando?";
			link.l1 = "Ahimè... Non posso fare altrimenti.";
			link.l1.go = "SharlieEpilog_Dassen_2";
		break;
		
		case "SharlieEpilog_Dassen_2":
			dialog.text = "Ebbene, per me è stato un onore servire sotto la stessa bandiera con voi, e lo rifarei con piacere, se il destino lo vorrà.";
			link.l1 = "Spero che la nostra amicizia non si spezzi, ma si rafforzi soltanto, poiché abbiamo condiviso non poche avventure.";
			link.l1.go = "SharlieEpilog_Dassen_nothing";
			link.l2 = "Per la vostra lealtà e professionalità, desidero corrispondervi, come indennità di congedo, un mese di paga.";
			link.l2.go = "SharlieEpilog_Dassen_salary";
			link.l3 = "Avete servito in modo impeccabile, e ritengo doveroso ricompensarvi come si deve. Accettate questo - qui ci sono tre mesi di paga. Avete più che meritato questa ricompensa.";
			link.l3.go = "SharlieEpilog_Dassen_salaryX3";
		break;
		
		case "SharlieEpilog_Dassen_nothing":
			dialog.text = "Condivido sinceramente questa speranza, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Chiamatemi semplicemente Charles. E, a proposito, ho qualcosa per voi.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			}
			else
			{
				link.l1 = "Ebbene, arrivederci alla prossima, monsieur "+npchar.lastname+". Addio.";
				link.l1.go = "SharlieEpilog_Dassen_Leave";
			}
		break;
		
		case "SharlieEpilog_Dassen_salary":
			dialog.text = "Vi ringrazio, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Chiamatemi semplicemente Charles. E, a proposito, ho ancora qualcosa per voi.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			}
			else
			{
		...
		case "SharlieEpilog_Dassen_salaryX3":
			dialog.text = "Vi sono molto riconoscente, "+GetTitle(NPChar, true)+", siete fin troppo generoso con me.";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Chiamatemi semplicemente Charles. E, a proposito, ho ancora qualcosa per voi.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			...
			{
				link.l1 = "Basta con le formalità, chiamatemi semplicemente Charles. In onore della mia partenza, ho intenzione di organizzare una piccola festa alla taverna. Spero che vi unirete a noi?";
		...
		case "SharlieEpilog_Dassen_Governor":
			dialog.text = "Avete stuzzicato la mia curiosità, "+pchar.name+".";
			link.l1 = "Vi ho raccomandato per la carica di governatore di Isla Mona. A breve giungerà dalla cancelleria la relativa lettera, e spero sinceramente che non la rifiuterete. Quest’isola significa moltissimo per me, e sarei felice di vedervi a capo della sua amministrazione.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_1";
		break;
		
		case "SharlieEpilog_Dassen_Governor_1":
			dialog.text = ""+UpperFirst(GetAddress_Form(NPChar))+"... "+pchar.name+"... È davvero inaspettato...";
			link.l1 = "E nondimeno. Quale sarà la vostra risposta?";
			link.l1.go = "SharlieEpilog_Dassen_Governor_2";
		break;
		
		case "SharlieEpilog_Dassen_Governor_2":
			dialog.text = "È un’offerta che non si può rifiutare. La accetto con piacere e prometto di fare tutto il possibile per la prosperità di quest’isola e il benessere dei suoi abitanti.";
			link.l1 = "Eccellente, amico mio! Allora vi aspetto alla taverna, per la festa in onore della mia partenza. Alonso vi avviserà quando tutto sarà pronto.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_3";
		break;
		
		case "SharlieEpilog_Dassen_Governor_3":
			dialog.text = "Non mancherò per nulla al mondo, monsignore.";
			link.l1 = "";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		
		case "SharlieEpilog_Dassen_Tavern":
			dialog.text = "Non mancherò per nulla al mondo, "+pchar.name+".";
			link.l1 = "Eccellente, amico mio. Allora ci incontreremo lì. Alonso vi farà sapere quando saremo pronti a cominciare.";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		...
		case "SharlieEpilog_PikarOnUliss_D_1":
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarAlive") || CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarResurrected")){dialog.text = "Hai ragione.";}
		...
		case "SharlieEpilog_HenriDeMonper_Mary_4":
			if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "君は僕を他のみんなに紹介する";
			else sStr = "君は僕をお客さんに紹介する";
		...
		case "SharlieEpilog_InKitchenDeMonpe_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer") || CheckAttribute(pchar, "questTemp.LSC.Mary_officer"))
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "buoni amici";
				else sStr = "compagno d’armi";
				dialog.text = "";
			...
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "i tuoi buoni amici";
				else sStr = "il tuo amico";
				dialog.text = "";
		...
		case "SharlieEpilog_KomendantFort_5":
			dialog.text = "Un piano eccellente, Vostra Grazia! Tuttavia… siete senza dubbio un uomo temprato dalle battaglie navali, eppure non si addice a qualcuno del vostro rango rischiare la propria vita. La flotta potrebbe benissimo essere guidata da…";
			link.l1 = "Così come non ho saputo sopportare la vita quieta in Europa, non saprò neppure restare ozioso sulla riva mentre si decide l’esito della battaglia. Al destino non si sfugge, "+GetAddress_Form(NPChar)+" "+npchar.lastname+". ";
			link.l1.go = "SharlieEpilog_KomendantFort_6";
		break;

		case "SharlieEpilog_KomendantFort_6":
			dialog.text = "Sia come desiderate. Mi consentite di dare l’ordine di iniziare i preparativi?";
			link.l1 = "Procedete. E che Dio sia con noi.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Mishelle_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) sStr = " e tua moglie";
			dialog.text = "Non hai ancora capito? Sei morto. Insieme alla tua ciurma"+sStr+". Un mercante qualunque che avevi deciso di rapinare ha fatto saltare la santabarbara — pur di non lasciare neppure un soldo a gente come te.\nSpectra sunt memoria peccatorum. Sei tu il fantasma, "+pchar.name+"... La leggenda dei Caraibi parla di un uomo divorato dall’avidità e da una vanità cieca. Quanti ne hai uccisi per l’oro?";
