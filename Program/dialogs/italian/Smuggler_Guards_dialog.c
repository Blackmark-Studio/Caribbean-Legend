    ...
    switch(Dialog.CurrentNode)
	{
		...
		case "GiveMeSomeMoneyToo":
            ...
            if (iMoney >= 25000)
            {
                ...
                link.l1 = "Per te, ufficiale, ho 25000 pesos! (" + attrName + " " + iTemp + "%)";
            ...
            if (iMoney >= 12000)
            {
                ...
                link.l2 = "E che ne dici 12000 pesos? (" + attrName + " " + iTemp + "%)";
            ...
            if (iMoney >= 5000)
            {
                iTemp = iBaseChance / 2 - 10;
                if (iTemp > 100) iTemp = 100;
                link.l3 = "Credo che 5000 pesos saranno sufficienti. (" + attrName + " " + iTemp + "%)";
