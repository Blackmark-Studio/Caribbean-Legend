...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "tonzag_bail_2":
			dialog.text = "Certo, tuttavia, sarà un po' più costoso per te. Lascia che ti dica esattamente... "+pchar.questTemp.TonzagQuest.Bail+" i dobloni saranno "+int(pchar.questTemp.TonzagQuest.Bail)* 150+" pesos.";
