...
// Jason-------------------------------------------------Сага----------------------------------------------
		...
		case "ispoved_2":
			dialog.text = "「その旗の下で航海した者たちの中に誰もいなかったことを願う」 "+NationNameGenitive(int(NPChar.nation))+"?";
        ...
        case "work":
            ...
            link.l2 = RandPhraseSimple("「教会のために働くことについて話したかったんだ」 "+NationNameGenitive(int(NPChar.nation))+".","教区の様子はどうだ？何か手伝いが必要か？");
			link.l2.go = "prihod";
