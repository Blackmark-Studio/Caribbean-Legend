...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("何の用だ？","何を知りたいんだ？"),"何の用だ、 "+GetAddress_Form(NPChar)+"?","「それで三度目だぜ、俺に聞こうとしたのは……」","もううんざりだ、消え失せろ！","block",1,npchar,Dialog.CurrentNode);
