...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "crew_1":
			...
			dialog.text = "「ある」 "+int(npchar.quest.crew.qty)+" 俺たちは一緒にしか雇われねえぜ。水夫の基本的な仕事なら全部できる。"+sTemp+"";
		...
		case "crew_2":
			...
			dialog.text = ""+FindRussianMoneyString(int(npchar.quest.crew.money))+" 一人につき、そして普通の水夫の月給だ。それ以上は要求しねえよ、船長。";
