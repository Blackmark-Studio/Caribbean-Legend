...
case "SharlieEpilog_Benua_1":
		...
		case "SharlieEpilog_Benua_Delivery":
			...
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Patent") && CheckCharacterItem(pchar, "patent_fra") || CheckAttribute(pchar, "questTemp.Patria.GenGovernor") && !CheckAttribute(pchar, "questTemp.SharlieEpilog_Governor"))
			{
				if (CheckAttribute(pchar, "questTemp.Patria.GenGovernor"))
				{
					link.l3 = "フォルジェ男爵およびカプステルヴィルの官庁に、私が総督の職を辞するやむなき事情にあることを知らせたい。";
					link.l3.go = "SharlieEpilog_Benua_Governor";
				}
				else
				{
					link.l3 = "有効なフランスの任命状を所持している——この決断をカプステルヴィルの官庁に通知したい。";
			...
			{
				link.l6 = "バス＝テールにいるファデイ・モスコヴィートへ伝言を送る必要がある。";
		...
		case "SharlieEpilog_Benua_Governor":
			dialog.text = "父上に会うためとはいえ、これほど高い地位を離れねばならないとは、心から残念に思います、"+pchar.name+"。それでも、あなたにとって家族が何よりも大切であることが分かり、安堵しました。";
			link.l1 = "私が悔やんでいるのは、ここカリブに滞在していた間、一度も彼に手紙を送らなかったことです。そして、その過ちを直接訪ねることで正そうと考えています。どれほど目覚ましい成功を収めたとしても、親に対する義務を忘れてはなりません。男爵のことについては——この突然の辞任も許してくれるでしょう。結局のところ、私は我々の国家のために十分な働きをしてきたのですから。";
			link.l1.go = "SharlieEpilog_Benua_Governor_2";
			pchar.questTemp.SharlieEpilog_Governor = true;
		break;

		case "SharlieEpilog_Benua_Governor_2":
			dialog.text = "困難ではあるが、尊い選択をしたのだ、我が子よ。権力や栄誉は移ろいやすいが、家族と血統への責務は永遠である。信じなさい、主はその志を見ておられ、称号ではなく心の忠実さに報いてくださる。";
			link.l1 = "ありがとうございます、神父様。お言葉は私にとって大きな意味を持ちます。";
		...
		case "SharlieEpilog_Benua_Governor_4":
			dialog.text = "結構です。書簡が最短の期間で届けられるよう、あらゆる手を尽くしましょう。";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Benua_Delivery";
