void ProcessDialogEvent() 
{
    ...
    switch(Dialog.CurrentNode)
	{
		...
		case "GiveMeSomeMoneyToo":	
			...
			Link.l1 = "私はそう思う"+makeint(sti(Pchar.money)/10)+" ペソで十分だろう。";
			...
			Link.l2 = "どうだ "+makeint(sti(Pchar.money)/5)+" ペソか？";
			...
			Link.l3 = "お前さんのために、士官殿、俺が用意したのは "+makeint(sti(Pchar.money)/2)+" ペソだ！";
