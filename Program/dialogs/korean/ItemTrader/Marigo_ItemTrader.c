...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("지금은 질문이 없소...","죄송하지만, 지금은 드릴 말씀이 없습니다..."),"다시 한 번, 미안하오...","정말 이제 거래를 할 때가 된 걸까...","죄송합니다, 거래합시다...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
