	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Benua_Delivery":
			...
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Patent") && CheckCharacterItem(pchar, "patent_fra") || CheckAttribute(pchar, "questTemp.Patria.GenGovernor") && !CheckAttribute(pchar, "questTemp.SharlieEpilog_Governor"))
			{
				if (CheckAttribute(pchar, "questTemp.Patria.GenGovernor"))
				{
					link.l3 = "포르제 남작과 캡스터빌의 관청에, 제가 총독의 직위를 내려놓아야만 하는 사정임을 알리고 싶습니다.";
					link.l3.go = "SharlieEpilog_Benua_Governor";
				}
				else
				{
					link.l3 = "유효한 프랑스 임명장을 가지고 있습니다—이 결정을 캡스터빌의 관청에 통보하고자 합니다.";
			...
			{
				link.l6 = "바스테르에 있는 파데이 모스코비트에게 소식을 전해야 합니다.";
		...
		case "SharlieEpilog_Benua_Money_4":
			dialog.text = "그렇다면 십만 페소의 기부로 충분할 것이다. 이 돈으로 우리는 수개월 동안 도움이 필요한 이들에게 식사를 제공할 수 있다. 교회에 바칠 헌금을 포함해 필요한 금액을 가지고 있다면, 지금 바로 시작할 수 있습니다.";
		...
		case "SharlieEpilog_Benua_Money_5":
			dialog.text = "그렇다면 네 기부금은 이십오만 페소가 되어야 한다. 이 자금으로 고아들을 위한 보호소를 세울 수 있으며, 그것은 네 이름을 기리고 최소한 초기에는 운영을 유지할 수 있을 것이다. 교회에 바칠 헌금을 포함해 필요한 금액을 가지고 있다면, 지금 바로 시작할 수 있습니다.";
		...
		case "SharlieEpilog_Benua_Money_6":
			dialog.text = "흠, 시간을 헛되이 보내지는 않았군, "+pchar.name+". 오십만 페소의 기부면 충분할 것 같다. 이 정도의 헌금이라면 병원을 세우고 오랜 세월 동안 필요한 모든 것을 제공할 수 있을 것이다. 교회에 바칠 헌금을 포함해 필요한 금액을 가지고 있다면, 지금 바로 시작할 수 있습니다.";
		...
		case "SharlieEpilog_Benua_Governor":
			dialog.text = "부친을 만나기 위해 이처럼 높은 직위를 내려놓아야 한다니 참으로 안타깝습니다, "+pchar.name+"님. 그럼에도 당신에게 가족이 무엇보다 우선이라는 점을 보게 되어 마음이 놓입니다.";
			link.l1 = "제가 마음에 걸리는 것은, 이곳 카리브에 머무는 동안 단 한 통의 편지도 보내지 못했다는 사실입니다. 그래서 직접 찾아뵈어 이를 바로잡고자 합니다. 제 성공이 아무리 눈부셨다 하더라도, 부모에 대한 의무를 잊어서는 안 됩니다. 남작에 관해서라면—이 갑작스러운 사임도 용서해 줄 것이라 생각합니다. 결국 저는 우리 공동의 국가를 위해 충분히 많은 일을 해왔으니까요.";
			link.l1.go = "SharlieEpilog_Benua_Governor_2";
			pchar.questTemp.SharlieEpilog_Governor = true;
		break;

		case "SharlieEpilog_Benua_Governor_2":
			dialog.text = "그대는 쉽지 않지만 고귀한 선택을 했네, 내 아들아. 권력과 명예는 덧없으나, 가족과 가문에 대한 의무는 영원하다네. 믿어라, 주님께서는 그대의 마음을 보시고 직함이 아닌 마음의 충실함에 보답하신다.";
			link.l1 = "감사합니다, 신부님. 말씀 하나하나가 제게 큰 의미가 됩니다.";
		...
		case "SharlieEpilog_Benua_Governor_4":
			dialog.text = "훌륭합니다. 편지들이 가능한 한 최단 시간 안에 전달되도록 모든 조치를 취하겠습니다.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Benua_Delivery";
