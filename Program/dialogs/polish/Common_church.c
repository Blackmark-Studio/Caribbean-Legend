...
// Jason-------------------------------------------------Сага----------------------------------------------
		...
		case "ispoved_2":
			dialog.text = " Mam nadzieję, że nie było nikogo wśród tych, którzy żeglowali pod banderą "+NationNameGenitive(int(NPChar.nation))+"?";
        ...
        case "work":
            ...
            link.l2 = RandPhraseSimple("Chciałem porozmawiać o pracy na rzecz dobra kościoła "+NationNameGenitive(int(NPChar.nation))+".","Jak się mają sprawy w parafii? Potrzebujecie jakiejś pomocy?");
			link.l2.go = "prihod";
