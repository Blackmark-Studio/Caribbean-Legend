...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "map_treasure_3":
			...
			if(bPesosMap)
			{
				dialog.Text = "To kosztuje tylko "+FindRussianMoneyString(iTreasureMapPesosCost)+"."; // Addon-2016 Jason
			...
			{
				dialog.Text = "To kosztuje tylko "+NPChar.TreasureMoney+" dublony."; // Addon-2016 Jason
				Link.l1 = "W porządku. I zawij to w ładny kawałek materiału.";
