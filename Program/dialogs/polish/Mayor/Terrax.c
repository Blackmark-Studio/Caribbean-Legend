...
//--> -----------------------------Сага - Искушение Барбазона завершающие этапы---------------------------
		...
		case "pirate_threat":
			...
			if (iGPThreat != 0)
			{
				...
				dialog.text = "Ha! Chłopaki z naszej braci dają ci w kość, co, " + GetSexPhrase("kolego", "koleżanko") + "? Mogę ich na chwilę uspokoić. Ale to cię będzie słono kosztować. " + FindRussianDublonString(iTerraxTotalTemp) + " na stół i jesteśmy dogadani.";
