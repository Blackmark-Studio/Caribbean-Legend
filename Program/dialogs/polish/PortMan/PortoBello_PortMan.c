...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "SharkGoldFleet_18":
			...
			dialog.text = "Przepraszam za czekanie. Oto twój "+int(pchar.questTemp.SharkGoldFleet)+" kawałki ośmiu. A w tym przypadku oni sami zapłacą za odpowiedź w Caracas. Powiedz mi, co zrobiłem.";
