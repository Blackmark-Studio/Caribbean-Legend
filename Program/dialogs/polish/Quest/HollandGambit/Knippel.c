...
//------------------------------------------------против всех-----------------------------------------------
		...
		case "Knippel_officer":
			...
			{
				dialog.text = "Kula armatnia w moją wątrobę, kapitanie. Już nigdy nie postawię stopy na lądzie. Ostatnim razem, gdy grałem w kości w tawernie, jakiś drań obczyścił mi kieszenie do ostatniego grosza.";
				Link.l1 = "Ha‑ha, a jesteś pewien, że ich nie przegrałeś przy stole, "+npchar.name+"? W każdym razie… chciałem z tobą porozmawiać. Postanowiłem popłynąć do Europy — jako pasażer na cudzym statku. Nie wiem, kiedy wrócę. Nie będę prosił, żebyś tu na mnie czekał. I też cię ze sobą nie zabiorę.";
	...
	// на Тайясаль
		...
		case "SharlieEpilog_Knippel_1":
			dialog.text = "Cóż, to doprawdy szkoda… kula armatnia w mój sprzęt. Szczerze mówiąc, nawet nie byłoby mi w smak zobaczyć Europę.";
			link.l1 = "Nie spodziewałem się usłyszeć tego od ciebie. Cóż więc, witaj na pokładzie pinasy '"+GetShipName("Ulysse")+"'. Jeśli chcesz, możemy odwiedzić naszego starego znajomego, Richarda Fleetwooda. Myślę, że masz mu coś do powiedzenia.";
			link.l1.go = "SharlieEpilog_Knippel_2";
		break;

		case "SharlieEpilog_Knippel_2":
			dialog.text = "Nie, proszę pana. Do diabła z Richardem. Nie chcę o nim słyszeć, a tym bardziej widzieć jego twarzy.";
			link.l1 = "Jak sobie życzysz, "+npchar.name+", jak sobie życzysz. Wypływamy za dwa tygodnie. Planuję porządną imprezę pożegnalną. Mam nadzieję, że się do nas dołączysz.";
			link.l1.go = "SharlieEpilog_Knippel_3";
		break;

		case "SharlieEpilog_Knippel_3":
			dialog.text = "Niech kula armatnia połamie mi kark, jeśli powiem nie, kapitanie!";
			link.l1 = "Świetnie. To zobaczymy się w tawernie, kiedy załatwię wszystkie pozostałe sprawy.";
			link.l1.go = "exit";
			NextDiag.TempNode = "Knippel_officer";
