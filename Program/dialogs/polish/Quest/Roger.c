...
void ProcessDialogEvent()
{
	...
	case "merida_head_8":
		...
		case "spy_sailor_1":
			...
			dialog.text = "Tak, kapitanie. Trzy statki. Okrętem flagowym jest " + ship1 + ", a pozostałe dwa to " + ship2 + " i " + ship3 + ".";
		...
		case "IslaMona_11":
			...
			AddRumor("Podobno kilku przestępców wypędzono na jedną z bezludnych wysp! Wygląda na to, że to tak dzikie potwory, że nawet kat i święci ojcowie nie chcieliby mieć z nimi do czynienia! Ale dlaczego zawsze przyprowadzają do nas takich ludzi?!", "1", "all", "none", "0", string((2022 - STARTGAME_YEAR) * 365), "IslaMona_TerksRumour", "none");
		break;
		...
		case "ShipStock_2":
			...
			dialog.Text = "Zatem, mamy tu zatrzymać"+XI_ConvertString(RealShips[int(chref.Ship.Type)].BaseName+"Akceptuj")+" nazwany '"+chref.Ship.Name+"'. Prawda?";
			Link.l1 = "Dobrze.";
		...
		case "GasparGold_meeting_sandbox":
			dialog.text = "Witam. Nazywam się Gaspar Parmentier. Czym mogę służyć?";
			link.l1 = "Witaj, Gasparze. Jestem kapitanem " + GetFullName(pchar) + ". Przysyła mnie tutejszy karczmarz. Mówią, że skupujesz różne błyskotki?";
			link.l1.go = "GasparGold_meeting_01";
			link.l2 = "Czołem, Złotozęby. Słyszałem, że kupujesz wszystko, co się świeci? Do diabła, chyba się dogadamy.";
			link.l2.go = "GasparGold_meeting_wrong";
		break;

		case "GasparGold_meeting_wrong":
			dialog.text = "Wydaje mi się, że pomylił mnie pan z kimś innym. Proszę opuścić to miejsce, zanim wezwę straż.";
			link.l1 = "Argh... No dobrze...";
			link.l1.go = "exit";
			NextDiag.TempNode = "Gaspar_sandbox_repeat";
		break;

		case "Gaspar_sandbox_repeat":
			dialog.text = RandPhraseSimple("Zdaje się, że prosiłem, by pan stąd wyszedł.", "Nie mam czasu na czcze gadanie. Proszę dać mi spokój.", "Twoja bezczelność jest zdumiewająca. Zamierzasz mnie dalej nękać?");
			link.l1 = "Spokojnie, przyjacielu. Przysyła mnie karczmarz.";
			link.l1.go = "Gaspar_Alternative";
			link.l2 = "Przestań kręcić! Wiem, że skupujesz klejnoty!";
			link.l2.go = "Gaspar_Angry";
		break;

		case "Gaspar_Angry":
			dialog.text = "Już mówiłem, że się tym nie zajmuję. Proszę się wynosić, zanim każę cię wyrzucić.";
			link.l1 = "...";
			link.l1.go = "exit";
			NextDiag.TempNode = "Gaspar_sandbox_repeat";
		break;
		...
		case "Gaspar_Alternative":
			dialog.text = "To zmienia postać rzeczy, kapitanie. Trafiłeś pod właściwy adres. Chcesz sprzedać jakieś klejnoty?";
			link.l1 = "No cóż, 'moje' to trochę na wyrost. He he.";
