void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Cureer":
			dialog.text = "Proszę wybaczyć. Czy pan/pani to " + GetTitle(NPChar, false) + " " + GetFullName(pchar) + "?";
			link.l1 = "We własnej osobie. W czym mogę pomóc?";
			link.l1.go = "SharlieEpilog_Cureer_1";
		break;

		case "SharlieEpilog_Cureer_1":
			dialog.text = "Och, nareszcie... Odnalezienie pana/pani było nie lada wyzwaniem — musiałem przeszukać niemal cały archipelag. Mam dla pana/pani korespondencję od opata Benoît.";
			link.l1 = "Hm... Od opata? Niespodziewane.";
			link.l1.go = "SharlieEpilog_Cureer_2";
		break;

		case "SharlieEpilog_Cureer_2":
			dialog.text = "Polecono mi przekazać ją osobiście. Proszę się nie martwić o opłatę — opat z góry pokrył wszystkie moje koszty.";
			link.l1 = "W porządku, proszę ją dać. Dziękuję.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Dassen":
			dialog.text = "Jakie będą rozkazy, "+GetTitle(NPChar, true)+"?";
			link.l1 = ""+npchar.name+", nie będę zwlekał - opuszczam archipelag. Sprawy rodzinne wymagają mojej obecności w posiadłości mojego ojca.";
			link.l1.go = "SharlieEpilog_Dassen_1";
		break;
		
		case "SharlieEpilog_Dassen_1":
			dialog.text = "Jeśli dobrze rozumiem, rozstajemy się?";
			link.l1 = "Niestety... Nie mogę postąpić inaczej.";
			link.l1.go = "SharlieEpilog_Dassen_2";
		break;
		
		case "SharlieEpilog_Dassen_2":
			dialog.text = "Cóż, zaszczytem było dla mnie służyć z tobą pod jedną banderą i z przyjemnością zrobiłbym to ponownie, jeśli los na to pozwoli.";
			link.l1 = "Mam nadzieję, że nasza przyjaźń nie zostanie zerwana, lecz tylko się umocni, bo wspólnie przeżyliśmy niemało przygód.";
			link.l1.go = "SharlieEpilog_Dassen_nothing";
			link.l2 = "Za twoją lojalność i profesjonalizm chciałbym, tytułem odprawy, wypłacić ci miesięczne żołdy.";
			link.l2.go = "SharlieEpilog_Dassen_salary";
			link.l3 = "Służyłeś bez zarzutu i uważam za konieczne należycie cię wynagrodzić. Przyjmij to - oto trzy miesięczne żołdy. W pełni zasłużyłeś na tę nagrodę.";
			link.l3.go = "SharlieEpilog_Dassen_salaryX3";
		break;
		
		case "SharlieEpilog_Dassen_nothing":
			dialog.text = "Szczerze podzielam tę nadzieję, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Mów mi po prostu Charles. A tak przy okazji, mam dla ciebie coś jeszcze.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			}
			else
			{
				link.l1 = "Cóż więc, do następnego spotkania, monsieur "+npchar.lastname+". Żegnaj.";
				link.l1.go = "SharlieEpilog_Dassen_Leave";
			}
		break;
		
		case "SharlieEpilog_Dassen_salary":
			dialog.text = "Dziękuję wam, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Mów mi po prostu Charles. A tak przy okazji, mam dla ciebie coś jeszcze.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			...
			{
				link.l1 = "Cóż więc, do następnego spotkania, monsieur "+npchar.lastname+". Żegnajcie.";
				link.l1.go = "SharlieEpilog_Dassen_Leave";
			}
		...
		case "SharlieEpilog_Dassen_salaryX3":
			dialog.text = "Jestem wam niezmiernie wdzięczny, "+GetTitle(NPChar, true)+", jesteście dla mnie aż nazbyt hojni.";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Mów mi po prostu Charles. A tak przy okazji, mam dla ciebie coś jeszcze.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			...
			{
				link.l1 = "Precz z formalnościami, mów mi po prostu Charles. Z okazji wypłynięcia zamierzam urządzić w tawernie niewielkie przyjęcie. Mam nadzieję, że do nas dołączysz?";
		...
		case "SharlieEpilog_Dassen_Governor":
			dialog.text = "Zaintrygowałeś mnie, "+pchar.name+".";
			link.l1 = "Poleciłem cię na stanowisko gubernatora Isla Mony. Wkrótce z kancelarii nadejdzie stosowne pismo i bardzo liczę na to, że nie odpowiesz na nie odmową. Ta wyspa znaczy dla mnie bardzo wiele i byłbym szczęśliwy, widząc cię na czele jej administracji.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_1";
		break;
		
		case "SharlieEpilog_Dassen_Governor_1":
			dialog.text = ""+UpperFirst(GetAddress_Form(NPChar))+"... "+pchar.name+"... To doprawdy bardzo nieoczekiwane...";
			link.l1 = "A jednak. Jaka będzie twoja odpowiedź?";
			link.l1.go = "SharlieEpilog_Dassen_Governor_2";
		break;
		
		case "SharlieEpilog_Dassen_Governor_2":
			dialog.text = "To propozycja, której się nie odrzuca. Z przyjemnością ją przyjmuję i obiecuję zrobić wszystko dla rozkwitu tej wyspy oraz pomyślności jej mieszkańców.";
			link.l1 = "Wspaniale, mój przyjacielu! W takim razie czekam na ciebie w tawernie, na uroczystości z okazji mojego wypłynięcia. Alonso da ci znać, gdy wszystko będzie gotowe.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_3";
		break;
		
		case "SharlieEpilog_Dassen_Governor_3":
			dialog.text = "Za nic w świecie tego nie opuszczę, monseigneur.";
			link.l1 = "";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		
		case "SharlieEpilog_Dassen_Tavern":
			dialog.text = "Za nic w świecie tego nie opuszczę, "+pchar.name+".";
			link.l1 = "Wspaniale, mój przyjacielu. W takim razie spotkamy się tam. Alonso da znać, gdy będziemy gotowi zacząć.";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		...
		case "SharlieEpilog_PikarOnUliss_D_1":
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarAlive") || CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarResurrected")){dialog.text = "Masz rację.";}
		...
		case "SharlieEpilog_HenriDeMonper_Mary_4":
			if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "przedstawisz mnie reszcie";
			else sStr = "przedstawisz mnie naszemu gościowi";
		...
		case "SharlieEpilog_InKitchenDeMonpe_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer") || CheckAttribute(pchar, "questTemp.LSC.Mary_officer"))
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "dobrych przyjaciół";
				else sStr = "towarzysza broni";
				dialog.text = "";
			...
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "twoich dobrych przyjaciół";
				else sStr = "twojego przyjaciela";
				dialog.text = "";
		...
		case "SharlieEpilog_KomendantFort_5":
			dialog.text = "Znakomity plan, Wasza Dostojność! Jednakże… bez wątpienia jest Pan człowiekiem zahartowanym w bitwach morskich, a mimo to osobom Pańskiego stanu nie przystoi narażać własnego życia. Flotą mógłby równie dobrze dowodzić…";
			link.l1 = "Tak jak nie zdołałem znieść spokojnego życia w Europie, tak nie zniosę bezczynnego oczekiwania na brzegu, gdy rozstrzygają się losy bitwy. Od losu nie ma ucieczki, "+GetAddress_Form(NPChar)+" "+npchar.lastname+". ";
			link.l1.go = "SharlieEpilog_KomendantFort_6";
		break;

		case "SharlieEpilog_KomendantFort_6":
			dialog.text = "Niech tak będzie. Czy pozwoli Pan wydać rozkaz rozpoczęcia przygotowań?";
			link.l1 = "Proszę działać. Niech Bóg będzie z nami.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Mishelle_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) sStr = " i z twoją żoną";
			dialog.text = "Więc jeszcze nie zrozumiałeś? Umarłeś. Razem ze swoją załogą"+sStr+". Jakiś kupiec, którego postanowiłeś obrabować, wysadził w powietrze prochownię — byle ani grosz nie trafił do rąk takich jak ty.\nSpectra sunt memoria peccatorum. To ty jesteś duchem, "+pchar.name+"... Karaibska legenda o człowieku, którego pożarły chciwość i ślepa pycha. Ilu zabiłeś dla złota?";
