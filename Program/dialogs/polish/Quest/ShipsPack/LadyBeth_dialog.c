void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LadyBeth_DialogInCity_Second_4":
			...
			link.l1 = "Panu również dziękuję. "+Goodbye(true)+".";
			link.l1.go = "LadyBeth_DialogInCity_Second_5";
		break;
		...
		case "LadyBeth_Alonso_2":
			dialog.text = "Zabici? W tej awanturze straciliśmy "+int(pchar.SailorDiedInBattleInfo)+" ludzi. Nie chcę być natrętny, kapitanie, ale... przecież ostrzegałem!";
