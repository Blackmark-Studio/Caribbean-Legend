...
//*************************** Открывание двери ***************************
	...
	// <-- хронометр Алекса
		...
		case "FDM_cabin":
			dialog.text = "Dlaczego nie? Moje ręce wciąż są sprawne.";
			link.l1 = "...";
		...
		case "FDM_cabin_s":
			dialog.text = "Siedem skrzyń z dublonami i będzie to zrobione w pięć dni.";
			link.l1 = "Umowa stoi!";
		...
		case "FDM_cabin_pay":
			...
			if (amount <= 0) // всё принес
			{
				...
				dialog.text = "Więc musiałeś mi przynieść "+FindRussianQtyString(int(npchar.quest.FDM_cabin.chest))+"skrzynie, które przyniosłeś"+FindRussianQtyString(iTemp)+" . Mam zapłatę. Teraz moja kolej. Idź i pospaceruj. Nie martw się, zrobię wszystko, co w mojej mocy.";
				link.l1 = "Dobrze...";
			...
			else
			{
				...
				dialog.text = "Więc, musiałeś mi przynieść "+FindRussianQtyString(int(npchar.quest.FDM_cabin.chest))+" skrzynie, które przyniosłeś "+FindRussianQtyString(iTemp)+". "+FindRussianQtyString(amount)+"  skrzynie zostały.";
		...
		case "FDM_hull_waitmaterials":
			...
			dialog.text = "„Nie boisz się chodzić po pirackiej osadzie z taką porządną sumką, hehe? Dobra, żartuję, to wszyscy uczciwi ludzie, na swój sposób. Teraz czekam na materiały. Przypominam, musisz dostarczyć łącznie 150 kawałków drewna żelaznego, 150 zwojów lin, 150 bel żaglówki i 150 beczek żywicy.”";
