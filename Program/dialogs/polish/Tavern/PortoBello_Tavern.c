...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l1 = "Słuchaj, szukam człowieka o imieniu Bertrand Pinette, słyszałeś o nim? Przybył do Portobelo niedawno. Imponujący jegomość w falistej peruce. Kupiec. Może tu był...";
                link.l1.go = "FMQG";
            }
			//--> Письмо от покойника
		...
		case "Portobello_rat_1":
			dialog.text = NPCStringReactionRepeat("Nie, nie wiem. Nie zatrzymał się w karczmie i nie widziałem go też w mieście.","Już o to pytałeś, a ja ci odpowiedziałem.","Powiedziałem ci 'już o to pytałeś, Gontierze'.","Słuchaj, odejdź i przestań mnie nękać! Czy całkiem straciłeś rozum?","block",0,npchar,Dialog.CurrentNode);
		...
		// Addon-2016 Jason ФМК-Гваделупа
		case "FMQG":
			dialog.text = "Nie słyszałem o nim, kumplu.";
			link.l1 = "Jest znajomym don Carlosa de Milyar. Na pewno nigdy o nim nie słyszałeś?";
			link.l1.go = "FMQG_1";
		break;
		
		case "FMQG_1":
			dialog.text = "Jeśli jest on przyjacielem de Milyara - idź do gubernatora i zapytaj o señor Carlosa. On opowie ci o tym twoim handlarzu.";
		...
		case "LFD_Tavern_1_2":
			dialog.text = "Tak. Jej mąż był kapitanem handlowej pinasy 'Falałamacz'. Dzięki licencji Holenderskiej Kompanii Zachodnioindyjskiej miał dostęp niemal do wszystkich portów archipelagu. Mówi się, że nie przeżył ataku piratów w drodze z Belize do Capsterville. To tu nie jest rzadkość, ale dla niej był to prawdziwy cios.";
			link.l1 = "I po prostu zniknęła?";
