...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "tonzag_bail_2":
			dialog.text = "Oczywiście, jednakże będzie to dla ciebie nieco droższe. Pozwól, że dokładnie ci powiem... "+pchar.questTemp.TonzagQuest.Bail+" dublony to będzie "+int(pchar.questTemp.TonzagQuest.Bail)* 150+" pesos.";
