...
//-------------------------------- квест доставки судового журнала до рассеяного кэпа ---------------------
		...
		case "SeekShip_good_1":
			dialog.text = "Я готов выплатить вам вознаграждение. Оно составляет " + sti(npchar.quest.money) + " дублонов. Больше я заплатить не могу, к сожалению.";
		...
		case "ShipStock_2":
			...
			dialog.Text = dialog.Text + " Если оставите с офицером и командой, тогда вместе с ними " + FindRussianMoneyString(sti(NPChar.MoneyForShip) + sti(NPChar.MoneyForCrew));
