...
//			bQuestDisableMapEnter = true;
		...
		case "ChurchGenQuest1_DialogShip_5_2":
			dialog.text = "Дело в том, что собственно с Вами у меня нет никаких дел. У меня поручение от Святого Отца - отвезти книги в " + XI_ConvertString("Colony" + PChar.GenQuest.ChurchQuest_1.QuestTown + "Acc") + " и вручить их тамошнему Падре. Где тут Вы? Нету Вас никаким боком. Всего хорошего.";
		...
		case "PiratesOnUninhabited_3":
			...
			if(hrand(1) == 0) 
			{
				...
				dialog.text = "Здравствуйте капитан! Не иначе сам Бог прислал Вас на выручку " + PChar.GenQuest.PiratesOnUninhabited.MainPirateName + " и его ребят... Мы с приятелями оказались в очень затруднительном положении. " +
					...
					"Целых " + (5 + hrand(7)) + " недель мы до боли в глазах всматривались в горизонт, надеясь увидеть парус хоть какого-то судёнышка.";
