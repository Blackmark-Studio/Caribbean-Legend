...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "serve_1":
			dialog.text = "Погодите, друг мой. Надеюсь, я могу называть вас так? Я хочу выразить вам благодарность от себя лично... Я внимательно наблюдал за вами с самого вашего прибытия на архипелаг, и в курсе большинства ваших дел. Вы успели заработать себе весьма громкую славу на Карибах и, без преувеличения - приобрели известность и немалый вес в определённых кругах. Такие люди нужны Франции\nКапитан "+GetFullName(pchar)+"! Властью, данной мне Его Величеством, королём Франции, я имею честь предложить вам патент капитана королевского флота и взять под своё командование корабль военно-морских сил Франции, тяжёлый корвет 'Гриффондор'!\nЕго бывший капитан шевалье де Фонтене вашими стараниями будет осваиваться в новой должности губернатора Тортуги, а место капитана лучшего тяжёлого корвета на Карибах не должно пустовать. Вы согласны?";
		...
		case "serve_4":
			dialog.text = "В ваше распоряжение поступает тяжёлый корвет 'Гриффондор'. Отныне этот великолепный корабль - ваш. Используйте его выдающиеся качества во славу Его Величества и для укрепления влияния Франции на Карибском архипелаге!";
		...
		case "patria_55":
			...
			{
				dialog.text = "Итак, вам осталось привести в наш порт ещё "+FindRussianQtyString(5-int(pchar.questTemp.Patria.Hunter))+" голландских ост-индцев.";
				link.l1 = "Так точно, шевалье!";
