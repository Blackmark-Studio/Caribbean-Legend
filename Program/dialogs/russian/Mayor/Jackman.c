...
// ============================================================================
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            link.l0 = "Джекман, я бы хотел" + GetSexPhrase("","а") + " обсудить свою безопасность в море. Парни из Берегового братства проявляют чрезмерный интерес к моей скромной персоне. Не мог бы ты их немного приструнить?";
...
//-----------------------------------------пиратская сага----------------------------------------------------
		...
		case "Saga_search_2":
			...
			link.l1 = "Хочется спросить, с чего бы такой переполох, но не буду. Жабрами чую, что такое любопытство может изрядно сократить мою биографию...";
        ...
        case "pirate_threat":
            ...
            if (iGPThreat != 0)
            {
                ...
                dialog.text = "Ха! Достаётся тебе от нашей братии, а, " + GetSexPhrase("приятель", "подруга") + "? Конечно, я могу на какое-то время придержать их в узде. Только тебе придётся знатно раскошелиться. " + FindRussianDublonString(iJackmanTotalTemp) + " на бочку, и считай, что мы договорились.";
