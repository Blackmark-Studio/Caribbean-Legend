...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Я прибыл"+GetSexPhrase("","а")+" по вашему настоятельному приглашению, минхер губернатор...";
				link.l1.go = "FMQN";
			}
			if (CheckAttribute(PChar, "questTemp.FMQN") && pchar.questTemp.FMQN == "hol_battle_complete")
			{
				link.l1 = "Я прибыл"+GetSexPhrase("","а")+" по вопросу об английских шпионах, минхер губернатор...";
				link.l1.go = "FMQN_7";
			}
		break;
		...
		case "FMQN_2":
			...
			link.l1 = "Сожалею, Ваша Светлость, но я прибыл"+GetSexPhrase("","а")+" исключительно по торговым делам, и после их завершения и пополнения припасов, буду вынужден"+GetSexPhrase("","а")+" как можно скорее продолжить свой путь.";
			link.l1.go = "FMQN_3";
		...
		case "FMQN_3":
			...
			link.l1 = "Да, минхер, я понял"+GetSexPhrase("","а")+". До свидания!";
			link.l1.go = "FMQN_4";
		break;
		...
		case "FMQN_8":
			...
			link.l1 = "Это стоит не меньше, минхер. Благодарю вас, был рад"+GetSexPhrase("","а")+" оказать вам помощь. А теперь мне пора откланяться.";
			link.l1.go = "exit";
