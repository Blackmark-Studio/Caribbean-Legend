...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
        case "quests":
			...
			{
				link.l1 = "Офицер, я наш"+GetSexPhrase("ёл ","ла")+"пропавший патруль. И английских шпионов тоже. Они на острове.";
				link.l1.go = "FMQN_3";
			}
		...
		case "FMQN_3":
			...
			link.l1 = "У входа в пещеру в джунглях я встретил"+GetSexPhrase("","а")+" патрульный отряд. Они остановили меня, спросили, куда иду и зачем, затем отстали. Но я сразу понял"+GetSexPhrase("","а")+": поглоти меня кит, если это не переодетые в голландскую форму англичане! А потом я заметил"+GetSexPhrase("","а")+" в джунглях среди зарослей что-то очень похожее на кучку лежащих на земле в одном нательном белье людей. Думаю, что диверсанты разоружили ваш патруль и одели его форму.";
			link.l1.go = "FMQN_4";
		break;
		
		case "FMQN_4":
			dialog.text = "...";
			link.l1 = "Как вы понимаете, связываться с этими головорезами я не рискнул"+GetSexPhrase("","а")+" и поспешил"+GetSexPhrase("","а")+" убраться восвояси, а затем - немедленно отправил"+GetSexPhrase("ся","ась")+" к вам.";
			link.l1.go = "FMQN_5";
		break;
		...
		case "FMQN_6":
			...
			link.l1.go = "FMQN_7";
			link.l2 = "Думаю, я смогу быть полез"+GetSexPhrase("ен","на")+" вашим людям - с моей помощью они быстрее отыщут шпионов.";
			link.l2.go = "FMQN_10";
		break;
