void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "WildRose_Tichingitu_Final_3":
			...
			link.l1 = "Нам с Мэри нужно побыть наедине. Собери всех раненых и отведи на корабль, убитых также заберите отсюда - похороним их в море. И, " + npchar.name + "... передай Алонсо, что отца Мэри нужно захоронить подобающим протестантам образом, где-то здесь. О том, именно он будет похоронен, должен знать только он и ты. Об этом месте не говорить никому, включая Мэри. Ни к чему ей терзать себя воспоминаниями.";
