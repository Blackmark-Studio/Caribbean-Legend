void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Naemnik_22":
			dialog.text = "Ты, мистер, однако, полон противоречий - такой  миролюбивый, и в то же время - хам. Мне, тем не менее, интересно, вымаливать прощение у этой рыжей сумасбродки?";
		...
		case "Mary_50":
			dialog.text = "Но для меня это важно, "+pchar.name+", да. Я хочу, я имею право знать, кем были мои родители. Разве ты с этим не согласен?";
		...
		case "Mary_76":
			...
			link.l1 = "И когда он стал тебе впору, ты вспомнила о нём?";
			link.l1.go = "Mary_77";
		break;
		...
		case "Mary_82":
			...
			link.l1 = "А я с тобой, "+npchar.name+". Ну, идём  Дональду? Нам будет о чём с ним поговорить.";
			link.l1.go = "exit";
		...
		case "Grinspy_14":
			dialog.text = "Я не совсем понимаю, что ты хочешь от меня, Мэри.";
			link.l1 = "...";
		...
		case "Mary_96":
			...
			link.l1 = "Если знать название судна. Или его полное имя. А не 'Джеффри или Джон или, на худой конец, Джек...'. Это нам ещё повезёт, если судно было военным. У торгашей со списками экипажа дела куда хуже.";
			link.l1.go = "Mary_97";
		break;
		...
		case "WildRose_Betancur_3_1":
			...
			link.l1 = "Видишь ли, мы с Мэри затеяли расследование, чтобы пролить свет на события двадцатилетней давности.";
		...
		case "WildRose_Chimiset_44":
			dialog.text = "В этом нет смысла, Мэри. Тебе достаточно взглянуть в зеркало - вы с ней похожи как две капли воды. Лишь этот прозительный взгляд достался тебе от отца.";
			link.l1 = "...";
		...
		case "WildRose_Sesil_18_1":
			dialog.text = "Ни о чём таком он не рассказывал. Да и посудите сами, "+pchar.name+", собирайся вы сбежать из тюрьмы, стали бы вы рассказывать об этом первому встречному? Тот тип определённо не стал бы, так я вам скажу.";
		...
		case "WildRose_Mary_174":
			dialog.text = "Что же могло заставить его назваться именем Джошуа Каспера? Что случилось на борту 'Корнуэлла', ставшего 'Рэнглером'? Неужели мой отец - преступник, "+pchar.name+"?";
		...
		case "WildRose_Mary_193":
			dialog.text = "Давно я не слышала такой решительности в твоём голосе, "+pchar.name+". Но ладно, у нас есть и другие заботы, да. Похороны состоятся завтра на закате, в семь часов.";
		...
		case "WildRose_Mary_216":
			dialog.text = "Разве ты не почувствовал это, "+pchar.name+"? Когда мы стояли у тела Орели.";
			link.l1 = "Что именно?";
		...
		case "WildRose_Mary_231":
			...
			link.l1 = "Я думал над этим всю дорогу, "+npchar.name+". И пришёл к выводу, что твой отец не стал бы скрываться под именем и фамилией, что уже использовал. В то же время от настоящего имени или фамилии он мог и не решиться отказаться: что будет, если в неподходящий момент он не отзовётся на чужое?";
		...
		case "WildRose_Mary_242":
			...
			link.l1 = "Согласен. Мы можем расспросить о нём хозяина 'Стеклянного глаза', или же обычных горожан. Пойдём, время дорого.";
			link.l1.go = "exit";
		...
		case "WildRose_Rupert_3":
			...
			{
				dialog.text = "Да-а, немало я повидал за свою долгую и нелёгкую жизнь. Всякий раз думаю, что ничто меня уже не удивит - и всякий раз ошибаюсь. Значит, ты всё-таки выжила там... И даже шляпу Терезы сохранила. Уже не думал, что когда-то увижу её снова.";
				link.l1 = "...";
		...
		case "WildRose_Rupert_3_3":
			dialog.text = "Как трогательно... Сейчас расплачусь. А я-то уж думал, что Терезу похоронили вместе с ней. Она не расставалась с ней ни на секунду с тех пор, как я подарил её ей. Твоя мать, хоть и была простой подавальщицей, но дух авантюризма у неё разве что из ушей не лился. Когда при захвате 'Флёр-де-Лиз' я её нашёл, то сразу понял, что Тереза будет от неё без ума. Выглядела она в ней смешно, но ей было плевать: снимала она эту шляпу только перед сном. Но тебе, Джулия, она к лицу.";
			link.l1 = "...";
			link.l1.go = "WildRose_Rupert_3_add";
			CharacterTurnByChr(CharacterFromID("WildRose_Rupert"), CharacterFromID("Mary"));
			CharacterTurnByChr(CharacterFromID("Mary"), CharacterFromID("WildRose_Rupert"));
		...
		case "WildRose_Rupert_12":
			dialog.text = "Превосходно (аплодирует). Я впечатлён. Это ты сам до всего допетрил, или моё ненаглядное чадо тоже внесло свой вклад?";
		...
		case "WildRose_Rupert_15":
			dialog.text = "Скажи, "+pchar.lastname+", она часто так истерит? Это у неё от матери. Тереза была замечательной девушкой, лучшей из всех, кого я только встречал. Но рыдать и закатывать истерики она любила, это да-а... Что сказать... ирландка.";
		...
		case "WildRose_Rupert_16":
			...
			link.l1 = "Напротив. Я хочу, чтобы вы рассказали нам свою историю. Мэри очень важно это знать. Но я не позволю вам её унижать. Так что держите себя в руках.";
		...
		case "WildRose_Rupert_19":
			dialog.text = "Да-а-а, вылитая Тереза. Я будто вернулся на двадцать лет, ха-ха. Чёрт с вами. Не хотел я всё это вспоминать... Так что, если к концу этого предания я решу всадить пулю тебе в лоб, дорогуша - пеняй только на себя.";
		...
		case "WildRose_Rupert_38":
			dialog.text = "Именно так. Каспер уже успел влить в себя порцию виски, а потому оставался глух к каким-либо воззваниям, приказав просто вышвырнуть девушку за борт. На все мои мольбы он лишь смеялся до упаду - проклятье, я рассказываю это, а у меня в голове стоит его хохот...";
		...
		case "WildRose_Rupert_40":
			dialog.text = "Я был уверен, что проведу 'Корнуэлл' через океан. Здесь наши рожи никому не были известны, и это давало нам шанс начать новую жизнь. Убедить остальных офицеров большого труда не составило - сказался не столько мой авторитет, сколько содержимое пары сундуков, о котором простые матросы не знали. Команда решила - Джошуа Каспер должен был остаться жив. Мы с горской офицеров решили выиграть нам немного времени, пожертвовать одним из сундуков и зайти на Антигуа, где я представился бы его именем. После, мы собирались взять курс на Провиденс\n Так оно и вышло, никто не заподозрил подмены, но когда до Провиденса оставалось всего пару дней, какая-то сволочь проболталась про второй сундук - и это внесло в команду раскол.";
		...
		case "WildRose_Rupert_51":
			dialog.text = "Справедливости - о да! От удара о риф 'Рэнглер' треснул пополам, но удивительным образом сохранил плавучесть - достаточную для того, чтобы его донесло до наваленных друг на друга иных кораблей. Шторм бушевал ещё чуть ли не двое суток, а когда утих - нас спасли жители того несчастного островка.";
		...
		case "WildRose_Rupert_76":
			...
			link.l1 = "Змеиный Глаз... Вам следовало быть благодарным ему за спасение своей шкуры.";
		...
		case "WildRose_Rupert_87":
			dialog.text = "В чём дело, салага? Потерял кого-то? Ха-ха-ха... Ха-ха-ха. ХА-ХА-ХА-ХА-ХА-ХА!!! Ох-х, видел бы ты сейчас свою рожу, дубина! Эй, Мэйсон, приведи сюда мой подарок нашим гостям.";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "WildRose_Alonso_12":
			...
			dialog.text = "А я-то как рад вас видеть, кэп! Этому мерзавцу кто-то шепнул о том, что вы его ищите — и нас встретили градом картечи прямо на полпути. Мне с горсткой ребят удалось отступить, и мы со всех ног помчались в порт, чтобы предупредить. К счастью, вахтенный на дозоре, как только увидел меня на баркасе, который я наспех прикупил в городе, сразу смекнул, что к чему. Он быстро собрал людей — и мы отправились сюда, на выручку.";
			link.l1 = "Спасибо тебе, друг... "+sld.name+" погиб по моей вине... Я отправил вас прямо в западню.";
			link.l1.go = "WildRose_Alonso_13";
		break;

		case "WildRose_Alonso_13":
			dialog.text = "Никто не знал, что там засада. Вы всё сделали верно, это нам стоило быть осторожнее.";
			link.l1 = "И тем не менее... Я должен был это предвидеть. Не стоило мне соваться в таверну.";
			link.l1.go = "WildRose_Alonso_14";
		break;

		case "WildRose_Alonso_14":
			dialog.text = "Теперь уже ничего не изменить, кэп. Что прикажете делать дальше?";
			link.l1 = "Тела наших парней нужно похоронить по всем традициям. Нортвуда тоже предайте земле, где-то подальше, в сельве. Об этом месте не должен знать никто, особенно Мэри. Так что возьми самых надёжных людей.";
			link.l1.go = "WildRose_Alonso_15";
		break;

		case "WildRose_Alonso_15":
			dialog.text = "Будет сделано.";
			link.l1 = "Мы с Мэри поднимемся на борт позже. Нам нужно побыть наедине.";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_261":
			string sSname = "";
			if (CheckAttribute(pchar, "questTemp.WildRose_Etap6_Tichingitu")) sSname = "Тичингиту";
			if (CheckAttribute(pchar, "questTemp.WildRose_Etap6_Duran")) sSname = "Клода";
			if (CheckAttribute(pchar, "questTemp.WildRose_Etap6_Tonzag")) sSname = "Эркюля";
			if (CheckAttribute(pchar, "questTemp.WildRose_Etap6_Irons")) sSname = "Томми";
			if (CheckAttribute(pchar, "questTemp.WildRose_Etap6_Longway")) sSname = "Лонгвэя";
			if (!CheckAttribute(pchar, "questTemp.WildRose_Etap6_GoodEnd"))
			{
				dialog.text = "Бог мой, "+pchar.name+"... Я до сих пор не могу, просто не могу поверить. Мой отец... Он чудовище... За что он так со мной? Он убил "+sSname+"! Неужели он и впрямь сошёл с ума?";
				link.l1 = "Бунт на 'Корнуэлле', побег через Атлантику, буря и смерть его матери, переход через порталы этих идолов - без зелья команчей! Испытания, надо признать, более чем достойные. И всё же, лучше бы он не вышел живым из всего этого ада.";
			}
			else
			{	
		...
		case "WildRose_Tichingitu_Final_1":  
			dialog.text = npchar.name+", прийти вовремя, капитан "+pchar.name+".";
			link.l1 = "Я знал, что на тебя можно положиться, друг мой. Спасибо тебе, никто не справился бы лучше тебя.";
			link.l1.go = "WildRose_Tichingitu_Final_2";
			DelLandQuestMark(npchar);
		break;

		case "WildRose_Tichingitu_Final_2":
			dialog.text = "Сельва - дом "+npchar.name+". "+npchar.name+" рад драться в сельве. Сельва приносить силы "+npchar.name+".";
			link.l1 = "Именно поэтому я тебя и отправил во главе отряда. И очень даже не зря - как видишь, нас здесь ждали с распростёртыми объятиями.";
			link.l1.go = "WildRose_Tichingitu_Final_3";
		break;

		case "WildRose_Tichingitu_Final_3":
			dialog.text = "Что капитан "+pchar.name+" собираться делать дальше?";
			link.l1 = "Нам с Мэри нужно побыть наедине. Собери всех раненых и отведи на корабль, убитых также заберите отсюда - похороним их в море. И, " + npchar.name + "... передай Алонсо, что отца Мэри нужно захоронить подобающим протестантам образом, где-то здесь. О том, где именно он будет похоронен, должен знать только он и ты. Об этом месте не говорить никому, включая Мэри. Ни к чему ей терзать себя воспоминаниями.";
			link.l1.go = "WildRose_Tichingitu_Final_4";
		break;

		case "WildRose_Tichingitu_Final_4":
			dialog.text = npchar.name+" понимать, капитан "+pchar.name+". Тичингиту всё сделать.";
			link.l1 = "...";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("WildRose_Etap6_LifeAfterDeath_31");
		break;
		...
		case "WildRose_Duran_Final_1":   
			dialog.text = "Крепкие подонки... Но мы их обхитрили, ха-ха. Вот пусть теперь гниют здесь и думают, стоило ли иметь с нами дело.";
			link.l1 = "Спасибо, " + npchar.name + ", вы отлично сработали. Страшно даже представить, что было бы с Мэри... и со мной... если бы я не отправил вас прикрыть тыл...";
			link.l1.go = "WildRose_Duran_Final_2";
			DelLandQuestMark(npchar);
		break;

		case "WildRose_Duran_Final_2":
			dialog.text = "Ха, кэп, ты бы выкрутился, я-то тебя знаю. Видал, какой у их главаря тесак? Я с него глаз не спускал. Если тебе не понравится - не обижусь, если ты мне его подаришь.";
			link.l1 = "Хм... Посмотрим, дружище, посмотрим. А пока собери всех, кто уцелел, и отведи на корабль. Тех, кто полёг, заберите на борт - отдадим их морю. И ещё... Тот самый главарь - отец Мэри. Возьми Алонсо и похороните его по протестантскому обычаю, где-то здесь. О том, где будет могила - никому ни слова. Особенно Мэри. Ни к чему ей терзать себя воспоминаниями.";
			link.l1.go = "WildRose_Duran_Final_3";
		break;

		case "WildRose_Duran_Final_3":
			dialog.text = "Будет сделано, кэп. Постой... Впрочем, не сейчас... Я пойду.";
			link.l1 = "...";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("WildRose_Etap6_LifeAfterDeath_31");
		break;
		...
		case "WildRose_Tonzag_Final_1": 
			dialog.text = "Жарковато здесь было, кэп. Ублюдки получили по заслугам. Видал, как перекосило морду этого коротышки, когда мы появились?";
			link.l1 = "Такого поворота он явно не ожидал. Как и мы с Мэри не ожидали того, каким негодяем он окажется. Но всё же нутро меня не подвело, когда я решил прикрыть тыл.";
			link.l1.go = "WildRose_Tonzag_Final_2";
			DelLandQuestMark(npchar);
		break;

		case "WildRose_Tonzag_Final_2":
			dialog.text = "Ты на Карибах не первый день уже. Стало быть, уже привык к тому, какая шваль здесь обитает и задницей чувствуешь подвох. Что прикажешь делать дальше? Возвращаемся на корабль?";
			link.l1 = "Забирай раненых, убитых и поднимайтесь на борт. Тех, кто пал, отдадим морю, как верных его сыновей. Мы с Мэри будем позже - нам нужно побыть наедине. И ещё одно: похороните отца Мэри по протестантскому обычаю. Можешь взять Алонсо в помощь. Только проследи, чтобы о месте захоронения никто не знал. Особенно Мэри. Не хочу, чтобы она терзала себя воспоминаниями.";
			link.l1.go = "WildRose_Tonzag_Final_3";
		break;

		case "WildRose_Tonzag_Final_3":
			dialog.text = "Тут ты прав. Ни к чему ей сюда наведываться и слёзы лить. Не переживай, сделаем всё, как надо, и ни одна живая душа об этом не узнает.";
			link.l1 = "...";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("WildRose_Etap6_LifeAfterDeath_31");
		break;
		...
		case "WildRose_Irons_Final_1":
			dialog.text = "Капитан-сэр, разрешите доложить: засада успешно сработала, негодяи перебиты, капитан спасён.";
			link.l1 = "Не до шуток, ты ехидничать решил? Это ты зря. Ты ведь не хочешь драить палубу на глазах у матросов? Ох и славно же они потешатся... Не советую более испытывать моё терпение. Особенно сегодня.";
			link.l1.go = "WildRose_Irons_Final_2";
			DelLandQuestMark(npchar);
		break;

		case "WildRose_Irons_Final_2":
			dialog.text = "Э-э... вообще-то я офицер, и...";
			link.l1 = "Это пока. Сегодня офицер - завтра матрос, а послезавтра - побирушка.";
			link.l1.go = "WildRose_Irons_Final_3";
		break;

		case "WildRose_Irons_Final_3":
			dialog.text = "Я понял: " + GetFullName(pchar) + " - капитан серьёзность. Отставить шутки. Какие будут приказания, сэр?";
			link.l1 = "Собери раненых и доставь на корабль. Передай Алонсо, чтобы он взял команду и забрал отсюда тела наших парней - отдадим их морю. Также пусть похоронит отца Мэри согласно традициям протестантов. О том, где он будет похоронен, должен знать только он и тот, кто будет ему помогать. Мэри этого знать не нужно. Не хочу, чтобы она терзала себя воспоминаниями.";
			link.l1.go = "WildRose_Irons_Final_4";
		break;

		case "WildRose_Irons_Final_4":
			dialog.text = "Ладно, что уж... Будет сделано. И не переживай, язык за зубами я держать умею.";
			link.l1 = "...";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("WildRose_Etap6_LifeAfterDeath_31");
		break;
		...
		case "WildRose_Longway_Final_1":
			dialog.text = "Господин капитан, мы победили. Ни одна собака не убежала.";
			link.l1 = "Хорошая работа, " + npchar.name + ", спасибо. Я знал, что на тебя можно положиться. Забирай всех, кто уцелел, и отправляйтесь на корабль. Мы с Мэри задержимся на берегу.";
			link.l1.go = "WildRose_Longway_Final_2";
			DelLandQuestMark(npchar);
		break;

		case "WildRose_Longway_Final_2":
			dialog.text = "Как нам поступить с телами погибших?";
			link.l1 = "Их мы предадим морю. Передай Алонсо, пусть займётся их подготовкой к погребению. И ещё: скажи ему, что отца Мэри нужно похоронить по протестантским традициям, здесь, в сельве, подальше от людских глаз. Никто не должен знать, где будет могила - особенно Мэри. Зная её, она непременно захочет сюда вернуться, а это ничего хорошего ей не принесёт.";
			link.l1.go = "WildRose_Longway_Final_3";
		break;

		case "WildRose_Longway_Final_3":
			dialog.text = "Я всё передам. Вам приказать что-то ещё?";
			link.l1 = "Это всё, дружище. Ступай, отдохни и подлечи раны.";
			link.l1.go = "exit";
			AddDialogExitQuestFunction("WildRose_Etap6_LifeAfterDeath_31");
		break;
		...
		case "WildRose_Alonso_Final_1":
			dialog.text = "Ну и бойня... Ты как, кэп?";
			link.l1 = "В порядке, если не считать, что нам с Мэри пришлось убить её отца...";
			link.l1.go = "WildRose_Alonso_Final_2";
			DelLandQuestMark(npchar);
		break;

		case "WildRose_Alonso_Final_2":
			dialog.text = "Судя по всему, мерзавец был ещё тот...";
			link.l1 = "Тут ты прав, " + npchar.name + ". Тут ты прав. Но как бы там ни было, нам нужно похоронить его подобающим образом - по канонам протестантов. Займись этим лично. Никто не должен знать, где будет эта могила. Особенно Мэри.";
			link.l1.go = "WildRose_Alonso_Final_3";
		break;

		case "WildRose_Alonso_Final_3":
			dialog.text = "Хочешь оградить её от дурных воспоминаний?";
			link.l1 = "И бесполезных терзаний. Всех остальных отправь на корабль залечивать раны. Погибших доставьте на борт - погребение проведём в море, как только мы с Мэри вернёмся на корабль. Сейчас нам нужно побыть наедине.";
			link.l1.go = "WildRose_Alonso_Final_4";
		break;

		case "WildRose_Alonso_Final_4":
			dialog.text = "Я передам парням, чтобы никто не пытался вас искать.";
