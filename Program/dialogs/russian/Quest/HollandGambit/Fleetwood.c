			...
			if (CheckAttribute(pchar, "questTemp.HWIC.Eng"))
			{
				...
				if (pchar.questTemp.HWIC.Eng == "GotoPortoffice")
				{
					...
					else
					{
						...
						link.l1 = "Спасибо! Буду действовать согласно нашему плану.";
