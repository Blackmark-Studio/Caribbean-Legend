...
//----------------------------------------против всех-------------------------------------------------------
		...
		case "Lucas_12":
			...
			link.l1 = "Я захватил 'Мейфенг', Лонгвэя допросил. Он всё рассказал. Я нашёл Стайвесанта, предупредил его о замыслах Роденбурга, и вместе с ним отправился в Виллемстад. Там Стайвесант выпустил Бека и арестовал Лукаса. Теперь он в тюрьме.";
			link.l1.go = "Lucas_13";
		break;
