	...
	switch(Dialog.CurrentNode)
	{
		...
		case "blade_3":
			...
			if (PCharDublonsTotal() > 0)
			{
				...
				link.l1 = "Вот, пожалуйста. У меня есть с собой "+FindRussianQtyString(int(npchar.quest.blade_pay))+".";
		...
		case "blade_pay": // оплата
			...
			Log_Info("Вы отдали "+int(npchar.quest.blade_pay)+" дублонов");
			...
			{
				dialog.text = "Хорошо. Я принимаю у вас дублоны. Вам осталось принести ещё "+FindRussianQtyString(int(npchar.quest.blade_dublon))+".";
