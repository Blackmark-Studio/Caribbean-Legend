...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Sergio_24":
			dialog.text = "Капитан, вы показались мне честным человеком, которому можно доверять. Также немаловажное значение имеет то, что вы - "+GetSexPhrase(""+NationNameMan(int(pchar.baseNation))+"",""+NationNameWoman(int(pchar.baseNation))+"")+", и у вас есть свой корабль. Я предлагаю заключить торговое соглашение.";
