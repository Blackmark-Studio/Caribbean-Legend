...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "greguar":
			...
			{
				dialog.text = "О, "+GetFullName(pchar)+"! Вас не узнать! Наслышан, очень наслышан. Вы быстро учитесь, месье, приятно видеть, когда твои уроки не пропадают даром. Успехов вам и дальше, рад был повидаться!";
			...
			{
				dialog.text = "О, "+GetFullName(pchar)+"! Я вас ждал! Вас не узнать! Наслышан, очень наслышан. Вы быстро учитесь, месье, приятно видеть, когда твои уроки не пропадают даром.";
		...
		case "prosper_6":
			...
			else
			{
				...
				if (n < 3) notification("Недостаточно людей", "X");
				if (n > 0)
				{
		...
		case "contra_1":
			...
			link.l1 = ""+FindRussianQtyString(int(pchar.questTemp.FMQL.Sanl))+" бакаута, "+FindRussianQtyString(int(pchar.questTemp.FMQL.Silk))+" шёлка, "+FindRussianQtyString(int(pchar.questTemp.FMQL.Rope))+" канатов и "+FindRussianQtyString(int(pchar.questTemp.FMQL.Oil))+" смол.";
			link.l1.go = "contra_2";
		break;
