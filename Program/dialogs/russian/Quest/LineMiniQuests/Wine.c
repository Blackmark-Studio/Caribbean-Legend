void ProcessDialogEvent()
{
	...
	break;
		...
		case "Wine_take":
			...
			{
				dialog.text = "Так, давайте посмотрим... Вы принесли "+int(pchar.questTemp.Wine.Qty)+" бутылок. Отлично! Я их забираю. Оплата - как и договаривались: " + FindRussianMoneyString(int(pchar.questTemp.Wine.Money))+".";
