...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "cureer_2":
			dialog.text = "Мне передал его один аббат, и попросил доставить капитану де Мору лично в руки. Я уже отчаялся вас найти и хотел оставить его в портовом управлении Сен Пьера, но вот удача - вы собственной персоной!";
