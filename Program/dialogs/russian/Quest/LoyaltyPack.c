void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Alonso":
			...
			{
				dialog.text = "...";
				Link.l1 = "Алонсо, мне нужно с тобой поговорить.";
		...
		case "SharlieEpilog_Alonso_1":
			dialog.text = "Это насчёт Флорана? Я уже сказал ему, что...";
			link.l1 = "Нет, дружище, я совсем по другому поводу. Я принял решение отплыть в Европу. На неопределённый срок.";
			link.l1.go = "SharlieEpilog_Alonso_2";
		break;

		case "SharlieEpilog_Alonso_2":
			if (GetCompanionQuantity(pchar) <= 1) sStr = "наш корабль";
			else sStr = "наши корабли";
			dialog.text = "Никаких проблем, кэп. Корабль у нас крепкий, команда опытная, нужно только провианта...";
			link.l1 = "Я поплыву на чужом корабле. Пассажиром. Тебе нужно будет поставить "+sStr+" на стоянку в портовое управление и распустить команду. А также принять решение: остаться здесь и пойти на службу на другое судно или же отправиться со мной, во Францию, в качестве друга.";
			link.l1.go = "SharlieEpilog_Alonso_3";
		break;

		case "SharlieEpilog_Alonso_3":
			dialog.text = "...";
			link.l1 = "Кстати, абсолютно не связанная с этим всем информация: (шёпотом) знаю я пару цыпочек в Бордо... На Карибах таких кудесниц не сыскать. На таких, как ты, они падкие, а уж если начнёшь о наших сражениях рассказывать...";
			link.l1.go = "SharlieEpilog_Alonso_4";
		break;

		case "SharlieEpilog_Alonso_4":
			dialog.text = "Ну если только к цыпочкам... то я с вами. Хе-хе. А почему не на нашем корабле? И почему пассажиром? Парни, конечно, немного поворчали бы для виду, но с вами они хоть в рай, хоть в ад.";
			link.l1 = "Когда я впервые прибыл сюда, и представить не мог себя в роли моряка. А теперь не могу представить себе другой жизни. Я хочу понять, смогу ли смириться с тем, что я больше не капитан... и что, возможно, придётся оставить позади грабежи караванов и жизнь в море.";
			link.l1.go = "SharlieEpilog_Alonso_nothing";
			if (int(pchar.Money) >= GetSalaryForShip(PChar))
			{
				link.l2 = "Долгая история. Расскажу тебе в таверне - за кружечкой рома. И пригласи команду. Устроим грандиозную попойку, на прощание. Вот, держи - выдай им месячное жалованье в качестве увольнительных.";
				link.l2.go = "SharlieEpilog_Alonso_salary";
			}
		break;
		
		case "SharlieEpilog_Alonso_nothing":
			dialog.text = "От судьбы не уйти, кэп. Если суждено вам быть капитаном до конца своих дней - так оно и будет.";
			link.l1 = "Посмотрим, "+npchar.name+", посмотрим. А пока - пора заняться делами. Отчаливаем через две недели. Ты ни за что не угадаешь, на каком корабле...";
			link.l1.go = "SharlieEpilog_Alonso_5";
		break;
		
		case "SharlieEpilog_Alonso_salary":
			dialog.text = "Вот это по-нашему! Теперь мне будет легче им такую новость сообщать.";
			link.l1 = "Ты ни за что не угадаешь, на каком корабле...";
			link.l1.go = "SharlieEpilog_Alonso_5";
			AddMoneyToCharacter(pchar, -GetSalaryForShip(PChar));
		break;

		case "SharlieEpilog_Alonso_5":
			dialog.text = "Не томите, кэп.";
			link.l1 = "На пинасе '"+GetShipName("Ulysse")+"'.";
			link.l1.go = "SharlieEpilog_Alonso_6";
		break;

		case "SharlieEpilog_Alonso_6":
			dialog.text = "Не может быть... Мы отплывём на том самом корабле, на котором когда-то прибыли? Ушам своим не верю...";
			link.l1 = "Именно на нём, "+npchar.name+". Как я узнал о нём - расскажу позже, в таверне, за кружечкой рома. А сейчас у нас есть дела.";
			link.l1.go = "SharlieEpilog_Alonso_7";
		break;

		case "SharlieEpilog_Alonso_7":
			dialog.text = "Так точно, кэп... Эх... Жаль будет расставаться с парнями. Они для меня как семья. Но что поделать...";
			link.l1 = "...";
			link.l1.go = "exit";
			NextDiag.TempNode = "Alonso";
