void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Tomas_13":
			dialog.text = "Ох, капитан... Колокол стоит немалых денег. Возможно, мне придётся расстаться с чем-то из украшений моей покойной жены. Но ради Эстер я готов отдать всё, что у меня есть, и даже больше. Разумеется, я буду молить Господа о прощении. Я отправлюсь к кузнецу, сделаю заказ и найду цыганку\nА вас прошу передать пастору, что колокол скоро будет. Я достану его даже из-под земли, если понадобится.";
		...
		case "gypsy_1":
			dialog.text = "Для приготовления снадобья, что вернёт девчушке здоровье, мне нужна мангароса - редкое растение, растущее в местах, где человек редко ступает. Знаю я одну пещеру за городом, там часто шастают... всякие отбросы. Мангаросу они на курево переводят, не понимая её силы. Выручи, соколик, добудь мне мангаросу, без неё ничего не получится.";
		...
		case "gypsy_46":
			...
			{
				dialog.text = "Душа твоя чиста, вижу я, что не станешь ты жечь мангаросу ради минутного удовольствия. Если она тебе понадобится срочно, приходи ко мне, соколик. Три стебля обойдутся тебе в триста пятьдесят дублонов\nТравка эта капризная, сам знаешь, не всякому её найти по силам. Так что не торопи меня - чаще чем раз в месяц не спрашивай, всё равно не добуду.";
			}
			else
			{
				dialog.text = "Душа твоя светла, вижу я - не прост ты, в травах разбираешься не хуже знахарок некоторых. Многое сыскать сумеешь, да не всегда удача улыбнётся. Есть растение редкое, что не каждому найти по плечу. Мангароссой зовётся оно. Коли понадобится - приходи ко мне, соколик. Три стебля достану, но даром не отдам - триста пятьдесят дублонов возьму\nТолько травка эта своенравная, так что не торопи меня. Чаще чем раз в месяц не спрашивай - хоть все карты судьбы раскинь, а раньше не добуду.";
			}
		...
		case "gypsy_Mangarosa_1":
			dialog.text = "Кто ж, как не я, милок, достанет тебе редкость такую? Триста пятьдесят дублонов - и она твоя, три стебля, не больше, не меньше.";
