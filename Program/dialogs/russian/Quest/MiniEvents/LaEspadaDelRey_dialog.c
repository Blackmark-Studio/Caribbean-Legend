void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LEDR_Gonsalo_22":
			dialog.text = "Что за вздор? Думаешь, я бы притащился сюда через весь архипелаг ради пары дублонов спустя сорок лет? Да если бы тебе хоть раз пришлось повидать того скелета, у тебя бы таких мыслей не возникло.";
		...
		case "LEDR_Gonsalo_24_1":
			dialog.text = "Кажется, да. Проклятая нежить... ноги подкосились, как перебитые мачты.";
		...
		case "LEDR_Gonsalo_25":
			...
			link.l1 = "Удивительно, что из одежды сохранились только лоскуты жилетки. И больше ничего.";
		...
		case "LEDR_Gonsalo_34_share":
			...
			link.l1 = "Признаюсь, история твоя сначала показалась мне бредом полоумного. Но рассказывал ты её так убедительно, что, хочешь не хочешь, а поневоле начинаешь верить. И всё же, появление той индейской нежити застало меня врасплох.";
