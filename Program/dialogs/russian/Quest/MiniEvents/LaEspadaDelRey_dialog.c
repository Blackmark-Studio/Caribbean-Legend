void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LEDR_Gonsalo_34_share":
			...
			link.l1 = "Признаюсь, история твоя сначала показалась мне бредом полоумного. Но рассказывал ты её так убедительно, что, хочешь не хочешь, а поневоле начинаешь верить. И всё же, появление тех индейской нежити застало меня врасплох.";
