void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BetsiPrice_5":
			...
			link.l1 = "Ты ведь понимаешь, что для них ты всего лишь проблема, которую нужно устранить. Они не остановятся, пока не добьются своего. Но у тебя ещё есть выбор. Отдай документы вон тому недоумку. Пусть он передаст их своему хозяину и заверит его, что ты отказалась от своих намерений и просто хочешь, чтобы всё это закончилось.";
		...
		case "Pirate_6":
			dialog.text = "...";
			link.l1 = "Слушай меня внимательно, ублюдок. Вот документы, за которыми вас послали. Отнеси их своему хозяину и передай: если он продолжит слать убийц за головой Бетси, их ждёт та же участь, что и твоего подельничка. Скажи ему, что она уходит из его жизни навсегда - и у него больше нет причин её преследовать. Пусть примет это как её добровольный шаг к примирению. Надеюсь, он окажется достаточно разумен, чтобы на этом всё закончить. Ты всё понял, или мне нужно вбить эту информацию в твою голову?";
			link.l1.go = "Pirate_7";
		...
		case "BetsiPrice_9":
			dialog.text = "Меня зовут Миранда. Миранда Белл. Имя Бетси я взяла, когда пришлось исчезнуть - новая жизнь, новое имя, сам"+GetSexPhrase("","а")+" понимаешь. Я бежала из Европы так поспешно, что прихватила лишь несколько монет и пару украшений\nОстальное, вероятно, досталось тем подонкам, что за мной охотились. Теперь вместо роскошных приёмов и дорогих нарядов - убогая лачуга на отшибе и работа в таверне. Никогда не думала, что однажды буду подавать ром, вместо того чтобы смаковать вино в хорошей компании...";
