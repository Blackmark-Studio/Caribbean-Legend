void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Kristian_6":
			dialog.text = ""+GetSexPhrase("Месье","Мадемуазель")+" "+pchar.lastname+", дело в том, э-э... ну... я знаю, где найти того, кто вам нужен. Могу передать ему... ваше предложение.";
		...
		case "Kristian_12":
			dialog.text = "Я уж думал, что всё это ловушка. Но, если честно, ваше предложение звучит... весьма заманчиво. Стабильность, надёжность... Кто бы мог подумать, что мне выпадет такой шанс. "+GetSexPhrase("Месье","Мадемуазель")+", я согласен! Сколько вы хотите покупать?";
