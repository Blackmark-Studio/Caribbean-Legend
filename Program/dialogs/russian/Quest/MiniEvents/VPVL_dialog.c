...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Kontr Le Maren1":
			...
			link.l1 = "Тысяча акул тебе в брюхо, "+sld.name+"! Ты самый хитроумный контрабандист на всём архипелаге!";
		...
		case "Pier_2":
			dialog.text = "Простите, я ничего не понимаю... Боль и голод лишили меня способности ясно мыслить... Почему вы пришли сюда?";
