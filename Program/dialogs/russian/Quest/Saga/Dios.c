...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "amap":
			...
			link.l1 = "Да. Это было нелегко, но удача всё же улыбнулась мне в этом предприятии. Возьмите ваши карты. Они великолепны, каждая из них в разы превосходит любую, которую я видел ранее.";
			link.l1.go = "amap_1";
		break;
		...
		case "amapcopy_01":
			...
			dialog.text = "Кроме того, раз уж всё так обернулось, у меня есть ещё одно небольшое предложение для вас.";
			link.l1 = "Какое же? Я вас очень внимательно слушаю.";
			link.l1.go = "best_map";
		break;
		
		case "best_map":
			dialog.text = "Мне пришла в голову мысль, что эти карты хороши для исследователя, но не дают всего необходимого морскому капитану. Сами посудите: все бухты, мысы и лагуны на них изображены очень точно, но путь между островами по ним не проложишь.";
			link.l1 = "Это верно, курс по ним не определить.";
			link.l1.go = "best_map_01";
		break;
		
		case "best_map_01":
			dialog.text = "Я могу сделать для вас карту архипелага! Но не такую, что можно купить у Голландской Вест-Индской Компании, а уникальную отличную карту.";
		...
		case "best_map_04":
			dialog.text = "Инструменты у меня уже имеются, благодарю вас. Мне понадобится обычная карта архипелага, а также я попрошу буссоль и тарифицированный хронометр: карта должна быть точной, иначе это будет только вредительством. И в качестве платы - один сундучок с дублонами.";
			if(CheckAMapItems())
			{
				link.l1 = "Всё, что вы назвали, у меня уже есть с собой. Вот, держите.";
				link.l1.go = "best_map_07";
			}
			link.l2 = "Обычная карта архипелага, буссоль, тарифицированный хронометр, один сундук с дублонами. Я запомнил! Доставлю как можно быстрее, ждите!";
		...
		case "best_map_waititems":
			dialog.text = "Приветствую, мой дорогой друг! Вы принесли обычную карту архипелага, буссоль, тарифицированный хронометр и сундук с дублонами?";
			link.l1 = "Нет ещё, сеньор Диос. Но обязательно принесу!";
			link.l1.go = "best_map_07e";
			if(CheckAMapItems())
			{
				link.l2 = "Да, сеньор Диос. Вот, здесь всё, держите.";
		...
		case "best_map_wait":
			...
			{
				dialog.text = "А вот и вы, сеньор "+pchar.lastname+"! Спешу вас порадовать: я закончил карту архипелага! И смею вас заверить, что она гораздо лучше той, которую вы предоставили мне.";
		...
		case "best_map_09":
			dialog.text = "Бросьте, мой друг. Для меня было отрадно составлять такую карту для благородного капитана, который может по достоинству оценить её. Ах да - и возвращаю вам ваш экземпляр обычной карты. Удачи вам на морских просторах!";
			link.l1 = "Огромное вам спасибо! Вы правы, эта карта для меня просто бесценна. До свидания, сеньор Диос!";
