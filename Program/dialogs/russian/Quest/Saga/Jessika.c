...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "shore_5":
			dialog.text = "Ты ничего не потерял от того, что не увидел его. Он очень плохой человек. А сейчас будем прощаться - меня ничего более здесь не держит. Обет выполнен, заклятие потеряло силу. Я обещала тебе подарок. Вот. Это мой фламберж. Мне он больше не нужен. Это уникальный клинок, второго такого, вероятно, нет на свете.";
			link.l1 = "Спасибо...";
			link.l1.go = "shore_6";
		break;
