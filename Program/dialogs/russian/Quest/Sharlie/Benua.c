...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LH_abbat_35":
			if (int(pchar.questTemp.LongHappy.Mistake) > 1) sTemp = "(шепчет) Шарль, "+GetSexPhrase("сын мой","дочь моя")+", просто открывай рот, умоляю - ни звука...";
			else sTemp = "";
		...
		case "WildRose_Abb_14":
			...
			link.l2 = "Нет, отче, у меня нет при себе таких денег. Но я скоро вернусь и принесу их.";
		...
		case "SharlieEpilog_Benua_Delivery":
			...
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Patent") && CheckCharacterItem(pchar, "patent_fra") || CheckAttribute(pchar, "questTemp.Patria.GenGovernor") && !CheckAttribute(pchar, "questTemp.SharlieEpilog_Governor"))
			{
				if (CheckAttribute(pchar, "questTemp.Patria.GenGovernor"))
				{
					link.l3 = "Я хочу известить барона Форже, и канцелярию Капстервиля о том, что я вынужден покинуть пост генерал-губернатора.";
			...
			{
				link.l6 = "Мне нужно отправить весточку Фадею Московиту из Бас-Тера.";
			...
			{
				link.l7 = "Я хочу сообщить о своём путешествии семье Хоуков из Марун-Тауна.";
				link.l7.go = "SharlieEpilog_Benua_Houk";
			}
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Jino") && CharacterIsAlive("Jino"))
			{
				link.l8 = "Я хочу уведомить Джино Гвинейли из Сент-Джонса об убытии в Старый Свет.";
		...
		case "SharlieEpilog_Benua_Money_4":
			dialog.text = "В таком случае пожертвования в сто тысяч песо будет достаточно. На эти деньги мы сможем устраивать обеды для нуждающихся ещё многие месяцы. Если у тебя при себе есть нужная сумма, включая пожертвование церкви, мы можем приступить прямо сейчас.";
		...
		case "SharlieEpilog_Benua_Money_5":
			dialog.text = "В таком случае твоё пожертвование должно составить двести пятьдесят тысяч песо. Эти средства позволят нам построить приют для сирот, который будет прославлять твоё имя и обеспечивать его нужды хотя бы первое время. Если у тебя при себе есть нужная сумма, включая пожертвование церкви, мы можем приступить прямо сейчас.";
		...
		case "SharlieEpilog_Benua_Money_6":
			dialog.text = "Что ж, похоже, ты времени зря не терял, "+pchar.name+". Думаю, пожертвования в пятьсот тысяч песо будет вполне достаточно. Благодаря такому взносу мы сможем построить больницу и обеспечить её всем необходимым на долгие годы. Если у тебя при себе есть нужная сумма, включая пожертвование церкви, мы можем приступить прямо сейчас.";
		...
		case "SharlieEpilog_Benua_Governor":
			dialog.text = "Мне искренне жаль, "+pchar.name+", что ради встречи с отцом тебе придётся оставить столь высокую должность. И всё же отрадно видеть, что для тебя семья превыше всего.";
			link.l1 = "Меня гложет то, что за всё время пребывания здесь, на Карибах, я не удосужился отправить ему ни единого письма; и я намерен это исправить личным визитом. Каким бы головокружительным ни был мой успех, мне не следует забывать о долге перед родителем. Что до барона — полагаю, он сможет простить мне столь резкий уход: в конце концов, я сделал во благо нашего с вами государства достаточно много.";
			link.l1.go = "SharlieEpilog_Benua_Governor_2";
			pchar.questTemp.SharlieEpilog_Governor = true;
		break;
		
		case "SharlieEpilog_Benua_Governor_2":
			dialog.text = "Ты сделал непростой, но достойный выбор, сын мой. Власть и почести преходящи, а долг перед семьёй и родом - вечен. Поверь, Господь видит твои помыслы и воздаст не за титулы, но за верность сердцу.";
			link.l1 = "Благодарю вас, отче. Ваши слова многое для меня значат.";
		...
		case "SharlieEpilog_Benua_Governor_4":
			dialog.text = "Превосходно. Я приму все меры, чтобы письма были доставлены в кратчайшие сроки.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Benua_Delivery";
