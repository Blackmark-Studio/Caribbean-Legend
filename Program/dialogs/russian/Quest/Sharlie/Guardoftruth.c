...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "gevarra_7":
			...
			link.l1 = "Вот-вот! Я примерно это ему и сказал. Он, конечно, разозлился... но мне очень нужна эта ваниль! Сеньор, я всё-таки не торговец, а вы, как я вижу, на этом деле собаку съели, да и корабль у вас вместительный...";
