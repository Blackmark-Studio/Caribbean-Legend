...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "guide_portoffice":
			dialog.text = "Это - портовое управление. Здесь можно оставить корабль на стоянку, а также найти честную работу для капитана: фрахт, сопровождение, доставка почты. Чем больше заданий вы выполняете — тем выгоднее они становятся.";
			link.l1 = "";
