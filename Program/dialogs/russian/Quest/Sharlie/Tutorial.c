void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "StartSailor_21_leadership":
			dialog.text = "Ха. Может, в вас и правда есть что-то. Но берегитесь - Карибы любят сдирать кожу с тех, кто высоко задирает нос. Встречи с авангардом пиратов вы не переживёте. Что говорить - вас зарежет первый же оборванец за воротами Сен-Пьера.";
			link.l1 = "Ты меня совсем не знаешь.";
			link.l1.go = "StartSailor_22";
			AddCharacterSkillPoints(pchar, "Leadership", 1);
		break;
