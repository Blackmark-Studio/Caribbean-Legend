void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LadyBeth_Alonso_2":
			dialog.text = "Убитыми? В этой авантюре мы потеряли "+int(pchar.SailorDiedInBattleInfo)+" человек. Не хочу показаться назойливым, капитан, но... я же вас предупреждал!";
