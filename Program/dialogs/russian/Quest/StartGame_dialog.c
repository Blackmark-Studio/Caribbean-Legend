...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		// тест квеста
		case "WildRose_Test_Start_1":
			dialog.text = "Откуда начнём?";
			link.l1     = "Эпизод 1. ЛОЩИНА ВЛЮБЛЁННЫХ.";
			link.l1.go  = "WildRose_Test_Start_episode_1";
			link.l2     = "Эпизод 2. ДИТЯ ОСТРОВА.";
			link.l2.go  = "WildRose_Test_Start_episode_2";
			link.l3     = "Эпизод 3. БУМАЖНАЯ РАБОТА.";
			link.l3.go  = "WildRose_Test_Start_episode_3";
			link.l4     = "Эпизод 4. ПУТЬ К СВЕТУ.";
			link.l4.go  = "WildRose_Test_Start_episode_4";
			link.l5     = "Эпизод 5. ЧУЖИМИ РУКАМИ.";
			link.l5.go  = "WildRose_Test_Start_episode_5";
			link.l6     = "Эпизод 6. ЖИЗНЬ ПОСЛЕ СМЕРТИ.";
			link.l6.go  = "WildRose_Test_Start_episode_6";
		break;
		
		case "WildRose_Test_Start_episode_1":
			DialogExit();
			//Телепорт
			DoFunctionReloadToLocation("Bridgetown_town", "reload", "reload1", "WildRose_Start");
			setCharacterShipLocation(pchar, "Bridgetown_town");
			setWDMPointXZ("Bridgetown_town");
			//Остальное
			AddDialogExitQuestFunction("WildRose_Test");
		break;
		
		case "WildRose_Test_Start_episode_2":
			DialogExit();
			//Телепорт
			DoFunctionReloadToLocation("LostShipsCity_town", "reload", "reload1_back", "WildRose_Etap2_IslandOfJustice_1");
		...
		case "WildRose_Test_Start_episode_3":
			DialogExit();
			//Телепорт
			DoFunctionReloadToLocation("FortFrance_Church", "reload", "reload1", "WildRose_Etap2_IslandOfJustice_27");
		...
		case "WildRose_Test_Start_episode_4":
			DialogExit();
			//Телепорт
			DoFunctionReloadToLocation("LostShipsCity_town", "reload", "reload1_back", "WildRose_Etap4_PathToLight_1");
			setCharacterShipLocation(pchar, "LostShipsCity_town");
			setWDMPointXZ("LostShipsCity_town");
			//Остальное
			AddDialogExitQuestFunction("WildRose_Test");
		...
		case "WildRose_Test_Start_episode_5":
			DialogExit();
			//Телепорт
			DoFunctionReloadToLocation("BasTer_houseSp1", "goto", "goto2", "WildRose_Etap4_PathToLight_21");
		...
		case "WildRose_Test_Start_episode_6":
			DialogExit();
			//Телепорт
			DoFunctionReloadToLocation("Beliz_town", "reload", "reload1", "WildRose_Etap6_LifeAfterDeath_1");
