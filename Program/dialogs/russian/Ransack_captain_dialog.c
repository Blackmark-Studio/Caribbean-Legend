...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FalseTrace_Prisoner_1":
			...
			link.l1 = "Ваш флейт я захватил по наводке Адама Рейнера, мужа Катерины. Он-то и сказал, что на нём полно серебра. Этот обман позволил ему вернуть назад свою жену, сбежавшую от него, как я понимаю, с вами.";
		...
		case "FalseTrace_Prisoner_2":
			...
			link.l1 = "Она его жена. Впрочем, меня это не касается. Я совершил промах, атаковав ваш флейт, но теперь поздно рассуждать о содеянном. Адам обещает расплатиться со мной за оказанную помощь в возврате жены.";
