void ProcessDialogEvent() 
{
    ...
    switch(Dialog.CurrentNode)
	{
		...
		case "GiveMeSomeMoneyToo":	
			...
			Link.l1 = "Думаю, что " + int(int(Pchar.money)/10) + " песо будет достаточно.";
			...
			Link.l2 = "Как насчёт " + int(int(Pchar.money)/5) + " песо?";
			...
			Link.l3 = "Вам, офицер, я готов"+GetSexPhrase("","а")+" отдать " + int(int(Pchar.money)/2) + " песо!";
