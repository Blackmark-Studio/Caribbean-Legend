...
*/			
		...
		case "result":
			...
			dialog.text = "Хорошо. Процентов под эту сумму я готов вам предложить... мм... скажем, " + fts(stf(Pchar.QuestTemp.Deposits.(sDepositType1).Interest), 1) + ". Разумеется, в месяц.";
