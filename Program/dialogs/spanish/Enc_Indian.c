...
void ProcessDialogEvent()
{
	...
	case "mangarosa_1":
		...
		dialog.text = "Sí. Ese es uno de los nombres que tiene, Manga Rosa. Te doy un amuleto por ello. Muy buen amuleto, tiene nombre, " + XI_ConvertString(npchar.quest.mangarosa) + "¿Haces comercio?";
