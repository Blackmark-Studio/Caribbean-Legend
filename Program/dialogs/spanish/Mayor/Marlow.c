	...
	case "pirate_town_pay":
		...
		case "pirate_threat":
			...
			if (iGPThreat != 0)
			{
				...
				dialog.text = "¡Ja! ¿Los de la Hermandad te están causando problemas, eh, " + GetSexPhrase("amigo", "amiga") + "? Puedo mantenerlos a raya por un tiempo. Pero te costará caro. " + FindRussianDublonString(iMarlowTotalTemp) + " sobre la mesa, y llegamos a un acuerdo.";
