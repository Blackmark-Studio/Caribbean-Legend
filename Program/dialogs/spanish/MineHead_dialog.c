...
void ProcessDialogEvent()
{
	...
	case "slaves":
		...
		if (int(location.quest.slaves.qty) > 350)
	...
	case "slaves_trade":
		...
		{
			dialog.text = "Lamentablemente, señor, en este momento no necesitamos tantos esclavos. La mina actualmente requiere " + FindRussianQtyString(int(location.quest.slaves.qty)) + ". ¿Vas a vender tantos?";
