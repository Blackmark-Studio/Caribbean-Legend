...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	case "SharkGoldFleet_18":
		...
		dialog.text = "Lo siento por la espera. Aquí están sus " + int(pchar.questTemp.SharkGoldFleet) + "piezas de a ocho. Y en este caso, ellos mismos pagarán por la respuesta en Caracas. Dime que lo hice.";
