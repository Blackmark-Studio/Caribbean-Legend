...
//--------------------------------------------против всех------------------------------------------------
		...
		case "Abigile_return_4":
			...
			link.l1 = "Por supuesto, querida señorita. Desafortunadamente, no hay nada para usted aquí en St. John's. Vaya, haga sus maletas, despídase de John y zarparemos de inmediato.";
