...
void ProcessDialogEvent()
{
	...
	case "return_2":
		...
		{
			dialog.text = "No, no tengo frío. Es sólo que... no quiero hablar de eso aquí. Ven a mi camarote cuando termines. Quiero estar contigo a solas, sí, ¿eh? ¿No vas a ver a Nathaniel ahora?";
			link.l1 = "Sí. Tengo que llevar a Danielle con él. No tomará mucho tiempo. Te veré pronto, Mary.";
		}
		link.l1.go = "return_3";
		break;
	...
	case "LongHappy_9c":
		...
		dialog.text = "Creo, " + int(pchar.questTemp.LongHappy.MarryMoney) + " pesos serán suficientes, sí, ¿eh? " + int(pchar.questTemp.LongHappy.MarryRum) + "barriles de ron, no hay nada peor que quedarse sin bebidas. Tan pronto como recojas todo lo que necesitamos, ven a la taberna, yo me encargaré del resto.";
