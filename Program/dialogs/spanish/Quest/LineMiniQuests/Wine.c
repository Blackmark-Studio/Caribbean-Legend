void ProcessDialogEvent()
{
	...
	case "Wine_take":
		...
		{
			dialog.text = "Bienvenido de nuevo. Veamos... Has traído " + int(pchar.questTemp.Wine.Qty) + " botellas. ¡Bien! Las tomaré. El pago es " + FindRussianMoneyString(int(pchar.questTemp.Wine.Money)) +".";
