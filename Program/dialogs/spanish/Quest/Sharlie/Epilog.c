void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Cureer":
			dialog.text = "Disculpe. ¿Es usted " + GetTitle(NPChar, false) + " " + GetFullName(pchar) + "?";
			link.l1 = "En persona. ¿A qué debo el honor?";
			link.l1.go = "SharlieEpilog_Cureer_1";
		break;

		case "SharlieEpilog_Cureer_1":
			dialog.text = "Oh, por fin... Encontrarle no fue nada fácil. He tenido que recorrer casi todo el archipiélago. Tengo una correspondencia para usted del abad Benoît.";
			link.l1 = "Hmm... ¿Del abad? Qué sorpresa.";
			link.l1.go = "SharlieEpilog_Cureer_2";
		break;

		case "SharlieEpilog_Cureer_2":
			dialog.text = "Me ordenaron entregársela en mano. No se preocupe por el pago — el abad ya ha cubierto todos mis gastos.";
			link.l1 = "Muy bien, entréguemela. Le agradezco.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Dassen":
			dialog.text = "¿Cuáles son sus órdenes, "+GetTitle(NPChar, true)+"?";
			link.l1 = ""+npchar.name+", no me extenderé - dejo el archipiélago. Los asuntos familiares requieren mi presencia en la hacienda de mi padre.";
			link.l1.go = "SharlieEpilog_Dassen_1";
		break;
		
		case "SharlieEpilog_Dassen_1":
			dialog.text = "Si lo entiendo bien, ¿nos estamos separando?";
			link.l1 = "Por desgracia... No puedo actuar de otra manera.";
			link.l1.go = "SharlieEpilog_Dassen_2";
		break;
		
		case "SharlieEpilog_Dassen_2":
			dialog.text = "Pues bien, para mí ha sido un honor servir bajo la misma bandera que usted, y lo haría de nuevo con gusto si el destino así lo permite.";
			link.l1 = "Espero que nuestra amistad no se rompa, sino que se fortalezca, pues hemos compartido no pocas aventuras.";
			link.l1.go = "SharlieEpilog_Dassen_nothing";
			link.l2 = "Por su lealtad y profesionalidad, deseo pagarle, en concepto de indemnización, un mes de salario.";
			link.l2.go = "SharlieEpilog_Dassen_salary";
			link.l3 = "Ha servido de manera impecable, y considero necesario recompensarle como corresponde. Acepte esto - aquí tiene tres meses de salario. Se ha ganado esta recompensa con creces.";
			link.l3.go = "SharlieEpilog_Dassen_salaryX3";
		break;
		
		case "SharlieEpilog_Dassen_nothing":
			dialog.text = "Comparto sinceramente esta esperanza, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Llámeme simplemente Charles. Y, por cierto, tengo algo para usted.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			}
			else
			{
				link.l1 = "Pues bien, hasta nuestro próximo encuentro, monsieur "+npchar.lastname+". Adiós.";
				link.l1.go = "SharlieEpilog_Dassen_Leave";
			}
		break;
		
		case "SharlieEpilog_Dassen_salary":
			dialog.text = "Le agradezco, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Llámeme simplemente Charles. Y, por cierto, tengo algo más para usted.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			}
			else
			{
		...
		case "SharlieEpilog_Dassen_salaryX3":
			dialog.text = "Le estoy muy agradecido, "+GetTitle(NPChar, true)+", es usted demasiado generoso conmigo.";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Llámeme simplemente Charles. Y, por cierto, tengo algo más para usted.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			...
			{
				link.l1 = "Basta de formalidades, llámeme simplemente Charles. Con motivo de la partida, pienso organizar una pequeña celebración en la taberna. ¿Espero que se una a nosotros?";
		...
		case "SharlieEpilog_Dassen_Governor":
			dialog.text = "Ha despertado mi curiosidad, "+pchar.name+".";
			link.l1 = "Lo he recomendado para el cargo de gobernador de Isla Mona. Pronto llegará desde la cancillería la carta correspondiente, y espero sinceramente que no la rechace. Esta isla significa muchísimo para mí, y estaría encantado de verlo al frente de su administración.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_1";
		break;

		case "SharlieEpilog_Dassen_Governor_1":
			dialog.text = ""+UpperFirst(GetAddress_Form(NPChar))+"... "+pchar.name+"... Esto es realmente inesperado...";
			link.l1 = "Y aun así. ¿Cuál será su respuesta?";
			link.l1.go = "SharlieEpilog_Dassen_Governor_2";
		break;
		
		case "SharlieEpilog_Dassen_Governor_2":
			dialog.text = "Es una oferta que no se rechaza. La acepto con gusto y prometo hacer todo lo posible por la prosperidad de esta isla y el bienestar de sus habitantes.";
			link.l1 = "¡Excelente, amigo mío! Entonces le esperaré en la taberna, en la celebración en honor a mi partida. Alonso le avisará cuando todo esté listo.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_3";
		break;
		
		case "SharlieEpilog_Dassen_Governor_3":
			dialog.text = "No me lo perderé por nada del mundo, monseñor.";
			link.l1 = "";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		
		case "SharlieEpilog_Dassen_Tavern":
			dialog.text = "No me lo perderé por nada del mundo, "+pchar.name+".";
			link.l1 = "Excelente, amigo mío. Entonces nos encontraremos allí. Alonso le avisará cuando estemos listos para empezar.";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		...
		case "SharlieEpilog_PikarOnUliss_D_1":
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarAlive") || CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarResurrected")){dialog.text = "Tienes razón.";}
		...
		case "SharlieEpilog_HenriDeMonper_Mary_4":
			if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "me presentarás a los demás";
			else sStr = "me presentarás a nuestro invitado";
		...
		case "SharlieEpilog_InKitchenDeMonpe_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer") || CheckAttribute(pchar, "questTemp.LSC.Mary_officer"))
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "buenos amigos";
				else sStr = "compañero";
				dialog.text = "";
			...
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "tus buenos amigos";
				else sStr = "tu amigo";
				dialog.text = "";
		...
		case "SharlieEpilog_KomendantFort_5":
			dialog.text = "¡Un plan excelente, Vuestra Excelencia! Sin embargo… sois, sin duda, un hombre curtido en los combates navales, y aun así no es propio de alguien de vuestro rango arriesgar la vida en persona. La flota bien podría ser comandada por…";
			link.l1 = "Así como no supe soportar la vida tranquila en Europa, tampoco soportaré una espera ociosa en la costa mientras se decide el destino de la batalla. Del destino no se huye, "+GetAddress_Form(NPChar)+" "+npchar.lastname+". ";
			link.l1.go = "SharlieEpilog_KomendantFort_6";
		break;

		case "SharlieEpilog_KomendantFort_6":
			dialog.text = "Sea, pues, a vuestra voluntad. ¿Me permitís dar la orden de iniciar los preparativos?";
			link.l1 = "Proceded. Y que Dios esté con nosotros.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Mishelle_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) sStr = " y con tu esposa";
			dialog.text = "¿Todavía no lo entiendes? Has muerto. Junto con tu tripulación"+sStr+". Un mercader cualquiera al que decidiste robar hizo volar la santabárbara — con tal de que ni una sola moneda fuera a parar a manos de gente como tú.\nSpectra sunt memoria peccatorum. El fantasma eres tú, "+pchar.name+"... La leyenda caribeña de un hombre devorado por la codicia y la vanidad ciega. ¿A cuántos mataste por oro?";
