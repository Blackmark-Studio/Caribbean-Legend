...
void ProcessDialogEvent()
{
	...
	case "First time":
		...
		if (CheckAttribute(pchar, "questTemp.Sharlie"))
		{
			...
			{
				dialog.text = "¿Qué puedo hacer por usted, monsieur? No hablo con personas que no conozco. Si ha venido para charlar, o para preguntar a qué hora del mes llega el Flota de Plata Española a Maracaibo en 1640, entonces debo decepcionarlo. No pierdo mi tiempo en charlas ociosas.";
				link.l1 = "Buenas tardes, monsieur Fadey. Usted, por supuesto, puede que aún no me conozca, pero sí conoce a mi hermano. Permítame presentarme, soy Charles de Maure, hermano de Michel de Monper.";
				link.l1.go = "Sharlie";
				break;
			}
			...
			if (CheckAttribute(pchar, "questTemp.Sharlie.Tichingitu") && pchar.questTemp.Sharlie.Tichingitu == "fadey")
			{
				...
				link.l1 = "Así es... Por eso he vuelto a ti.";
			...
			if (CheckAttribute(pchar, "questTemp.Sharlie.Tichingitu") && pchar.questTemp.Sharlie.Tichingitu == "dublon")
			{
				...
				if (CheckAttribute(npchar, "questTemp.Sharlie.Tichingitu_Skidka"))
				{
					...
					{
						link.l1 = "Sí. Aquí tienes tus 35 doblones.";
				...
				else
				{
					...
					{
						link.l1 = "Sí. Aquí tienes tus 40 doblones.";
						link.l1.go = "Tichingitu_7";
					}
					else
					{
			...
			if (CheckAttribute(pchar, "questTemp.Mtraxx.MagicBox") && pchar.questTemp.Mtraxx.MagicBox == "FindMoney")
			{
				...
				{
					link.l1 = "He cumplido, monsieur Fadey. Aquí tienes tus 75 doblones.";
					link.l1.go = "pistols_4D";
				}
				if (sti(Pchar.money) >= 40000)
				{
					link.l2 = "¡Los tengo, monsieur Fadey! Aquí están tus 40,000 pesos.";
			...
			if (CheckAttribute(pchar, "questTemp.Mtraxx.MagicBox") && pchar.questTemp.Mtraxx.MagicBox == "FindMoney")
			{
				...
				if (PCharDublonsTotal() >= 75)
				{
					link.l1 = "Toma 75 doblones. Pediré a los marineros que lleven esta caja a mi barco. Oh, ¿qué haría sin ti, Fadey? ¡No tienes idea de cuánto me has ayudado!";
			...
			{
				dialog.text = "¡Ah, por fin ha llegado, buen señor! Al saber que su barco había echado anclas en nuestro puerto, tuve la esperanza de que me honrara con una visita.";
				link.l1 = "Buenos días, "+npchar.name+". No le aburriré con una larga historia. Mi compañera Mary y yo estamos buscando a su padre, quien desapareció sin dejar rastro hace veinte años...";
				link.l1.go = "WildRose_Fadey_4";
				break;
			}
			if (CheckAttribute(pchar, "questTemp.WildRose_Etap5_Fadey_2")) 
			{
				link.l31 = "Sobre el padre de Mary...";
				link.l31.go = "WildRose_Fadey_return";
			}
			if (CheckAttribute(pchar, "questTemp.WildRose_Etap5_Fadey_3"))
			{
				dialog.text = "¡Ah, es usted, "+pchar.name+"!";
				link.l1 = "Lo noto de muy buen humor, "+npchar.name+". Vamos, cuénteme — ¿consiguió averiguar algo?";
			...
			if (CheckAttribute(pchar, "questTemp.Guardoftruth.Baster_church") && pchar.questTemp.Guardoftruth.Baster_church == "find" && !CheckAttribute(npchar, "quest.utensil"))
			{
				...
				link.l1 = "¡Por supuesto que sí! ¿Cómo te fue?";
			...
			{ // персидские клинки
				link.l2 = "Echa un vistazo, Fadey. Supongo que esto es un shamshir persa, ¿posiblemente uno de esos robados de tu colección?";
				link.l2.go = "persian";
			}
	...
	case "Sharlie_1":
		dialog.text = "¡Qué dices! ¡Este ron es agua de orina débil comparado con el vodka ruso! ¡No sabes de lo que te estás perdiendo, que me lleve el mar si miento! Bien, al grano entonces. Soy todo oídos, Charles.";
	...
	case "Sharlie_5":
		dialog.text = "¡Oh, ho ho! Ahora, Charles, soy un buen cristiano, no un chamán indio. No tengo manera de conocer todas las propiedades ocultas de esta hoja. ¡Pero existen, oh sí! ¡Sujeta este puñal en tu mano y sentirás el poder dentro de ti mismo! ¡Tómalo, beri! ¿Qué tal eso? ¿Sientes algo?";
	...
	case "Sharlie_6":
		...
		link.l1 = "Bueno, ¿tengo otra opción? Lo tomaré ya que no tienes el dinero...";
	...
	case "Sharlie_7":
		...
		// Log_Info("¡Has recibido la Garra del Jefe!");
		sld = ItemsFromID("knife_01");
		sld.Weight = 1.5;
		sld.price = 0;
		AddLandQuestMark(characterFromId("Mishelle"), "questmarkmain");
		AddMapQuestMarkCity("FortFrance", false);
		dialog.text = "Spasibo, Charles. No te arrepentirás, ¡oh, ciertamente no lo harás! Aquí tienes. Y asegúrate de saludar a Michel de mi parte. ¡Dile que venga a visitarme, en cuanto tenga la oportunidad!";
		link.l1 = "Oh, le diré...";
		link.l1.go = "exit";
	...
	case "Sharlie_11":
		...
		link.l2 = "Sabes, no soy un experto en armas finas. Me temo que no podré ayudar. Así que sería deshonesto de mi parte dar falsas esperanzas.";
	...
	case "Sharlie_13":
		dialog.text = "Lástima, pero no sirve de nada llorar por la luna. ¡Da, Charles, imagínate, hace poco tuve otro intento de robo!\nUn ladrón intentó entrar a mi casa hace solo unos días.\n¡Eso fue demasiado para mí! Sin embargo, no escapó de mí: logré atraparlo, le di una buena paliza y lo envié a la prisión. No puedes ser feliz a expensas de la desgracia ajena. ¡Espero que lo cuelguen pronto!";
		link.l1 = "¿Crees que es uno de los ladrones que se llevaron tus shamshirs?";
		link.l1.go = "Sharlie_14";
	...
	case "Sharlie_15":
		...
		link.l1 = "Todo lo mejor para ti, Fadey.";
		link.l1.go = "exit";
	...
	case "Tichingitu":
		...
		link.l1 = "Fadey, he hablado con ese indio. Y vine a ti para pedirte ayuda para sacarlo. El pobre desgraciado solo quería algo de comer...";
		link.l1.go = "Tichingitu_1";
		break;

	case "Tichingitu_1":
		dialog.text = "Ja-ja-ja, ¿y creíste esa historia? Los jóvenes de hoy en día son tan crédulos...";
	...
	case "Tichingitu_5":
		dialog.text = "Horosho, horosho, 40 doblones de oro. Pero es el precio final. Y doblones, no pesos. Nuestro usurero seguro que tendrá algo.";
		if (PCharDublonsTotal() >= 40) // belamour legendary edition
		{
			link.l1 = "Tengo la cantidad necesaria ahora mismo. Tome, sus 40 doblones.";
			link.l1.go = "Tichingitu_7";
		}
	...
	case "Tichingitu_7_TW":
		dialog.text = "Oh, llegarás lejos, amigo mío. ¡Me han convencido! 35 doblones de oro — ¡ni una moneda menos!";
		link.l1 = "";
	...
	case "Tichingitu_7":
		if (CheckAttribute(npchar,"questTemp.Sharlie.Tichingitu_Skidka"))
		{
			...
			RemoveDublonsFromPCharTotal(40); // belamour legendary edition
		PlaySound("interface\important_item.wav");
	...
	case "vodka_1":
		...
		link.l1 = "¿Una mandoble? ¿Te burlas de mí, Fadey? ¿Para qué me serviría una vieja espada de verdugo oxidada? ¡Este es el siglo diecisiete del Señor Jesucristo! ¡No daría ni un solo peso por ella!";
		link.l1.go = "vodka_2";
		break;
	...
	case "vodka_4":
		...
		dialog.text = "¡Detente, Charles! Seré honesto, me gusta tu estilo. Tal vez tú y yo podríamos llegar a ser los mejores amigos algún día. ¿Y por qué no dar el primer paso hacia esa amistad ahora mismo? He estado enfriando dos botellas de excelente vodka ruso en agua de manantial helada abajo en la bodega. ¿Qué dices si abrimos una botella a la salud de tu hermano?";
	...
	case "vodka_5":
		dialog.text = "¡Eso es lo que me gusta oír! ¡Espléndido! ¡Toma asiento y descansa los pies! Por favor, monsieur, siéntete como en casa mientras voy a buscar el vodka. ¡Oh, cuánto he echado de menos estas reuniones vespertinas con amigos! Ah, el vodka está bien frío, seguro que lo disfrutarás, ¡na zdorovie! Permíteme poner unos encurtidos y jamón ahumado.";
		link.l1 = "...";
		link.l1.go = "vodka_6";
		break;
	...
	case "vodka_8":
		...
		link.l1 = "Sí, sí, vodka... es... es absolutamente magnífico, este vodka. Nunca he bebido algo parecido.";
		link.l1.go = "vodka_9";
		break;

	case "vodka_9":
		dialog.text = "¡Ja! ¡Tienes razón! Este tipo de vodka se hace según recetas secretas y se envía desde mi madre patria, Rusia, y ni siquiera allí todos saben cómo hacerlo correctamente. ¡Yo compro solo lo mejor! Como este brebaje que tú y yo hemos tenido la oportunidad de probar.";
		link.l1 = "¿P-pero dime, Fadey: c-cómo p-puedes beber t-tanto y no emborracharte? ¿C-cómo lo haces, eh? Comparte el secreto conmigo. Q-quizás me sirva de algo más tarde... ¡Hip!";
		link.l1.go = "vodka_10";
		break;

	case "vodka_10":
		dialog.text = "¡Ja! Bueno, no puedes compararte conmigo, joven Charles. Solo mírate, flaco como un látigo. Además, no estás acostumbrado a beber en serio, ¡ha! Pero como somos verdaderos amigos, te compartiré algunos secretos sobre cómo beber y no orinarte encima.";
		link.l1 = "Po-favor h-ha... ¡hip!";
		link.l1.go = "vodka_11";
		break;

	case "vodka_11":
		dialog.text = "Bueno, si quieres beber y no terminar borracho al instante, debes seguir unas cuantas reglas clave. Lo más importante, nunca bebas si tu estómago está vacío. Come algo sustancioso antes de que empiece la sesión de bebida.\nEn segundo lugar, no olvides comer algo después de cada copa. La carne o el pescado serán lo mejor, algo rico y salado. En tercer lugar, no enjuagues el interior de tu boca con el vodka, trágatelo de una vez.\nAdemás, beber un pequeño trago, no más de media pinta, antes del plato principal preparará tu cuerpo para recibir dosis serias de alcohol. No exageres con este aperitivo, de lo contrario el efecto será todo lo contrario y te destrozarás antes de zarpar.\nFinalmente, el entrenamiento disciplinado es clave, beber cantidades moderadas de ron u otros tipos de alcohol de manera regular te hará más resistente a ellos.";
	...
	case "vodka_12":
		...
		link.l1 = "¡A-a-adiós, Fadey! Me voy al, ¡hip! - el Concededor de Deseos!";
		link.l1.go = "vodka_13";
		break;
	...
	case "trial_2":
		dialog.text = "Ve a la tienda mañana. Un hombre llamado Gerard LeCroix te estará esperando allí. Te dará algo de trabajo. Estará en esta colonia solo hasta mañana por la noche. Ve a verlo pronto y haz el trabajo correctamente. No me pongas en una posición incómoda.";
	...
	case "Slaves_1":
		...
		if (PCharDublonsTotal() >= 150)
		{
			link.l1 = "¡No esperaba menos, monsieur Fadey! Aquí está tu oro.";
			link.l1.go = "Slaves_2";
		}
		else
		{
			link.l1 = "¡Voy al usurero inmediatamente! ¡Espera, monsieur Fadey, ya regreso!";
			link.l1.go = "exit";
	...
	case "pistols_2":
		...
		dialog.text = "Eso es bueno de escuchar. Puedo ayudar.";
	...
	case "pistols_3":
		...
		link.l1 = "Ten algo de fe en mí, Fadey. ¿Cuánto?";
		link.l1.go = "pistols_4";
		break;

	case "pistols_4":
		dialog.text = "Horosho, entonces ... pistolas y un par de mosquetes, con pólvora y bala para cada uno... Por lo tanto, no puedo prometer que conseguiré absolutamente todo lo que pediste, pero haré todo lo que esté en mi poder. Mientras tanto, necesito un depósito de 40,000 pesos, o 75 doblones si prefieres.";
		if (PCharDublonsTotal() >= 75)
		{
	...
	case "pistols_5":
		...
		if (PCharDublonsTotal() >= 75)
		{
			link.l1 = "Toma 75 doblones. Haré que mis hombres lleven las armas a mi barco. ¿Qué haría sin ti, Fadey? ¡No tienes idea de cuánto me has ayudado!";
			link.l1.go = "pistols_5D";
		}
		if (sti(Pchar.money) >= 40000)
		{
	...
	case "pistols_5P":
		...
		case "WildRose_Fadey_4":
			dialog.text = "¡Vaya asunto el que se ha propuesto, "+pchar.name+"! Sin duda es una causa noble, pero... ¿realmente factible? En veinte años puede pasar de todo...";
			link.l1 = "Tiene razón, Fadey. Pero hemos invertido mucho tiempo y esfuerzo, recorrido un largo camino — y estamos casi en la meta. Descubrimos prácticamente todo sobre él: su nombre, su servicio en la Armada Real inglesa, el nombre del barco en que navegaba... y algunos otros detalles de su biografía. El rastro se pierde tras un naufragio cerca del cabo Catoche en junio de 1638.";
		...
		case "WildRose_Fadey_5":
			dialog.text = "¿Catoche? Uf, amigo mío, ¡ni con un palo me harían ir a esos lares! Por ahí rondan hordas de salvajes malditos. Si llegó a esas costas y no se ahogó, lo más probable es que haya terminado en el estómago de algún indígena...";
			link.l1 = "Tenemos indicios de que sobrevivió al naufragio, y que incluso logró llegar hasta Cuba. Tal vez encontró allí su final, pero por lo que sabemos de él, era lo bastante... hábil y astuto para evitar caer en manos de la Inquisición. Dudo que se haya quedado en Cuba — lo más probable es que se haya asentado en alguna colonia del Archipiélago...";
			link.l1.go = "WildRose_Fadey_6";
		break;

		case "WildRose_Fadey_6":
			dialog.text = "En este mundo pasan muchas cosas extrañas, amigo mío, así que todo es posible. Pero aún no entiendo por qué me cuenta todo esto.";
			link.l1 = ""+npchar.name+", usted tiene más contactos que cualquier gobernador. Estoy seguro de que conoce a gente competente capaz de cumplir tareas sencillas...";
			link.l1.go = "WildRose_Fadey_7_1";
			link.l2 = ""+npchar.name+", usted es una persona respetada e influyente. Tiene acceso a los círculos más altos y mantiene relaciones más allá de Guadalupe. Pero como es imposible ocuparse de todo solo, seguramente recurre a agentes de confianza para cumplir encargos simples...";
			link.l2.go = "WildRose_Fadey_7_2";
		break;

		case "WildRose_Fadey_7_1":
			dialog.text = "Es usted una persona inteligente y perspicaz, "+pchar.name+". No me cabe duda de que se lo han dicho más de una vez. Tengo gente capaz y preparada, no se equivoca. Pero dígame: ¿qué desea de ellos?";
			link.l1 = "Quisiera pedirle que los envíe a algunas colonias del Archipiélago para averiguar si alguien sabe algo del hombre que estamos buscando. Quizás alguien lo haya visto o incluso lo conozca. Por supuesto, me haré cargo de todos los gastos. "+npchar.name+", esto es muy importante para Mary, y no tenemos a nadie más a quien acudir.";
		...
		case "WildRose_Fadey_8":
			dialog.text = "¿Cómo podría negarme a un buen amigo como usted, "+pchar.name+"? Y más aún, si está dispuesto a invertir en una causa tan noble. En ese caso, dígame el nombre de la persona a quien desea encontrar.";
			link.l1 = "Respecto al nombre, no estoy del todo seguro, pero creo que podría haberse hecho llamar Rupert Casper o Joshua Northwood.";
			link.l1.go = "WildRose_Fadey_9";
		break;

		case "WildRose_Fadey_9":
			dialog.text = "Bueno, pues encontraremos a ese buen hombre, si así se hacía llamar...";
			link.l1 = "Perfecto, "+npchar.name+". ¿Hablamos del pago por sus servicios?";
			link.l1.go = "WildRose_Fadey_10";
		break;

		case "WildRose_Fadey_10":
			dialog.text = "No es lo más agradable del asunto, pero es necesario, me temo.";
			link.l1 = "Entonces vamos al grano. No creo que se atreviera a ir a colonias españolas u holandesas. Este hombre causó algunos... problemas en Antigua, así que no tendría sentido buscarlo allí ni, probablemente, en Barbados. Es posible que se haya establecido en Tierra Firme, en Jamaica después de la expulsión de los españoles, en colonias francesas o incluso en asentamientos piratas.";
			link.l1.go = "WildRose_Fadey_11";
		break;
		
				case "WildRose_Fadey_11":
			dialog.text = "Le diré directamente, estimado amigo: en todo el tiempo que llevo en Basse-Terre, jamás he oído hablar de un caballero con alguno de esos nombres. Así que aquí no tiene sentido buscarlo. En Martinica y Saint-Christophe conozco a varios caballeros ingleses, y él no está entre ellos.";
			link.l1 = "Entonces el área de búsqueda se reduce bastante.";
			link.l1.go = "WildRose_Fadey_12";
		break;

		case "WildRose_Fadey_12":
			dialog.text = "Habrá que investigar en Tortuga, por supuesto — y a ese mismo muchacho le encargaré pasar por La Vega, Puerto Príncipe y Puerto Príncipe. También enviaré a mis hombres capaces a Belice y Blueveld, así como a Jamaica e Isla Tesoro.";
			link.l1 = "¿Y cuánto me costará todo esto?";
			link.l1.go = "WildRose_Fadey_13";
		break;

		case "WildRose_Fadey_13":
			dialog.text = "Son hombres hábiles, trabajadores y con experiencia. Por tanto, el servicio de cada uno costará ciento cincuenta doblones. Al enviado que irá a Tortuga, La Española y Cuba habrá que recompensarlo con cincuenta monedas de oro adicionales — al fin y al cabo, visitará cuatro asentamientos.";
			link.l1 = "Un total de 800 doblones... Bueno, ¿empezamos el pago?";
			link.l1.go = "WildRose_Fadey_14";
		break;
		
		case "WildRose_Fadey_14":
			dialog.text = "Así es, ¿para qué perder tiempo en balde? ¿Tiene usted el oro necesario, buen hombre?";
			if (PCharDublonsTotal() >= 800)
			{
				link.l1 = "Por supuesto. Aquí tiene.";
				link.l1.go = "WildRose_Fadey_14_pay";
			}
			else
			{
				link.l1 = "Hmm... No tengo toda la suma ahora mismo.";
		...
		case "WildRose_Fadey_14_pay":
			...
			dialog.text = "¡Excelente, mi querido amigo! Enviaré de inmediato cartas a mis agentes, y se pondrán manos a la obra. Tendrán que buscar navíos que viajen a esas regiones, lo cual tomará algo de tiempo. Y el viaje mismo depende del viento, que está en manos de Nuestro Señor. Pero entiendo que, como máximo, en un mes mis hombres estarán de regreso.";
			link.l1 = "Entonces nos veremos dentro de un mes, "+npchar.name+". Gracias de nuevo. Nos ha ayudado mucho. ¡Hasta pronto!";
			link.l1.go = "exit";
		...
		case "WildRose_Fadey_14_nopay":
			dialog.text = "Comprendo, "+pchar.name+", la suma no es poca, eso está claro. Lo esperaré aquí en cuanto reúna el dinero.";
		...
		case "WildRose_Fadey_return":
			dialog.text = "Recuerdo bien su asunto, estimado amigo. ¿Ha conseguido los ochocientos doblones?";
			if (PCharDublonsTotal() >= 800)
				{
					link.l21 = "¡Adelante, monsieur Fadey! Aquí está su oro. Todo según lo acordado.";
					link.l21.go = "WildRose_Fadey_14_pay";
				}
			link.l31 = "Aún estoy reuniendo la suma, pero no se preocupe, no tardaré en volver.";
			link.l31.go = "exit";
		break;
		
		case "WildRose_Fadey_16":
			dialog.text = "¡Lo logramos, amigo mío — y de qué manera! Todos mis hombres regresaron sin resultados... excepto uno. Jérôme Sauvernier, a quien envié a Belice, no ha vuelto, pero envió noticias. Buenas noticias para usted.";
			link.l1 = "¿Le envió una carta? ¿Podríamos leerla?";
		...
		break;
			...
			dialog.text = "Por supuesto, "+pchar.name+". Lo he guardado especialmente para usted, sabía que querría leerlo. Adelante, mi amigo.";
			link.l1 = "Gracias, vamos a leerlo ahora mismo.";
			link.l1.go = "WildRose_Fadey_18";
			AddQuestRecordInfo("WildRose_Records_6", "1");
		break;
		
		case "WildRose_Fadey_18":
			dialog.text = "¡Hace tiempo que no veía una sonrisa así en su rostro, buen amigo!";
			link.l1 = "¡Y no es para menos, "+npchar.name+"! ¡Llevamos tanto tiempo esperando este momento! Pero, ¿sabe?, siempre creímos que lo lograríamos. Y no sé cómo agradecerle por haber sido una parte tan crucial de esto.";
			link.l1.go = "WildRose_Fadey_19";
		break;

		case "WildRose_Fadey_19":
			dialog.text = "Oh, deje ya eso, buen muchacho. Usted es mi amigo, y a los amigos, como es sabido, siempre se les debe ayudar. Vuelva pronto — estoy seguro de que monsieur Jérôme se recuperará rápido y tomará el primer barco que encuentre...";
			link.l1 = "Creo que aceleraremos un poco las cosas. Iremos nosotros mismos a Belice y hablaremos con su enviado. Gracias de nuevo, "+npchar.name+". ¡No tiene idea de lo que ha hecho por nosotros! ¡Hasta pronto!";
			link.l1.go = "exit";
		...
		case "LoyaltyPack_Fadey_1":
			dialog.text = "¿Mi querido amigo Alonso Pimentel que sirve en vuestro navío? ¡Ja! Por supuesto. Cada vez que vuestro barco atraca, ese buen hombre siempre pasa a tomar una jarra. Pocos amigos me quedan, "+pchar.name+". Y valoro a cada uno.";
			link.l1 = "Alonso me contó historias asombrosas sobre vuestras aventuras en la guerra. Incluso me dio vuestra bandolera.";
			link.l1.go = "LoyaltyPack_Fadey_2";
			DelLandQuestMark(npchar);
		break;

		case "LoyaltyPack_Fadey_2":
			dialog.text = "Espero y confío en que las más extraordinarias las haya guardado para sí. Pero ya que Alonso ha compartido nuestra amistad con vos, tendréis también de mí una curiosidad. ¡Mirad!";
			link.l1 = "¿Eso es... una armadura?";
			link.l1.go = "LoyaltyPack_Fadey_3";
		break;

		case "LoyaltyPack_Fadey_3":
			dialog.text = "Ah, amigo mío. Esto es todo lo que queda de mi armadura de espejos que llevé durante aquella maldita guerra. Y luego, cerca de Smolensk, tuve que\n"+
			"Sea como fuere, incluso en este estado se ve magnífica y protege aún mejor. ¡Y ya no me queda en absoluto!";
			link.l1 = "Se ve exótico... incluso para estos lares. Un regalo magnífico, Fadey. Gracias.";
			link.l1.go = "LoyaltyPack_Fadey_4";
		break;
		
		case "LoyaltyPack_Fadey_4":
			dialog.text = "Para vos, amigo mío, solo mil doblones.";
			if (PCharDublonsTotal() >= 600)
			{
				if (GetSummonSkillFromName(pchar, SKILL_Commerce) >= 60)
				{
					link.l1 = "Permitidme corregiros, querido Fadey. Mil doblones sería por una armadura completa. ¿Pero por solo el peto?";
					link.l1.go = "LoyaltyPack_Fadey_5";
					Notification_Skill(true, 60, SKILL_COMMERCE);
				}
				else if (PCharDublonsTotal() >= 1000)
				{
					link.l1 = "No me extraña que os llevéis bien con Alonso. Tomad vuestro oro.";
					link.l1.go = "LoyaltyPack_Fadey_1000";
					Notification_Skill(false, 60, SKILL_COMMERCE);
				}
			}
			link.l2 = "¡Ja! ¡Casi me atrapáis, Fadey! Quizás en otra ocasión.";
			link.l2.go = "LoyaltyPack_Fadey_MoneyLater";
		break;
		
		case "LoyaltyPack_Fadey_MoneyLater":
			dialog.text = "Por supuesto, no hay prisa. Mi armadura de espejos siempre os estará esperando.";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "LoyaltyPack_Fadey_5":
			dialog.text = "¡Oh, qué astuto, qué sagaz! Está bien, me desprenderé de ella por seiscientas piezas de oro.";
			link.l1 = "No me extraña que os llevéis bien con Alonso. Tomad vuestro oro.";
			link.l1.go = "LoyaltyPack_Fadey_600";
		break;
		
		case "LoyaltyPack_Fadey_1000":
			dialog.text = "Un buen trato. Os agradezco y entrego mi armadura de espejos a buenas manos. Y cuidad de Alonso, capitán.";
			link.l1 = "Quién cuida de quién aquí...";
	...
	case "guardoftruth":
		...
		link.l1 = "Un corsario ofreció a la parroquia una cruz pectoral de oro con lazurita para el perdón de sus pecados. Es un objeto único y valioso. El problema es que esta cruz fue robada de otra parroquia. No solo eso, sino que un sacerdote fue asesinado durante el robo.";
		link.l1.go = "guardoftruth_1";
		break;

	case "guardoftruth_1":
		dialog.text = "¡Oh, inmaculada Theotokos! ¡No me digas!";
		link.l1 = "Pues así son las cosas. Estoy representando a los feligreses robados e intentando devolver la cruz a sus dueños originales.";
		link.l1.go = "guardoftruth_2";
		break;

	case "guardoftruth_2":
		dialog.text = "Una acción noble y muy piadosa. ¿Intentando ganarte puntos con el Todopoderoso?";
		link.l1 = "El problema es que el padre se niega a devolvérmelo, a pesar de todo lo que le he dicho. No lo entiendo. ¿Cómo se puede colocar tranquilamente una cruz robada con la sangre de un hombre inocente en la Casa de Dios? ¡Eso es blasfemia!";
	...
	case "guardoftruth_3":
		...
		link.l1 = "¡Así es! Tienes bastante influencia en Basse-Terre. Eres muy respetado, así que quizás el sacerdote escuche tus amonestaciones.";
	...
	case "guardoftruth_12":
		...
		// Log_Info("¡Has recibido una cruz dorada con lazurita!");
		PlaySound("interface\important_item.wav");
		dialog.text = "Siempre me alegra ayudar a un amigo amable y, lo que es más importante, generoso. Pásate más a menudo. Quizás tenga un poco de vodka cuando me lo traigan de la madre patria.";
		link.l1 = "¡Con gusto!";
	...
	case "guardoftruth_17":
		dialog.text = "Por supuesto que no, ahora está muerto. Una banda de malditos piratas envió su filibote al Reino de Davy Jones, y a toda la tripulación a Mictlantecuhtli. La verdad sea dicha, los rumores decían que fueron atacados por profesionales disfrazados de piratas... agentes de la Inquisición. El Padre Vincento siempre atrapa a su presa, dicen.";
	...
	case "guardoftruth_18":
		...
		link.l1 = "¿Conoces a Patterson?";
		link.l1.go = "guardoftruth_19";
		break;

	case "guardoftruth_19":
		dialog.text = "¿Quién no conoce a William Patterson!? Es un recién llegado al Caribe, al igual que tú. Y al igual que tú, ya ha forjado una reputación imponente. El Sr. Patterson es el amigo más cercano del Coronel Fox, y está bien relacionado con el propio Lord Windsor, el Gobernador General de todas las colonias inglesas en el Caribe. A menudo visita el palacio del gobernador en Port Royal, en Jamaica.";
	...
	// персидские клинки
	case "persian":
		dialog.text = "Echemos un vistazo, " + pchar.name + "¡... Da! ¡Es uno de ellas! ¡Ese es mi chico, me has alegrado el día! ¿Dónde la encontraste?";
	...
	case "persian_4":
		...
		link.l1 = "Entendido. ¡Es una oferta estupenda, Fadey! Creo que aprovecharé la oportunidad que me has presentado. Entonces, ¿cada vigésimo día del mes, quinientos doblones por cincuenta piezas?";
		link.l1.go = "persian_5";
		break;

	case "persian_5":
		AddQuestRecordInfo("Unique_Goods", "2");
		dialog.text = "Da. Ve a recoger tu compra. ¡Pero espera, espera, querido amigo! Además de este shamshir, que me devolviste por pura benevolencia, había otras dos espadas. Te ruego, por favor, si los encuentras, tráemelos de vuelta y te pagaré más que un precio justo por su devolución.";
	...
	case "persian_8":
		...
		// Log_Info("¡Has recibido el amuleto del escarabajo!");
		PlaySound("interface\important_item.wav");
	...
	case "persian_9":
		dialog.text = "¡Oh, gracias a Dios que pedí ayuda precisamente a ti!" + pchar.name + "¡Eres un hombre milagroso, amigo mío! Muéstrame... ¡Ohooo! Es, es ella. ¡Mi querida! ¡Krasavitsa! ¡Gramercy, buen hombre, me inclino ante ti! Aquí, aquí está tu dinero. ¡Cuatrocientos doblones y ni un kopek menos! No seré tacaño.";
	...
	case "persian_11":
		dialog.text = "Es muy cómoda y duradera, pero aún así funciona tan bien como el coracero de hierro. ¡Y además se ve estupenda! Deberías volver en un par de semanas y echarle un vistazo. Pero no tardes más de un mes, o se lo venderé al cliente original.";
	...
	case "persian_14":
		...
		// Log_Info("¡Has recibido una armadura de mimbre!");
		AddCharacterExpToSkill(pchar, "Sneak", 300);
		dialog.text = "¡Sí, buen hombre! Aquí, ten. Esta armadura de mimbre te servirá bien, te lo aseguro. ¡No hay nada igual en todo el Caribe!";
		link.l1 = "Sí, puedo ver eso. ¡Gracias! No puedo esperar para probármela...";
	...
	case "ropes":
		...
		{
			dialog.text = "Entra, mi querido amigo. La mercancía está lista para que la compres. 2 125 doblones por doscientas cincuenta piezas.";
	...
	case "relation":
		...
		if (rate < 2)
		{
			dialog.text = "Por supuesto. Seguro que he oído hablar de tus aventuras, o desventuras. Puedo encargarme de tu pequeño problema, nada que la cantidad adecuada de oro engrasando las palmas adecuadas no pueda arreglar. " + sTemp + " de oro y te sacaré del caldero.";
			if (PCharDublonsTotal() >= iFadeyPseudoGlobal) // belamour legendary edition
			{
				link.l1 = "¡Estupendo! Aquí está el oro.";
				link.l1.go = "agree";
			}
			link.l2 = "Entonces es el momento justo para ir a buscar el dinero.";
			link.l2.go = "exit";
		}
		else
		{
			if (rate < 4)
			{
				dialog.text = "Por supuesto. He oído hablar de tus aventuras, o desventuras. Puedo encargarme de tu pequeño problema, nada que la cantidad adecuada de oro engrasando las palmas adecuadas no pueda solucionar. " + sTemp + " de oro y te sacaré de la sartén.";
				if (PCharDublonsTotal() >= iFadeyPseudoGlobal) // belamour legendary edition
				{
					link.l1 = "¡Estupendo! Aquí está el oro.";
					link.l1.go = "agree";
			...
			{
				dialog.text = "¡Sí, estás en un buen lío! No puedo resolver completamente esta situación. Sin embargo, puedo suavizar el golpe del rayo que está a punto de descender sobre tu pecadora cabeza. Y más tarde, en cualquier momento, podemos presentar un soborno nuevamente si tienes el dinero y el deseo. " + sTemp + " de oro y puedo empezar a suavizar tus problemas.";
				if (PCharDublonsTotal() >= iFadeyPseudoGlobal) // belamour legendary edition
				{
	...
	case "contraband":
		...
		sTemp = FindRussianDublonString(iFadeyPseudoGlobal);
		dialog.Text = "¿Por qué fuiste y los enfureciste, buen hombre? Los contrabandistas no son la peor calaña en esta parte del mundo, y pueden darte buenas ganancias. Está bien, te ayudaré, sé cómo congraciarme con ellos... Eso serán " + sTemp + ", sin regateos.";
		if (PCharDublonsTotal() >= iFadeyPseudoGlobal) // belamour legendary edition
		{
	...
	case "UpgradeRopes_3":
		dialog.text = "Bueno, si esa es tu decisión, no hay más que discutir. Este cambio no afectará nuestra amistad. Vuelve a visitarme, " + GetSexPhrase("buen señor", "bella dama") + ".";
		link.l1 = "Adiós.";
		link.l1.go = "exit";
	...
	case "UpgradeRopes_Agreed":
		dialog.text = "¡Eso es sensato! No eres de los que hablan por hablar, sino que sabes actuar. Para personas de negocios como tú, siempre hay un descuento disponible. ¡Quince por ciento de descuento en todos los futuros envíos! Aquí está nuestro trato: 250 bobinas de cuerda de cáñamo que tendré listas para ti cada mes. Puedes recogerlas, como antes, el día 20, pagando 2 125 doblones por todo, sin resto.";
