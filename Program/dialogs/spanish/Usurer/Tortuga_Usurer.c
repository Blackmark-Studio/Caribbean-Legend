...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	case "tonzag_bail_2":
		dialog.text = "Por supuesto, sin embargo, será un poco más caro para usted. Permítame decirle exactamente... " + pchar.questTemp.TonzagQuest.Bail + " los doblones serán " + int(pchar.questTemp.TonzagQuest.Bail) * 150 + " pesos.";
