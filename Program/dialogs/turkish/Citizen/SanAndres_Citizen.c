...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = RandPhraseSimple("Fikrimi değiştirdim.'","Şu anda söyleyecek başka bir şeyim yok.");
		    link.l1.go = "exit";
		break;
		
		case "info":
        // заменить на описание неких НПС, по квестам
			dialog.text = "Sence gizli servis için mi çalışıyorum "+NationNameGenitive(int(NPChar.nation))+"?";
        ...
        // заменить на описание как пройти, по квестам
            ...
            link.l1 = "Ne kadar da şaşkınsın! Defol.";
			link.l1.go = "exit";
