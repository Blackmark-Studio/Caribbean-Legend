...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Fikrimi değiştirdim, rahatsız ettiğim için kusura bakmayın.","Söyleyecek bir şeyim yok, affedin."),"Haklısınız, özür dilerim.","Haklısınız, bu zaten üçüncü sefer oldu. Affedin beni.","Üzgünüm, önemli bir şey değil.",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
