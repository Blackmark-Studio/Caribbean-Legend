...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Ne tür sorular?","Ne istiyorsun, "+GetAddress_Form(NPChar)+"?"),"Bana zaten bir soru sormaya çalıştınız "+GetAddress_Form(NPChar)+"...","Bugün o soruyu üçüncü kez gündeme getiriyorsun...","Bak, eğer limanın işleriyle ilgili bana söyleyecek bir şeyin yoksa, o zaman sorularınla beni meşgul etme.","block",1,npchar,Dialog.CurrentNode);
