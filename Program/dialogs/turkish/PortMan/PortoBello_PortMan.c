...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "SharkGoldFleet_18":
			...
			dialog.text = "Beklettiğim için üzgünüm. İşte sizin "+int(pchar.questTemp.SharkGoldFleet)+" sekiz reales. Ve bu durumda, cevabın bedelini Caracas'ta kendileri ödeyecekler. Onlara bunu benim söylediğimi ilet.";
