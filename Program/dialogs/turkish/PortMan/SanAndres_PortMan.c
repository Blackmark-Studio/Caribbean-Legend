...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Fikrimi değiştirdim.","Konuşacak bir şeyim yok."),"Boş ver.","Gerçekten de, bu üçüncü sefer...","Üzgünüm, ama şimdilik limanın işlerine ilgim yok.",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
