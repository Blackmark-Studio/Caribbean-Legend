void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Grinspy_40":
			dialog.text = "Sen aptal değilsin, "+pchar.name +". Buradaki birçok kişinin aksine. Evet, aşağı yukarı böyle çalışır. Şahsen, tüm bu evrakları yorucu buluyorum, ama Alan Milroe ve ondan önce Narwhal klanını yönetenlerin zamanından beri böyle oldu. Bu tür kayıtları tutuyoruz - ve bundan daha fazlası: ilk önce Rivadolar veya korsanlar tarafından ulaşılan gemileri bile kaydediyoruz. Bu durumlarda, elbette, gemide kimin veya neyin olduğunu bilmiyoruz...";
		...
		case "WildRose_Alonso_12":
			...
			dialog.text = "Seni gördüğüme çok sevindim kaptan! O herifin, seni aradığını öğrendiği kesin — yolun ortasında üzüm saçmasıyla karşılandık. Birkaç adamımla geri çekilmeyi başardım ve limana koşup haber verdik. Neyse ki, şehirden alelacele aldığım kayıktaki halimi gören nöbetçi hemen durumu kavradı. Hızla adamları topladı — ve yardıma buraya geldik.";
			link.l1 = "Teşekkür ederim dostum... "+sld.name+" benim yüzümden öldü... Sizi doğrudan tuzağa gönderdim.";
			link.l1.go = "WildRose_Alonso_13";
		break;

		case "WildRose_Alonso_13":
			dialog.text = "Kimse bunun bir tuzak olduğunu bilmiyordu. Sen doğru olanı yaptın — daha dikkatli olmamız gerekirdi.";
			link.l1 = "Yine de... bunu öngörmeliydim. O meyhaneye hiç girmemeliydim.";
			link.l1.go = "WildRose_Alonso_14";
		break;

		case "WildRose_Alonso_14":
			dialog.text = "Artık çok geç, kaptan. Ne yapmamızı emrediyorsun?";
			link.l1 = "Adamlarımız geleneklere uygun şekilde gömülmeli. Northwood'u da, uzak bir yerde ormanın içinde gömün. Bu yeri kimse bilmemeli, özellikle Mary. O yüzden sadece en güvendiğin adamları al.";
			link.l1.go = "WildRose_Alonso_15";
		break;

		case "WildRose_Alonso_15":
			dialog.text = "Emredersiniz.";
			link.l1 = "Mary ile sonra gemiye döneceğiz. Biraz yalnız kalmamız gerek.";
			link.l1.go = "exit";
		...
		case "WildRose_Mary_261":
			...
			{
				dialog.text = "Tanrım, "+pchar.name+"... Hâlâ inanamıyorum, gerçekten inanamıyorum. Babam... O bir canavar... Bunu bana neden yaptı? "+sSname+"'i öldürdü! Gerçekten delirmiş olabilir mi?";
				link.l1 = "'Cornwall'da isyan, Atlantik üzerinden kaçış, fırtına ve annesinin ölümü, o putların portalından geçiş – Komançi iksiri olmadan! Bunlar, fazlasıyla zorlu sınavlardı. Ama keşke o cehennemden sağ çıkmasaydı.";
			}
			else
			{	
				dialog.text = "Tanrım, "+pchar.name+"... Hâlâ inanamıyorum, gerçekten inanamıyorum. Babam... O bir canavar... Bunu bana neden yaptı? Gerçekten delirmiş olabilir mi?";
				link.l1 = "Korkunç acılardan geçti. 'Cornwall'da isyan, Atlantik üzerinden kaçış, fırtına, annenin ölümü... Komançi iksiri olmadan o putların portalından nasıl geçtiğini hayal bile edemiyorum – ama bu onun aklını mahvetti.";
			}
