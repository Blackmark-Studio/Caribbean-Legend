...
void ProcessDialogEvent()
{
	...
	// --------------------------------------вернулся на Остров---------------------------------------------
		...
		case "return_2":
			...
			{
				dialog.text = "Hayır, üşümüyorum. Sadece... burada konuşmak istemiyorum. Sonra kamarama gel. Seninle yalnız konuşmak istiyorum, di mi? Şimdi Nathaniel’in yanına mı gidiyorsun?";
				link.l1 = "Evet. Danielle'i ona götürmem gerekiyor. Uzun sürmeyecek. Yakında görüşürüz, Mary.";
			}
			link.l1.go = "return_3";
		break;
	...
	// --> Мэри вне LSC
		...
		case "LongHappy_9c":
			...
			dialog.text = "Bence, "+int(pchar.questTemp.LongHappy.MarryMoney)+" peso yeter, di mi? "+int(pchar.questTemp.LongHappy.MarryRum)+" varil rom - içkisiz kalmaktan daha kötüsü yok! Her şeyi toplar toplamaz meyhaneye gel. Gerisini ben hallederim.";
