	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
			...
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Patent") && CheckCharacterItem(pchar, "patent_fra") || CheckAttribute(pchar, "questTemp.Patria.GenGovernor") && !CheckAttribute(pchar, "questTemp.SharlieEpilog_Governor"))
			{
				if (CheckAttribute(pchar, "questTemp.Patria.GenGovernor"))
				{
					link.l3 = "Forger Baronu’nu ve Capsterville kâtipliğini, genel vali görevini bırakmak zorunda olduğum konusunda bilgilendirmek istiyorum.";
					link.l3.go = "SharlieEpilog_Benua_Governor";
				}
				else
				{
					link.l3 = "Geçerli bir Fransız patentine sahibim — bu kararımı Capsterville kâtipliğine bildirmek istiyorum.";
			...
			{
				link.l6 = "Bas-Ter’deki Moskof Fadey’e bir haber göndermem gerekiyor.";
			...
			{
				link.l7 = "Maroon Town’daki Hawk ailesine yolculuğumdan bahsetmek istiyorum.";
				link.l7.go = "SharlieEpilog_Benua_Houk";
			}
			if (!CheckAttribute(pchar, "questTemp.SharlieEpilog_Jino") && CharacterIsAlive("Jino"))
			{
				link.l8 = "Saint John’s’dan Gino Guineyli’ye Eski Dünya’ya gittiğimi bildirmek istiyorum.";
		...
		case "SharlieEpilog_Benua_Money_4":
			dialog.text = "Bu durumda, yüz bin peso bağış yeterli olacaktır. Bu parayla ihtiyacı olanlar için aylarca yemek sağlayabiliriz. Gerekli miktar, kilise bağışı da dâhil olmak üzere, yanında varsa hemen başlayabiliriz.";
		...
		case "SharlieEpilog_Benua_Money_5":
			dialog.text = "Bu durumda bağışın iki yüz elli bin peso olmalı. Bu miktar bize, senin adını yüceltecek ve en azından başlarda ihtiyaçlarını karşılayacak bir yetimhane inşa etmemizi sağlar. Gerekli miktar, kilise bağışı da dâhil olmak üzere, yanında varsa hemen başlayabiliriz.";
		...
		case "SharlieEpilog_Benua_Money_6":
			dialog.text = "Görünüşe göre zamanını boşa harcamamışsın, "+pchar.name+". Sanırım beş yüz bin peso bağış fazlasıyla yeterli olacaktır. Böyle bir katkı sayesinde bir hastane inşa edebilir ve onu uzun yıllar boyunca tüm ihtiyaçlarıyla donatabiliriz. Gerekli miktar, kilise bağışı da dâhil olmak üzere, yanında varsa hemen başlayabiliriz.";
		...
		case "SharlieEpilog_Benua_Governor":
			dialog.text = "Babanla görüşebilmek uğruna böylesine yüksek bir makamdan vazgeçmek zorunda kalmana içtenlikle üzülüyorum, "+pchar.name+". Yine de senin için ailenin her şeyin üzerinde olduğunu görmek teselli verici.";
			link.l1 = "Beni asıl rahatsız eden, burada, Karayipler’de geçirdiğim onca zaman boyunca ona tek bir mektup bile göndermemiş olmamdır; bunu şahsen yapacağım bir ziyaretle telafi etmeye niyetliyim. Başarım ne kadar baş döndürücü olursa olsun, babama karşı olan görevimi unutmamalıyım. Barona gelince — böylesine ani bir ayrılığı bağışlayacağını düşünüyorum: nihayetinde ortak devletimizin yararı için yeterince çok şey yaptım.";
			link.l1.go = "SharlieEpilog_Benua_Governor_2";
			pchar.questTemp.SharlieEpilog_Governor = true;
		break;

		case "SharlieEpilog_Benua_Governor_2":
			dialog.text = "Zor ama onurlu bir seçim yaptın, evladım. Güç ve unvanlar geçicidir, fakat aileye ve soya karşı görev ebedidir. İnan bana, Tanrı niyetlerini görür ve unvanlara değil, kalbin sadakatine karşılık verir.";
			link.l1 = "Teşekkür ederim, kutsal baba. Sözleriniz benim için çok değerli.";
		...
		case "SharlieEpilog_Benua_Governor_4":
			dialog.text = "Mükemmel. Mektupların mümkün olan en kısa sürede ulaştırılması için her türlü tedbiri alacağım.";
			link.l1 = "...";
			link.l1.go = "SharlieEpilog_Benua_Delivery";
