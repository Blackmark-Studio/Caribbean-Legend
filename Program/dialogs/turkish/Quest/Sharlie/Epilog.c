void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SharlieEpilog_Cureer":
			dialog.text = "Affedersiniz. Siz " + GetTitle(NPChar, false) + " " + GetFullName(pchar) + " misiniz?";
			link.l1 = "Bizzat kendisiyim. Size nasıl yardımcı olabilirim?";
			link.l1.go = "SharlieEpilog_Cureer_1";
		break;

		case "SharlieEpilog_Cureer_1":
			dialog.text = "Ah, sonunda... Sizi bulmak hiç de kolay olmadı. Neredeyse tüm takımadayı aramak zorunda kaldım. Size Başrahip Benoît'den bir mektup getirdim.";
			link.l1 = "Hmm... Başrahip'ten mi? Beklenmedik.";
			link.l1.go = "SharlieEpilog_Cureer_2";
		break;

		case "SharlieEpilog_Cureer_2":
			dialog.text = "Mektubu doğrudan size teslim etmem emredildi. Ödeme konusunda endişelenmeyin — Başrahip tüm masraflarımı önceden karşıladı.";
			link.l1 = "Peki, verin bakalım. Teşekkür ederim.";
			link.l1.go = "exit";
		...
		case "SharlieEpilog_Dassen":
			dialog.text = "Emirleriniz nelerdir, "+GetTitle(NPChar, true)+"?";
			link.l1 = ""+npchar.name+", lafı uzatmayacağım - takımdan ayrılıyorum. Ailevi meseleler, babamın malikanesinde bulunmamı gerektiriyor.";
			link.l1.go = "SharlieEpilog_Dassen_1";
		break;
		
		case "SharlieEpilog_Dassen_1":
			dialog.text = "Doğru anlıyorsam, yollarımız ayrılıyor mu?";
			link.l1 = "Ne yazık ki... Başka türlü davranamam.";
			link.l1.go = "SharlieEpilog_Dassen_2";
		break;
		
		case "SharlieEpilog_Dassen_2":
			dialog.text = "Öyleyse, sizinle aynı bayrak altında hizmet etmek benim için bir onurdu ve kader izin verirse bunu yeniden memnuniyetle yaparım.";
			link.l1 = "Umarım aramızdaki dostluk kopmaz, aksine daha da güçlenir; zira birlikte azımsanmayacak maceralar paylaştık.";
			link.l1.go = "SharlieEpilog_Dassen_nothing";
			link.l2 = "Sadakatiniz ve profesyonelliğiniz karşılığında, terhis ödemesi olarak size bir aylık maaş vermek istiyorum.";
			link.l2.go = "SharlieEpilog_Dassen_salary";
			link.l3 = "Hizmetiniz kusursuzdu ve sizi layıkıyla ödüllendirmem gerektiğini düşünüyorum. Bunu kabul edin - işte üç aylık maaş. Bu ödülü fazlasıyla hak ettiniz.";
			link.l3.go = "SharlieEpilog_Dassen_salaryX3";
		break;
		
		case "SharlieEpilog_Dassen_nothing":
			dialog.text = "Bu umudu içtenlikle paylaşıyorum, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Bana sadece Charles deyin. Bu arada, sizin için bir şeyim daha var.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			}
			else
			{
				link.l1 = "Öyleyse, bir sonraki buluşmamıza kadar, monsieur "+npchar.lastname+". Hoşça kalın.";
				link.l1.go = "SharlieEpilog_Dassen_Leave";
			}
		break;
		
		case "SharlieEpilog_Dassen_salary":
			dialog.text = "Teşekkür ederim, "+GetTitle(NPChar, true)+".";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Bana sadece Charles deyin. Bu arada, sizin için bir şeyim daha var.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			...
			{
				link.l1 = "Öyleyse, bir sonraki karşılaşmamıza kadar, monsieur "+npchar.lastname+". Hoşça kalın.";
				link.l1.go = "SharlieEpilog_Dassen_Leave";
			}
		...
		case "SharlieEpilog_Dassen_salaryX3":
			dialog.text = "Son derece minnettarım, "+GetTitle(NPChar, true)+", bana karşı fazlasıyla cömertsiniz.";
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
			{	
				link.l1 = "Bana sadece Charles deyin. Bu arada, sizin için bir şeyim daha var.";
				link.l1.go = "SharlieEpilog_Dassen_Governor";
			...
			{
				link.l1 = "Resmiyeti bir kenara bırakalım, bana sadece Charles deyin. Yola çıkışım şerefine, handa küçük bir kutlama düzenlemeyi düşünüyorum. Umarım bize katılırsınız?";
		...
		case "SharlieEpilog_Dassen_Governor":
			dialog.text = "Merakımı uyandırdınız, "+pchar.name+".";
			link.l1 = "Sizi Isla Mona valiliği görevine tavsiye ettim. Yakında ilgili bir mektup kançılaryadan gelecektir ve umarım buna ret cevabı vermezsiniz. Bu ada benim için çok şey ifade ediyor ve sizi yönetimin başında görmekten büyük mutluluk duyarım.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_1";
		break;
		
		case "SharlieEpilog_Dassen_Governor_1":
			dialog.text = ""+UpperFirst(GetAddress_Form(NPChar))+"... "+pchar.name+"... Bu gerçekten de oldukça beklenmedik...";
			link.l1 = "Yine de. Cevabınız ne olacak?";
			link.l1.go = "SharlieEpilog_Dassen_Governor_2";
		break;
		
		case "SharlieEpilog_Dassen_Governor_2":
			dialog.text = "Reddedilemeyecek bir teklif. Memnuniyetle kabul ediyorum ve bu adanın refahı ile halkının esenliği için elimden gelen her şeyi yapacağıma söz veriyorum.";
			link.l1 = "Mükemmel, dostum! O hâlde, yola çıkışım şerefine düzenlenecek kutlama için sizi handa bekliyorum. Her şey hazır olduğunda Alonso size haber verecek.";
			link.l1.go = "SharlieEpilog_Dassen_Governor_3";
		break;
		
		case "SharlieEpilog_Dassen_Governor_3":
			dialog.text = "Bunu asla kaçırmam, monseigneur.";
			link.l1 = "";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		
		case "SharlieEpilog_Dassen_Tavern":
			dialog.text = "Bunu asla kaçırmam, "+pchar.name+".";
			link.l1 = "Mükemmel, dostum. O hâlde orada buluşuruz. Başlamaya hazır olduğumuzda Alonso size haber verecek.";
			link.l1.go = "SharlieEpilog_Dassen_Leave";
		break;
		...
		case "SharlieEpilog_PikarOnUliss_D_1":
			if (CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarAlive") || CheckAttribute(pchar, "questTemp.SharlieEpilog_PikarResurrected")) {dialog.text = "Haklısın.";}
		...
		case "SharlieEpilog_InKitchenDeMonpe_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer") || CheckAttribute(pchar, "questTemp.LSC.Mary_officer"))
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "iyi arkadaşlar";
				else sStr = "silah arkadaşı";
				dialog.text = "";
			...
			{
				if (GetAttributeInt(pchar, "questTemp.SharlieEpilog_Friends") >= 2) sStr = "senin iyi arkadaşların";
				else sStr = "senin arkadaşın";
				dialog.text = "";
		...
		case "SharlieEpilog_KomendantFort_5":
			dialog.text = "Mükemmel bir plan, Yüce Hazretleri! Ancak… deniz savaşlarında çelikleşmiş bir insan olsanız da, böylesi bir mevkidekilerin hayatlarını bizzat tehlikeye atmaları uygun değildir. Filoya pekâlâ … komuta edebilir.";
			link.l1 = "Avrupa’daki sakin hayata katlanamadığım gibi, savaşın kaderi belirlenirken kıyıda boş boş beklemeye de katlanamam. Kaderden kaçış yoktur, "+GetAddress_Form(NPChar)+" "+npchar.lastname+". ";
			link.l1.go = "SharlieEpilog_KomendantFort_6";
		break;

		case "SharlieEpilog_KomendantFort_6":
			dialog.text = "Öyleyse sizin dediğiniz gibi olsun. Hazırlıklara başlanması emrini vermeme izin veriyor musunuz?";
		...
		case "SharlieEpilog_Mishelle_3":
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) sStr = " ve eşinle birlikte";
			dialog.text = "Hâlâ anlamadın mı? Öldün. Mürettebatınla birlikte"+sStr+". Soymaya karar verdiğin sıradan bir tüccar, barut mahzenini havaya uçurdu — senin gibilerin eline tek bir akçe bile geçmesin diye.\nSpectra sunt memoria peccatorum. Hayalet sensin, "+pchar.name+"... Karayipler'de anlatılan, açgözlülük ve kör kibir tarafından yutulmuş bir adamın efsanesi. Kaç kişiyi altın uğruna öldürdün?";
