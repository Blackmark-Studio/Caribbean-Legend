...
case "Europe":
		...
		case "MOT_Barbie_107":
			dialog.text = "Evet. Maalesef geçen yıl Santiago kaçakçılarıyla aram bozuldu. Neredeyse bunu unutuyordum ama bu kişiler yakın bağlantılar ve uzun belleğe sahipler. İşte bir tavsiye: onları kızdırmaktan ve anlaşmalardan dönmekten kaçın; sonra düzeltemeyeceğin bir durum olur.";
