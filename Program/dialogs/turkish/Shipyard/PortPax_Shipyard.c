...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Hangi sorularınız var?","Size nasıl yardımcı olabilirim?"),"Az önce bana bir soru sormaya çalıştınız...","Benim tersanemde ya da bu kasabada böylesine meraklı insanlara hiç rastlamadım.","Bu kadar çok soru neden? Benim işim gemi yapmak. Hadi ona bakalım.","block",1,npchar,Dialog.CurrentNode);
