...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Hangi sorularınız var?","Size nasıl yardımcı olabilirim?"),"Az önce bana bir soru sormaya çalıştınız...","Bu şehirde ya da tersanemde böylesine meraklı insanlarla hiç karşılaşmadım.","Bu kadar çok soru neden? Benim işim gemi yapmak. Hadi işimize bakalım.","block",1,npchar,Dialog.CurrentNode);
