...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Bir askere ne sormak istersin?","Askerin tüm hayatı planlı - nöbet tutmak, koşturmak... Size nasıl yardımcı olabilirim, "+GetAddress_Form(NPChar)+"?"),"Bir askeri aptalca sorularla rahatsız etmemelisin, "+GetAddress_Form(NPChar)+"...","Bugün bana üçüncü kez soru sormaya çalışıyorsun...","Bir askerin hayatı kolay değildir, şimdi de sen, pislik, beni deli ediyorsun...","block",1,npchar,Dialog.CurrentNode);
