...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat("Biliyor musun, "+NPChar.name+", belki bir dahaki sefere.","Evet, nedense unuttum...","Evet, gerçekten de üçüncü kez...","Hm, yapamam...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
