...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat("Biliyor musun, "+NPChar.name+", belki bir dahaki sefere.","Doğru ya, nedense unutmuşum...","Evet, gerçekten de üçüncü kez...","Hm, yapamam...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
