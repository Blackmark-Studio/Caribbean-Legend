...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Hangi sorularınız var?","Size nasıl yardımcı olabilirim?"),"Bana bu soruyu kısa bir süre önce de sormuştunuz...","Evet, tahmin edeyim... Yine aynı şeyleri mi dolaşıyorsun?","Dinle, burada finans işlerini ben yönetiyorum, sorulara cevap vermem...","block",1,npchar,Dialog.CurrentNode);
