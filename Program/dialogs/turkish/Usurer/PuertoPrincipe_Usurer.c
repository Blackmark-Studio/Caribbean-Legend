...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Hangi sorularınız var?","Size nasıl yardımcı olabilirim?"),"Bana bu soruyu kısa bir süre önce de sormuştunuz...","Evet, tahmin edeyim... Yine aynı şeyleri mi tekrarlıyorsunuz?","Bakın, burada finans işlerini ben yürütüyorum, soruları yanıtlamam...","block",1,npchar,Dialog.CurrentNode);
