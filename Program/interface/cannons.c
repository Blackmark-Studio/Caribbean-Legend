...
void ShowGoodsInfo(int iGoodIndex)
{
	...
	BuyOrSell = 0;
	if (int(refStore.Goods.(GoodName).TradeType) == T_TYPE_CONTRABAND)
	{
	    iStorePrice = 0;
	...
	if ((int(refStore.Goods.(GoodName).TradeType) == T_TYPE_AMMUNITION) && (refStore.Colony == "none"))
	{
	    iShipPrice = 0;
