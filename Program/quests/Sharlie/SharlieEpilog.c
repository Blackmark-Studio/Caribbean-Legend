...
void SharlieEpilog_Benua_activation()
{
	if (CharacterIsAlive("SharlieEpilog_cureer"))
	{
...
void SharlieEpilog_Start_2(string qName)
{
	ReOpenQuestHeader("Sharlie");
	AddQuestRecord("Sharlie", "45");
	SharlieEpilog_Benua_activation();
	pchar.questTemp.SharlieEpilog_Start = true;
}
...
void SharlieEpilog_FarewellOfficers()
{
	...
	if (CharacterIsAlive("Ecliaton_Cap"))
	{
		sld = CharacterFromID("Ecliaton_Cap");
		sld.dialog.filename = "Quest\Sharlie\Epilog.c";
		sld.dialog.currentnode = "SharlieEpilog_Dassen";
	}
}
...
void SharlieEpilog_Dassen_exit()
{
	sld = CharacterFromID("Ecliaton_Cap");
	RemovePassenger(pchar, sld);
	LAi_SetCitizenType(sld);
	...
	LAi_group_MoveCharacter(sld, LAI_GROUP_PEACE);
	sld.quest.SharlieEpilog_FarewellOfficers = true;
	pchar.questTemp.SharlieEpilog_Dassen = true;
}
...
void SharlieEpilog_UlysseInSea_3()
{
	...
	//убираем все корабли Шарля, а также пассажиров
	int cn;
...
void SharlieEpilog_UlysseInSea_9(string qName)
{
	...
	//Брашпиль
	if (!CharacterIsAlive("SharlieTutorial_Windlass"))
	{
	...
	sld.reload.l1.name = "reload_cabin";
	sld.reload.l1.go = "Quest_Cabin_Medium";
	sld.reload.l1.emerge = "reload1";
	sld.reload.l1.label = "cabine";
	sld.reload.l1.disable = false;
	
	sld.reload.l2.name = "reload_camp1";
	sld.reload.l2.go = "Quest_Campus";
	sld.reload.l2.emerge = "reload_deck1";
	sld.reload.l2.label = "My_Campus";
	sld.reload.l2.disable = false;
	
	sld.reload.l3.name = "reload_arsenal";
	sld.reload.l3.go = "Quest_Deck_Medium";
	sld.reload.l3.emerge = "reload_deck";
	sld.reload.l3.label = "My_Deck_Medium";
	sld.reload.l3.disable = false;
	
	sld.reload.l4.name = "reload_kitchen";
	sld.reload.l4.go = "Quest_Deck_Medium";
	sld.reload.l4.emerge = "reload_deck";
	sld.reload.l4.label = "My_Deck_Medium";
	sld.reload.l4.disable = false;
...
void SharlieEpilog_LetterFromBenua()
{
	if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_Pirate")) 
	{
		if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) {AddQuestRecordInfo("SharlieEpilogLetter_Jan", "1_1");}
		if (CheckAttribute(pchar, "questTemp.LSC.Mary_officer"))
		{
			if (CheckAttribute(pchar, "questTemp.WildRoseComplete")) {AddQuestRecordInfo("SharlieEpilogLetter_Jan", "1_2");}
			else {AddQuestRecordInfo("SharlieEpilogLetter_Jan", "1_4");}
		}
		if (!CheckAttribute(pchar, "questTemp.Saga.Helena_officer") && !CheckAttribute(pchar, "questTemp.LSC.Mary_officer")) {AddQuestRecordInfo("SharlieEpilogLetter_Jan", "1_3");}
		AddQuestRecordInfo("SharlieEpilogLetter_Rodgar", "1");
	}
	if (CheckAttribute(pchar, "questTemp.SharlieEpilog_Svenson") && !CheckAttribute(pchar, "questTemp.IslaMona.Plantation"))
	{
		if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer")) {AddQuestRecordInfo("SharlieEpilogLetter_Jan", "1_1");}
		if (CheckAttribute(pchar, "questTemp.LSC.Mary_officer"))
		{
			if (CheckAttribute(pchar, "questTemp.WildRoseComplete")) {AddQuestRecordInfo("SharlieEpilogLetter_Jan", "1_2");}
			else {AddQuestRecordInfo("SharlieEpilogLetter_Jan", "1_3");}
		}
		if (!CheckAttribute(pchar, "questTemp.Saga.Helena_officer") && !CheckAttribute(pchar, "questTemp.LSC.Mary_officer")) {AddQuestRecordInfo("SharlieEpilogLetter_Jan", "1_3");}
	}
	if (CheckAttribute(pchar, "questTemp.SharlieEpilog_IslaMona_France"))
	{
		if (CharacterIsAlive("Ecliaton_Cap")) {AddQuestRecordInfo("SharlieEpilogLetter_Caps", "2");}
		else {AddQuestRecordInfo("SharlieEpilogLetter_Caps", "3");}
		AddQuestRecordInfo("SharlieEpilogLetter_Rodgar", "2");

	}
	if (CheckAttribute(pchar, "questTemp.SharlieEpilog_Houk")) 
	{
		AddQuestRecordInfo("SharlieEpilogLetter_Hawk", "1");
		if (!CheckAttribute(pchar, "questTemp.Saga.Helena_officer") && !CheckAttribute(pchar, "questTemp.LSC.Mary_officer")) {AddQuestUserData("SharlieEpilogLetter_Hawk", "sText", StringFromKey("Neutral_41"));}
		else {AddQuestUserData("SharlieEpilogLetter_Hawk", "sText", StringFromKey("Neutral_42"));}
	}
	if (CheckAttribute(pchar, "questTemp.SharlieEpilog_Fadey")) {AddQuestRecordInfo("SharlieEpilogLetter_Fadey", "1");}
	if (CheckAttribute(pchar, "questTemp.SharlieEpilog_Jino")) {AddQuestRecordInfo("SharlieEpilogLetter_Jino", "1");}
	if (CheckAttribute(pchar, "questTemp.SharlieEpilog_Baron")) {AddQuestRecordInfo("SharlieEpilogLetter_Tirax", "1");}
	if (CheckAttribute(pchar, "questTemp.SharlieEpilog_Governor")) {AddQuestRecordInfo("SharlieEpilogLetter_Caps", "1");}
}
