...
{
	if(pchar.GenQuest.EncGirl == "toParents" || pchar.GenQuest.EncGirl == "FindLover" || pchar.GenQuest.EncGirl == "FindingLover")
	{
...
{
	// квест успел закрыться
	if (!CheckAttribute(pchar, "GenQuest.EncGirl.city")) return;
